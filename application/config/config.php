...
define('ROOT_UPLOADS_PATH', $config['base_url'].'assets/uploads/');
define('ROOT_PLUGIN_PATH', $config['base_url'].'assets/plugin/');

define('SMTP_HOST','ssl://smtp.gmail.com');
define('SMTP_PORT','465');
define('SMTP_EMAIL','arvind.kumar@sarasolutions.in');
define('SMTP_PASSWORD','ssss@123'); 
//define('PAGE_TITLE','');
define('PAGE_TITLE','');
