...
class Payment_mode_field_archive_model extends CI_Model {

	var $table = 'hms_payment_mode';
	//var $column = array('hms_payment_mode.p_mode_id','hms_payment_mode_to_field.field_name','hms_payment_mode.created_date');
...
$this->db->join('hms_payment_mode_to_field','hms_payment_mode_to_field.p_mode_id = hms_payment_mode.id','left');
        ...
        $this->db->where('hms_payment_mode.branch_id',$users_data['parent_id']);$i = 0;
