...
class Ipd_discharge_booking_model extends CI_Model 
{
	...
	function search_report_data()
	{
	   ...
	   $search = $this->session->userdata('ipd_discharge_booking_search');
       $user_data = $this->session->userdata('auth_users');
		$this->db->select("hms_ipd_booking.*,hms_patient.*,hms_users.*,hms_ipd_packages.name as package_name,hms_ipd_panel_company.panel_company,hms_ipd_panel_type.panel_type,hms_doctors.doctor_name,hms_ipd_rooms.room_no,hms_ipd_room_to_bad.bad_no,hms_ipd_room_to_bad.bad_name,hms_ipd_room_category.room_category,hms_ipd_booking.created_date as createdate,
...
//hms_patient.address2,hms_patient.address3,
		...
		$this->db->select("hms_ipd_booking.*, hms_patient.patient_email, hms_patient.patient_code,hms_patient.id as patient_id,hms_patient.patient_name,hms_patient.mobile_no,hms_patient.gender,hms_patient.dob,hms_patient.age,hms_patient.age_y,hms_patient.age_m,hms_patient.age_d,hms_patient.simulation_id,hms_patient.address,hms_patient.city_id,hms_patient.state_id,hms_patient.country_id,hms_patient.address,hms_patient.pincode,hms_ipd_packages.name as package_name,hms_ipd_panel_company.panel_company,hms_ipd_panel_type.panel_type,hms_doctors.doctor_name,hms_ipd_rooms.room_no,hms_ipd_room_to_bad.bad_no,hms_ipd_room_to_bad.bad_name,hms_ipd_room_category.room_category,hms_payment_mode.payment_mode,hms_ipd_booking.created_date as createdate,hms_branch_hospital_no.reciept_prefix,hms_branch_hospital_no.reciept_suffix"); 
