...
class Expense_print_setting_model extends CI_Model 
{
	...
	public function save()
	{
		...
		$post = $this->input->post();  
				...
				"setting_name"=>'EXPENSES_PRINT_SETTING',
		...
		{    
			...
			$this->db->update('hms_branch_print_expense_setting',$data);  
			//echo $this->db->last_query(); exit;
		}
		else{    
			$this->db->set('created_by',$user_data['id']);
			$this->db->set('created_date',date('Y-m-d H:i:s'));
			$this->db->insert('hms_branch_print_expense_setting',$data);               
		} 	
	}
