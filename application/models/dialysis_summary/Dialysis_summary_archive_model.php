...
class Dialysis_summary_archive_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->where('hms_dialysis_summery.is_deleted','1');
        $this->db->where('hms_dialysis_summery.branch_id = "'.$users_data['parent_id'].'"');

          $this->db->join('hms_dialysis_management','hms_dialysis_management.id=hms_dialysis_summery.dialysis');
		$i = 0;
