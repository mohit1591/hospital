...
class Ipd_doctor_signature_archive_model extends CI_Model {

	var $table = 'hms_signature';
	var $column = array('hms_signature.id','hms_doctors.doctor_name', 'hms_department.department','hms_signature.signature','hms_signature.sign_img','hms_signature.created_date','hms_signature.modified_date');  
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("hms_signature.*, hms_doctors.doctor_name, hms_department.department"); 
		$this->db->from($this->table);  
        $this->db->where('hms_signature.branch_id = "'.$users_data['parent_id'].'"');
          $this->db->where('hms_signature.is_deleted ','1');
