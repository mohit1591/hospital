...
class Rate_archive_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
	    ...
	    $this->db->where('path_rate_plan.is_deleted','1');
	  
		 $this->db->where('path_rate_plan.branch_id = "'.$user_data['parent_id'].'"');
