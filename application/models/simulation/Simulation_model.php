...
class Simulation_model extends CI_Model {
	...
	var $column = array('hms_simulation.id','hms_simulation.simulation', 'hms_simulation.status','hms_simulation.sort_order');  
	...
	public function get_by_id($id)
	{
		...
		$this->db->where('hms_simulation.id',$id);
		$this->db->where('hms_simulation.is_deleted','0');
		$query = $this->db->get(); 
	...
	public function save()
	{
		...
		{    
			...
			$this->db->update('hms_simulation',$data);  
		}
		else{    
			$this->db->set('created_by',$user_data['id']);
			$this->db->set('created_date',date('Y-m-d H:i:s'));
			$this->db->insert('hms_simulation',$data);               
		} 	
	}
