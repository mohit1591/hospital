    ...
    if(!empty($booked_test_list))
     {
        ...
        { 
         ...
         foreach($booked_test_list as $booked_test)
         {
           ...
           $comission_arr = get_doc_hos_comission($post['referral_doctor'],$post['referral_hospital'],$booked_test['price']-$per_booked_tp_discount,$test_data->dept_id); 
    ...
    if(!empty($profile_data))
     {
        ...
        { 
         ...
         { 
           $comission_arr = get_doc_hos_comission($post['referral_doctor'],$post['referral_hospital'],$profile_d['price']-$per_booked_tp_discount,8); 
            if(!empty($comission_arr))
            {
                $total_comission_data = $total_comission_data+$comission_arr['total_comission'];
            }  
