...
class Prescription_file_model extends CI_Model {
	...
	var $table = 'hms_opd_prescription_files';
	var $column = array('hms_opd_prescription_files.id','hms_opd_prescription_files.prescription_files','hms_opd_prescription_files.created_date');  
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("hms_opd_prescription_files.*, hms_opd_prescription_files.prescription_files"); 
		$this->db->from($this->table);  
        $this->db->where('hms_opd_prescription_files.branch_id = "'.$users_data['parent_id'].'"');
    ...
    public function delete($id="")
    {
    	...
    	{ 
    		$this->db->select('*');  
			$this->db->where('id',$id);
			$query = $this->db->get('hms_opd_prescription_files');
			$result = $query->result();
			if(!empty($result))
			{
			...
			$this->db->where('id',$id);
			$this->db->delete('hms_opd_prescription_files'); 
    	} 
    }
