...
class Ipd_patient_discharge_summary_archive_model extends CI_Model {

	var $table = 'hms_ipd_patient_discharge_summery';
	var $column = array('hms_ipd_patient_discharge_summery.id','hms_ipd_patient_discharge_summery.patient_id', 'hms_ipd_patient_discharge_summery.status','hms_ipd_patient_discharge_summery.created_date');   
	...
	private function _get_datatables_query()
	{
		...
		$this->db->where('hms_ipd_patient_discharge_summery.is_deleted','1');
