...
class Certificate_type_model extends CI_Model {
   ...
   function get_opd_patient()
   {
    ...
    function save_certificate()
    {
		...
		$data = array(    
				...
				'template_header'=>$post['template_header'],
   ...
   function get_module_patient_list($post='')
   {
       ...
       if($type=='0')
       {
            $this->db->select("hms_patient.id,hms_patient.patient_name,hms_patient.patient_code"); 
    	   $this->db->from('hms_patient');
    	//    $this->db->join('hms_opd_booking','hms_opd_booking.patient_id=hms_patient.id AND hms_opd_booking.branch_id='.$user_data['parent_id']);
    	   $this->db->where('hms_patient.is_deleted','0');
    	   $this->db->where('hms_patient.branch_id',$user_data['parent_id']);
       ...
       elseif($type=='1')
       {
           $this->db->select("hms_patient.id,hms_patient.patient_name,hms_patient.patient_code"); 
    	   $this->db->from('hms_patient');
    	//    $this->db->join('hms_ipd_booking','hms_ipd_booking.patient_id=hms_patient.id AND hms_ipd_booking.branch_id='.$user_data['parent_id']);
    	   $this->db->where('hms_patient.is_deleted','0');
    	   $this->db->where('hms_patient.branch_id',$user_data['parent_id']);
    	   if(!empty($patient_name))
		   {
       ...
       elseif($type=='2')
       {
           $this->db->select("hms_patient.id,hms_patient.patient_name,hms_patient.patient_code"); 
    	   $this->db->from('hms_patient');
    	//    $this->db->join('hms_operation_booking','hms_operation_booking.patient_id=hms_patient.id AND hms_operation_booking.branch_id='.$user_data['parent_id']);
    	   $this->db->where('hms_patient.is_deleted','0');
    	   $this->db->where('hms_patient.branch_id',$user_data['parent_id']);
    	   if(!empty($patient_name))
		   {
       ...
       elseif($type=='3')
       {
           ...
           $this->db->select("hms_patient.id,hms_patient.patient_name,hms_patient.patient_code"); 
    	   $this->db->from('hms_patient');
    	//    $this->db->join('path_test_booking','path_test_booking.patient_id=hms_patient.id AND path_test_booking.branch_id='.$user_data['parent_id']);
    	   $this->db->where('hms_patient.is_deleted','0');
    	   $this->db->where('hms_patient.branch_id',$user_data['parent_id']);
    	   if(!empty($patient_name))
		   {
