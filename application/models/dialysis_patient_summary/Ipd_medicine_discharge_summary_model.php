...
class Ipd_medicine_discharge_summary_model extends CI_Model {

	var $table = 'hms_ipd_patient_discharge_summery_medicine';
	var $column = array('hms_ipd_patient_discharge_summery_medicine.medicine_name');   
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("hms_ipd_patient_discharge_summery_medicine.*,hms_ipd_booking.ipd_no,hms_patient.patient_name,hms_patient.age_m,hms_patient.age_y,hms_patient.age_d,hms_patient.patient_code, hms_patient.age_y,hms_patient.gender,hms_patient.mobile_no,hms_patient.address");
