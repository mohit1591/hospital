...
class Procedure_note_summary_archive_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->where('hms_procedure_note_summery.is_deleted','1');
        $this->db->where('hms_procedure_note_summery.branch_id = "'.$users_data['parent_id'].'"');
        $this->db->join('hms_ot_management','hms_ot_management.id=hms_procedure_note_summery.operation');
		$i = 0;
