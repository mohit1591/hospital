...
class Religion_archive_model extends CI_Model {

	var $table = 'hms_religion';
	var $column = array('hms_religion.id','hms_religion.religion', 'hms_religion.status','hms_religion.created_date');  
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->where('hms_religion.is_deleted','1');
