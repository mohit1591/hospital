...
class Ipd_advance_discharge_summary_template_archive_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->where('hms_ipd_advance_discharge_summary_template.is_deleted','1');
   ...
   //  	{  
			// $this->db->where('id',$id);
			// $this->db->delete('hms_ipd_advance_discharge_summary_template');
   //  	} 
    	if(!empty($id) && $id>0)
    	{
