...
class Popup_maintenance_model extends CI_Model {
          ...
          // echo $this->db->last_query(); exit; 
            ...
            return $query->result();
             ...
             if($get['section_type']==6){
                ...
                $this->db->select("path_item.*,path_stock_category.category,hms_stock_item_unit.unit,sum(path_stock_item.debit-path_stock_item.credit)as stock_qty"); 
