...
class Stock_purchase_return_archive_model extends CI_Model {
	var $table = 'path_purchase_return_item';
	var $column = array('path_purchase_return_item.id','path_purchase_return_item.purchase_no','path_purchase_return_item.return_no','path_purchase_return_item.purchase_date','hms_medicine_vendors.name','path_purchase_return_item.total_amount','path_purchase_return_item.net_amount','path_purchase_return_item.created_date');   
	...
	private function _get_datatables_query()
	{
		...
		$this->db->where('path_purchase_return_item.is_deleted','1'); 
    ...
    public function trash($id="")
    {
    	...
    	{  
			//$this->db->where('id',$id);
			//$this->db->delete('path_purchase_return_item');
                        $user_data = $this->session->userdata('auth_users');
