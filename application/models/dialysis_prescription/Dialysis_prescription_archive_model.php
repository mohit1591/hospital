...
class Dialysis_prescription_archive_model extends CI_Model {
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->where('hms_dialysis_prescription.is_deleted','1'); 
