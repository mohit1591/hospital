...
class Sales_vaccination_archive_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("hms_vaccination_sale.*, hms_patient.patient_name,hms_doctors.doctor_name,, (select count(id) from hms_medicine_sale_to_medicine where sales_id = hms_vaccination_sale.id) as total_medicine"); 
		$this->db->join('hms_patient','hms_patient.id = hms_vaccination_sale.patient_id','left'); 
		$this->db->where('hms_vaccination_sale.is_deleted','1'); 
