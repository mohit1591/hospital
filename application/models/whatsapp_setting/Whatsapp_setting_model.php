...
class Whatsapp_setting_model extends CI_Model 
{
	...
	public function get_master_unique()
	{
        ...
        $this->db->select('hms_sms_setting_name.*, hms_branch_whatsapp_sms_setting.setting_name,hms_branch_whatsapp_sms_setting.sms_status,hms_branch_whatsapp_sms_setting.email_status');
        $this->db->join('hms_branch_whatsapp_sms_setting', 'hms_branch_whatsapp_sms_setting.unique_id=hms_sms_setting_name.id','left');
        $this->db->from('hms_sms_setting_name');
        $this->db->where('hms_branch_whatsapp_sms_setting.branch_id',$user_data['parent_id']);
        $query = $this->db->get(); 
	...
	{  
		...
		{    
            ...
            {	
              ...
              $this->db->update('hms_branch_whatsapp_sms_setting');
