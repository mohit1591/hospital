...
class Doctors_archive_model extends CI_Model {

	var $table = 'hms_doctors';
	var $column = array('hms_doctors.id','hms_doctors.doctor_code','hms_doctors.doctor_type', 'hms_doctors.doctor_name', 'hms_doctors.mobile_no','hms_cities.city', 'hms_doctors.status', 'hms_doctors.created_date', 'hms_doctors.modified_date');  
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->where('hms_doctors.is_deleted','1');
