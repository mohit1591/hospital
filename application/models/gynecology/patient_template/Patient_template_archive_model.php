...
class Patient_template_archive_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->where('hms_gynecology_patient_template.is_deleted','1');
        $this->db->where('hms_gynecology_patient_template.branch_id = "'.$users_data['parent_id'].'"');
		$i = 0;
