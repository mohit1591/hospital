...
class Test_head_archive_model extends CI_Model {

	var $table = 'path_test_heads';
	var $column = array('path_test_heads.id','hms_department.department', 'path_test_heads.test_heads', 'path_test_heads.status','path_test_heads.created_date');  
	...
	private function _get_datatables_query()
	{
		...
		$this->db->from($this->table);  
		 $this->db->where('path_test_heads.is_deleted','1');
       
         $this->db->where('path_test_heads.branch_id IN ('.$users_data['parent_id'].',0)');
