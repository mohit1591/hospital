...
class Relation_archive_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("path_relation.*"); 
		$this->db->from($this->table);
        $this->db->where('path_relation.is_deleted','1');
        $this->db->where('path_relation.branch_id = "'.$users_data['parent_id'].'"');
		$i = 0;
