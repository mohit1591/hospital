...
class Purchase_return_archive_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("hms_vaccination_purchase_return.*, hms_medicine_vendors.name as vendor_name, (select count(id) from hms_medicine_return_to_return where purchase_return_id = hms_vaccination_purchase_return.id) as total_medicine"); 
		$this->db->join('hms_medicine_vendors','hms_medicine_vendors.id = hms_vaccination_purchase_return.vendor_id','left'); 
		$this->db->where('hms_vaccination_purchase_return.is_deleted','1'); 
