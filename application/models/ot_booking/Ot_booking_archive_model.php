...
class Ot_booking_archive_model extends CI_Model {



	var $table = 'hms_operation_booking';
	var $column = array('hms_operation_booking.id','hms_operation_booking.ipd_id','hms_patient.patient_code','hms_patient.patient_name','hms_operation_booking.operation_date','hms_operation_booking.operation_time','hms_doctors.doctor_name','hms_ipd_room_category.room_category','hms_ipd_rooms.room_no','hms_ipd_room_to_bad.bad_no');
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("hms_operation_booking.*,hms_ipd_booking.ipd_no,hms_ipd_booking.patient_id,hms_doctors.doctor_name,hms_ipd_rooms.room_no,hms_ipd_room_to_bad.bad_no,hms_ipd_room_category.room_category as room_type, hms_patient.patient_name as p_name,hms_patient.patient_code as p_code"); 
