...
class Vaccination_entry_archive_model extends CI_Model {
	...
	var $column = array('hms_vaccination_entry.id','hms_vaccination_entry.medicine_code', 'hms_vaccination_entry.medicine_name', 'hms_vaccination_entry.unit_id','hms_vaccination_entry.unit_second_id','hms_vaccination_entry.conversion','hms_vaccination_entry.min_alrt','hms_vaccination_entry.packing','hms_vaccination_entry.rack_no','hms_vaccination_entry.salt','hms_vaccination_entry.manuf_company','hms_vaccination_entry.mrp','hms_vaccination_entry.purchase_rate','hms_vaccination_entry.vat','hms_vaccination_entry.status', 'hms_vaccination_entry.created_date', 'hms_vaccination_entry.modified_date'); 
    ...
    public function trash($id="")
    {
    	...
    	{  
			$this->db->where('id',$id);
			$this->db->delete('hms_vaccination_entry');
    	} 
    }
