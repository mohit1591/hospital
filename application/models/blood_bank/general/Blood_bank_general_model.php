...
class Blood_bank_general_model extends CI_Model 
{
    ...
    public function get_stock_dashboard_grand_total_quantity($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="")
    {
        ...
        $this->db->where('(hms_blood_stock.donation_status=1 OR hms_blood_stock.donation_status=2)');
    ...
    public function get_stock_quantity_awaiting_data($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="")
    {
        ...
        if(!empty($donor_id))
        {
         ...
         //$this->db->where('hms_blood_stock.flag=1');
           $this->db->where('hms_blood_stock.donation_status',2);
    ...
    public function get_stock_quantity_twelve_data($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="",$days='')
    {
        ...
        $date_s = date('Y-m-d', strtotime(date('Y-m-d'). ' + 12 days'));
        $this->db->where('hms_blood_stock.expiry_date<=',$date_s);
        $this->db->where('hms_blood_stock.expiry_date >',date('Y-m-d'));
    ...
    public function get_stock_quantity_seven_data($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="",$days='')
    {
        ...
        $date_s = date('Y-m-d', strtotime(date('Y-m-d'). ' + 7 days'));
        $this->db->where('hms_blood_stock.expiry_date<=',$date_s);
        $this->db->where('hms_blood_stock.expiry_date >',date('Y-m-d'));
         $this->db->where('hms_blood_stock.donation_status',1);
          $this->db->where('hms_blood_stock.is_issued',0);
    ...
    public function get_stock_quantity_qc_failed_data($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="")
    {
        //echo $blood_group_id; die;
        $users_data = $this->session->userdata('auth_users');
        $this->db->select("(sum(hms_blood_stock.debit)) as total_qty");
        //$this->db->join('hms_blood_donor','hms_blood_donor.id=hms_blood_stock.donor_id','left');
        ...
        $this->db->where('hms_blood_stock.flag!=',2);
        $this->db->where('hms_blood_stock.qc_status=',1);
        
        $this->db->where('hms_blood_stock.donation_status',5);
    ...
    public function get_stock_quantity_discarded_data($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="")
    {
        //echo $blood_group_id; die;
        $users_data = $this->session->userdata('auth_users');
        $this->db->select("(sum(hms_blood_stock.debit)) as total_qty");
        ...
        $this->db->join('hms_blood_qc_examination','hms_blood_qc_examination.donor_id=hms_blood_stock.donor_id','left');
         if((!empty($blood_group_id)) && ($blood_group_id!=""))           
        {
            $this->db->where('hms_blood_stock.blood_group_id IN('.$blood_group_id.') ');
         }
        $this->db->where('hms_blood_stock.flag!=',2);
        $this->db->where('hms_blood_stock.is_issued=',0);
        ...
        //$this->db->where('hms_blood_stock.expiry_date >=',date('Y-m-d'));
         $this->db->where('hms_blood_stock.expiry_date <',date('Y-m-d'));
         $this->db->where('hms_blood_donor.donor_status',4);
        $query = $this->db->get('hms_blood_stock');
       //echo $this->db->last_query();
        return $query->row_array();
    ...
    public function get_stock_quantity_expired_by_group($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="")
    {
        //echo $blood_group_id; die;
        $users_data = $this->session->userdata('auth_users');
        $this->db->select("(sum(hms_blood_stock.debit)) as total_qty");
    ...
    public function get_stock_dashboard_quantity($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="")
    {
        $users_data = $this->session->userdata('auth_users');
        $this->db->select("(sum(hms_blood_stock.debit)-sum(hms_blood_stock.credit)) as total_qty");
    ...
    public function get_qc_status($id="")
    {
        $users_data = $this->session->userdata('auth_users');
        $this->db->select('id');
        $this->db->from('hms_blood_qc_stock_examination');
    ...
    public function check_qc_field($qc_field="",$parent_qc_field='',$id="")
    {
        ...
        //$this->db->where('parent_qc_field= "'.$parent_qc_field.'"'); 
      
        }
        if(!empty($parent_qc_field))
        {
             $this->db->where('parent_qc_field= "'.$parent_qc_field.'"'); 
        } 
        if(!empty($id))
 ...
 public function get_setting_value_for_donor($var_title='',$parent_id="")
    ...
    public function get_stock_quantity($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="")
    {
        $users_data = $this->session->userdata('auth_users');
    ...
    public function get_stock_quantity_tested_data($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="")
    {
        //echo $blood_group_id;
        $users_data = $this->session->userdata('auth_users');
        $this->db->select("(sum(hms_blood_stock.debit)) as total_qty");
     ...
     public function get_stock_quantity_untested_data($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="")
    {
    ...
    public function get_stock_quantity_expired_data($bag_type_id="",$component_id="",$exist_ids='',$donor_id="",$blood_group_id="")
    {
        $users_data = $this->session->userdata('auth_users');
        $this->db->select("(sum(hms_blood_stock.debit)) as total_qty");
        if(isset($search['branch_id']) && $search['branch_id']!=''){
        ...
        {
            //$this->db->where('hms_blood_stock.blood_group_id',$blood_group_id);
             $this->db->where('hms_blood_stock.blood_group_id IN('.$blood_group_id.') AND (hms_blood_stock.is_issued=0) AND (hms_blood_stock.expiry_date < "'.date('Y-m-d H:i:s').'" OR `hms_blood_qc_examination`.`blood_condition`= 2)');
