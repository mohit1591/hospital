<?php
class Ipd_discharge_summary_print_setting_model extends CI_Model 
{
	var $table = 'hms_branch_discharge_summary_setting'; 
    ...
    $this->db->where('hms_branch_discharge_summary_setting.branch_id',$user_data['parent_id']); 
    $this->db->where('hms_branch_discharge_summary_setting.setting_name','DISCHARGE_SUMMARY_PRINT_SETTING'); 
		$query = $this->db->get();
    return $query->result();
	}
    ...
    if(!empty($post['data_id']))
    {
        ...
        $this->db->update('hms_branch_discharge_summary_setting',$data);
    }
	...
	// 		/*$this->db->where('branch_id',$user_data['parent_id']);
 //      $this->db->where('setting_name','DISCHARGE_SUMMARY_PRINT_SETTING');
	// 		$this->db->delete('hms_branch_discharge_summary_setting');*/
