...
{
    var $table = 'hms_admission_notes_prescription_template';
    var $column = array('hms_admission_notes_prescription_template.id','hms_admission_notes_prescription_template.template_name','hms_admission_notes_prescription_template.status', 'hms_admission_notes_prescription_template.created_date', 'hms_admission_notes_prescription_template.modified_date');  
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->where('hms_admission_notes_prescription_template.branch_id = "'.$user_data['parent_id'].'"');
    ...
    public function get_by_id($id)
    {
        $user_data = $this->session->userdata('auth_users');
        $this->db->select('hms_admission_notes_prescription_template.*');
        $this->db->from('hms_admission_notes_prescription_template'); 
        $this->db->where('hms_admission_notes_prescription_template.branch_id',$user_data['parent_id']); 
        $this->db->where('hms_admission_notes_prescription_template.id',$id);
        $this->db->where('hms_admission_notes_prescription_template.is_deleted','0');
        $query = $this->db->get(); 
    ...
    {  
        ...
        $data = array(     
            ...
            "status"=>1,
            "history_presenting_illness"=>$post['history_presenting_illness'], // added by nitin sharma 19th Feb 2024
            "obstetrics_menstrual_history"=>$post['obstetrics_menstrual_history'], // added by nitin sharma 19th Feb 2024
            "family_history_disease"=>$post['family_history_disease'], // added by nitin sharma 19th Feb 2024
            "remark1"=>$post['remark1'], // added by nitin sharma 19th Feb 2024
            "remark2"=>$post['remark2'], // added by nitin sharma 19th Feb 2024
            "remark3"=>$post['remark3'], // added by nitin sharma 19th Feb 2024
            "remark4"=>$post['remark4'], // added by nitin sharma 19th Feb 2024
            "remark5"=>$post['remark5'], // added by nitin sharma 19th Feb 2024
            
            "examination_type"=>$post['optradio'], // added by nitin sharma 19th Feb 2024
            "cvs"=>$post['cvs'], // added by nitin sharma 19th Feb 2024
            "cns"=>$post['cns'], // added by nitin sharma 19th Feb 2024
            "respiratory_system"=>$post['respiratory_system'], // added by nitin sharma 19th Feb 2024
            "per_abdomen"=>$post['per_abdomen'], // added by nitin sharma 19th Feb 2024
            "per_vaginal"=>$post['per_vaginal'], // added by nitin sharma 19th Feb 2024
            "local_examination"=>$post['local_examination_text'], // added by nitin sharma 19th Feb 2024
        );
        ...
        {    
            ...
            if($total_test > 0)
            {
                ...
                $this->db->delete('hms_admission_notes_prescription_patient_test_template');
            }
            ...
            for($i=0;$i<$total_test;$i++)
            {
                  ...
                  $test_data = array(
                        ...
                        "test_name"=>$post['test_name'][$i],
                        "test_id"=>$test_id);
                    $this->db->insert('hms_admission_notes_prescription_patient_test_template',$test_data); 
            ...
            {
                $this->db->where('template_id',$post['data_id']);
                $this->db->delete('hms_admission_notes_prescription_patient_pres_template');
            }
            /*for($i=0;$i<=$total_prescription-1;$i++)
            {
                    ...
                    $this->db->insert('hms_admission_notes_prescription_patient_pres_template',$prescription_data); 
                    $test_data_id = $this->db->insert_id(); 
            }*/
            ...
            $this->db->update('hms_admission_notes_prescription_template',$data); 
//echo $this->db->last_query(); exit;
        }
        else
        {    
            ...
            $this->db->set('created_by',$user_data['id']);
            $this->db->set('created_date',date('Y-m-d H:i:s'));
            $this->db->insert('hms_admission_notes_prescription_template',$data); 
            // echo $this->db->last_query(); exit;
    ...
    function get_opd_prescription_template($template_id='')
    {
        ...
        $this->db->from('hms_admission_notes_prescription_patient_pres_template'); 
    ...
    function get_opd_test_template($template_id='')
    {
        ...
        $this->db->from('hms_admission_notes_prescription_patient_test_template'); 
    ...
    public function delete($id="")
    {
        if(!empty($id) && $id>0)
        {
            ...
            $this->db->where('id',$id);
            $this->db->update('hms_admission_notes_prescription_template');
        } 
    }
