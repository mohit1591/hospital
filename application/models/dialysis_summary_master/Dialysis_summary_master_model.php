...
class Dialysis_summary_master_model extends CI_Model {

    var $table = 'hms_dialysis_field_master';
    var $column = array('hms_dialysis_field_master.id','hms_dialysis_field_master.discharge_lable','hms_dialysis_field_master.discharge_short_code', 'hms_dialysis_field_master.type','hms_dialysis_field_master.sort_order','hms_dialysis_field_master.status','hms_dialysis_field_master.created_date');  
    ...
    public function discharge_field_master_list()
    {
        ...
        $query = $this->db->get('hms_dialysis_field_master');
        return $query->result();
    }
    ...
    public function get_by_id($id)
    {
        ...
        $this->db->where('hms_dialysis_field_master.id',$id);
        $this->db->where('hms_dialysis_field_master.is_deleted','0');
        $query = $this->db->get(); 
    ...
    public function save()
    {
        ...
        {    
            ...
            $this->db->update('hms_dialysis_field_master',$data);  
        }
        else
        {    
            ...
            $this->db->insert('hms_dialysis_field_master',$data);               
        }   
    }
    ...
    public function delete($id="")
    {
        if(!empty($id) && $id>0)
        {
            ...
            $this->db->where('id',$id);
            $this->db->update('hms_dialysis_field_master');
            //echo $this->db->last_query();die;
        } 
    }
