...
class Prescription_setting_model extends CI_Model 
{
	...
	public function get_master_unique($type='0')
	{
		...
		$this->db->select('hms_prescription_setting.*, hms_branch_prescription_setting.setting_name, hms_branch_prescription_setting.setting_value,
    hms_branch_prescription_setting.vital_show');
