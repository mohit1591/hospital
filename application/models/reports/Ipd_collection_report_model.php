...
if(isset($search_data['patient_name']) && !empty($search_data['patient_name'])
            ...
            if(!empty($search_data['insurance_type']))
              {
                $this->db->where('hms_ipd_booking.patient_type',$search_data['insurance_type']);
              }

              if(!empty($search_data['insurance_type_id']))
              {
                $this->db->where('hms_ipd_booking.panel_type',$search_data['insurance_type_id']);
              }

              if(!empty($search_data['ins_company_id']))
              {
                $this->db->where('hms_ipd_booking.panel_name',$search_data['ins_company_id']);
              }
