...
class Medicine_report_model extends CI_Model {
var $table = 'hms_medicine_purchase';
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->select("hms_medicine_purchase_to_purchase.*,hms_medicine_purchase.invoice_id,hms_medicine_purchase.net_amount,hms_medicine_purchase.purchase_date,hms_medicine_vendors.name as vendor_name, hms_medicine_vendors.vendor_gst,hms_medicine_vendors.vendor_id as v_id,hms_medicine_vendors.mobile,hms_medicine_purchase.id as p_id"); 
...
////////////////////old work ////////////////
    ...
    function summ_get_datatables()
    {
        $this->_summ_get_datatables_query();
        if($_POST['length'] != -1)
        $this->db->limit($_POST['length'], $_POST['start']);
        $query = $this->db->get(); 
       // echo $this->db->last_query();die;
    ...
    private function _summ_get_datatables_query()
    {
        $users_data = $this->session->userdata('auth_users');
        $search = $this->session->userdata('gstr1_search');
        $this->db->select("hms_medicine_purchase_to_purchase.id, (CASE WHEN hms_medicine_purchase_to_purchase.sgst=9 and hms_medicine_purchase_to_purchase.cgst=9  THEN hms_medicine_purchase_to_purchase.total_amount  ELSE 0 END ) as egst, (CASE WHEN hms_medicine_purchase_to_purchase.sgst=6 and hms_medicine_purchase_to_purchase.cgst=6  THEN hms_medicine_purchase_to_purchase.total_amount  ELSE 0 END ) as tgst,(CASE WHEN hms_medicine_purchase_to_purchase.sgst=2.50 and hms_medicine_purchase_to_purchase.cgst=2.50  THEN hms_medicine_purchase_to_purchase.total_amount  ELSE 0 END ) as fgst, (CASE WHEN hms_medicine_purchase_to_purchase.sgst=0.00 and hms_medicine_purchase_to_purchase.cgst=0.00  THEN hms_medicine_purchase_to_purchase.total_amount  ELSE 0 END ) as zgst, hms_medicine_purchase.purchase_date,hms_medicine_purchase.purchase_id as p_id"); 
    ...
    function summ_search_medicine_data()
    {
