...
class Medicine_reportr2_model extends CI_Model {
var $table = 'hms_medicine_sale'; //hms_medicine_sale_to_medicine //hms_medicine_sale
    var $column = array('hms_medicine_sale.id','hms_patient.patient_name','hms_patient.mobile_no','hms_medicine_sale.sale_no','hms_medicine_sale_to_medicine.sale_date','hms_medicine_sale_to_medicine.sgst','hms_medicine_sale_to_medicine.cgst','hms_medicine_sale_to_medicine.igst','hms_patient.mobile_no','hms_patient.mobile_no','hms_patient.mobile_no','hms_patient.mobile_no','hms_patient.mobile_no','hms_patient.mobile_no','hms_patient.mobile_no','hms_patient.mobile_no','hms_patient.mobile_no','hms_patient.mobile_no','hms_patient.mobile_no');  
