...
class Purchase_archive_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("hms_vaccination_purchase.*, hms_medicine_vendors.name as vendor_name, (select count(id) from hms_medicine_purchase_to_purchase where purchase_id = hms_vaccination_purchase.id) as total_medicine"); 
		$this->db->join('hms_medicine_vendors','hms_medicine_vendors.id = hms_vaccination_purchase.vendor_id','left'); 
		$this->db->where('hms_vaccination_purchase.is_deleted','1'); 
