<?php
class Day_care_running_bill_print_letterhead_setting_model extends CI_Model 
{
  var $table = 'hms_day_care_running_bill_print_letterhead_setting'; 
  ...
  public function get_master_unique() //doctor_signature_position
  {
   ...
   $this->db->where('hms_day_care_running_bill_print_letterhead_setting.branch_id = "'.$user_data['parent_id'].'"');
 ...
 //print_r($post);die;
    ...
    {    
      ...
      $this->db->delete('hms_day_care_running_bill_print_letterhead_setting');
      ...
      if(isset($post['pixel_value']))
      {
        $pixel_value = $post['pixel_value']; 
            ...
            foreach($post['data'] as $key=>$val)
            {
              ...
              $this->db->insert('hms_day_care_running_bill_print_letterhead_setting',$data);
