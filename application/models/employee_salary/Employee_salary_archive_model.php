...
class Employee_salary_archive_model extends CI_Model {
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("hms_expenses.*,hms_payment_mode.payment_mode"); 
		$this->db->from($this->table); 
		$this->db->join('hms_payment_mode','hms_payment_mode.id=hms_expenses.payment_mode');
        $this->db->where('(hms_expenses.is_deleted="1" AND hms_expenses.type="1")');
