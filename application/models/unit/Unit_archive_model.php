...
class Unit_archive_model extends CI_Model {

	var $table = 'path_unit';
	var $column = array('path_unit.id','path_unit.unit', 'path_unit.status','path_unit.created_date');  
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->where('path_unit.is_deleted','1');
