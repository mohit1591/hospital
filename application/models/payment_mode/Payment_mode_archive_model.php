...
class Payment_mode_archive_model extends CI_Model {

	var $table = 'hms_payment_mode';
	var $column = array('hms_payment_mode.id','hms_payment_mode.payment_mode', 'hms_payment_mode.status','hms_payment_mode.created_date');  
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->where('hms_payment_mode.is_deleted','1');
