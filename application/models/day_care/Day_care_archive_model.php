...
class Day_care_archive_model extends CI_Model 
{
	var $table = 'hms_day_care_booking';
	var $column = array('hms_day_care_booking.booking_code','hms_day_care_booking.type','hms_day_care_booking.patient_id','hms_day_care_booking.attended_doctor', 'hms_day_care_booking.confirm_date','hms_day_care_booking.total_amount','hms_day_care_booking.booking_status','hms_day_care_booking.created_date','hms_day_care_booking.modified_date','hms_day_care_booking.status');  
	...
	private function _get_datatables_query()
	{
		...
		$this->db->where('hms_day_care_booking.is_deleted','1'); 
