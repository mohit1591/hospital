...
class Ipd_patient_advance_discharge_summary_model extends CI_Model {
...
$users_data = $this->session->userdata('auth_users'); 
    ...
    public function advance_template_list($id="")
    {
        $users_data = $this->session->userdata('auth_users');
        $this->db->select('*');  
        $this->db->where('status','1');
  ...
  public function get_detail_by_summary_id($discharge_id)
  {
    ...
    $this->db->select('hms_ipd_patient_discharge_summery_medicine.medicine_name,hms_ipd_patient_discharge_summery_medicine.medicine_dose,hms_ipd_patient_discharge_summery_medicine.medicine_duration,hms_ipd_patient_discharge_summery_medicine.medicine_frequency,hms_ipd_patient_discharge_summery_medicine.medicine_advice,hms_ipd_patient_discharge_summery_medicine.medicine_type,hms_ipd_patient_discharge_summery_medicine.medicine_salt,hms_ipd_patient_discharge_summery_medicine.medicine_brand');
  ...
  public function get_doctor_signature($doctor_id='')
  {
    ...
    public function get_medicine_by_id($id,$ipd_id)
	{
		$this->db->select('hms_ipd_patient_discharge_summery_medicine.*');
		$this->db->from('hms_ipd_patient_discharge_summery_medicine'); 
		$this->db->where('hms_ipd_patient_discharge_summery_medicine.discharge_summary_id',$id);
		$this->db->where('hms_ipd_patient_discharge_summery_medicine.ipd_id',$ipd_id);
		$query = $this->db->get(); 
		//echo $this->db->last_query(); exit;
  ...
  /********** Medicine List of discharge summary ************/
  	public function get_discharge_medicine($id,$ipd_id='')
	{ //medicine_advice
		$this->db->select('hms_ipd_patient_discharge_summery_medicine.medicine_name,hms_ipd_patient_discharge_summery_medicine.medicine_dose,hms_ipd_patient_discharge_summery_medicine.medicine_duration,hms_ipd_patient_discharge_summery_medicine.medicine_frequency,hms_ipd_patient_discharge_summery_medicine.medicine_advice,hms_ipd_patient_discharge_summery_medicine.medicine_type,hms_ipd_patient_discharge_summery_medicine.medicine_salt,hms_ipd_patient_discharge_summery_medicine.medicine_brand');
		$this->db->from('hms_ipd_patient_discharge_summery_medicine'); 
		$this->db->where('hms_ipd_patient_discharge_summery_medicine.discharge_summary_id',$id);
	...
	public function get_advance_discharge_medicine($id)
	{
 ...
 function test_report_template_format_adv($data="")
    {
      $users_data = $this->session->userdata('auth_users'); 
      $company_data = $this->session->userdata('company_data'); 
      $this->db->select('hms_ipd_discharge_advance_report_print_letter_head_setting.*');
      $this->db->where($data);
     
            $this->db->where('hms_ipd_discharge_advance_report_print_letter_head_setting.branch_id',$users_data['parent_id']); 
       
      $this->db->from('hms_ipd_discharge_advance_report_print_letter_head_setting');
      $result=$this->db->get()->row();
      //echo $this->db->last_query();die;
      return $result;
  ...
  public function get_ipd_pathology_test($ipd_id)
  {
    $users_data = $this->session->userdata('auth_users');
   
    $this->db->select('path_test_booking.id');
  ...
  public function report_test_list($booking_id="",$parent_status="",$test_type="",$profile_id="",$child_profile_status="")
    ...
    $users_data = $this->session->userdata('auth_users');
    $this->db->select('path_test.test_name,path_test_booking_to_test.profile_id,path_test_booking_to_test.test_id,path_test_booking_to_test.booking_id');  
    ...
    {
        $users_data = $this->session->userdata('auth_users');
        $this->db->select('path_test_booking_to_profile.profile_id,path_profile.profile_name,path_profile.print_name');  
