...
*/
    $this->db->select('hms_ipd_patient_discharge_summery_medicine.medicine_name,hms_ipd_patient_discharge_summery_medicine.medicine_dose,hms_ipd_patient_discharge_summery_medicine.medicine_duration,hms_ipd_patient_discharge_summery_medicine.medicine_frequency,hms_ipd_patient_discharge_summery_medicine.medicine_advice,hms_ipd_patient_discharge_summery_medicine.medicine_type');
