...
class Sale_model extends CI_Model 
{
	...
	$search = $this->session->userdata('sale_search_item');
		...
		if(isset($search) && !empty($search))
		{
			...
			{
			   $this->db->where('hms_patient.mobile_no LIKE "'.$search['mobile'].'%"');
			}
...
//echo $this->db->last_query();die;
	...
	function get_all_detail_print($ids="",$branch_id="")
	{
		...
		$this->db->select("hms_canteen_sale.*,hms_customers.customer_name ,hms_customers.customer_code, hms_customers.mobile_no as customer_mobile, hms_patient.patient_name ,hms_patient.patient_code, hms_patient.mobile_no as patient_mobile,
