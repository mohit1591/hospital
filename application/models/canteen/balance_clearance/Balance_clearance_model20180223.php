		...
		{ 
			...
			if($section_id==1)
			{
				...
				$this->db->join('hms_patient','hms_patient.id = hms_payment.patient_id','left');
                                $this->db->join('hms_branch_hospital_no','hms_branch_hospital_no.parent_id = hms_payment.id AND hms_branch_hospital_no.section_id=11','left');
			...
			$this->db->join('hms_branch_hospital_no','hms_branch_hospital_no.parent_id = hms_payment.id AND hms_branch_hospital_no.section_id=10','left');
			...
			elseif($section_id==2)
			{
				...
				$this->db->join('hms_payment','hms_payment.patient_id = hms_patient.id');
$this->db->join('hms_branch_hospital_no','hms_branch_hospital_no.parent_id = hms_payment.id AND hms_branch_hospital_no.section_id=8','left');
...
$this->db->join('hms_branch_hospital_no','hms_branch_hospital_no.parent_id = hms_payment.id AND hms_branch_hospital_no.section_id=12','left');
...
$this->db->join('hms_branch_hospital_no','hms_branch_hospital_no.parent_id = hms_payment.id AND hms_branch_hospital_no.section_id=9','left');
			...
			else if($section_id==7)
			{
				...
				$this->db->join('hms_branch_hospital_no','hms_branch_hospital_no.parent_id = hms_payment.id AND hms_branch_hospital_no.section_id=13','left');
