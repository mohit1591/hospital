...
class Test_report_print_setting_model extends CI_Model 
{
	...
	public function get_master_unique() //doctor_signature_position
	{
		...
		$this->db->join('path_test_report_print_setting', 'path_test_report_print_setting.unique_id=path_print_report_setting.id AND path_test_report_print_setting.temp_id=0 AND path_test_report_print_setting.branch_id = "'.$user_data['parent_id'].'"','left');
