...
class Ot_pacakge_model extends CI_Model {
	...
	{
		$this->db->select("hms_ot_pacakge_details.*,hms_ot_pacakge_details.particular_name as particular");
   ...
   public function type_list()
    {
     ...
     public function save_all_ot_pacakge($ot_all_data = array())
	{
        ...
        if(!empty($ot_all_data))
        {
            foreach($ot_all_data as $ot_data)
            {
               ...
               //echo $this->db->last_query(); exit;
				    $this->db->insert('hms_ot_pacakge',$ot_data_array);
	                //echo $this->db->last_query(); exit;
	            }
            }   	
        }
