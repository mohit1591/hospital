...
{
  var $table = 'hms_ipd_running_bill_print_letterhead_setting'; 
  ...
  public function get_master_unique() //doctor_signature_position
  {
    ...
    $this->db->select('hms_ipd_running_bill_print_letterhead_setting.*');
   $this->db->where('hms_ipd_running_bill_print_letterhead_setting.branch_id = "'.$user_data['parent_id'].'"');
    $this->db->from('hms_ipd_running_bill_print_letterhead_setting');  
    $query = $this->db->get(); 
    return $query->result();
  }
  ...
  {  
    ...
    {    
      ...
      $this->db->delete('hms_ipd_running_bill_print_letterhead_setting');
      ...
      if(isset($post['pixel_value']))
      {
        $pixel_value = $post['pixel_value']; 
            ...
            foreach($post['data'] as $key=>$val)
            {
              ...
              $this->db->insert('hms_ipd_running_bill_print_letterhead_setting',$data);
