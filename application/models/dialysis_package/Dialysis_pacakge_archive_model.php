...
class Dialysis_pacakge_archive_model extends CI_Model {


	var $table = 'hms_dialysis_pacakge';
	var $column = array('hms_dialysis_pacakge.id','hms_dialysis_pacakge.name','hms_dialysis_pacakge.hours','hms_dialysis_pacakge.days','hms_dialysis_pacakge.amount','hms_dialysis_pacakge.status');  
	...
	private function _get_datatables_query()
	{
        ...
        $this->db->where('hms_dialysis_pacakge.is_deleted','1');
