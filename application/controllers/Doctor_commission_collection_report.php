...
class Doctor_commission_collection_report extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('doctor_commission_collection_report/Doctor_commission_collection_report_model','reports');
        $this->load->library('form_validation');
    }

   
     public function doctor_comm_coll_report()
     {
        unauthorise_permission('42','245');
        $users_data = $this->session->userdata('auth_users'); 
        $this->load->model('general/general_model','general_model');
        $data['doctor_list'] = $this->general_model->referal_doctor_list($users_data['parent_id']);
        $data['hospital_list'] = $this->general_model->referal_hospital_list($users_data['parent_id']);
        
        $data['department'] = get_collecton_department();   
        $data['page_title'] = 'Doctor commission & collection Report';
        $data['from_c_date'] = date('d-m-Y');
        $data['to_c_date'] = date('d-m-Y'); 
        $this->load->view('doctor_commission_collection_report/collection_report',$data);
    }
    public function next_appoitment(){
      ...
      // $data['next_appotment_list'] = $this->reports->next_appotment_list();
       ...
       $data['from_c_date'] = date('d-m-Y');
       $data['to_c_date'] = date('d-m-Y'); 
       $this->load->view('doctor_commission_collection_report/next_appoitment_report',$data);
    }
    public function medicine_collections(){
      ...
      $this->load->view('doctor_commission_collection_report/medicine_collection_report',$data);
    }
    ...
    public function advance_search()
    {
        ...
        $this->load->view('doctor_commission_collection_report/advance_search',$data);
    }
    ...
    {    
        ...
        $this->load->view('doctor_commission_collection_report/opd_report_html',$data);
    ...
    { 
     ...
     $this->load->view('doctor_commission_collection_report/list_expenses_reports',$data);  
    ...
    { 
      ...
      $this->load->view('doctor_commission_collection_report/list_collection_report_data',$data);
    ...
    { 
      ...
      $data['get'] = $get;
      $data['collection_tab_setting'] = $this->reports->get_collection_tab_setting();
      $this->load->view('doctor_commission_collection_report/list_hospital_collection_report',$data);  
 ...
 function collection_excel($get)
    ...
    public function enquiry_source(){
       ...
       $data['from_c_date'] = date('d-m-Y');
       $data['to_c_date'] = date('d-m-Y'); 
       $this->load->view('doctor_commission_collection_report/source_report',$data);
    }
    ...
    { 
      ...
      $data['get'] = $get;
      $this->load->view('doctor_commission_collection_report/list_source_from_data',$data);  
    ...
    public function collections_day()
    {
        ...
        $data['from_c_date'] = date('d-m-Y');
        $data['to_c_date'] = date('d-m-Y'); 
        $this->load->view('doctor_commission_collection_report/collection_day_report',$data);
    }
    ...
    { 
      $this->load->model('doctor_commission_collection_report/reports_day_model','reports_day');
      unauthorise_permission('42','245');
      $get = $this->input->get();
      $users_data = $this->session->userdata('auth_users');
     ...
     $data['self_purchase_return_collection_list'] = $this->reports_day->self_purchase_collection_list($get);
      ...
      {
        $this->load->view('doctor_commission_collection_report/list_collection_day_report_preview',$data);
      }
      else
      {
        ...
        $middle_replace_part=$this->load->view('doctor_commission_collection_report/list_collection_day_report_data',$data,true);
 ...
 public function print_opd_collection_day_reports20201221()
    ...
    { 
      ...
      $data['collection_tab_setting'] = $this->reports->get_collection_tab_setting();
        ...
        $middle_replace_part=$this->load->view('doctor_commission_collection_report/adv_list_collection_report_data',$data,true);
        $this->load->library('m_pdf');
   ...
   //new code 20 may 2020
    ...
    public function ledger_report(){
       ...
       $data['from_c_date'] = date('d-m-Y');
       $data['to_c_date'] = date('d-m-Y'); 
       $this->load->view('doctor_commission_collection_report/ledger_reports',$data);
    }
  ...
  { 
    unauthorise_permission('43','252'); 
    $get =$this->input->get();  
    $this->load->model('doctor_commission_collection_report/reports_leder_model','ledger_report');  
     $data['report_list'] = []; 
     if(!empty($get['branch_id']))  
     {  
        $datas=array(); 
   ...
   //echo "<pre>"; print_r($datas);die(); 
     ...
     $data['get'] = $get; 
     $data['page_title'] ="Ledger Reports";   
     $this->load->view('doctor_commission_collection_report/ledger_reports_list',$data);  
  } 
  ...
  // collection with time
    public function collections_with_time(){
       ...
       $data['from_c_date'] = date('d-m-Y');
       $data['to_c_date'] = date('d-m-Y'); 
       $this->load->view('doctor_commission_collection_report/collection_time_report',$data);
    }
    ...
    { 
      ...
      $this->load->model('doctor_commission_collection_report/advance_reports_model','advance_reports');
      unauthorise_permission('42','245'); 
      $get = $this->input->get(); 
       $departs = array();  
      if(!empty($get['dept']) && $get['dept'] !='') 
    ...
    if(in_array(10, $departs) || empty($departs)) 
    {
      ...
      if(!empty($get['send']) && $get['send']=='preview') 
      { 
        $this->load->view('doctor_commission_collection_report/list_collection_time_report_preview',$data); 
      } 
      else  
      { 
			$from_date = $get['start_date'];  
			...
			$middle_replace_part=$this->load->view('doctor_commission_collection_report/list_collection_time_report_data',$data,true);  
			$this->load->library('m_pdf');  
			$this->m_pdf->pdf->setAutoTopMargin = 'stretch';  
 ...
 // doctor wise collection  
    public function doctor_wise_collection_report(){  
      ...
      $data['department'] = get_collecton_department(); 
       $data['from_c_date'] = date('d-m-Y');  
       $data['to_c_date'] = date('d-m-Y');  
       $this->load->view('doctor_commission_collection_report/doctor_collection_report',$data); 
    } 
 public function print_doctor_collection_reports()  
    { 
      $this->load->model('doctor_commission_collection_report/reports_doctor_wise_model','reports_doctor'); 
       $get = $this->input->get();  
       if(!empty($get)) 
       {  
          $data['page_title'] = 'Doctor Wise Collections Reports';  
          ...
          $data['get']=$get;  
        $this->load->view('doctor_commission_collection_report/doctor_wise_collection_reports',$data);  
       }  
    } 
...
// module wise profit loss  
    ...
    { 
        ...
        $this->load->view('doctor_commission_collection_report/modul_profit_loss',$data); 
    } 
   ...
   // $from_date = $get['start_date'];  
   // $to_date = $get['end_date'];  
  $this->load->view('doctor_commission_collection_report/profit_loss_module',$data);  
   }  
   ...
   public function collection_reports_excel()
    {
          ...
          //  Field names in the first row
          $fields_array = array('S. No.','Patient Name','Booking Code','Doctor/Hospital','Date','Receipt No.','Total Amount','Discount','Net Amount','Paid Amount','Balance','Commission','Payment Mode');
        ...
        //echo "<pre>"; print_r($self_opd_coll_payment_mode); exit;
          ...
          if(!empty($self_opd_coll_data))
          {
               ...
               foreach($self_opd_coll_data as $collection)
               {
                        ...
                        array_push($rowData,$collection->total_comission);
      ...
      if(in_array(4, $departs) || empty($departs))  
      {
        ...
        //echo "<pre>"; print_r($data_excel); exit;
          ...
          header("Content-Disposition: attachment; filename=doctor_commission_collection_report_".time().".xls");
          header("Pragma: no-cache"); 
          header("Expires: 0");
         if(!empty($data))
         {
