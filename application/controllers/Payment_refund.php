...
class Payment_refund extends CI_Controller {
 
	function __construct() 
	{
		parent::__construct();	
		auth_users();  
		$this->load->model('payment_refund/payment_refund_model','payment_refund');
  ...
  {   
      ...
      $data['page_title']='Payment Refund';
      ...
      $this->load->view('payment_refund/list',$data);     
  }
