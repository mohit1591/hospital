...
class Prescription_tab_setting extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('pediatrician/prescription_tab_setting/prescription_tab_setting_model','prescriptiontabsetting');
        $this->load->library('form_validation');
    }

    public function index()
    {
        unauthorise_permission(325,2036);
        ...
        $this->load->view('pediatrician/prescription_tab_setting/add',$data);
    } 
