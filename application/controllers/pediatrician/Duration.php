...
class Duration extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('pediatrician/duration/duration_model','duration');
        $this->load->library('form_validation');
    }

    public function index()
    { 
        unauthorise_permission('331','2020');
        $data['page_title'] = 'Duration List'; 
        $this->load->view('pediatrician/duration/list',$data);
    }
    ...
    { 
        ...
        foreach ($list as $duration) {
         // print_r($relation);die;
          ...
          $btnedit='';
          $btndelete='';
          if(in_array('2022',$users_data['permission']['action'])){
           ...
           if(in_array('2023',$users_data['permission']['action'])){
    ...
    public function add()
    {
        unauthorise_permission('331','2021');
       ...
       $this->load->view('pediatrician/duration/add',$data);       
    }
    
    public function edit($id="")
    {
      unauthorise_permission('331','2022');
    ...
    {
       unauthorise_permission('331','2023');
       if(!empty($id) && $id>0)
       {
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('pediatrician/duration/view',$data);     
      }
    }  
    ...
    {
        unauthorise_permission('331','2024');
        $data['page_title'] = 'Duration Archive List';
        $this->load->helper('url');
        $this->load->view('pediatrician/duration/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('331','2024');
        $this->load->model('pediatrician/duration/duration_archive_model','duration_archive'); 
        ...
        foreach ($list as $duration) { 
          ...
          $btnrestore='';
          $btndelete='';
          if(in_array('2026',$users_data['permission']['action'])){
          ...
          if(in_array('2025',$users_data['permission']['action'])){
    ...
    {
        unauthorise_permission('331','2026');
        $this->load->model('pediatrician/duration/duration_archive_model','duration_archive');
       if(!empty($id) && $id>0)
       {
    ...
    {
        unauthorise_permission('331','2025');
        $this->load->model('pediatrician/duration/duration_archive_model','duration_archive');
       if(!empty($id) && $id>0)
       {
