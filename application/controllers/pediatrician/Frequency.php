...
class Frequency extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('pediatrician/frequency/frequency_model','frequency');
        $this->load->library('form_validation');
    }

    public function index()
    { 
        unauthorise_permission('330','1943');
        $data['page_title'] = 'Frequency List'; 
        $this->load->view('pediatrician/frequency/list',$data);
    }
    ...
    { 
        ...
        foreach ($list as $frequency) {
         // print_r($relation);die;
          ...
          $btnedit='';
          $btndelete='';
          if(in_array('1945',$users_data['permission']['action'])){
           ...
           if(in_array('1946',$users_data['permission']['action'])){
    ...
    public function add()
    {
        unauthorise_permission('330','1944');
       ...
       $this->load->view('pediatrician/frequency/add',$data);       
    }
    
    public function edit($id="")
    {
      unauthorise_permission('330','1945');
    ...
    {
       unauthorise_permission('330','1946');
       if(!empty($id) && $id>0)
       {
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('pediatrician/frequency/view',$data);     
      }
    }  
    ...
    {
        unauthorise_permission('330','1947');
        $data['page_title'] = 'Frequency Archive List';
        $this->load->helper('url');
        $this->load->view('pediatrician/frequency/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('330','1947');
        $this->load->model('pediatrician/frequency/frequency_archive_model','frequency_archive'); 
        ...
        foreach ($list as $frequency) { 
          ...
          $btnrestore='';
          $btndelete='';
          if(in_array('1949',$users_data['permission']['action'])){
          ...
          if(in_array('1948',$users_data['permission']['action'])){
    ...
    {
        unauthorise_permission('330','1949');
        $this->load->model('pediatrician/frequency/frequency_archive_model','frequency_archive');
       if(!empty($id) && $id>0)
       {
    ...
    {
       unauthorise_permission('330','1948');
        $this->load->model('pediatrician/frequency/frequency_archive_model','frequency_archive');
       if(!empty($id) && $id>0)
       {
