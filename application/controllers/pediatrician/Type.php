...
class Type extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('pediatrician/type/type_model','typemodel');
    ...
    { 
        ...
        $this->load->view('pediatrician/type/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('pediatrician/type/add',$data);       
    }
   ...
   public function medicine_type($str){
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('pediatrician/type/view',$data);     
      }
    }  
    ...
    public function archive()
    {
        ...
        $this->load->view('pediatrician/type/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('336','1989');
        $this->load->model('pediatrician/type/type_archive_model','type_archive'); 
