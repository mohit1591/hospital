...
class Balance_clearance extends CI_Controller {
	...
	function __construct() 
	{
		parent::__construct();	
		auth_users();  
		$this->load->model('balance_clearance/balance_clearance_model','balance_clearance');
  ...
  public function index()
  {
      ...
      $this->load->view('balance_clearance/list',$data);     
  }
  ...
  public function pay_now($pid="", $parent_id="",$section_id="",$branch_id="")
  {
          ...
          $this->load->model('day_care/day_care_model','day_care');
          ...
          if(isset($post) && !empty($post) && !isset($post['bal']))
          {
              ...
              if($this->form_validation->run() == TRUE)
              {
                ...
                if(!empty($pay_id))
                {
                    ...
                    elseif ($post['section_id']=='15') //Dialysis
                    {
                        $get_by_id_data = $this->dialysisbooking->get_all_detail_print($post['parent_id']);
                       // echo "<pre>"; print_r($get_by_id_data); exit;
                        $patient_name = $get_by_id_data['dialysis_list'][0]->patient_name;
                        $balance = $post['balance'];
                        $mobile_no = $get_by_id_data['dialysis_list'][0]->mobile_no;
                        $patient_email = $get_by_id_data['dialysis_list'][0]->patient_email;
                        $booking_code = $get_by_id_data['dialysis_list'][0]->ipd_no;
                    }
                  ...
                  if(in_array('640',$users_data['permission']['action']))
                  {
                    ...
                    if(!empty($mobile_no))
                    {
                      send_sms('balance_clearance',10,$patient_name,$mobile_no,array('{Name}'=>$patient_name,'{Amt}'=>$post['balance'],'{Billno}'=>$booking_code)); 
                    }
                  }
                  ...
                  elseif($post['section_id']=='14') //Day care
                    {
                        $get_by_id_data = $this->day_care->get_by_id($post['parent_id']);
                        $patient_name = $get_by_id_data['patient_name'];
                        $patient_email = $get_by_id_data['patient_email'];
                        $balance = $post['balance'];
                        $booking_code = $get_by_id_data['booking_no'];
          ...
          $this->load->view('balance_clearance/pay_patient_to_branch',$data);
   ...
   public function get_drop_down_value()
   {
      ...
      echo $this->load->view('balance_clearance/drop_down_data',$data,true);
   }
    ...
    public function print_patient_balance_receipt($id="",$patient_id="",$payment_date='',$section_id="")
    {
       ...
       //get transaction IDS
        ...
        $this->load->model('general/general_model'); 
     $transaction_id=$this->general_model->get_transaction_id($id,8,5);   //8 section id and 5 type
     ...
     else
     {
       ...
       if($section_id==1)
        { 
              ...
              $this->load->view('balance_clearance/print_test_balance_clearance_report',$data);
       ...
       else if($section_id==3)
        {
              ...
              $data['new_balance']=$get_balance_previous;
              // $data['balance']=$this->session->userdata('balance');
              $this->load->view('balance_clearance/print_medicine_balance_clearance_report',$data);
        ...
        elseif($section_id==2)
        {
            ...
            $this->load->view('balance_clearance/print_opd_balance_clearance_report',$data);

      }
      elseif($section_id==4)
      {
            $template_format = $this->balance_clearance->template_format(array('section_id'=>16,'types'=>1));  
            //$template_format = $this->balance_clearance->template_format(array('section_id'=>1,'types'=>1,'sub_section'=>0));//,'sub_section'=>2
            //print_r($template_format); exit;
            ...
            $data['user_detail']=$user_detail;
            $data['new_balance']=$get_balance_previous;
            $this->load->view('balance_clearance/print_billing_balance_clearance_report',$data);
      ...
      elseif($section_id==5)
      {
              ...
              $data['user_detail']=$user_detail;
              $data['new_balance']=$get_balance_previous;
              $this->load->view('balance_clearance/print_ipd_balance_clearance_report',$data);
      ...
      else if($section_id==7)
        {
              ...
              // $data['balance']=$this->session->userdata('balance');
              //print_r($data);die;
              $this->load->view('balance_clearance/print_vaccine_balance_clearance_report',$data);
        ...
        else if($section_id==8)  //OT
        {
              ...
              $data['user_detail']=$user_detail;
              $data['new_balance']=$get_balance_previous;
              $this->load->view('balance_clearance/print_ot_balance_clearance_report',$data);
       ...
       // print '<pre>';print_r($data['all_detail']);
        $this->load->view('balance_clearance/print_blood_bank_balance_clearance_report',$data);

        }
        elseif($section_id==13)
        {
            $template_format = $this->balance_clearance->template_format(array('section_id'=>13,'types'=>1));  
            //$template_format = $this->balance_clearance->template_format(array('section_id'=>1,'types'=>1,'sub_section'=>0));//,'sub_section'=>2
            //print_r($template_format); exit;
            ...
            $data['new_balance']=$get_balance_previous;
            //echo "<pre>"; print_r($data);die;
            $this->load->view('balance_clearance/print_ambulance_balance_clearance_report',$data);

      }
      elseif($section_id==14)
        {
            $template_format = $this->balance_clearance->template_format(array('section_id'=>14,'types'=>1));  
            //$template_format = $this->balance_clearance->template_format(array('section_id'=>1,'types'=>1,'sub_section'=>0));//,'sub_section'=>2
            //print_r($template_format); exit;
       ...
       elseif($section_id==15)
      {
              ...
              $template_format = $this->balance_clearance->template_format(array('section_id'=>17,'types'=>1));  
              $data['type']=$section_id;
              $data['template_data']=$template_format;
              $data['all_detail']= $get_by_id_data;
              ...
              $data['user_detail']=$user_detail;
              $data['new_balance']=$get_balance_previous;
              $this->load->view('balance_clearance/print_dialysis_balance_clearance_report',$data);
