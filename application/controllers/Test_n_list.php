...
class Test_n_list extends CI_Controller {
    ...
    { 
        ...
        $query = $this->db->query('SELECT path_test.test_name FROM `path_test`  join path_multi_interpration on path_multi_interpration.test_id = path_test.id where path_test.branch_id=0 and is_deleted=0 group by path_test.id');
