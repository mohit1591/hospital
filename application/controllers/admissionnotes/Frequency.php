...
class Frequency extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('admissionnotes/frequency/frequency_model','frequency');
    ...
    { 
      ...
      if(in_array('492',$users_data['permission']['action']) || in_array('121',$users_data['permission']['section'])){
        ...
        $this->load->view('admissionnotes/frequency/list',$data);
    }
    ...
    public function add()
    {
      ...
      if(in_array('496',$users_data['permission']['action']) || in_array('121',$users_data['permission']['section'])){
       ...
       $this->load->view('admissionnotes/frequency/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('admissionnotes/frequency/view',$data);     
      }
    }  
    ...
    public function archive()
    {
      ...
      if(in_array('499',$users_data['permission']['action']) || in_array('121',$users_data['permission']['section'])){
        ...
        $this->load->view('admissionnotes/frequency/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      if(in_array('499',$users_data['permission']['action']) || in_array('121',$users_data['permission']['section'])){
        ...
        $this->load->model('admissionnotes/frequency/frequency_archive_model','frequency_archive'); 
