...
class Personal_history extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('admissionnotes/personal_history/personal_history_model','personal_history');
    ...
    { 
        ...
        $this->load->view('admissionnotes/personal_history/list',$data);
    }
    ...
    public function add()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
       ...
       $this->load->view('admissionnotes/personal_history/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('admissionnotes/personal_history/view',$data);     
      }
    }  
    ...
    public function archive()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('admissionnotes/personal_history/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        else
        {
         ...
         $users_data = $this->session->userdata('auth_users');
        $this->load->model('admissionnotes/personal_history/personal_history_archive_model','personal_history_archive'); 
