...
class Advice extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('admissionnotes/advice/advice_model','advice');
    ...
    { 
      ...
      if(in_array('502',$users_data['permission']['action']) || in_array('121',$users_data['permission']['section'])){
        ...
        $this->load->view('admissionnotes/advice/list',$data);
    }
    ...
    public function add()
    {
      ...
      if(in_array('503',$users_data['permission']['action']) || in_array('121',$users_data['permission']['section'])){
       ...
       $this->load->view('admissionnotes/advice/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('admissionnotes/advice/view',$data);     
      }
    }  
    ...
    public function archive()
    {
      ...
      if(in_array('506',$users_data['permission']['action']) || in_array('121',$users_data['permission']['section'])){
        ...
        $this->load->view('admissionnotes/advice/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      if(in_array('506',$users_data['permission']['action']) || in_array('121',$users_data['permission']['section'])){
        ...
        $this->load->model('admissionnotes/advice/advice_archive_model','advice_archive'); 
