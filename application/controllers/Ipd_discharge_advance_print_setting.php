...
class Ipd_discharge_advance_print_setting extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
$this->load->model('ipd_discharge_summary_print_setting/ipd_discharge_advance_summary_print_setting_model','discharge_print_setting');
    ...
    public function index()
    {
        ...
        $this->load->view('ipd_discharge_summary_print_setting/add_advance',$data);
    }
    ...
    public function get_according_to_section()
    {
     ...
     $this->load->view('ipd_discharge_summary_print_setting/print_advance_template',$data);
