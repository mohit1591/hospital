...
class Chief_complaints extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('eye/chief_complaints/Chiefcomplaint_model','chief_complaints');
        $this->load->library('form_validation');
    }

    public function index()
    { 
        unauthorise_permission('225','1265');
        $data['page_title'] = 'Chief Complaints List'; 
        $this->load->view('eye/chief_complaints/list',$data);
    }
    ...
    { 
        ...
        foreach ($list as $chief_complaints) {
         // print_r($chief_complaints);die;
          ...
          $btnedit='';
          $btndelete='';
          if(in_array('1267',$users_data['permission']['action'])){
          ...
          if(in_array('1268',$users_data['permission']['action'])){
    ...
    public function add()
    {
        unauthorise_permission('225','1266');
       ...
       $this->load->view('eye/chief_complaints/add',$data);       
    }
    
    public function edit($id="")
    {
      unauthorise_permission('225','1267');
    ...
    {
       unauthorise_permission('225','1268');
       if(!empty($id) && $id>0)
       {
    ...
    {
        unauthorise_permission('225','1269');
        $data['page_title'] = 'chief Complaints Archive List';
        $this->load->helper('url');
        $this->load->view('eye/chief_complaints/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
        unauthorise_permission('225','1269');
        $users_data = $this->session->userdata('auth_users');
        $this->load->model('eye/chief_complaints/chiefcomplaint_archive_model','chief_complaints_archive'); 
    ...
    {
        unauthorise_permission('225','1271');
        $this->load->model('eye/chief_complaints/chiefcomplaint_archive_model','chief_complaints_archive');
       if(!empty($id) && $id>0)
       {
    ...
    {
        unauthorise_permission('225','1270');
        $this->load->model('eye/chief_complaints/chiefcomplaint_archive_model','chief_complaints_archive');
       if(!empty($id) && $id>0)
       {
