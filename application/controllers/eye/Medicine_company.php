...
class Medicine_company extends CI_Controller {
    ...
    { 
        unauthorise_permission('240','1370');
        $data['page_title'] = 'Manufacturing Company List'; 
        $this->load->view('eye/medicine_company/list',$data);
    }
    ...
    { 
        ...
        foreach ($list as $type) {
         // print_r($relation);die;
          ...
          $btnedit='';
          $btndelete='';
          if(in_array('1372',$users_data['permission']['action'])){
           ...
           if(in_array('1373',$users_data['permission']['action'])){
    ...
    public function add()
    {
        unauthorise_permission('240','1371');
       ...
       $this->load->view('eye/medicine_company/add',$data);       
    }
    
    public function edit($id="")
    {
      unauthorise_permission('240','1372');
   ...
   public function medicine_company($str){
    ...
    {
       unauthorise_permission('240','1373');
       if(!empty($id) && $id>0)
       {
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('eye/medicine_company/view',$data);     
      }
    }  
    ...
    {
        unauthorise_permission('240','1374');
        $data['page_title'] = 'Manufacturing company Archive List';
        $this->load->helper('url');
        $this->load->view('eye/medicine_company/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('240','1374');
        $this->load->model('eye/medicine_company/medicine_company_archive_model','medicine_company_archive'); 
        ...
        foreach ($list as $type) { 
          ...
          $btnrestore='';
          $btndelete='';
          if(in_array('1376',$users_data['permission']['action'])){
    ...
    {
        unauthorise_permission('240','1376');
        $this->load->model('eye/medicine_company/medicine_company_archive_model','medicine_company_archive');
       if(!empty($id) && $id>0)
       {
    ...
    {
        unauthorise_permission('240','1375');
        $this->load->model('eye/medicine_company/medicine_company_archive_model','medicine_company_archive');
       if(!empty($id) && $id>0)
       {
