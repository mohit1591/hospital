...
class Duration extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('eye/duration/duration_model','duration');
        $this->load->library('form_validation');
    }

    public function index()
    { 
        unauthorise_permission('233','1321');
        $data['page_title'] = 'Duration List'; 
        $this->load->view('eye/duration/list',$data);
    }
    ...
    { 
        ...
        foreach ($list as $duration) {
         // print_r($relation);die;
          ...
          $btnedit='';
          $btndelete='';
          if(in_array('1323',$users_data['permission']['action'])){
           ...
           if(in_array('1324',$users_data['permission']['action'])){
    ...
    public function add()
    {
        unauthorise_permission('233','1322');
       ...
       $this->load->view('eye/duration/add',$data);       
    }
    
    public function edit($id="")
    {
      unauthorise_permission('233','1323');
    ...
    {
       unauthorise_permission('233','1324');
       if(!empty($id) && $id>0)
       {
    ...
    {
        unauthorise_permission('233','1325');
        $data['page_title'] = 'Duration Archive List';
        $this->load->helper('url');
        $this->load->view('eye/duration/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('233','1325');
        $this->load->model('eye/duration/duration_archive_model','duration_archive'); 
        ...
        foreach ($list as $duration) { 
          ...
          $btnrestore='';
          $btndelete='';
          if(in_array('1327',$users_data['permission']['action'])){
          ...
          if(in_array('1326',$users_data['permission']['action'])){
    ...
    {
        unauthorise_permission('233','1327');
        $this->load->model('eye/duration/duration_archive_model','duration_archive');
       if(!empty($id) && $id>0)
       {
    ...
    {
        unauthorise_permission('233','1326');
        $this->load->model('eye/duration/duration_archive_model','duration_archive');
       if(!empty($id) && $id>0)
       {
