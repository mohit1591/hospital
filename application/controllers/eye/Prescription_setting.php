...
class Prescription_setting extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('eye/prescription_setting/prescription_setting_model','prescriptionsetting');
    ...
    public function index()
    {
        ...
        unauthorise_permission(245,1398);
        ...
        $this->load->view('eye/prescription_setting/add',$data);
    }


    public function preview($id="")
    {
        $this->load->model('eye/prescription/prescription_model','prescription');
        ...
        $this->load->view('eye/prescription_setting/preview',$data);
    } 
