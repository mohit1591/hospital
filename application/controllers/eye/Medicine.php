...
class Medicine extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('eye/medicine/medicine_model','medicine');
        $this->load->model('eye/medicine_company/medicine_company_model','medicine_company');
        $this->load->library('form_validation');
    }

    public function index()
    { 
        unauthorise_permission('229','1293');
        $data['page_title'] = 'Medicine List'; 
        $this->load->view('eye/medicine/list',$data);
    }
    ...
    { 
        ...
        foreach ($list as $medicine) {
         // print_r($relation);die;
          ...
          $btnedit='';
          $btndelete='';
          if(in_array('1295',$users_data['permission']['action'])){
          ...
          if(in_array('1296',$users_data['permission']['action'])){
    ...
    public function add()
    {
        unauthorise_permission('229','1294');
       ...
       $this->load->view('eye/medicine/add',$data);       
    }
    
    public function edit($id="")
    {
      unauthorise_permission('229','1295');
   ...
   public function brand($str){
          ...
          if(!empty($post['brand']))
          {
               ...
               if(!empty($post['data_id']) && $post['data_id']>0)
               {
                    $data_cat= $this->medicine_company->get_by_id($post['data_id']);
                      ...
                      {
                        $medicine_company = $this->eye_general->check_medicine_company($str);
               ...
               else
               {
                    ...
                    $medicine_company = $this->eye_general->check_medicine_company($post['brand'], $post['data_id']);
    ...
    {
       unauthorise_permission('229','1296');
       if(!empty($id) && $id>0)
       {
    ...
    public function archive()
    {
        ...
        $this->load->view('eye/medicine/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('229','1297');
        $this->load->model('eye/medicine/medicine_archive_model','medicine_archive'); 
        ...
        foreach ($list as $medicine) { 
          ...
          $btnrestore='';
          $btndelete='';
          if(in_array('1299',$users_data['permission']['action'])){
          ...
          if(in_array('1298',$users_data['permission']['action'])){
    ...
    {
        unauthorise_permission('229','1299');
        $this->load->model('eye/medicine/medicine_archive_model','medicine_archive');
       if(!empty($id) && $id>0)
       {
    ...
    {
        unauthorise_permission('229','1298');
        $this->load->model('eye/medicine/medicine_archive_model','medicine_archive');
       if(!empty($id) && $id>0)
       {
