...
class Type extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('eye/type/type_model','typemodel');
        $this->load->library('form_validation');
    }

    public function index()
    { 
        unauthorise_permission('231','1307');
        $data['page_title'] = 'Medicine Unit List'; 
        $this->load->view('eye/type/list',$data);
    }
    ...
    { 
        ...
        foreach ($list as $type) {
         // print_r($relation);die;
          ...
          $btnedit='';
          $btndelete='';
          if(in_array('1309',$users_data['permission']['action'])){
           ...
           if(in_array('1310',$users_data['permission']['action'])){
    ...
    public function add()
    {
        unauthorise_permission('231','1308');
       ...
       $this->load->view('eye/type/add',$data);       
    }
    
    public function edit($id="")
    {
      unauthorise_permission('231','1309');
   ...
   public function medicine_type($str){
    ...
    {
       unauthorise_permission('231','1310');
       if(!empty($id) && $id>0)
       {
    ...
    {
        unauthorise_permission('231','1311');
        $data['page_title'] = 'Medicine Unit Archive List';
        $this->load->helper('url');
        $this->load->view('eye/type/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('231','1311');
        $this->load->model('eye/type/type_archive_model','type_archive'); 
        ...
        foreach ($list as $type) { 
          ...
          $btnrestore='';
          $btndelete='';
          if(in_array('1313',$users_data['permission']['action'])){
          ...
          if(in_array('1312',$users_data['permission']['action'])){
    ...
    {
        unauthorise_permission('231','1313');
        $this->load->model('eye/type/type_archive_model','type_archive');
       if(!empty($id) && $id>0)
       {
    ...
    {
        unauthorise_permission('231','1312');
        $this->load->model('eye/type/type_archive_model','type_archive');
       if(!empty($id) && $id>0)
       {
