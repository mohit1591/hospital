...
class Test_name extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('nursingnotes/test_name/test_name_model','test_name');
    ...
    { 
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('nursingnotes/test_name/list',$data);
    }
    ...
    public function add()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
       ...
       $this->load->view('nursingnotes/test_name/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('nursingnotes/test_name/view',$data);     
      }
    }  
    ...
    public function archive()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('nursingnotes/test_name/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $users_data = $this->session->userdata('auth_users');
        $this->load->model('nursingnotes/test_name/test_name_archive_model','test_name_archive'); 
