...
class Dosage extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('nursingnotes/dosage/dosage_model','dosage');
    ...
    { 
        ...
        $this->load->view('nursingnotes/dosage/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('nursingnotes/dosage/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('nursingnotes/dosage/view',$data);     
      }
    }  
    ...
    public function archive()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('nursingnotes/dosage/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->model('nursingnotes/dosage/dosage_archive_model','dosage_archive'); 
