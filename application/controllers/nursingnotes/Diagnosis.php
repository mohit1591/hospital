...
class Diagnosis extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('nursingnotes/diagnosis/Diagnosis_model','diagnosis');
    ...
    { 
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('nursingnotes/diagnosis/list',$data);
    }
    ...
    public function add()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
       ...
       $this->load->view('nursingnotes/diagnosis/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('nursingnotes/diagnosis/view',$data);     
      }
    }  
    ...
    public function archive()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('nursingnotes/diagnosis/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        else
        {
         ...
         $users_data = $this->session->userdata('auth_users');
        $this->load->model('nursingnotes/diagnosis/diagnosis_archive_model','diagnosis_archive'); 
