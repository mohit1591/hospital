...
class Examination extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('nursingnotes/examination/Examination_model','examination');
    ...
    { 
        ...
        $this->load->view('nursingnotes/examination/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('nursingnotes/examination/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('nursingnotes/examination/view',$data);     
      }
    }  
    ...
    public function archive()
    {
       ...
       $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('nursingnotes/examination/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
       ...
       $users_data = $this->session->userdata('auth_users');
        ...
        $users_data = $this->session->userdata('auth_users');
        $this->load->model('nursingnotes/examination/Examination_archive_model','examination_archive'); 
