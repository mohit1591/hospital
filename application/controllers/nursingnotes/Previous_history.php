...
class Previous_history extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('nursingnotes/previous_history/Previous_history_model','previoushis');
    ...
    { 
        ...
        $this->load->view('nursingnotes/previous_history/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('nursingnotes/previous_history/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('nursingnotes/previous_history/view',$data);     
      }
    }  
    ...
    public function archive()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('nursingnotes/previous_history/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        else
        {
         ...
         $users_data = $this->session->userdata('auth_users');
        $this->load->model('nursingnotes/previous_history/previous_history_archive_model','previoushis_archive'); 
