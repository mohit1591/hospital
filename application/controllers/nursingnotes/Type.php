...
class Type extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('nursingnotes/type/type_model','typemodel');
    ...
    { 
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('nursingnotes/type/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('nursingnotes/type/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('nursingnotes/type/view',$data);     
      }
    }  
    ...
    public function archive()
    {
        ...
        $this->load->view('nursingnotes/type/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->model('nursingnotes/type/type_archive_model','type_archive'); 
