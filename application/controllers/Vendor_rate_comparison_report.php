...
class Vendor_rate_comparison_report extends CI_Controller {

  public function __construct()
  {
    parent::__construct();
    auth_users();
    $this->load->model('medicine_report/vendor_rate_comparison_report_model','vendor_rate_comparison');  
   ...
   public function index()
   {
       ...
       $data['page_title'] = 'Vendor Rate Comparison Report';
       $data['form_data'] = array('start_date'=>$start_date, 'end_date'=>$end_date);
       $this->load->model('purchase/purchase_model','purchase_medicine');
       $data['vendor_list'] = $this->purchase_medicine->vendor_list();
       $this->load->view('medicine_report/vendor_rate_comparison_report',$data);
    }
   ...
   // echo"<pre>";print_r($list);die;
    ...
    public function vendor_rate_comparison_excel()
    {
         ...
         $fields = array('S.No.','Vendor Name','Medicine Name','Purchase Date','Purchase Rate');
        ...
        if(!empty($list))
        {
            ...
            if($k==1)
            {
              array_push($rowData,$k,$data_list->vendor_name,$data_list->medicine_name,date('d-m-Y', strtotime($data_list->purchase_date)),$data_list->purchase_rate);
                //$k++;
            }
            else
            {
    ...
    {    
        ...
        $this->load->view('medicine_report/vendor_rate_comparison_html',$data);
