...
class Ambulance_print_setting extends CI_Controller {
 
  function __construct() 
  {
      parent::__construct();	
      auth_users();  
      $this->load->model('ambulance_print_setting/ambulance_print_setting_model','opd_print');
  ...
  public function index()
  {
      ...
      $data['page_title'] = 'Ambulance Print List'; 
      $this->load->view('ambulance_print_setting/list',$data);
  }
	...
	public function add()
	{
      ...
      else
      {
          ...
          $printer_paper_type='';
      		...
      		$data['page_title'] = "Add Ambulance Print Settings";
      		$data['form_error'] = [];
      ...
      {   
        ...
        if($this->form_validation->run() == TRUE)
        {
              ...
              redirect('ambulance_print_setting/add');
        }
        else
        {
		...
		$this->load->view('ambulance_print_setting/add',$data);
	}
  ...
  public function opd_printtemplate_dropdown()
  {
      ...
      $data_array= array('printer_id'=>$value,'section'=>13,'types'=>1);
