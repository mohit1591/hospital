           ...
           else if(in_array('2521',$users_data['permission']['action']))
           {
            ...
            $btn_advanced = '<div class="slidedown">
              <button disabled class="btn-custom">More <span class="caret"></span></button>
                ...
                '.$btnmedic.$btnmedicine_view.$btn_medicine_print.$btn_advance.'
              </ul>
            </div> ';
           
             $row[] = $btnedit.$btndelete.$btn_print.$btn_letter_print.$btneditadvance.$btn_letter_print_adv.$btn_advanced;
            $data[] = $row;
            $i++;
        }
