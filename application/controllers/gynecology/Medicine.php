...
class Medicine extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('gynecology/medicine/medicine_model','medicine');
        $this->load->library('form_validation');
    }

    public function index()
    { 
        unauthorise_permission('310','1852');
        $data['page_title'] = 'Medicine List'; 
        $this->load->view('gynecology/medicine/list',$data);
    }
    ...
    { 
        ...
        foreach ($list as $medicine) {
         // print_r($relation);die;
          ...
          $btnedit='';
          $btndelete='';
          if(in_array('1854',$users_data['permission']['action'])){
           ...
           if(in_array('1855',$users_data['permission']['action'])){
    ...
    public function add()
    {
        unauthorise_permission('310','1853');
       ...
       $this->load->view('gynecology/medicine/add',$data);       
    }
    

    public function edit($id="")
    {
      unauthorise_permission('310','1854');
    ...
    {
       unauthorise_permission('310','1855');
       if(!empty($id) && $id>0)
       {
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('gynecology/medicine/view',$data);     
      }
    }  
    ...
    {
        unauthorise_permission('310','1856');
        $data['page_title'] = 'Medicine Archive List';
        $this->load->helper('url');
        $this->load->view('gynecology/medicine/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
        ...
        unauthorise_permission('310','1856');
        $this->load->model('gynecology/medicine/medicine_archive_model','medicine_archive'); 
        ...
        foreach ($list as $medicine) { 
          ...
          $btnrestore='';
          $btndelete='';
          if(in_array('1858',$users_data['permission']['action'])){
          ...
          if(in_array('1857',$users_data['permission']['action'])){
    ...
    {
        unauthorise_permission('310','1858');
        $this->load->model('gynecology/medicine/medicine_archive_model','medicine_archive');
       if(!empty($id) && $id>0)
       {
    ...
    {
       unauthorise_permission('310','1857');
        $this->load->model('gynecology/medicine/medicine_archive_model','medicine_archive');
       if(!empty($id) && $id>0)
       {
