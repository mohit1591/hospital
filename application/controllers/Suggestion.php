...
class Suggestion extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('suggestion/suggestion_model','suggestion');
    ...
    {  
      ...
      if(in_array('509',$users_data['permission']['action']) || in_array('121',$users_data['permission']['section'])){
        ...
        $this->load->view('suggestion/list',$data);
    }
    ...
    public function archive()
    {
      ...
      if(in_array('513',$users_data['permission']['action']) || in_array('121',$users_data['permission']['section'])){
        ...
        $this->load->view('suggestion/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      if(in_array('513',$users_data['permission']['action']) || in_array('121',$users_data['permission']['section'])){
        ...
        $users_data = $this->session->userdata('auth_users');
        $this->load->model('suggestion/suggestion_archive_model','suggestion_archive'); 
