...
class Amb_print_setting extends CI_Controller {
 
  function __construct() 
  {
      parent::__construct();	
      auth_users();  
      $this->load->model('ambulance/print_setting_model','opd_print');
	...
	public function add()
	{
      ...
      {   
        ...
        if($this->form_validation->run() == TRUE)
        {
              ...
              redirect('ambulance/amb_print_setting/add');
        }
        else
        {
		...
		$this->load->view('ambulance/print_setting/add',$data);
	}
