...
class Dialysis_prescription_template extends CI_Controller {
 
	function __construct() 
	{
		parent::__construct();	
		auth_users();  
		$this->load->model('dialysis_prescription_template/dialysis_prescription_template_model','prescriptiontemplate');
	  ...
	  public function index()
    {
        ...
        $data['page_title'] = 'Dialysis Prescription Template List'; 
        $this->load->view('dialysis_prescription_template/list',$data);
    }
    ...
    {   
        ...
        foreach ($list as $prescriptions) {
         // print_r($test);die;
            ...
            //{
              $btn_edit = ' <a class="btn-custom" href="'.base_url("dialysis_prescription_template/edit/".$prescriptions->id).'" title="Edit"><i class="fa fa-pencil"></i> Edit</a>';
            //}
    ...
    {  
     ...
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('dialysis_prescription_template/view',$data);     
      }
    }  
	...
	public function add()
	{
        ...
        {   
            ...
            if($this->form_validation->run() == TRUE)
            {
              ...
              redirect(base_url('dialysis_prescription_template'));
            }
            else
            {
         ...
         $this->load->view('dialysis_prescription_template/add_template',$data);
    }
    ...
    public function edit($id="")
    {
     ...
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $data['prescription_template_data'] = $this->prescriptiontemplate->get_dialysis_prescription_template($id); 
        $data['test_template_data'] = $this->prescriptiontemplate->get_dialysis_test_template($id); 
   ...
   public function delete_pres_medicine($medicine_presc_id="",$template_id='')
   {
    ...
    public function archive()
    {
        ...
        $data['page_title'] = 'Dialysis Prescription Template Archive List';
        $this->load->helper('url');
        $this->load->view('dialysis_prescription_template/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('81','543');
        $this->load->model('dialysis_prescription_template/dialysis_prescription_template_archive_model','prescription_template_archive'); 
