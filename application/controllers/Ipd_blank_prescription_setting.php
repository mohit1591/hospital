...
class Ipd_blank_prescription_setting extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('ipd_prescription_setting/blank_prescription_setting_model','prescriptionsetting');
    ...
    public function index()
    {
        ...
        $this->load->view('ipd_blank_prescription_setting/add',$data);
    }
    ...
    public function preview($id="",$type='1')
    {
        ...
        $this->load->view('ipd_blank_prescription_setting/preview',$data);
    } 
