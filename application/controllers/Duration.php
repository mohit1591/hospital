...
class Duration extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('duration/duration_model','duration');
    ...
    { 
        ...
        $this->load->view('duration/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('duration/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('duration/view',$data);     
      }
    }  
    ...
    public function archive()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('duration/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->model('duration/duration_archive_model','duration_archive'); 
