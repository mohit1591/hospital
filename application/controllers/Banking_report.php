...
class Banking_report extends CI_Controller {
	...
	public function __construct()
	{
		parent::__construct();
		auth_users();
		$this->load->model('banking_report/banking_report_model','banking_report');
	...
	public function index()
	{
	 ...
	 public function banking(){
       ...
       $this->load->view('banking_report/bank_report_add_report',$data);
    }
    ...
    { 
     ...
     // print_r($data['self_branch_bank_list']);die;
      ...
      $this->load->view('banking_report/banking_report_data',$data);  
    ...
    {    
     ...
     // print '<pre>';print_r($data);die;
      //print '<pre>';print_r($data['branch_bank_collection_list']);die;
       ...
       $data['parent_id']=$users_data['parent_id'];
       //$this->load->view('banking_report/banking_report_data',$data);
      $html = $this->load->view('banking_report/pdf_banking_report_html',$data,TRUE); 
    ...
    {    
     ...
     // print '<pre>';print_r($data);die;
      //print '<pre>';print_r($data['branch_bank_collection_list']);die;
        $data['get'] = $get;
       $data['parent_id']=$users_data['parent_id'];
        $this->load->view('banking_report/pdf_banking_report_html',$data); 
    }
