...
class Pathology_inventory_reports extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('reports/pathology_inventory_report_model','reports');
    ...
    {   
        ...
        $this->load->view('reports/list_pathology_inventory_report_data',$data);
    }
    ...
    {    
        ...
        $this->load->view('reports/pathology_inventory_report_html',$data);
