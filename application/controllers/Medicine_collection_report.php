...
class Medicine_collection_report extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('reports/medicine_collection_report_model','medicine_collection_reports');
    ...
    {   unauthorise_permission('159','931');
        ...
        // End Defaul Search
        $data['form_data'] = array('from_date'=>$start_date, 'end_date'=>$end_date,'branch_id'=>'','col_type'=>0);
        $data['page_title'] = 'Medicine Collection Report';
        $this->load->model('general/general_model','general_model');
        $data['employee_list'] = $this->general_model->branch_user_list();
        $this->load->view('medicine_collection/list',$data);
    }
        ...
        foreach($list as $reports) 
        {
          //print_r($reports);
            ...
            if($reports->blnce>0 && $reports->parent_id>0){
               $print_url = "'".base_url('sales_medicine/print_sales_report/'.$reports->id)."'";
    ...
    public function medicine_report_excel()
    {
        ...
        unauthorise_permission('159','931');
         ...
         // print_r($objWorksheet);die;
          ...
          header("Content-Disposition: attachment; filename=medicine_collection_report_".time().".xls");  
    ...
    public function advance_search()
    {
      $data['page_title'] = "Advance Search";
       ...
       // print_r($data);die;
        $this->load->view('medicine_collection/advance_search',$data);
    }
    ...
    {   
        ...
        $this->load->view('medicine_collection/medicine_report_html',$data);
