...
class Manuf_company extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('canteen/manuf_company/manuf_company_model','manuf_company');
    ...
    { 
       ...
       unauthorise_permission('55','360');
        $data['page_title'] = 'Manufacturing company list'; 
        $this->load->view('canteen/manuf_company/list',$data);
    }
    ...
    { 
      // unauthorise_permission('55','360');
       ...
       $btnedit='';
       $btndelete='';
      if(in_array('362',$users_data['permission']['action'])){
    ...
    public function add()
    {
       ...
       $this->load->view('canteen/manuf_company/add',$data);       
    }
    
    public function edit($id="")
    {
     //unauthorise_permission('55','362');
   ...
   public function check_company($str)
  {
    ...
    if(!empty($str))
    {
        ...
        {
                $companydata = $this->general->check_canteen_company($str);
    ...
    {  
     ...
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('canteen/manuf_company/view',$data);     
      }
    }  
    ...
    {
        //unauthorise_permission('55','364');
        $data['page_title'] = 'Manufacturing company archive list';
        $this->load->helper('url');
        $this->load->view('canteen/manuf_company/archive',$data);
    }

    public function archive_ajax_list()
    {
       //unauthorise_permission('55','364');
        $this->load->model('canteen/manuf_company/manuf_company_archive_model','manuf_company_archive'); 
