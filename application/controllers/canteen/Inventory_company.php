...
class Inventory_company extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('canteen/inventory_company/inventory_company_model','manuf_company');
    ...
    { 
       ...
       //unauthorise_permission('55','360');
        ...
        $this->load->view('canteen/inventory_company/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('canteen/inventory_company/add',$data);       
    }
   ...
   public function check_company($str)
  {
    ...
    {  
     ...
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('canteen/inventory_company/view',$data);     
      }
    }  
    ...
    public function archive()
    {
        ...
        $this->load->view('canteen/inventory_company/archive',$data);
    }

    public function archive_ajax_list()
    {
       //unauthorise_permission('55','364');
        $this->load->model('canteen/inventory_company/inventory_company_archive_model','manuf_company_archive'); 
