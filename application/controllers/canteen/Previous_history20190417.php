...
class Previous_history extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('previous_history/Previous_history_model','previoushis');
    ...
    { 
        ...
        $this->load->view('previous_history/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('previous_history/add',$data);       
    }
    ...
    private function _validate()
    {
        ...
        $this->form_validation->set_rules('prv_history', 'previous history', 'trim|required'); 
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('previous_history/view',$data);     
      }
    }  
    ...
    public function archive()
    {
        ...
        $this->load->view('previous_history/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
        unauthorise_permission('68','429');
         $users_data = $this->session->userdata('auth_users');
        $this->load->model('previous_history/previous_history_archive_model','previoushis_archive'); 
