...
class Reports extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('canteen/reports/reports_model','reports');
    ...
    {   
        ...
        $this->load->view('canteen/reports/list',$data);
    }
    public function expenses()
    {
        ...
        $this->load->view('canteen/reports/expense_report',$data);
    }
     public function collections(){
      // unauthorise_permission('42','245');
       ...
       $this->load->view('canteen/reports/collection_report',$data);
    }
     public function day_collections(){
      // unauthorise_permission('42','245');
       //$data['employee_list'] = $this->reports->employee_list();
                         $this->load->model('general/general_model','general_model');
       $data['employee_list'] = $this->general_model->branch_user_list();      
       ...
       $data['from_c_date'] = date('d-m-Y');
       $data['to_c_date'] = date('d-m-Y'); 
       $this->load->view('canteen/reports/day_collection_report',$data);
    }
    public function next_appoitment(){
      ...
      // $data['next_appotment_list'] = $this->reports->next_appotment_list();
       ...
       $data['from_c_date'] = date('d-m-Y');
       $data['to_c_date'] = date('d-m-Y'); 
       $this->load->view('canteen/reports/next_appoitment_report',$data);
    }
    public function medicine_collections(){
      $data['employee_list'] = $this->reports->employee_list();
      $data['page_title'] = 'Medicine Collections Reports';
      $this->load->view('canteen/reports/medicine_collection_report',$data);
    }
    ...
    public function advance_search()
    {
        ...
        $this->load->view('canteen/reports/advance_search',$data);
    }
    ...
    {    
        ...
        $this->load->view('canteen/reports/opd_report_html',$data);
    ...
    { 
     ...
     $this->load->view('canteen/reports/list_expenses_reports',$data);  
   ...
   // echo "<pre>"; print_r($data['self_purchase_return_collection_list']);die;
      /* 14-10-2019 */
       /* 06-11-2019 */
      ...
      //$this->load->view('canteen/reports/list_collection_report_data',$data); 
      
             if(!empty($get['send']) && $get['send']=='preview')
      {
        $this->load->view('canteen/reports/list_collection_report_preview',$data);
      }
      else
      {
      ...
      //echo "<pre>"; print_r($get['start_date']); exit;
    $from_date = $get['start_date'];
    $to_date = $get['end_date'];
          
        $middle_replace_part=$this->load->view('canteen/reports/list_collection_report_data',$data,true);
...
<div style="text-align: center; font-weight: bold;">
    ...
    { 
      ...
      $data['get'] = $get;
      $data['collection_tab_setting'] = $this->reports->get_collection_tab_setting();
      $this->load->view('canteen/reports/list_hospital_collection_report',$data);  
      //branch_collection_list
    }
 ...
 function collection_excel($get)
    ...
    public function enquiry_source(){
       ...
       $data['from_c_date'] = date('d-m-Y');
       $data['to_c_date'] = date('d-m-Y'); 
       $this->load->view('canteen/reports/source_report',$data);
    }
    ...
    { 
      ...
      $data['get'] = $get;
      $this->load->view('canteen/reports/list_source_from_data',$data);  
