...
class Banking extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('canteen/banking/banking_model','banking','banking_archive_model');
    ...
    public function index()
    {
        ...
        $this->load->view('canteen/banking/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('canteen/banking/add',$data);       
    }
    ...
    public function archive()
    {
        ...
        $this->load->view('canteen/banking/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission(95,616);
        $this->load->model('canteen/banking/banking_archive_model','banking_archive'); 
        $users_data = $this->session->userdata('auth_users');
        ...
        //unauthorise_permission(63,578);
          ...
          if(!empty($list))
          {
               ...
               foreach($list as $reports)
               {
                    ...
                    array_push($rowData,$reports->bank_name,$reports->account_holder,$reports->account_no,$reports->amount,date('d-M-Y',strtotime($reports->deposite_date)));
                    $count = count($rowData);
                    for($j=0;$j<$count;$j++)
                    {
    ...
    {    
        ...
        $this->load->view('canteen/banking/banking_report_html',$data);
