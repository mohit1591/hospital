...
class Billing extends CI_Controller {
    ...
    {    
        ...
        // End Defaul Search
        $data['form_data'] = array('branch_id'=>'','doctor_id'=>'','start_date'=>$start_date, 'end_date'=>$end_date);
		if(!empty($post))
		{
...
// Default Search Setting
    ...
    public function get_payment_mode_data()
    {
        ...
        $html.='<div class="purchase_medicine_mod_of_payment"><label>'.$payment_detail->field_name.'</label><span class="star">*</span><input type="text" name="field_name[]" value="" onkeypress="payment_calc_all();" required><input type="hidden" value="'.$payment_detail->id.'" name="field_id[]" /><div class="f_right">'.$var_form_error.'</div></div>';
        }
        echo $html;exit;
...
function print_doctor_commission_letter_head()
{
    ...
    $table_data='
        <table border=1 cellpadding="8" width="100%" style="font:13px Arial;border-collapse:collapse;">
          <tr style="font-weight:bold;">
                ...
                <th align="right">Booking / Sale Date</th> 
                <th align="right">Department</th>
                <th align="right">Total Commission</th>
              </tr> ';
 ...
 if(!empty($list))
 {
    ...
    $table_data.='<tr>
        ...
        <td align="right">'.date('d-m-Y',strtotime($data->booking_date)).'</td> 
        <td align="right">'. $data->commission_type.'</td>
