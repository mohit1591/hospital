...
class Stock_issue_allotment extends CI_Controller {
	...
	function __construct() 
	{
  	parent::__construct();	
  	 auth_users();  
  	$this->load->model('canteen/stock_issue_allotment/stock_issue_allotment_model','stock_issue_allotment');
  	...
  	public function index()
    {
        ...
        $this->load->view('canteen/stock_issue_allotment/list',$data);
      }
    ...
    {    
        ...
        $this->load->view('canteen/stock_issue_allotment/stock_allotment_issue_report_html',$data);
    ...
    public function add($ipd_id="",$patient_id="")
    {
        ...
        $this->load->view('canteen/stock_issue_allotment/add',$data);
    }
          ...
          {   
            ...
            if(isset( $stock_issue_allotment_item_list) && !empty($stock_issue_allotment_item_list))
            {
             ...
             else
             {
                  ...
                  $stock_issue_allotment_item_list[$post['item_id']] = array('item_id'=>$post['item_id'],'total_price'=>$post['total_price'],'total_price'=>$post['total_price'],'category_id'=>$post['category_id'],'item_code'=>$post['item_code'],'unit'=>$post['unit'], 'quantity'=>$post['quantity'], 'amount'=>$post['amount'],'item_price'=>$post['item_price'],'total_amount'=>$post['total_amount'],'item_name'=>$post['item_name']);
  ...
  public function archive_ajax_list()
    {
        ...
        $this->load->model('canteen/stock_issue_allotment/stock_issue_allotment_archive_model','stock_issue_allotment_archive'); 
...
public function get_payment_mode_data()
{
 ...
 public function payment_calc_all()
    { 
        $stock_issue_allotment_item_list = $this->session->userdata('stock_issue_allotment_item_list'); 
       // print_r($stock_issue_allotment_item_list);die;
        $post = $this->input->post();
        $total_amount = 0;
        $total_discount =0;
    ...
    public function payment_cal_perrow()
    {
      ...
      { 
        ...
        $stock_issue_allotment_item_list[$post['item_id']] =  array('item_id'=>$post['item_id'],'category_id'=>$post['category_id'],'item_code'=>$post['item_code'],'item_name'=>$post['item_name'],'amount'=>$post['item_price']*$post['quantity'],'unit'=>$post['unit'],'item_price'=>$post['item_price'],'quantity'=>$post['quantity'],'total_amount'=>'','total_price'=>$total_price); 
        $this->session->set_userdata('stock_issue_allotment_item_list', $stock_issue_allotment_item_list);
     ...
     public function archive()
    {
       //unauthorise_permission(167,965);
        ...
        $this->load->view('canteen/stock_issue_allotment/archive',$data);
    }
    function deleteall()
    {
