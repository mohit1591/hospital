...
class Vaccine_billing_report extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('canteen/vaccine_billing_report/vaccine_billing_model','vaccine_bill');
     ...
     public function vaccine_bill_report(){
       ...
       $this->load->view('canteen/vaccine_billing_report/vaccine_billing_report',$data);
    }
    ...
    { 
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $data['get'] = $get;
      $this->load->view('canteen/vaccine_billing_report/list_collection_report_data',$data);  
    }
