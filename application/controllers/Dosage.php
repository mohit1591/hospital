...
class Dosage extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('dosage/dosage_model','dosage');
    ...
    { 
        ...
        $this->load->view('dosage/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('dosage/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('dosage/view',$data);     
      }
    }  
    ...
    public function archive()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('dosage/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->model('dosage/dosage_archive_model','dosage_archive'); 
