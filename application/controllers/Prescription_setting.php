...
class Prescription_setting extends CI_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model('prescription_setting/prescription_setting_model','prescriptionsetting');
    ...
    public function index()
    {
        ...
        $this->load->view('prescription_setting/add',$data);
    }
    ...
    public function preview($id="")
    {
        ...
        $this->load->view('prescription_setting/preview',$data);
    } 
