...
class Chief_complaints extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('chief_complaints/Chiefcomplaint_model','chief_complaints');
    ...
    { 
        ...
        $this->load->view('chief_complaints/list',$data);
    }
    ...
    public function add()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
       ...
       $this->load->view('chief_complaints/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('chief_complaints/view',$data);     
      }
    }  
    ...
    public function archive()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        $this->load->view('chief_complaints/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
      ...
      $users_data = $this->session->userdata('auth_users');
        ...
        else
        {
         ...
         $users_data = $this->session->userdata('auth_users');
        $this->load->model('chief_complaints/chiefcomplaint_archive_model','chief_complaints_archive'); 
