...
class Daycare_discharge_labels_setting  extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        auth_users();
        unauthorise_permission('414','2501');
    ...
    public function index()
    {
        ...
        unauthorise_permission('414','2501');
        $data['page_title'] = 'Day Care Discharge Labels Settings'; 
       ...
       // print '<pre>'; print_r($post);die;
        ...
        $this->load->view('daycare_discharge_labels_setting/add',$data);
    } 
