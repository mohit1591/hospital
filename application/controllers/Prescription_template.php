...
class Prescription_template extends CI_Controller {
	...
	function __construct() 
	{
		parent::__construct();	
		auth_users();  
		$this->load->model('prescription_template/prescription_template_model','prescriptiontemplate');
	  ...
	  public function index()
    {
        ...
        $this->load->view('prescription_template/list',$data);
    }
    ...
    {   
        ...
        foreach ($list as $prescriptions) {
         // print_r($test);die;
            ...
            {
              $btn_edit = ' <a class="btn-custom" href="'.base_url("prescription_template/edit/".$prescriptions->id).'" title="Edit"><i class="fa fa-pencil"></i> Edit</a>';
            }
    ...
    {  
     ...
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('prescription_template/view',$data);     
      }
    }  
	...
	public function add()
	{
        ...
        {   
            ...
            if($this->form_validation->run() == TRUE)
            {
              ...
              redirect(base_url('prescription_template'));
            }
            else
            {
         ...
         $this->load->view('prescription_template/add_template',$data);
    }
   ...
   public function delete_pres_medicine($medicine_presc_id="",$template_id='')
   {
    ...
    public function archive()
    {
        ...
        $this->load->view('prescription_template/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('81','543');
        $this->load->model('prescription_template/prescription_template_archive_model','prescription_template_archive'); 
