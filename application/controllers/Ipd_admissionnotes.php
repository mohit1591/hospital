...
class Ipd_admissionnotes extends CI_Controller {
 
    function __construct() 
    {
        parent::__construct();  
        auth_users();  
        $this->load->model('ipd_admissionnotes/prescription_model','prescription');
        $this->load->model('ipd_admissionnotes/prescription_file_model','prescription_file');
  ...
  public function index()
  {
      ...
      $data['page_title'] = 'Initial Assessment List';
      ...
      $this->load->view('ipd_admissionnotes/list',$data);
  }
    ...
    {   
        ...
        foreach ($list as $prescription) { 
            ...
            if($users_data['parent_id']==$prescription->branch_id)
            {
                ...
                $btn_edit = ' <a class="btn-custom" href="'.base_url("ipd_admissionnotes/edit/".$prescription->id).'" title="Edit Initial Assessment"><i class="fa fa-pencil"></i> Edit Initial Assessment</a>';
               ...
               $btn_view_pre='';
                /*$btn_view_pre = ' <a class="btn-custom"  href="'.base_url('/ipd_prescription/view_prescription/'.$prescription->id.'/'.$prescription->branch_id).'" title="View Progress Report" target="_blank" data-url="512"><i class="fa fa-info-circle"></i> View Progress Report</a>';*/
                
                $print_url = "'".base_url('ipd_admissionnotes/print_prescriptions/'.$prescription->id.'/'.$prescription->branch_id)."'";
                $btn_print_pre = ' <a class="btn-custom" onClick="return print_window_page('.$print_url.')" href="javascript:void(0)" title="Print Initial Assessment"  data-url="512"><i class="fa fa-print"></i> Print Initial Assessment</a>';
        ...
        if($users_data['parent_id']==$prescription->branch_id)
        {
            ...
            $btn_upload_pre = '<a class="btn-custom" onclick="return upload_prescription('.$prescription->id.')" href="javascript:void(0)" title="View"><i class="fa fa-info-circle"></i> Upload Initial Assessment </a>';
               
            $btn_view_upload_pre = '<a class="btn-custom" href="'.base_url('/ipd_admissionnotes/view_files/'.$prescription->id.'/'.$prescription->branch_id).'" title="View Initial Assessment" data-url="512"><i class="fa fa-circle"></i> View Initial Assessment Files</a>';
    ...
    public function advance_search()
    {
        ...
        $this->load->view('ipd_admissionnotes/advance_search',$data);
    }
    ...
    {  
     ...
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('ipd_admissionnotes/view',$data);     
      }
    }  
    ...
    public function archive()
    {
        ...
        $this->load->view('ipd_admissionnotes/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
        //unauthorise_permission(86,536);
        $users_data = $this->session->userdata('auth_users'); 
        $this->load->model('ipd_admissionnotes/prescription_archive_model','prescription_archive'); 
  ...
  public function prescription_dropdown()
  {
    ...
    { 
        ...
        $this->load->view('ipd_admissionnotes/print_template1',$data);
    ...
    public function print_prescriptions($prescription_id="",$branch_id='')
    {
        ...
        $prescriptions_id= $this->session->userdata('ipd_admission_prescription_id');
        ...
        $data['prescription_tab_setting'] = get_ipd_admission_prescription_print_tab_setting('',$branch_id);
        $data['prescription_medicine_tab_setting'] = get_ipd_admission_prescription_medicine_print_tab_setting('',$branch_id);
...
$signature_reprt_data .= '<tr>
    ...
    <tr>
        ...
        $this->load->view('ipd_admissionnotes/print_prescription_template',$data);
    }
    ...
    public function print_blank_prescriptions($booking_id="",$branch_id='')
    {
        ...
        $data['prescription_tab_setting'] = get_ipd_admission_prescription_print_tab_setting();
        //print_r($data['prescription_tab_setting']); exit;
        $data['prescription_medicine_tab_setting'] = get_ipd_admission_prescription_medicine_print_tab_setting();
        $data['signature'] = '';
    ...
    public function print_prescription_pdf($id)
    {
          ...
          $prescription_tab_setting = get_ipd_admission_prescription_tab_setting(); 
            $presc_prescriptions = '';
        ...
        if(!empty($appointment_date) && $appointment_date!=='0000-00-00')
        {
         ...
         $pdf_template = $this->load->view('ipd_admissionnotes/pdf_template',$pdf_data,true);
         $result['success'] = true;
...
{ 
    ...
    $data['test_data'] = $this->prescription->get_ipd_test($id); 
    $data['page_title'] = $data['form_data']['patient_name']." Prescription";
    $data['prescription_tab_setting'] = get_ipd_admission_prescription_tab_setting('',$branch_id);
    $data['prescription_medicine_tab_setting'] = get_ipd_admission_prescription_medicine_tab_setting('',$branch_id);
    $this->load->model('general/general_model');
    $data['vitals_list']=$this->general_model->vitals_list(); 
    $data['id'] = $id;
    $this->load->view('ipd_admissionnotes/print_template1',$data);
...
{ 
    ...
    if(isset($post) && !empty($post))
    {   
        //echo DIR_UPLOAD_PATH.'ipd_prescription/'; exit;
        ...
        if($this->form_validation->run() == TRUE)
        {
             ...
             $config['upload_path']   = DIR_UPLOAD_PATH.'ipd_admissionnotes/';  
    ...
    $this->load->view('ipd_admissionnotes/add_file',$data);
}
...
{ 
    ...
    $data['prescription_id'] = $prescription_id;
    $this->load->view('ipd_admissionnotes/view_prescription_files',$data);
}
...
{ 
        ...
        foreach ($list as $prescription) { 
            ...
            $sign_img = "";
            if(!empty($prescription->prescription_files) && file_exists(DIR_UPLOAD_PATH.'ipd_admissionnotes/'.$prescription->prescription_files))
            {
                $sign_img = ROOT_UPLOADS_PATH.'ipd_admissionnotes/'.$prescription->prescription_files;
    ...
    { 
      ...
      {      
        ...
        $data['page_title'] = "Update Initial Assessment";  
        $post = $this->input->post();
        $data['form_error'] = ''; 
        // if(isset($post) && !empty($post))
        // {
        ...
        $data['form_data'] = array(
          ...
          'history_presenting_illness'=>$prescription_data->history_presenting_illness, // Added by Nitin Sharma 28th Jan 2024
          'obstetrics_menstrual_history'=>$prescription_data->obstetrics_menstrual_history, // Added by Nitin Sharma 28th Jan 2024
          'family_history_disease'=>$prescription_data->family_history_disease, // Added by Nitin Sharma 28th Jan 2024
          'remark1'=>$prescription_data->remark1, // Added by Nitin Sharma 28th Jan 2024
          'remark2'=>$prescription_data->remark2, // Added by Nitin Sharma 28th Jan 2024
          'remark3'=>$prescription_data->remark3, // Added by Nitin Sharma 28th Jan 2024
          'remark4'=>$prescription_data->remark4, // Added by Nitin Sharma 28th Jan 2024
          'remark5'=>$prescription_data->remark5, // Added by Nitin Sharma 28th Jan 2024
          'examination_type'=>$prescription_data->examination_type, // Added by Nitin Sharma 28th Jan 2024
          'cvs'=>$prescription_data->cvs, // Added by Nitin Sharma 28th Jan 2024
          'cns'=>$prescription_data->cns, // Added by Nitin Sharma 28th Jan 2024
          'respiratory_system'=>$prescription_data->respiratory_system, // Added by Nitin Sharma 28th Jan 2024
          'per_abdomen'=>$prescription_data->per_abdomen, // Added by Nitin Sharma 28th Jan 2024
          'per_vaginal'=>$prescription_data->per_vaginal, // Added by Nitin Sharma 28th Jan 2024
          'local_examination'=>$prescription_data->local_examination, // Added by Nitin Sharma 28th Jan 2024
        ...
        {   
            ...
            if($this->form_validation->run() == TRUE)
            {
                ...
                $this->session->set_flashdata('success','Initial Assessment updated successfully.');
        ...
        // print_r($data['obstetrics_menstrual_history_list']);die;
        $this->load->view('ipd_admissionnotes/prescription',$data);       
      }
    }
	 ...
	 public function print_consolidate_prescription()
    {
        ...
        $this->load->view('ipd_admissionnotes/consolidate_prescription',$data);
    }
    ...
    public function search_box_data()
  {
    $this->load->model('opd/opd_model','opd'); 
      ...
      if($post['class'] == 'chief_complaints_data'){
        $getData = $this->general_model->admission_chief_complaint_list("",$type); 
      ...
      } else if($post['class'] == 'history_presenting_illness_data') {
        $getData = $this->opd->history_presenting_illness_list($type);
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
            'name'  => $row->illness_name
          );
        }
      } else if ($post['class'] == 'prv_history_data') {
        $getData = $this->opd->admission_prv_history_list($type);  
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
        ...
        $getData = $this->opd->admission_personal_history_list($type);
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
      ...
      } else if ($post['class'] == 'obstetrics_menstrual_history_data') {
        $getData = $this->opd->obstetrics_menstrual_history_list($type);  
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
            'name'  => $row->obstetrics_menstrual_history
          );
        }
      } else if($post['class'] == 'family_history_disease_data') {
        $getData = $this->opd->family_history_disease_list($type);  
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
            'name'  => $row->family_history_disease
          );
        }
      } else if($post['class'] == 'examination_data') {
        $getData = $this->opd->admission_examinations_list($type);  
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
      ...
      } else if($post['class'] == 'diagnosis_data' || $post['class'] == 'remark1_data') {
        ...
        $getData = $this->opd->admission_suggetion_list($type);  
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
      ...
      } else if($post['class'] == 'remark4_data') {
        $getData = $this->pain_score->list($type);  
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
      ...
      } else if($post['class'] == 'remark2_data') {
        $getData = $this->nutritional_screening->list($type);  
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
      ...
      } else if($post['class'] == 'remark3_data') {
        $getData = $this->plan_of_care->list($type);  
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
      ...
      } else if($post['class'] == 'remark_data') {
        $getData = $this->advice_master->list($type);  
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
      ...
      } else if($post['class'] == 'remark5_data') {
        $getData = $this->initial_assessment_performed_by_doctor->list($type);  
        foreach($getData as $row)
        {
          $output[] = array(
            'id'  => $row->id,
