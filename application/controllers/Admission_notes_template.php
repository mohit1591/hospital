...
class Admission_notes_template extends CI_Controller {
 
    function __construct() 
    {
        parent::__construct();  
        auth_users();  
        $this->load->model('admission_notes_template/prescription_template_model','prescriptiontemplate');
      ...
      public function index()
    {
        ...
        $this->load->view('admission_notes_template/list',$data);
    }
    ...
    {   
        ...
        foreach ($list as $prescriptions) {
         // print_r($test);die;
            ...
            {
              $btn_edit = ' <a class="btn-custom" href="'.base_url("admission_notes_template/edit/".$prescriptions->id).'" title="Edit"><i class="fa fa-pencil"></i> Edit</a>';
            }
    ...
    public function delete($id="")
    {
       ...
       if(!empty($id) && $id>0)
       {
           ...
           $response = "Admission Note successfully deleted.";
           echo $response;
       }
    }
    ...
    function deleteall()
    {
        ...
        if(!empty($post))
        {
            ...
            $response = "Admission Note Booking successfully deleted.";
            echo $response;
        }
    }
    ...
    {  
     ...
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('admission_notes_template/view',$data);     
      }
    }  
    ...
    public function add()
    {
        ...
        $data['page_title'] = "Add Admission Note";
        ...
        {   
            ...
            if($this->form_validation->run() == TRUE)
            {
              ...
              $this->session->set_flashdata('success','Admission Note successfully added.');
              redirect(base_url('admission_notes_template'));
            }
            else
            {
         ...
         $this->load->view('admission_notes_template/add_template',$data);
    }
    ...
    public function edit($id="")
    {
     ...
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $data['page_title'] = "Update Admission Note";  
        $post = $this->input->post();
        $data['form_error'] = ''; 
        $data['form_data'] = array(
          'data_id'=>$result['id'],
          ...
          'history_presenting_illness'=>$result['history_presenting_illness'], // Added by Nitin Sharma 28th Jan 2024
          'obstetrics_menstrual_history'=>$result['obstetrics_menstrual_history'], // Added by Nitin Sharma 28th Jan 2024
          'family_history_disease'=>$result['family_history_disease'], // Added by Nitin Sharma 28th Jan 2024
          'remark1'=>$result['remark1'], // Added by Nitin Sharma 28th Jan 2024
          'remark2'=>$result['remark2'], // Added by Nitin Sharma 28th Jan 2024
          'remark3'=>$result['remark3'], // Added by Nitin Sharma 28th Jan 2024
          'remark4'=>$result['remark4'], // Added by Nitin Sharma 28th Jan 2024
          'remark5'=>$result['remark5'], // Added by Nitin Sharma 28th Jan 2024
          'examination_type'=>$result['examination_type'], // Added by Nitin Sharma 28th Jan 2024
          'cvs'=>$result['cvs'], // Added by Nitin Sharma 28th Jan 2024
          'cns'=>$result['cns'], // Added by Nitin Sharma 28th Jan 2024
          'respiratory_system'=>$result['respiratory_system'], // Added by Nitin Sharma 28th Jan 2024
          'per_abdomen'=>$result['per_abdomen'], // Added by Nitin Sharma 28th Jan 2024
          'per_vaginal'=>$result['per_vaginal'], // Added by Nitin Sharma 28th Jan 2024
          'local_examination'=>$result['local_examination'], // Added by Nitin Sharma 28th Jan 2024
        ...
        {   
            ...
            {
                $this->prescriptiontemplate->save();
                $this->session->set_flashdata('success','Admission Note updated successfully.');
                redirect(base_url('admission_notes_template'));
        ...
        $data['personal_history'] = $this->opd->admission_personal_history_list();  
        $data['prescription_tab_setting'] = get_ipd_admission_prescription_print_tab_setting();
        $data['history_presenting_illness_list'] = $this->opd->history_presenting_illness_list();  //Added by Nitin Sharma 19th Feb 2024
        $data['obstetrics_menstrual_history_list'] = $this->opd->obstetrics_menstrual_history_list();  //Added by Nitin Sharma 19th Feb 2024
        $data['family_history_disease_list'] = $this->opd->family_history_disease_list();  //Added by Nitin Sharma 19th Feb 2024
        $data['prescription_medicine_tab_setting'] = get_ipd_admission_prescription_medicine_print_tab_setting();
       $this->load->view('admission_notes_template/add_template',$data);       
      }
    }
   ...
   public function delete_pres_medicine($medicine_presc_id="",$template_id='')
   {
    ...
    public function archive()
    {
        ...
        $data['page_title'] = 'Admission Note Archive List';
        $this->load->helper('url');
        $this->load->view('admission_notes_template/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('81','543');
        $this->load->model('admission_notes_template/prescription_template_archive_model','prescription_template_archive'); 
    ...
    public function restore($id="")
    {
       ...
       if(!empty($id) && $id>0)
       {
           ...
           $response = "Admission Note successfully restore in list.";
           echo $response;
       }
    }
    ...
    public function trash($id="")
    {
       ...
       if(!empty($id) && $id>0)
       {
           ...
           $response = "Admission Note successfully deleted parmanently.";
           echo $response;
       }
    }
