...
class Camp_details extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('blood_bank/camp_details/camp_details_model','camp_details');
        $this->load->library('form_validation');
    }

    public function index()
    { 
        unauthorise_permission('260','1490');
        $data['page_title'] = 'Camp Details List'; 
        $this->load->view('blood_bank/camp_details/list',$data);
    }
        ...
        foreach ($list as $camp_details) {
         // print_r($relation);die;
           ...
           // $row[] = $camp_details->camp_involved;
            ...
            $btnedit='';
            $btndelete='';
          if(in_array('1492',$users_data['permission']['action'])){
          ...
          if(in_array('1493',$users_data['permission']['action'])){
    ...
    public function add()
    {
        unauthorise_permission('260','1491');
       ...
       $this->load->view('blood_bank/camp_details/add',$data);       
    }
    
    public function edit($id="")
    {
      unauthorise_permission('260','1492');
        $this->load->model('general/general_model','general_model');
        $data['country_list'] = $this->general_model->country_list();
    ...
    {
      unauthorise_permission('260','1493');
       if(!empty($id) && $id>0)
       {
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('blood_bank/camp_details/view',$data);     
      }
    }  
    ...
    {
          unauthorise_permission('260','1494');
         $data['page_title'] = 'Camp Details Archive List'; 
        $this->load->helper('url');
        $this->load->view('blood_bank/camp_details/archive',$data);
    }

    public function archive_ajax_list()
    {
          unauthorise_permission('260','1494');
        $this->load->model('blood_bank/camp_details/camp_details_archive_model','camp_details_archive'); 
        ...
        foreach ($list as $camp_details_archive) { 
          ...
          $btnrestore='';
          $btndelete='';
          if(in_array('1495',$users_data['permission']['action'])){
          ...
          if(in_array('1497',$users_data['permission']['action'])){
    ...
    {
         unauthorise_permission('260','1497');
        $this->load->model('blood_bank/camp_details/camp_details_archive_model','camp_details_archive');
       if(!empty($id) && $id>0)
       {
    ...
    {
          unauthorise_permission('260','1495');
        $this->load->model('blood_bank/camp_details/camp_details_archive_model','camp_details_archive');
       if(!empty($id) && $id>0)
       {
