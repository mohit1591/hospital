...
class Relation extends CI_Controller {
    ...
    private function _validate($id='')
    {
        ...
        $this->form_validation->set_rules('relation', 'relation', 'trim|required|callback_check_unique_value['.$id.']'); 
   ...
   function check_unique_value($relation, $id='') 
      {     
        ...
        if($result == 0)
            ...
            $this->form_validation->set_message('check_unique_value', 'Relation name already exist.');
            $response = false;
        }
        return $response;
      }
