...
class Opd_billing extends CI_Controller {
 ...
 public function get_allsub_branch_list(){
    ...
    private function _validate()
    {
       ...
       // echo "<pre>"; print_r($post); exit;
        ...
        if(!isset($opd_particular_billing_list) && empty($opd_particular_billing_list) && empty($post['data_id']))
        {
          ...
          $this->form_validation->set_rules('particularid', 'particularid', 'trim|callback_check_particularid');
        }
    ...
    private function _validatebilling()
    {
        ...
        {
            $this->form_validation->set_rules('particularidnew', 'particularid', 'trim|callback_check_particularidnew');
        }
    ...
    public function check_particularid()
    {
       $opd_particular_billing_list = $this->session->userdata('opd_particular_billing');
       if(isset($opd_particular_billing_list) && !empty($opd_particular_billing_list))
       {
       ...
       {
          $this->form_validation->set_message('check_particularid', 'Please add a particular.');
          return false;
       }
    }
    
    public function check_particularidnew()
    {
       // echo $particular; die;
       $post = $this->input->post();
       $particular = $post['particulars'];
       if(isset($particular) && !empty($particular))
       {
         $this->form_validation->set_message('check_particularidnew', 'Please add particular.');
          return false;
...
*/
    ...
    public function print_billing_report($id="",$branch_id='')
    {
      ...
      //die;
      $template_format = $this->opd_billing->template_format(array('section_id'=>16,'types'=>1),$branch_id);
