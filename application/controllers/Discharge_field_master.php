...
class Discharge_field_master extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('discharge_field_master/discharge_field_master_model','field_master');
        $this->load->library('form_validation');
    }

    public function index()
    { 
        unauthorise_permission('222','1250');
        $data['page_title'] = 'Discharge field Master'; 
        $this->load->view('discharge_field_master/list',$data);
    }
    ...
    public function add()
    {
        unauthorise_permission('222','1251');
        $data['page_title'] = "Add discharge field";  
       ...
       $this->load->view('discharge_field_master/add',$data);       
    }
    
    public function edit($id="")
    {
      unauthorise_permission('222','1252');
    ...
    {
       unauthorise_permission('222','1253');
       if(!empty($id) && $id>0)
       {
           $result = $this->field_master->delete($id);
           $response = "Discharge field Master successfully deleted.";
           echo $response;
       }
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('discharge_field_master/view',$data);     
      }
    }  
    ...
    {
        unauthorise_permission('222','1254');
        $data['page_title'] = 'Discharge field Archive List';
        $this->load->helper('url');
        $this->load->view('discharge_field_master/archive',$data);
    }
    ...
    {
        unauthorise_permission('222','1255');
        $this->load->model('discharge_field_master/discharge_field_master_archive_model','field_master_archive');
       if(!empty($id) && $id>0)
       {
           $result = $this->field_master_archive->restore($id);
           $response = "Discharge field successfully restore in discharge field list.";
           echo $response;
       }
    }
    ...
    public function trash($id="")
    {
       ...
       if(!empty($id) && $id>0)
       {
           ...
           $response = "Discharge field successfully deleted parmanently.";
           echo $response;
       }
    }
