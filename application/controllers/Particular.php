...
class Particular extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('particular/particular_model','particular');
    ...
    { 
        ...
        $this->load->view('particular/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('particular/add',$data);       
    }
    ...
    {  
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $this->load->view('particular/view',$data);     
      }
    }  
    ...
    public function archive()
    {
        ...
        $this->load->view('particular/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('84','548');
        $this->load->model('particular/particular_archive_model','particular_archive'); 
    ...
    public function restore($id="")
    {
       ...
       if(!empty($id) && $id>0)
       {
           ...
           $response = "Particular successfully restore in Particular list.";
           echo $response;
       }
    }
  ...
  // this function is used for sample excel sheet doctor list on 23-04-2018
     ...
     public function import_particular_excel()
    {
        ...
        $this->load->library('excel');
        $data['page_title'] = 'Import particular excel';
        $arr_data = array();
        $header = array();
        $path='';
      ...
      //echo"hello";print_r($_FILES); 
        ...
        $this->load->view('particular/import_particular_excel',$data);
    } 
