...
class Chief_complaints extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('dental/chief_complaints/Chiefcomplaint_model','chief_complaints');
    ...
    { 
        //echo "hi";die;
        unauthorise_permission('277','1632');
        $data['page_title'] = 'Chief Complaints List'; 
        $this->load->view('dental/chief_complaints/list',$data);
    }
    ...
    { 
        ...
        foreach ($list as $chief_complaints) {
         // print_r($chief_complaints);die;
          ...
          $btnedit='';
          $btndelete='';
          if(in_array('1634',$users_data['permission']['action'])){
          ...
          if(in_array('1635',$users_data['permission']['action'])){
    ...
    public function add()
    {
        ...
        unauthorise_permission('277','1633');
       ...
       $this->load->view('dental/chief_complaints/add',$data);       
    }
    
    public function edit($id="")
    {
      unauthorise_permission('277','1634');
    ...
    {
       unauthorise_permission('277','1635');
       if(!empty($id) && $id>0)
       {
    ...
    {
       unauthorise_permission('277','1636');
        $data['page_title'] = 'chief Complaints Archive List';
        $this->load->helper('url');
        $this->load->view('dental/chief_complaints/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
        unauthorise_permission('277','1636');
        $users_data = $this->session->userdata('auth_users');
        $this->load->model('dental/chief_complaints/chiefcomplaint_archive_model','chief_complaints_archive'); 
       ...
       // print_r($list);die; 
        ...
        foreach ($list as $chief_complaints) { 
          ...
          $btnrestore='';
          $btndelete='';
          if(in_array('1638',$users_data['permission']['action'])){
          ...
          if(in_array('1637',$users_data['permission']['action'])){
    ...
    {
        unauthorise_permission('277','1638');
        $this->load->model('dental/chief_complaints/chiefcomplaint_archive_model','chief_complaints_archive');
       if(!empty($id) && $id>0)
       {
    ...
    {
        unauthorise_permission('277','1637');
        $this->load->model('dental/chief_complaints/chiefcomplaint_archive_model','chief_complaints_archive');
       if(!empty($id) && $id>0)
       {
