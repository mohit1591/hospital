...
class Treatment extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('dental/treatment/Treatment_model','treatment');
    ...
    { 
        ...
        $data['page_title'] = 'Treatment List'; 
        $this->load->view('dental/treatment/list',$data);
    }
    ...
    public function add()
    {
       ...
       $this->load->view('dental/treatment/add',$data);       
    }
    ...
    public function edit($id="")
    {
     ...
     if(isset($id) && !empty($id) && is_numeric($id))
      {      
        ...
        $data['page_title'] = "Update Treatment";  
        $post = $this->input->post();
        $data['form_error'] = ''; 
        $data['form_data'] = array(
                                  'data_id'=>$result['id'],
    ...
    public function archive()
    {
       unauthorise_permission('281','1664');
        $data['page_title'] = 'Treatment Archive List';
        $this->load->helper('url');
        $this->load->view('dental/treatment/archive',$data);
    }
    ...
    public function archive_ajax_list()
    {
        unauthorise_permission('281','1664');
        $users_data = $this->session->userdata('auth_users');
        $this->load->model('dental/treatment/treatment_archive_model','treatment_archive'); 
    ...
    public function restore($id="")
    {
       ...
       if(!empty($id) && $id>0)
       {
           ...
           $response = "Treatment successfully restore in Treatment list.";
           echo $response;
       }
    }
    ...
    function trashall()
    {
        ...
        if(!empty($post))
        {
            ...
            $response = "Treatment successfully deleted parmanently.";
            echo $response;
        }
    }
  ...
  public function treatment_dropdown()
  {
      ...
      $dropdown = '<option value="">Select treatment</option>'; 
