...
class Opdprescriptionhistory extends CI_Controller {
  ...
  public function lists($patient_id='')
  {
      ...
      $data['page_title'] = 'Dental Prescription History'; 
      $data['patient_id'] = $patient_id; 
      $this->load->view('dental/dental_prescription/prescription_history',$data);
  }
  ...
  { 
        ...
        foreach ($list as $prescription) { 
            ...
            //{
               $btn_view_pre = '';//' <a class="btn-custom"  href="'.base_url('/prescription/view_prescription/'.$prescription->id).'" title="View Prescription" data-url="512"><i class="fa fa-info-circle"></i> View Prescription</a>';
            //} 
