...
class Blank_prescription_setting extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        //auth_users();
        unauthorise_permission('294','1741');
        $this->load->model('dental/prescription_setting/blank_prescription_setting_model','prescription_setting');
...
//print '<pre>'; print_r($users_data);die;
        ...
        $this->load->view('dental/blank_prescription_setting/add',$data);
    }
