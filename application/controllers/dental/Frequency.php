...
class Frequency extends CI_Controller {
    ...
    public function __construct()
    {
        parent::__construct();
        auth_users();
        $this->load->model('dental/frequency/frequency_model','frequency');
        $this->load->library('form_validation');
    }

    public function index()
    { 
        unauthorise_permission('291','1724');
        $data['page_title'] = 'Frequency List'; 
        $this->load->view('dental/frequency/list',$data);
    }
    ...
    { 
        ...
        foreach ($list as $frequency) {
         // print_r($relation);die;
          ...
          $btnedit='';
          $btndelete='';
          if(in_array('1726',$users_data['permission']['action'])){
           ...
           if(in_array('1727',$users_data['permission']['action'])){
    ...
    public function add()
    {
        unauthorise_permission('291','1725');
       ...
       $this->load->view('dental/frequency/add',$data);       
    }
    
    public function edit($id="")
    {
      unauthorise_permission('291','1726');
    ...
    {
       unauthorise_permission('291','1727');
       if(!empty($id) && $id>0)
       {
    ...
    {
        unauthorise_permission('291','1728');
        $data['page_title'] = 'Frequency Archive List';
        $this->load->helper('url');
        $this->load->view('dental/frequency/archive',$data);
    }

    public function archive_ajax_list()
    {
        unauthorise_permission('291','1728');
        $this->load->model('dental/frequency/frequency_archive_model','frequency_archive'); 
        ...
        foreach ($list as $frequency) { 
          ...
          $btnrestore='';
          $btndelete='';
          if(in_array('1730',$users_data['permission']['action'])){
          ...
          if(in_array('1729',$users_data['permission']['action'])){
    ...
    {
        unauthorise_permission('291','1730');
        $this->load->model('dental/frequency/frequency_archive_model','frequency_archive');
       if(!empty($id) && $id>0)
       {
    ...
    {
       unauthorise_permission('291','1729');
        $this->load->model('dental/frequency/frequency_archive_model','frequency_archive');
       if(!empty($id) && $id>0)
       {
