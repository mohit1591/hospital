...
class Test extends CI_Controller {
    ...
    {     
        ...
        if(!empty($report_setting_data))
          ...
          else
          {
            $balance_status = '1';
                      ...
                      //////////////////////////////////////
        $btn_whatsapp_report_send = ""; //   Changes by Nitin Sharma 05/02/2024
      if($comp_print==1 && $balance_status=='1')
      {
        ...
        if(in_array('413',$users_data['permission']['section']))
         {
          $new_report_btn_print = ' <li><a onClick="return print_report_template('.$test->id.');"  href="javascript:void(0)" style="'.$test->id.'" title="Print Reports By Template"><i class="fa fa-print"></i> Advance Report Print</a></li>';
         }
          if(!empty($test->mobile_no))
            {
              ...
              $btn_whatsapp_report_send .= '<li><a onClick="return sendWhatsApp('.$test->id.' , '.$test->mobile_no.');"  href="javascript:void(0)" title="Report send to whatsapp" ><i class="fa fa-whatsapp" aria-hidden="true"></i>  WhatsApp Report Send</a></li>'; 
              //   Changes by Nitin Sharma 05/02/2024
            }
      }
         ...
         {  
          ...
          $btn_a = '<div class="slidedown">
            <button disabled class="btn-custom">More <span class="caret"></span></button>
              ...
              '.$btn_delete.$btn_report_fill.$btn_report_print.$new_report_btn_print.$btn_report_download.$btn_print_bill.$opd_consolidated_bill.$btn_print_barcode.$btn_delivered.$btn_upload_pre.$btn_whatsapp_report_send.'
            </ul>
          </div> ';
        //   Changes by Nitin Sharma 05/02/2024
    ...
    public function advance_search()
    {
        ...
        if(isset($search_data) && !empty($search_data))
        {
          ...
          if(isset($search_data['test_ids']) && !empty($search_data['test_ids']))
           {
              $test_ids = $search_data['test_ids'];
           }
           else
           {
            $test_ids='';
      ...
      { 
                ...
                { 
                        ...
                        if(is_numeric($test_list->result))
                        {
                            ...
                            $test_list1 = $this->display_test_range($test_list->booking_id,$test_list->test_id,$test_list->result);
                            
                              if(!empty($test_list1))
                              {
                                
                                $range_val =  $test_list1->range_from_pre.' '.$test_list1->range_from.' '.$test_list1->range_from_post.' - '.$test_list1->range_to_pre.' '.$test_list1->range_to.' '.$test_list1->range_to_post;
                              ...
                              if(!empty($test_list1) && $test_list->result > $test_list1->range_to && !empty($test_list->result) && !empty($test_list1->range_to))
                              {
                              ...
                              elseif(!empty($test_list1) && $test_list->result < $test_list1->range_from && !empty($test_list->result) && !empty($test_list1->range_from))
                              {
                              ...
                              }elseif(!empty($test_list1) && !empty($test_list->result) &&  $test_list->result > $test_list1->range_from  && !empty($test_list1->range_from) && $test_list->result < $test_list1->range_to && !empty($test_list->result) && !empty($test_list1->range_to))
                              {
                                  $test_result='';
                                  $result_style = '';
                              }
...
$break='';
          ...
          { 
           ...
           // echo $test_report_data;die;
            ...
            { 
                    ...
                    {
                        $test_list1 = $this->display_test_range($profile_test_list->booking_id,$profile_test_list->test_id,$profile_test_list->result);
            ...
            if(!empty($test_list1))
            {
              ...
              if($profile_test_list->result > $test_list1->range_to && !empty($profile_test_list->result) && !empty($test_list1->range_to))
            {
            ...
            elseif($profile_test_list->result < $test_list1->range_from && !empty($profile_test_list->result) && !empty($test_list1->range_from))
            {
              $test_result='';
      ...
      {             
        ...
        {    
            ...
            if(!empty($profile_test_list->interp_sec_page))
            {
               
                $int_qpage_text=str_ireplace('<p>','',$profile_test_list->interp_sec_page);
                $int_text_pagese=str_ireplace('</p>','<br />',$int_qpage_text);
                $test_report_data .='<div style="float:left;width:100%;font-size:12px;font-family:arial;padding:0px 4px;margin:0;">
                        <div style="float:left;width:100%; line-height:14px; font-size:11px;font-family:arial;"> '.$int_text_pagese.'</div></div>';    
                    
            }  
            if(!empty($profile_test_list->interp_thir_page))
            {
               
                $int_qtext=str_ireplace('<p>','',$profile_test_list->interp_thir_page);
                $int_pagetext=str_ireplace('</p>','<br />',$int_qtext);
                $test_report_data .='<div style="float:left;width:100%;font-size:12px;font-family:arial;padding:0px 4px;margin:0;">
                        <div style="float:left;width:100%; line-height:14px; font-size:11px;font-family:arial;"> '.$int_pagetext.'</div></div>';    
              ...
              {             
                ...
                {    
                    ...
                    if(!empty($profile_test_list->interp_sec_page))
                     ...
                     $test_heading_interpretation .='<tr><td colspan="4"><div style="float:left;width:100%;margin:1em 0;padding:4px;">
                          <div style="font-size:11px;font-family:arial;padding:2px 0px;">'.$profile_test_list->interp_sec_page.'
                        </div>
                        </div></td></tr>';
                      ...
                      {
                     $test_heading_interpretation .='<tr><td colspan="4"><div style="float:left;width:100%;margin:1em 0;padding:4px;">
                          <div style="font-size:11px;font-family:arial;padding:2px 0px;">'.$profile_test_list->interp_thir_page.'
                        </div>
                        </div></td></tr>';
                ...
                { 
                   if(!empty($profile_test_list->interpratation_data))
                     ...
                     if(!empty($profile_test_list->interp_sec_page))
                      {
                     $test_heading_interpretation .='<div style="float:left;width:100%;font-size:12px;font-family:arial;padding:0px 4px;margin:0;">
                        <div style="float:left;width:100%; line-height:13px; font-size:11px;font-family:arial;"> '.$profile_test_list->interp_sec_page.'</div></div>';
                      ...
                      {
                     $test_heading_interpretation .='<div style="float:left;width:100%;font-size:12px;font-family:arial;padding:0px 4px;margin:0;">
                        <div style="float:left;width:100%; line-height:13px; font-size:11px;font-family:arial;"> '.$profile_test_list->interp_thir_page.'</div></div>';
                ...
                if(!empty($test_list->adv_interpretation_status) && $test_list->adv_interpretation_status==1)
                  {  
                     ...
                     $test_heading_interpretation ='<tr><td colspan="4"><div style="float:left;width:100%;margin:1em 0;padding:4px;">
                      ...
                      if(!empty($test_list->interp_sec_page))
                      {
                     $test_heading_interpretation .='<tr><td colspan="4"><div style="float:left;width:100%;margin:1em 0;padding:4px;">
                          <div style="font-size:11px;font-family:arial;padding:2px 0px;">'.$test_list->interp_sec_page.'
                        </div>
                        </div></td></tr>';
                        
                        
                      }
                      if(!empty($test_list->interp_thir_page))
                      {
                     $test_heading_interpretation .='<tr><td colspan="4"><div style="float:left;width:100%;margin:1em 0;padding:4px;">
                          <div style="font-size:11px;font-family:arial;padding:2px 0px;">'.$test_list->interp_thir_page.'
                        </div>
                        </div></td></tr>';
...
$response = $this->general_library->email($email,$subject,$message,'',$attachment,'','','','',$booking_data->branch_id);
  ...
  public function set_profile($profile_id="", $mainPrice=0)
  {
      $post=$this->input->post();
       if(!empty($profile_id) && is_numeric($profile_id) && $profile_id>0)
       {
          ...
          ////// Set Profile Price ///
           if(!empty($result))
           {
              ...
              {
                 //$master_rate = $result['profile_master_rate'];
                 $master_rate = isset($post['profile_price_updated']) ?$post['profile_price_updated']:$mainPrice;
              }
              else
              {
                 $master_rate = isset($post['profile_price_updated']) ?$post['profile_price_updated']:$mainPrice;//$result['master_rate'];
                 if(isset($booking_doctor_type) && !empty($booking_doctor_type))
                 {
                    $master_rate = $this->make_master_price(isset($post['profile_price_updated']) ?$post['profile_price_updated']:$mainPrice);        
                 }
              }

              if(!empty($result['profile_base_rate']) && $result['profile_base_rate']>0)
              {
                 $base_rate = isset($post['profile_price_updated']) ?$post['profile_price_updated']:$mainPrice;//$result['profile_base_rate'];
              }
              else
              {
                 $base_rate = isset($post['profile_price_updated']) ?$post['profile_price_updated']:$mainPrice;//$result['base_rate'];
                 if(isset($booking_doctor_type) && !empty($booking_doctor_type))
                 {
                    $base_rate = $this->make_base_price(isset($post['profile_price_updated']) ?$post['profile_price_updated']:$mainPrice);        
                 }
              }
           }
          ////// End Profile Price //////
  ...
  public function add_interpretation($booking_id="",$test_id="")
   {
     ...
     //echo "<pre>"; print_r($post); exit;
      if(!empty($post))
      {
        ...
        else
        {
          ...
          $data['form_data'] = array(
                                   ...
                                   'interp_sec_page'=>$post['interp_sec_page'],
                                   'interp_thir_page'=>$post['interp_thir_page']
                                ); 
        }
      }
       $interpretation = ""; 
      ...
      if(!empty($interpretation_data->interp_sec_page))
      {
        $interp_sec_page = $interpretation_data->interp_sec_page;
      } 
      if(!empty($interpretation_data->interp_thir_page))
      {
        $interp_thir_page = $interpretation_data->interp_thir_page;
      } 
      ...
      $data['form_data'] = array(
                                   ...
                                   'interp_sec_page'=>$interp_sec_page,
                                   'interp_thir_page'=>$interp_thir_page
                                ); 
      $this->load->view('test/add_interpretation',$data);
    }

   public function add_interpretation20220328($booking_id="",$test_id="")
   {
       ini_set('memory_limit', '-1');
      $data['page_title'] = 'Add Interpretation';      
      $data['form_error'] = [];
...
error_reporting(E_ALL);
      ...
      if(isset($prescription_test_list) && !empty($prescription_test_list))
      {
          ...
          foreach($prescription_test_list as $prescription_test)
          {
              ...
              $explode = explode('-',$prescription_test->test_id);
              $profile_list = [];
              $test_list = [];
              if(isset($explode[1]) && $explode[1] == "profile"){
                $profile_list = $this->test->profile_list("",$explode[0]);
                $this->set_profile($profile_list[0]->id,$profile_list[0]->master_rate);
                if(count($profile_list) > 0){
                  $profileData[$profile_list[0]->id] = [
                    'order' => $profile_list[0]->sort_order,
                    'id' => $profile_list[0]->id,
                    'name' => $profile_list[0]->profile_name,
                    'price' => $profile_list[0]->master_rate,
                    'base_price' => $profile_list[0]->master_rate
                  ];
                }
          ...
          $this->session->set_userdata('book_test',$post_test);
           ...
           $this->session->set_userdata('set_profile',$profileData); 
...
//echo "<pre>"; print_r($footer_data_part);die;
 ...
 public function display_test_range($booking_id="",$test_id="",$result="")
 { 
    if(!empty($booking_id) && !empty($test_id))
    {  
      $booking_data = $this->test->get_by_id($booking_id);
      ...
      $advance_range = $this->test->get_all_test_advance_range($test_id,$gender);
      //echo "<pre>"; print_r($advance_range); exit;
      if(!empty($advance_range))
      {
  ...
  public function print_report_template($id)
    {
        $data['page_title'] = 'Select Template';
        //$post = $this->input->post();  
        $data['id'] = $id;
        $this->load->view('test/template',$data);
    }
    
    public function print_report_by_template($booking_id='',$branch_id='',$temp_type='')    
    {
      ...
      {  
        ...
        $book_data = $this->test->get_by_id($booking_id);
        $this->load->library('m_pdf');
        $report_templ_part = $this->test->report_html_template('',$book_data['branch_id'],$temp_type);
...
//echo "<pre>"; print_r($footer_data_part);die;
    ...
    function get_test_name($vals="")
    {
        if(!empty($vals))
        {
            $result = $this->test->get_all_test_name($vals);  
            if(!empty($result))
            {
