	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<div class="row m-b-5" id="hospital_div" <?php if($form_data['referred_by']==1){  }else{ ?> style="display: none;" <?php  } ?>>
				...
				<div class="col-md-8">
					<select name="referral_hospital" class="w-150px" id="referral_hospital" class="m_input_default" onchange="return form_submit();">
      ...
      <div class="col-md-8">
        <select name="branch_id" id="branch_id" class="w-150px" onchange="return form_submit();">
          <?php echo $option ;?>
