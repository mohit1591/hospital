							...
							<div class="row m-b-5" id="hospital_div" <?php if($form_data['referred_by']==1){  }else{ ?> style="display: none;" <?php  } ?>>
								...
								<div class="row m-b-5">
									...
									<div class="col-md-7">
										...
										<input type="text"  class="w-133px" name="name" class="mr_name alpha_numeric_space" value="<?php echo $form_data['name'];?>" autofocus="">
				...
				<div class="col-md-4">
					<div class="row">
						...
						<div class="col-md-7">
							...
							<?php echo $form_data['patient_reg_code'];?>
						</div>
					</div>	
...
?>  
  ...
  $('#sales_vaccination_return_count').modal({
     backdrop: 'static',
      keyboard: false
        })
<?php 
...
$("button[data-number=4]").click(function(){
    $('#sales_vaccination_return_count').modal('hide');
   /* $(this).hide();*/
});
</script>
...
<div id="sales_vaccination_return_count" class="modal fade dlt-modal">
