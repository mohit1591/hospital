...
$template_data->template = str_replace("{patient_name}",$all_detail['sales_list'][0]->patient_name,$template_data->template);
...
$template_data->template = str_replace("{sales_name}",$all_detail['sales_list'][0]->username,$template_data->template);
     ...
     html2canvas($("page"), {
        onrendered: function(canvas) {
           var imgsrc = canvas.toDataURL("image/png");
            $.ajax({
                url:'<?php echo base_url('sales_return_vaccination/save_image')?>', 
                type:'POST', 
                data:{
                    data:imgsrc,
