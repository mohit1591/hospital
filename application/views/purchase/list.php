    ...
    <form>
  	...
  	<div class="userlist-right">
  		<div class="btns">
               ...
               ?>
  			     <button class="btn-update" onclick="window.location.href='<?php echo base_url('purchase/add'); ?>'">
               ...
               ?>
                ...
                <a href="<?php echo base_url('purchase/medicine_purchase_excel'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-excel-o"></i> Excel
                </a>

                <a href="<?php echo base_url('purchase/medicine_purchase_csv'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-word-o"></i> CSV
                </a>

                <a href="<?php echo base_url('purchase/pdf_medicine_purchase'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-pdf-o"></i> PDF
                </a>

                 <a href="javascript:void(0)" class="btn-anchor m-b-2"  onClick="return print_window_page('<?php echo base_url("purchase/print_medicine_purchase"); ?>');"> <i class="fa fa-print"></i> Print</a>
               ...
               ?>
  			     <button class="btn-update" onclick="window.location.href='<?php echo base_url('purchase/archive'); ?>'">
    ...
    { 
        $.ajax({
                 ...
                 success: function(result)
                 {
                     if(result==1)
                     {
                         var msg='Purchase successfully deleted.';
                         flash_session_msg(msg);
                     }
                     else if(result==2)
                     {
                         var msg='You can not delete this purchase as some of the medicine are already saled.';
                         error_flash_session_msg(msg);
                     }
