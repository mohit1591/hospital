...
<section class="userlist">
    ...
    <div class="overlay-loader">
     ...
     <form id="progress_report_tab_setting_form">
      ...
      <?php
        if(in_array('762',$users_data['permission']['action']))
        {
        if(!empty($progress_report_tab_setting_list))
        {
          foreach($progress_report_tab_setting_list as $tab_setting_list)
          {
        ?>
      <div class="row">
        <div class="col-xs-4 br-h-small">
...
$("#progress_report_tab_setting_form").on("submit", function(event) { 
  event.preventDefault(); 
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>ipd_progress_report_tab_setting/",
    type: "post",
    data: $(this).serialize(),
