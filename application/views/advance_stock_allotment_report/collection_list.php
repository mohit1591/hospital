    ...
    <form>
  	...
  	<div class="userlist-right">
  		<div class="btns">
             ...
             <?php if(in_array('952',$users_data['permission']['action'])) {
               ?>
              <a href="<?php echo base_url('advance_stock_allotment_report/excel'); ?>" class="btn-anchor m-b-2">
              <i class="fa fa-file-excel-o"></i> Excel
              </a>

        

              <a href="<?php echo base_url('advance_stock_allotment_report/pdf_stock'); ?>" class="btn-anchor m-b-2">
              <i class="fa fa-file-pdf-o"></i> PDF
              </a>

              <a href="javascript:void(0)" class="btn-anchor m-b-2"  onClick="return print_window_page('<?php echo base_url("advance_stock_allotment_report/print_stock"); ?>');"> <i class="fa fa-print"></i> Print</a>
...
{ 
  ...
  var end_date = $('#end_date_p').val();
   $.ajax({
         url: "<?php echo base_url('advance_stock_allotment_report/advance_search/'); ?>", 
         type: 'POST',
...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('advance_stock_allotment_report/ajax_list')?>",
            "type": "POST",
        }, 
        "columnDefs": [
        { 
...
function reset_search()
  { 
    ...
    $('#purchase_no').val('');
    $('#vendor_code').val('');
    $.ajax({url: "<?php echo base_url(); ?>advance_stock_allotment_report/reset_search/", 
      success: function(result)
      { 
        reload_table();
      } 
