...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('disease/ajax_list')?>",
            "type": "POST",
...
{
  var $modal = $('#load_add_disease_modal_popup');
  $modal.load('<?php echo base_url().'disease/edit/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        .one('click', '#delete', function(e)
        {
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('disease/deleteall');?>",
                      data: {row_id: allVals},
     ...
     <?php } ?>
  	...
  	<div class="userlist-right">
  		<div class="btns">
               ...
               <?php } ?>
                 <?php 
            if(in_array('65',$users_data['permission']['action'])) { ?>
                <a href="<?php echo base_url('disease/sample_import_disease_excel'); ?>" class="btn-anchor m-b-2">
          ...
          ?>
               ...
               ?>
  			     <button class="btn-update" onclick="window.location.href='<?php echo base_url('disease/archive'); ?>'">
