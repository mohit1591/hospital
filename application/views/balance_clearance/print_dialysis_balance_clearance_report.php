...
$users_data = $this->session->userdata('auth_users');
  ...
  $dialysis_date=date('d-m-Y' , strtotime($all_detail['sales_list'][0]->dialysis_date));
        $dialysis_time=date('H:i A' , strtotime($all_detail['sales_list'][0]->dialysis_time));
        $template_data->template = str_replace("{dialysis_date_time}", $dialysis_date." ".$dialysis_time, $template_data->template); 
...
//insurance_type
        ...
        $template_data->template = str_replace("{insurance_type_name}",'', $template_data->template);  
        //insurance_type_name

        //insurance_company_name
        //$insurance_company_name= ucwords($all_detail['sales_list'][0]->insurance_company_name);
        $template_data->template = str_replace("{insurance_company_name}",'', $template_data->template);  
        //insurance_company_name
...
//$all_detail['sales_list'][0]->recepit_no
$template_data->template = str_replace("{invoice_no}",'',$template_data->template);
...
if(isset($all_detail['sales_list'][0]->token_no) && !empty($all_detail['sales_list'][0]->token_no))
    ...
    if(!empty($all_detail['sales_list'][0]->booking_code))
    {
        
        $template_data->template = str_replace("{booking_code}",$all_detail['sales_list'][0]->booking_code,$template_data->template);
    }
