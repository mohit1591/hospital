...
/* if($type==2){
 ...
 $template_data->template = str_replace("{booking_code}",$all_detail['sales_list'][0]->recepit_no,$template_data->template);
  ...
  $template_data->template = str_replace("{booking_code}",$all_detail['sales_list'][0]->recepit_no,$template_data->template);
   ...
   $template_data->template = str_replace("{booking_date_level}",'Billing Date:',$template_data->template);
        $template_data->template = str_replace("{booking_date}",date('d-m-Y',strtotime($all_detail['sales_list'][0]->date)),$template_data->template);
 ...
 $booking_date = '<b>Booking Date :</b>'.date('d-m-Y',strtotime($all_detail['sales_list'][0]->c_date));
  ...
  $template_data->template = str_replace("{booking_code}",$receipt_code,$template_data->template);
    ...
    $template_data->template = str_replace("{opd_type}",'',$template_data->template);
    $template_data->template = str_replace("{panel_type}",'',$template_data->template);
       $template_data->template = str_replace("OPD Type :",'',$template_data->template);
       $template_data->template = str_replace("OPD Type",'',$template_data->template);
       
    $template_data->template = str_replace("OPD Type ",'',$template_data->template);
    $template_data->template = str_replace("Panel Type :",'',$template_data->template);
    $template_data->template = str_replace("Panel Type ",'',$template_data->template);
    $template_data->template = str_replace("Panel Type",'',$template_data->template);
...
if(in_array('218',$users_data['permission']['section']))
   ...
   $receipt_code = '<div><b>IPD No.:</b>'.$all_detail['sales_list'][0]->recepit_no.'</div>';
        $template_data->template = str_replace("{booking_code}",$receipt_code,$template_data->template);
$template_data->template = str_replace("{Quantity_level}",'',$template_data->template);
