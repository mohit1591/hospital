...
$template_data->template = str_replace("{amount_in_words}",AmountInWordsdisplay($all_detail['sales_list'][0]->debit),$template_data->template);

$cel_val = ceil($all_detail['sales_list'][0]->debit);

$round_h = $cel_val-$all_detail['sales_list'][0]->debit;
