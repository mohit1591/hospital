...
<div class="overlay-loader" id="overlay-loader">
  ...
  <form  id="ot_management" class="form-inline">
      ...
      <div class="modal-body">   
          <div class="row">
            <div class="col-md-12 m-b1">
              ...
              <div class="row m-b-5">
                ...
                <!--  <div class="col-md-7">
                    ...
                    <input type="hidden" value="" id="ot_type_id" name="ot_type_id"/>
              ...
              <div class="" id="filed_name_new_<?php echo $i; ?>">
                 ...
                 <?php } elseif(isset($ot_details->particular_name) && $ot_details->particular_name!='')
                  ...
                  <div id="particular_div_<?php echo $i; ?>">
                    ...
                    <input type="text" name="doctor_wise[<?php echo $i; ?>][code_p][]" value="<?php if(isset($ot_details->code)){ echo $ot_details->code;}?>" id="code_<?php echo $i; ?>" class="w-90px code" Placeholder="Code"/>
             ...
             <div class="col-md-5">
                ...
                <div id="doctor_div_0" >
                      ...
                      <input type="text" name="doctor_wise[0][doctor_name][]" value="" id="doctor_name" class="w-90px doctor_name" placeholder="Name"/>
                ...
                <div id="particular_div_0" style="display:none">
                    <div class="col-md-7">
                    <input type="text" name="doctor_wise[0][code_p][]" value="" id="" class="w-90px code_p" Placeholder="Code"/>
                      <input type="text" name="doctor_wise[0][particular_name][]" value="" id="" class="w-90px particular_name" placeholder="Name"/>
            ...
            <div class="row m-b-5">
              ...
              <div class="row m-b-5">
                <div class="col-md-5">
                <label>Operation Hours<span class="star">*</span></label>
                </div>
                <div class="col-md-7">
              ...
              <!--  <div class="row m-b-5">
                ...
                <div class="col-md-7">
                <textarea  name="ot_procedure" ><?php //echo $form_data['ot_procedure']; ?></textarea>
                   <?php //if(!empty($form_error)){ echo form_error('ot_procedure'); } ?>
                </div>
              </div>    -->
              <input type="hidden"  name="ot_procedure" id="ot_procedure" value="">
...
{
        var my_div = '';  
        my_div= '<div id="filed_name_new_'+divSize+'"><div class="row m-b-5" > <div class="col-md-5"><label><input name="doctor_wise['+divSize+'][type_ot][]" id="type_ot_d_'+divSize+'" value="0" type="radio" checked onclick="check_type('+divSize+',0);"> Doctor &nbsp;</label> <label><input name="doctor_wise['+divSize+'][type_ot][]" id="type_ot_p_'+divSize+'" value="1" type="radio" onclick="check_type('+divSize+',1);"> Particulars </label> </div><div id="doctor_div_'+divSize+'" ><div class="col-md-7"><input type="text" name="doctor_wise['+divSize+'][code][]" value="" id="code_'+divSize+'" class="w-90px code" placeholder="Code"/> <input type="text" name="doctor_wise['+divSize+'][doctor_name][]" value="" id="doctor_name_'+divSize+'" class="w-90px doctor_name" Placeholder="Name"/><input type="hidden" name="doctor_wise['+divSize+'][doctor_id][]" id="doctor_id_'+divSize+'" value=""/> <select onchange="return check_field_valid(this.value,'+f+')" name="doctor_wise['+divSize+'][master_type][]" class="w-50px master_type"><option value="0"> Rs </option><option value="1" > % </option></select> <input type="text" onkeyup="return check_field_valid(this.value,'+f+')" name="doctor_wise['+divSize+'][master_rate][]"  class="w-50px rate_plan" value=""><a href="javascript:void(0)" class="btn-new" onclick=" return add_more_field(1);"><i class="fa fa-plus"></i></a> <a href="javascript:void(0)" class="btn-new" onclick=" return remove_field('+divSize+',0);" ><i class="fa fa-minus"></i></a></div></div><div id="particular_div_'+divSize+'"></div></div></div>';
...
function check_type(divsize,type_data)
{
      ...
      if(type_data==0)
      {
         ...
         $('#doctor_div_'+divsize).html('<div class="col-md-7"><input type="text" name="doctor_wise['+divsize+'][code][]" value="" id="code_'+divsize+'" class="w-90px code" Placeholder="Code"/> <input type="text" name="doctor_wise['+divsize+'][doctor_name][]" value="" id="doctor_name_'+divsize+'" class="w-90px doctor_name" Placeholder="Name" /><input type="hidden" name="doctor_wise['+divsize+'][doctor_id][]" id="doctor_id_'+divsize+'" value=""/> <select onchange="return check_field_valid(this.value,'+f+')" name="doctor_wise['+divsize+'][master_type][]" class="w-50px master_type"><option value="0"> Rs </option><option value="1" > % </option></select> <input type="text" onkeyup="return check_field_valid(this.value,'+f+')" name="doctor_wise['+divsize+'][master_rate][]"  class="w-50px rate_plan" value=""> <a href="javascript:void(0)" class="btn-new" onclick="'+onclick_event+'" ><i class="fa '+css_c+'"></i></a></div>');
    ...
    if(type_data==1)
    {
       ...
       else
       {
        ...
        $('#particular_div_'+divsize).html('<div class="col-md-7"><input type="text" name="doctor_wise['+divsize+'][code_p][]" value="" id="code_'+divsize+'" class="w-90px code" placeholder="Code"/> <input type="text" name="doctor_wise['+divsize+'][particular_name][]" value="" id="particular_name_'+divsize+'" class="w-90px particular_name" Placeholder="Name"/><input type="hidden" name="doctor_wise['+divsize+'][particular_id][]" id="particular_id_'+divsize+'" value=""/> <select onchange="return check_field_valid(this.value,'+f+')" name="doctor_wise['+divsize+'][master_type][]" class="w-50px master_type"><option value="0" > Rs </option><option value="1" > % </option></select> <input type="text" name="doctor_wise['+divsize+'][master_rate][]"  class="w-50px rate_plan" value="" onkeyup="return check_field_valid(this.value,'+f+')"> <a href="javascript:void(0)" class="btn-new" onclick="'+onclick_event+'"><i class="fa '+css_c+'"></i></a></div>');
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('ot_management/get_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
    ...
    var selectItem = function (event, ui) { 
        ...
        $("#ot_management_types").val(ui.item.value);
        return false;
    }

    $("#ot_management_types").autocomplete({ 
        source: getData,
        select: selectItem,
        minLength: 1,
        change: function() {  
...
function isNumberKey(evt) {
    ...
    row = i ;
        $.ajax({
        url : "<?php echo base_url('ot_management/get_item_values/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
        data: {
        name_startsWith: request.term,
...
$("#ot_management").on("submit", function(event) { 
  event.preventDefault(); 
   ...
   if(pack_amount!="")
   {
       ...
       else
       {
         if(total_val!="")
         {
            $('#valid_error_msg').html('Total amount of OT details is not equal to operation amount.');
            return false;
         } 
       }
  }
  ...
  { 
    var path = 'edit/'+ids;
    var msg = 'Operation management successfully updated.';
  }
  else
  {
    var path = 'add/';
    var msg = 'Operation management successfully created.';
  } 
  //alert('ddd');return false;
    $.ajax({
      url: "<?php echo base_url('ot_management/'); ?>"+path,
      type: "post",
      data: $(this).serialize(),
      success: function(result) {
        if(result==1)
        {
          $('#load_add_ot_management_modal_popup').modal('hide');
        ...
        {
          $("#load_add_ot_management_modal_popup").html(result);
        }       
        $('#overlay-loader').hide();
      }
    });
...
function get_ot_management()
{
   $.ajax({url: "<?php echo base_url(); ?>ot_management/ot_summary_dropdown/", 
    success: function(result)
    {
      $('#ot_management_id').html(result); 
    } 
  });
}
...
<div id="load_add_operation_type_modal_popup" class="modal fade modal-top15" role="dialog" data-backdrop="static" data-keyboard="false"></div>
        </div><!-- /.modal-content -->
