          ...
          function find_employee_salary(){
            ...
            var emp_id= $('#emp_id').val();
               ...
               if(emp_id!=''){
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url().'employee_salary/find_employee_salary' ?>", 
        ...
        // startDate: '-0d',
         autoclose: true
          ...
          $("#employee_salary_form").on("submit", function(event) { 
               ...
               $.ajax({
                    url: "<?php echo base_url(); ?>employee_salary/"+path,
                    type: "post",
                    data: $(this).serialize(),
                     //dataType: "json",
                    success: function(result) {
                         if(result==1){
                              ...
                              $('#load_add_modal_popup').modal('hide');
                               window.location.href='<?php echo base_url('employee_salary/?status=print');?>';
                         } else{
