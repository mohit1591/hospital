      ...
      <div class="row">
        <div class="col-xs-7 br-h-small">
         ...
         <label>Token Setting:&nbsp;&nbsp;</label>
            <input type="radio" name="type" value="0" <?php  if($path_token_setting->type==0){ echo 'checked="checked"'; } ?>> Hospital Wise
            <input type="radio" name="type" value="1" <?php  if($path_token_setting->type==1){ echo 'checked="checked"'; } ?>> Department Wise
...
$("#token_setting_form").on("submit", function(event) { 
  ...
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>path_token_setting/",
    type: "post",
    data: $(this).serialize(),
