...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "order": [], 
        "ajax": {
            "url": "<?php echo base_url('patient_category/archive_ajax_list')?>",
            "type": "POST",
             "data":function(d){
...
<section class="userlist">
    ...
    <form>
       ...
       <!-- bootstrap data table -->
        <table id="table" class="table table-striped table-bordered patient_category_archive" cellspacing="0" width="100%">
  	...
  	<div class="userlist-right">
          ...
          <?php } ?> 
        <button class="btn-update" onclick="window.location.href='<?php echo base_url('patient_category'); ?>'">
