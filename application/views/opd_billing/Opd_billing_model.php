           ...
           //// Recipet no set  
		    if(!empty($row_d_pay))
		    {
		    	foreach($row_d_pay as $row_d)
		    	{
            		...
            		// Set comission //
            		$comission_arr = get_doc_hos_comission($post['referral_doctor'],$post['referral_hospital'],$post['paid_amount'],3);
