 <div class="modal-dialog advance-search-modal">
  ...
  <div class="modal-content"> 
      <form  id="search_form_opd_bill" class="form-inline"> 
                    ...
                    <div class="advance-search">
                      <div class="inner">
                        ...
                        <div class="grp">
                         ...
                         <div class="grp">
                          ...
                          <input type="text" name="adhar_no" class="inputFocus" value="<?php echo $form_data['adhar_no']; ?>">
                        </div>
                      ...
                      <div class="inner">
                        ...
                        <div class="grp">
                          ...
                          <input type="text" name="reciept_code" id="booking_code" value="<?php echo $form_data['reciept_code']; ?>" />
                        </div>
 ...
 <div class="grp">
                          <label>Disease</label>
                          <input type="text" name="disease" class="inputFocus" value="<?php echo $form_data['disease']; ?>">
                        </div>
                         <div class="grp">
                          <label>ICD-10</label>
                          <input type="text" name="disease_code" class="inputFocus" value="<?php echo $form_data['disease_code']; ?>">
                        </div>
                        ...
                        <div class="grp">
                          ...
                          <select name="specialization" id="specialization" onChange="return get_doctor_specilization(this.value);">
...
$("#search_form_opd_bill").on("submit", function(event) { 
