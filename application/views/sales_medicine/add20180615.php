...
<div class="row" style="padding-right:4em;">
    <div class="col-md-4">
      ...
      { ?>        
              <input type="text" name="opd_patient" id="opd_patient" placeholder="Patient OPD Patient" class="opd_patient"> <label></label>
              <?php } ?>
 ...
 if (v == true){
  ...
  function validation_check(unit,id){
    ...
    var mbid =$('#mbid_'+id).val();
     $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>sales_medicine/check_stock_avability/", 
      dataType: "json",
