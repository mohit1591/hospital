			...
			<div class="row">
				<div class="col-md-4">
					...
					<div class="row m-b-5">
						...
						<div class="col-md-8">
							<input type="text" name="start_date" id="start_date_s" class="datepicker m_input_defa"  onkeyup="return form_submit();" value="<?php echo $form_data['start_date'];?>">
						</div>
					</div>
    ...
    <form>
  	...
  	<div class="userlist-right">
  		<div class="btns">
               ...
               <!--  <a href="javascript:void(0)" class="btn-anchor m-b-2" id="deleteAll" onClick="return openPrintnewWindow('< ?php echo base_url("sales_medicine/print_medicine_sales"); ?>', 'windowTitle', 'width=820,height=600');">
...
/*function openPrintWindow(url, name, specs) {
   if(url==123){
    url='< ?php echo base_url("sales_medicine/print_sales_report"); ?>/'+name;
    name='windowTitle';
