...
$("#diagnosis").on("submit", function(event) { 
  ...
  { 
    var path = 'edit/'+ids;
    var msg = 'Caste successfully updated.';
  }
  else
  {
    var path = 'add/';
    var msg = 'Caste successfully created.';
  } 
  //alert('ddd');return false;
  $.ajax({
    url: "<?php echo base_url('caste_master/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
...
{
   $.ajax({url: "<?php echo base_url(); ?>caste_master/dropdown/", 
    success: function(result)
    {
