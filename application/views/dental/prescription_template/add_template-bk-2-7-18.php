    ...
    <div class="row tab-pane fade in active" id="chief">
      <div class="col-md-5" >
        <div class="box-left">
          ...
          <?php $display=''; if($form_data['check_appointment']!=NULL) {
          ...
          <div class="row" id="date_time_next" style="<?php echo $display;?>">
            ...
            <div class="col-md-6">
             <input type="text" name="next_appointment_date"  class="datepickertime date "  data-date-format="dd-mm-yyyy HH:ii"  value="<?php echo $form_data['next_appointment_date']; ?>" /> 
            </div>
