...
<div class="overlay-loader" id="overlay-loader">
  ...
  <form  id="dental_allergy" class="form-inline">
          ...
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row">
                ...
                <div class="col-md-7">
                    <input type="text" name="allergy_name" class="inputFocus first_txt_cap" value="<?php echo $form_data['allergy_name']; ?>">
...
$("#dental_allergy").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('dental/allergy/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
    success: function(result) {
      ...
      {
        $("#load_add_dental_allergy_modal_popup").html(result);
      }       
      $('#overlay-loader').hide();
    }
  });
...
function get_allery()
{
   $.ajax({url: "<?php echo base_url(); ?>dental/allergy/allergy_dropdown/", 
    success: function(result)
    {
