...
<section class="userlist">
    ...
    <div class="overlay-loader">
     ...
     <form id="dental_prescription_tab_setting_form">
      ...
      <?php
        if(in_array('1739',$users_data['permission']['action']))
        {
      ...
      <div class="row">
        <div class="col-xs-4 br-h-small">
              <div class="row">
                ...
                <div class="col-xs-6">
                    <input class="form-control text-13px"  name="data[<?php echo $tab_setting_list->id; ?>][setting_name]" value="<?php echo $tab_setting_list->setting_name; ?>" type="text" data-toggle="tooltip"  title="Allow only characters." class="tooltip-text" <?php if(!empty($tab_setting_list->setting_name)){ echo 'readonly'; } ?>>
                </div>
              </div> <!-- innerRow -->
        </div> <!-- 6 -->
        <div class="col-xs-8">
...
$("#dental_prescription_tab_setting_form").on("submit", function(event) { 
  event.preventDefault(); 
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>dental/prescription_medicine_tab_setting/",
    type: "post",
    data: $(this).serialize(),
