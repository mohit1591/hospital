          ...
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row">
                ...
                <div class="col-md-7">
                    <input type="text" name="advice" class="inputFocus first_txt_cap" value="<?php echo $form_data['advice']; ?>">
...
$("#chief_complaints").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('dental/advice/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
    success: function(result) {
      ...
      {
        $("#load_add_dental_advice_modal_popup").html(result);
      }       
      $('#overlay-loader').hide();
    }
  });
...
{
   $.ajax({url: "<?php echo base_url(); ?>dental/advice/advice_dropdown/", 
    success: function(result)
    {
