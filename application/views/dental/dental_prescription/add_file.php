        ...
        <div class="modal-body">  
         <div class="row m-b1">
           ...
           <div class="row m-b1">
                ...
                <div class="col-xs-8">
                <p>Allowed Only (pdf | jpeg | jpg | png) </p>
                    ...
                    if(!empty($form_data['old_prescription_img']) && file_exists(DIR_UPLOAD_PATH.'opd/prescription/'.$form_data['old_prescription_files']))
                    {
                        $prescription_files = ROOT_UPLOADS_PATH.'opd/prescription/'.$form_data['old_prescription_files'];
...
$("#prescription_files_form").on("submit", function(event) { 
  ...
  {
     var path = 'edit_dental_prescription_file/'+data_id+'/'+prescription_id;
     var msg = "Prescription successfully updated.";
  }
  else
  {
     var path = 'upload_dental_prescription'+'/'+prescription_id;
     var msg = "Prescription file successfully added.";
  }

  $.ajax({
    url: "<?php echo base_url('dental/dental_prescription/'); ?>"+path,
    type: "post", 
