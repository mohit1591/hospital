...
"<br>";
 if(strcmp(strtolower($tab_value->setting_name),'previous_history')=='0')
    ...
    <thead>
        <tr>
            <th align="left" height="30">Disease Name</th>
            <th align="center" height="30">Disease Details</th>
            <th align="center" height="30">Operation</th> 
              <th align="center" height="30">Operation Date</th>       
        </tr></thead><tbody>';
...
if(strcmp(strtolower($tab_value->setting_name),'allergy')=='0')
    ...
    <thead>
       <tr>
            <th align="left" height="30">Allergy Name</th>
            <th align="center" height="30">Reason</th>
            <th align="center" height="30" colspan="2">Duration</th>
        </tr></thead><tbody>';
        $num_var='';
...
if(strcmp(strtolower($tab_value->setting_name),'oral_habits')=='0')
    ...
    <thead>
       <tr>
            <th align="left" height="30">Oral Habit Name</th>
            <th align="center" height="30" colspan="2">Duration</th>
                </tr></thead><tbody>';
        $num_var='';
...
if(strcmp(strtolower($tab_value->setting_name),'investigation')=='0')
    ...
    <table width="100%" border="" cellspacing="0" cellpadding="0" class="grid_tbl">
        <thead><tr>
            <th align="left" height="30">Investigations</th>
             <th align="left" height="30">Tooth Name</th>
            
            <th align="center" height="30">Tooth Number</th>
            <th align="center" height="30">Remarks</th>       
        </tr></thead><tbody>';
        $time_var='';
     ...
     $investigation_data.='</tbody></table>
</div>';
...
//incestigation end
  ...
  if(strcmp(strtolower($tab_value->setting_name),'diagnosis')=='0')
    ...
    <thead>
        <tr>
            <th align="left" height="30">Diagnosis Name</th>
            <th align="center" height="30">Teeth Type</th>
            <th align="center" height="30">Tooth No.</th>       
        </tr></thead><tbody>';
        $time_var='';
        ...
        if(!empty($all_detail['prescription_list']['prescription_presc_list']))
          {
            ...
            $patient_pres .= '<thead>
                ...
                $patient_pres .= '<th  align="left">'.$Medicine_name.'</th>';
                ...
                $patient_pres .= '<th align="left">'.$Medicine_salt.'</th>';
                ...
                $patient_pres .= '<th align="left">'.$Medicine_brand.'</th>';
                ...
                $patient_pres .= '<th align="left">'.$Types.'</th>';
                ...
                $patient_pres .= '<th align="left">'.$Dose.'</th>';
                ...
                $patient_pres .= '<th align="left">'.$Duration.'</th>';
                ...
                $patient_pres .= '<th  align="left">'.$Frequency.'</th>';
                ...
                $patient_pres .= '<th align="left">'.$Advice.'</th>';
...
if(strcmp(strtolower($tab_value->setting_name),'treatment')=='0')
    ...
    <table width="100%" border="" cellspacing="0" cellpadding="0" class="grid_tbl">
        <thead><tr>
            <th align="left" height="30">Treatment Name</th>
            
            <th align="center" height="30">Teeth Type</th>
            <th align="center" height="30">Tooth No.</th>    
            
        </tr></thead><tbody>';
        //<th align="left" height="30">Materials</th><th align="left" height="30">Remarks</th>
        $time_var='';
       foreach($all_detail['prescription_list']['treatment_booking'] as $treatment_booking_li)
       {
        $treatment.='<tr>
            ...
            //$treatment.='<td align="left" height="30">'.$treatment_booking_li->treatment_type_id.'</td>';
           ...
           // $treatment.='<td align="left" height="30">'.$treatment_booking_li->treatment_remarks.'</td>';
             
        $treatment.='</tr>';
       }
        
       
     $treatment.='</tbody></table>
</div>';
...
if(strcmp(strtolower($tab_value->setting_name),'advice')=='0')
    ...
    <table width="100%" border="" cellspacing="0" cellpadding="0" class="grid_tbl">
        <thead>
        <tr>
            <th align="left" height="30">Advice Name</th>
