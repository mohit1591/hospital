...
<div class="overlay-loader" id="overlay-loader">
  ...
  <form  id="dental_medicine" class="form-inline">
          ...
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row m-b-5">
                ...
                <div class="col-md-8">
                    <input type="text" name="medicine"  class=" inputFocus first_txt_cap" value="<?php echo $form_data['medicine']; ?>">
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('dental/medicine/get_unit_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
   var i=1;
    var getData = function (request, response) { 
        row = i ;
        $.ajax({
        url : "<?php echo base_url('dental/medicine/get_company_vals/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
       data: {
...
$("#dental_medicine").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('dental/medicine/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
