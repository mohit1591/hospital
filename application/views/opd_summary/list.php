...
{   
    ...
    var attended_doctor = $('#attended_doctor').val();
    $.ajax({
           url: "<?php echo base_url('opd_summary_report/search_data/'); ?>", 
           type: 'POST',
           data: { start_date: start_date, end_date : end_date,attended_doctor:attended_doctor} ,
...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "aaSorting": [],
        "ajax": {
            "url": "<?php echo base_url('opd_summary_report/ajax_list')?>",
            "type": "POST"
        }, 
        "columnDefs": [
        { 
...
function reset_date_search()
  {
      ...
      $('#employee').val('');
      $.ajax({
         url: "<?php echo base_url('opd_summary_report/reset_date_search/'); ?>",  
         success: function(result)
         { 
          reload_table(); 
         }
...
$modal.load('<?php echo base_url().'opd_summary_report/advance_search/' ?>',
{
//'id1': '1',
//'id2': '2'
},
...
<section class="userlist">
    ...
    <div class="grp_box m-b-5">
      ...
      <div class="grp">
        ...
        <select name="attended_doctor" id="attended_doctor" onchange="return form_submit();">
    ...
    <div class="userlist-right relative" id="example_wrapper">
      <div class="fixed">
      <div class="btns"> 
               <a href="<?php echo base_url('opd_summary_report/opd_summary_report_excel'); ?>" class="btn-anchor m-b-2">
                    <i class="fa fa-file-excel-o"></i> Excel
               </a>
               <a href="<?php echo base_url('opd_summary_report/pdf_opd_summary_report'); ?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-pdf-o"></i> PDF
               </a>
            <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("opd_summary_report/print_opd_collection_report"); ?>');">
...
function clear_form_elements(ele) {
   $.ajax({url: "<?php echo base_url(); ?>opd_summary_report/reset_date_search/",
      success: function(result)
      {
