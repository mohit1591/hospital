...
if(!empty($prescription_list))
{
    ...
    foreach($prescription_list as $pres_detail)
    {
            ...
            if(!empty($pres_detail->validity_date) && $pres_detail->validity_date!='0000-00-00')
        {
            ...
            if(!empty($pres_detail->shift)) {
              $template_data = str_replace("{shift}",$pres_detail->shift." Shift",$template_data);
            } else {
        ...
        <?php }   }
            ...
            $signature_image = get_doctor_signature($pres_detail->attended_doctor);
