                ...
                <div class="row m-t-10">
                   ...
                   <select name="template_list"  id="template_list" >
                     ...
                     ?>
                        ...
                        <a href="<?=base_url('nursing_notes_template/add')?>" target="_blank" class="btn btn-success"><i class="fa fa-plus"></i> Add new</a>
                    </div>
                    <div class="col-xs-3">
                        <label for="">Shift</label>
                        <select name="shift" id="">
                          <option value="Morning" <?php echo $form_data['shift']=='Morning'?"selected":"" ?>>Morning Shift</option>
                          <option value="Night" <?php echo $form_data['shift']=='Night'?"selected":"" ?>>Night Shift</option>
                        </select>
                    </div>
                    ...
                    <div class="col-xs-11">
                       ...
                       <?php 
                            ...
                            <div id="tab_previous_history" class="inner_tab_box tab-pane fade  <?php if($j==1){ ?> in active <?php  } ?>">
                                <div class="row m-t-10">
                                    <div class="col-xs-8">
                                        <div class="well"><h4><?=$value->setting_value?></h4>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="well tab-right-scroll">
                                          <!--   <div class="grp">DSHPT1</div>
                                            ...
                                            <a href="<?=base_url('nursingnotes/personal_history')?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-plus"></i> Add new</a>
                                ...
                                <div class="row m-t-10">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="well tab-right-scroll">
                                            ...
                                            <a href="<?=base_url('nursingnotes/chief_complaints')?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-plus"></i> Add new</a>
                                ...
                                <div class="row m-t-10">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="well tab-right-scroll">
                                            ...
                                            <a href="<?=base_url('nursingnotes/examination')?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-plus"></i> Add new</a>
...
<div class="row m-t-10">
  <div class="col-xs-12">
        ...
        <div class="row m-t-10">
            ...
            <div class="col-xs-4">
                <div class="well tab-right-scroll">
                    ...
                    <a href="<?=base_url('nursingnotes/suggestion')?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-plus"></i> Add new</a>
    ...
    <div id="tab_remarks" class="inner_tab_box tab-pane fade <?php if($j==1){ ?> in active <?php  } ?>">
        ...
        <div class="row m-t-10">
            <div class="col-xs-1">
                <label><b><?=$value->setting_value?></b></label>
            </div>
            <div class="col-xs-11">
 ...
 ?>
      ...
      <a href="<?php echo base_url('ipd_nursingnotes'); ?>"  class="btn-anchor" >
...
<script type="text/javascript">
  ...
  $('#template_list').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>opd/get_nursing_template_data/"+template_id, 
  ...
  function load_values(jdata)
  {
    ...
    {
        $.ajax({url: "<?php echo base_url(); ?>opd/get_nursing_template_test_data/"+template_id, 
        success: function(result)
        {
...
/*<a href="javascript:void(0)" class="btn-w-60 addrow">Add</a>*/
    ...
    {
        $.ajax({url: "<?php echo base_url(); ?>opd/get_nursing_template_prescription_data/"+template_id, 
        success: function(result)
        {
    ...
    //   var chief_complaints_val = $("#chief_complaints").val();
      ...
      $.ajax({url: "<?php echo base_url(); ?>opd/nursing_complaints_name/"+complaints_id, 
        success: function(result)
        {
    ...
    $('#examination_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>opd/nursing_examination_name/"+examination_id, 
        success: function(result)
        {
           if(examination_val!='')
           {
    ...
    $('#diagnosis_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>opd/nursing_diagnosis_name/"+diagnosis_id, 
        success: function(result)
        {
           if(diagnosis_val!='')
           {
     ...
     $('#suggestion_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>opd/nursing_suggetion_name/"+suggetion_id, 
        success: function(result)
        {
           if(suggestion_val!='')
           {
    ...
    //   var personal_history_val = $("#personal_history").val();
      ...
      $.ajax({url: "<?php echo base_url(); ?>opd/nursing_personal_history_name/"+personal_history_id, 
        success: function(result)
        {
    ...
    //   var prv_history_val = $("#prv_history").val();
      ...
      $.ajax({url: "<?php echo base_url(); ?>opd/nursing_prv_history_name/"+prv_history_id, 
        success: function(result)
        {
           if(prv_history_val!='')
           {
    ...
    $(".addrow").click(function(){ 
      ...
      var i=$('#test_name_table tr').length;
        ...
        $(function () {
         /* var getData = function (request, response) { 
              $.getJSON(
                  "<?php echo base_url('ipd_nursingnotes/get_test_vals/'); ?>" + request.term,
                  function (data) {
                      response(data);
                  });
          };*/
