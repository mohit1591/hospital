    ...
    if(!empty($all_detail['prescription_list'][0]->admission_date) && $all_detail['prescription_list'][0]->admission_date!='0000-00-00')
{
    ...
    if(!empty($all_detail['prescription_list'][0]->shift)) {
      $template_data = str_replace("{shift}",$all_detail['prescription_list'][0]->shift." Shift",$template_data);
    } else {
      $template_data = str_replace("{shift}",'',$template_data);
    }
