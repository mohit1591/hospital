...
/* if($type==2){
 ...
 $booking_date = '<b>Booking Date :</b>'.date('d-m-Y',strtotime($all_detail['sales_list'][0]->c_date));

  $template_data->template = str_replace("{booking_date}",$booking_date,$template_data->template);
  $receipt_code = '<div><b>Receipt No.:</b>'.$all_detail['sales_list'][0]->recepit_no.'</div>';
  $template_data->template = str_replace("{booking_code}",$receipt_code,$template_data->template);
   ...
   if(!empty($all_detail['sales_list'][0]->specialization_id))
    {
        
        $template_data->template = str_replace("{specialization_level}",'Spec. :',$template_data->template);
        $template_data->template = str_replace("{specialization}",get_specilization_name($all_detail['sales_list'][0]->specialization_id),$template_data->template);
    }
    else
    {
...
$template_data->template = str_replace("{total_net}",$new_balance['balance'][0]->balance,$template_data->template);
...
$template_data->template = str_replace("{balance}",number_format($new_balance['balance'][0]->balance-$all_detail['sales_list'][0]->debit,2,'.',''),$template_data->template);
...
//$all_detail['sales_list'][0]->username
...
$template_data->template = str_replace("{total_net}",number_format($new_balance['balance'][0]->balance,2,'.',''),$template_data->template);

$template_data->template = str_replace("{paid_amount}",$all_detail['sales_list'][0]->debit,$template_data->template);

$template_data->template = str_replace("{total_gross}",number_format($new_balance['balance'][0]->balance,2,'.',''),$template_data->template);
...
$template_data->template = str_replace("{gross_total_amount}",number_format($new_balance['balance'][0]->balance,2,'.', ''),$template_data->template);
