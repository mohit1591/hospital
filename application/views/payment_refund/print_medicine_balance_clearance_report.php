...
$template_data->template = str_replace("{total_amount}",$new_balance['balance'][0]->balance,$template_data->template);
...
$template_data->template = str_replace('{cgst}',"0",$template_data->template);
$template_data->template = str_replace('{igst}',"0",$template_data->template);
$template_data->template = str_replace('{sgst}',"0",$template_data->template);
$template_data->template = str_replace('{discount}',"0",$template_data->template);
...
$template_data->template = str_replace('{igst}',"0",$template_data->template);
$template_data->template = str_replace('{sgst}',"0",$template_data->template);
$template_data->template = str_replace('{medicine_per_discount}',"0",$template_data->template);
$template_data->template = str_replace('{tot_cgst}',"0.00",$template_data->template);
$template_data->template = str_replace('{tot_igst}',"0.00",$template_data->template);
$template_data->template = str_replace('{tot_sgst}',"0.00",$template_data->template);
