...
var table;
<?php
if(in_array('848',$users_data['permission']['action'])) 
{
?>
...
{
  var $modal = $('#load_add_unit_modal_popup');
  $modal.load('<?php echo base_url().'unit/edit/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
...
<section class="userlist">
    ...
    <form>
  	...
  	<div class="userlist-right">
  		<div class="btns">
          <?php
               if(in_array('849',$users_data['permission']['action'])) {
          ?>
          ...
          ?>
  			<button class="btn-update" onclick="window.location.href='<?php echo base_url('unit/archive'); ?>'">
...
<script>  
 ...
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('unit/delete/'); ?>"+rate_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
