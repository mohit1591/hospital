     ...
     <div class="modal-body">   
          <div class="row">
               <div class="col-md-12">
                    <div class="row m-b-5">
                         ...
                         <div class="col-md-7">
                              <input type="text" id="start_date_from" name="from_date" class="collection_datepicker" readonly="" value="<?php echo date('d-m-Y'); ?>">
                         </div>
                    </div>
                    <div class="row m-b-5">
                         <div class="col-md-5">      
                         ...
                         <div class="col-md-7">
                              <input type="text" name="to_date" id="end_date_to" class="collection_datepicker_to" readonly="" value="<?php echo date('d-m-Y'); ?>">
                         </div>
                    </div>
                    <div class="row">
                         <div class="col-md-5">      
      ...
      <div class="modal-footer"> 
        <div style="float:right;width:80%;display:inline-flex;">
         <button type="submit" class="btn-update" id="reset_date" onClick="reset_date_search();">Reset</button>
         <button type="submit" class="btn-update" name="submit" id="print">Print</button>
         ...
         <a href="" class="btn-anchor" style="display:none;" class="btn-update"  name="print_pdf" id="print_pdf">Print</a>
          <?php } ?>
         <button type="button" class="btn-cancel m-l-2px" data-number="1">Close</button>
        </div>
      </div>
</form>     
...
function print_options_report(print_option){
     ...
     if(print_option!=''){
          if(print_option==1){
               ...
               $("#print").removeAttr("onClick");
               $("#print").attr("onClick","return openPrintWindow('<?php echo base_url('reports/print_path_collection_reports?') ?>start_date="+start_date+"&end_date="+end_date+"', 'windowTitle', 'width=820,height=600');");
...
{  
     ...
     window.open('<?php echo base_url('reports/print_path_collection_reports?') ?>start_date='+start_date+'&end_date='+end_date,'mywin','width=800,height=600');
