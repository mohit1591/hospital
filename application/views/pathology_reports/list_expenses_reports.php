...
<page size="A4">
    ...
    <div style="float:left; margin-top:10px; width:100%;border:1px solid #111;border-top:none;font-size:13px;">       
     ...
     if(!empty($expense_list))
     {
        ...
        //echo "<pre>"; print_r($expense_list); exit;
        foreach($expense_list as $expenses)
        {
          ...
          <div style="float:left;width:100%; height: 35px;">
              ...
              <div style="float:left;width:15%;padding:1px 4px;"><?php echo $expenses->type.' '.ucfirst($expenses->paid_to_name); ?></div> 
              <div style="float:left;width:15%;padding:1px 4px;"><?php echo $expenses->exp_category; ?></div>
     ...
     else
     {
      ?>
       <div style="float:left;width:100%;">
            <div style="float:left;width:100%;padding:1px 4px;text-indent:15px;"><div style="text-align:center;color:#cc0000;">Record not found</div></div>
       </div> 
      <?php
     }
     ?>           
