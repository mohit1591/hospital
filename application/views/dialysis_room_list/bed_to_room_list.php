...
<section class="userlist">
  ...
  <div class="row m-b-5">
    ...
    <div class="userlist-right">
        ...
        <button class="btn-update" onclick="window.location.href='<?php echo base_url('dialysis_room_list'); ?>'">
...
//alert();
 ...
 var $modal = $('#load_edit_ipd_bed_modal_popup');
  $modal.load('<?php echo base_url().'dialysis_room_list/edit_bed/' ?>'+bed_id,
  {
    //'id1': '1',
    //'id2': '2'
    },
