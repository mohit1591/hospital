...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('ipd_prescription/ajax_file_list/'.$prescription_id)?>",
            "type": "POST",
        }, 
        "columnDefs": [
        { 
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('ipd_prescription/deleteall_prescription_file');?>",
                      data: {row_id: allVals},
...
<section class="userlist">
    ...
    <div class="userlist-right">
      <div class="btns">
        ...
        <button class="btn-update" id="new" onclick="return upload_prescription('<?php echo $prescription_id; ?>')">
...
<script>  
 ...
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('ipd_prescription/delete_prescription_file/'); ?>"+prescription_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
