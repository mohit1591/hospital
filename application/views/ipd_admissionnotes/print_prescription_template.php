...
/* start thermal printing */
    ...
    $booking_date_time='';
    if(!empty($all_detail['prescription_list'][0]->admission_date) && $all_detail['prescription_list'][0]->admission_date!='0000-00-00')
{
    $booking_date_time = date('d-m-Y',strtotime($all_detail['prescription_list'][0]->admission_date)); 
}
    ...
    $template_data = str_replace("{ipd_no}",$all_detail['prescription_list'][0]->ipd_no,$template_data);
    ...
    {
      $template_data = str_replace("{date_time_new}",$all_detail['prescription_list'][0]->date_time_new,$template_data);
    } else {
 ...
 $template_data = str_replace("{vitals}",$patient_vital,$template_data);
    ...
    {
        // Changes By Nitin Sharma 02/04/2024
        ...
        if(!empty($all_detail['prescription_list'][0]->examination)){
            ...
            $examination .= '<div style="float:left;width:100%;margin:1em 0 0;margin-left:15px;">
                  <div style="font-size:small;line-height:18px;">
                    <b>General  :</b>
            ...
            $examination .= '<div style="font-size:small;line-height:18px; margin-left:15px;">
                        <b>CVS :</b>
                       '.nl2br($all_detail['prescription_list'][0]->cvs).'
                      </div>';
            $examination .= '<div style="font-size:small;line-height:18px; margin-left:15px;">
                        <b>CVS :</b>
                       '.nl2br($all_detail['prescription_list'][0]->cvs).'
            ...
            $examination .= '<div style="font-size:small;line-height:18px; margin-left:15px;">
                        <b>CNS :</b>
                       '.nl2br($all_detail['prescription_list'][0]->cns).'
                      </div>';
            $examination .= '<div style="font-size:small;line-height:18px; margin-left:15px;">
                        <b>Respiratory System :</b>
                       '.nl2br($all_detail['prescription_list'][0]->respiratory_system).'
                      </div>';
            $examination .= '<div style="font-size:small;line-height:18px; margin-left:15px;">
                        <b>Per Abdomen :</b>
                       '.nl2br($all_detail['prescription_list'][0]->per_abdomen).'
                      </div>';  
            $examination .= '<div style="font-size:small;line-height:18px; margin-left:15px;">
                        <b>Per Vaginal :</b>
                       '.nl2br($all_detail['prescription_list'][0]->per_vaginal).'
                      </div>';
            $examination .= '<div style="float:left;width:100%;margin:1em 0 0; margin-left:15px;">
                  <div style="font-size:small;line-height:18px;">
                    <b>Local  :</b>
                   '.nl2br($all_detail['prescription_list'][0]->local_examination).'
                  </div>
                </div>';
        }
        // Changes By Nitin Sharma 02/04/2024
    ...
    if(strcmp(strtolower($value->setting_name),'history_presenting_illness')=='0')
    { 
        if(!empty($value->setting_value)) { $Remark =  $value->setting_value; } else { $Remark =  $value->var_title; }
        if(!empty($all_detail['prescription_list'][0]->history_presenting_illness)){ 
        $history_presenting_illness = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;">
            <b>'.$Remark.' :</b>
           '.nl2br($all_detail['prescription_list'][0]->history_presenting_illness).'
          </div>
        </div>';
        }
    }
    
    if(strcmp(strtolower($value->setting_name),'obstetrics_menstrual_history')=='0')
    { 
        if(!empty($value->setting_value)) { $Remark =  $value->setting_value; } else { $Remark =  $value->var_title; }
        if(!empty($all_detail['prescription_list'][0]->obstetrics_menstrual_history)){ 
        $obstetrics_menstrual_history = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;">
            <b>'.$Remark.' :</b>
           '.nl2br($all_detail['prescription_list'][0]->obstetrics_menstrual_history).'
          </div>
        </div>';
        }
    }
    
    if(strcmp(strtolower($value->setting_name),'family_history_disease')=='0')
    { 
        if(!empty($value->setting_value)) { $Remark =  $value->setting_value; } else { $Remark =  $value->var_title; }
        if(!empty($all_detail['prescription_list'][0]->family_history_disease)){ 
        $family_history_disease = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;">
            <b>'.$Remark.' :</b>
           '.nl2br($all_detail['prescription_list'][0]->family_history_disease).'
          </div>
        </div>';
        }
    }
    
    if(strcmp(strtolower($value->setting_name),'remark1')=='0')
    { 
        if(!empty($value->setting_value)) { $Remark =  $value->setting_value; } else { $Remark =  $value->var_title; }
        if(!empty($all_detail['prescription_list'][0]->remark1)){ 
        $remark1 = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;">
            <b>'.$Remark.' :</b>
           '.nl2br($all_detail['prescription_list'][0]->remark1).'
          </div>
        </div>';
        }
    }
    
    if(strcmp(strtolower($value->setting_name),'remark2')=='0')
    { 
        if(!empty($value->setting_value)) { $Remark =  $value->setting_value; } else { $Remark =  $value->var_title; }
        if(!empty($all_detail['prescription_list'][0]->remark2)){ 
        $remark2 = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;">
            <b>'.$Remark.' :</b>
           '.nl2br($all_detail['prescription_list'][0]->remark2).'
          </div>
        </div>';
        }
    }
    
    if(strcmp(strtolower($value->setting_name),'remark3')=='0')
    { 
        if(!empty($value->setting_value)) { $Remark =  $value->setting_value; } else { $Remark =  $value->var_title; }
        if(!empty($all_detail['prescription_list'][0]->remark3)){ 
        $remark3 = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;">
            <b>'.$Remark.' :</b>
           '.nl2br($all_detail['prescription_list'][0]->remark3).'
          </div>
        </div>';
        }
    }
    
    if(strcmp(strtolower($value->setting_name),'remark4')=='0')
    { 
        if(!empty($value->setting_value)) { $Remark =  $value->setting_value; } else { $Remark =  $value->var_title; }
        if(!empty($all_detail['prescription_list'][0]->remark4)){ 
        $remark4 = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;">
            <b>'.$Remark.' :</b>
           '.nl2br($all_detail['prescription_list'][0]->remark4).'
          </div>
        </div>';
        }
    }
    
    if(strcmp(strtolower($value->setting_name),'remark5')=='0')
    { 
        if(!empty($value->setting_value)) { $Remark =  $value->setting_value; } else { $Remark =  $value->var_title; }
        if(!empty($all_detail['prescription_list'][0]->remark5)){ 
        $remark5 = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;">
            <b>'.$Remark.' :</b>
           '.nl2br($all_detail['prescription_list'][0]->remark5).'
          </div>
        </div>';
        }
    }
...
<?php }   }
    ...
    $template_data = str_replace("{history_presenting_illness}",$history_presenting_illness,$template_data); // Added By Nitin Sharma
    $template_data = str_replace("{obstetrics_menstrual_history}",$obstetrics_menstrual_history,$template_data); // Added By Nitin Sharma
    $template_data = str_replace("{family_history_disease}",$family_history_disease,$template_data); // Added By Nitin Sharma
    $template_data = str_replace("{remark1}",$remark1,$template_data); // Added By Nitin Sharma
    $template_data = str_replace("{remark2}",$remark2,$template_data); // Added By Nitin Sharma
    $template_data = str_replace("{remark3}",$remark3,$template_data); // Added By Nitin Sharma
    $template_data = str_replace("{remark4}",$remark4,$template_data); // Added By Nitin Sharma
    $template_data = str_replace("{remark5}",$remark5,$template_data); // Added By Nitin Sharma
    ...
    $template_data = preg_replace('/<br\s*\/?>/i', '', $template_data);
    echo $template_data; 
