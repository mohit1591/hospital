       ...
       <!-- bootstrap data table -->
        <table id="table" class="table table-striped table-bordered table-responsive medicine_stock_list" cellspacing="0" width="100%">
            ...
            <tr>
              ...
              <td>
              <?php
              if($running_data['end_date']=='0000-00-00 00:00:00')
              {
                 ...
                 {
                   echo date('d-m-Y',strtotime($running_data['start_date']));
                 }
        ...
        <div class="left">
            <div class="right_box">
                <div class="sale_medicine_mod_of_payment">
                    ...
                    <input type="text" id="total_net_amount" value="<?php if(isset($net_advance_data[0])){echo $net_advance_data[0];}?>"  readonly="" />
                </div>
               <div class="sale_medicine_mod_of_payment">
                 <label>Received</label>
                  <input type="text" id="total_paid_amount" value="<?php if(isset($received_amount)) {echo $received_amount;}?>"  readonly="" />
                </div>
                <div class="sale_medicine_mod_of_payment">
                    <label>Balance</label>
