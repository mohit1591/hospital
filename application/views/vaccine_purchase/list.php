...
{   
    ...
    $.ajax({
      url: "<?php echo base_url('vaccine_purchase/advance_search/'); ?>",
      type: "post",
...
var table;
<?php
if(in_array('1074',$users_data['permission']['action'])) 
{
?>
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('vaccine_purchase/ajax_list')?>",
            "type": "POST",
        }, 
        "columnDefs": [
        { 
        ...
        "drawCallback": function() 
        {
            $.ajax({
                      dataType: "json",
                      url: "<?php echo base_url('vaccine_purchase/total_calc_return');?>",
                      success: function(result) 
                      {
...
function edit_purchase(id)
{
  ...
  window.location.href='<?php echo base_url().'vaccine_purchase/edit/';?>'+id
...
function view_medicine_entry(id)
{
  ...
  $modal.load('<?php echo base_url().'vaccine_purchase/view/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('vaccine_purchase/deleteall');?>",
                      data: {row_id: allVals},
                      success: function(result) 
                      {
...
<section class="userlist">
    <div class="userlist-box">
     <?php if(in_array('1074',$users_data['permission']['action'])) {
       ?>
    ...
    <table class="ptl_tbl">
      ...
      <tr>
        <td><label>Purchase No.</label><input type="text" id="purchase_no" value="<?php echo $form_data['purchase_no'] ?>" name="purchase_no" class=" "  onkeyup="return form_submit();" autofocus=""></td>
    ...
    <form>
  	...
  	<div class="userlist-right">
  		<div class="btns">
               ...
               <?php if(in_array('1075',$users_data['permission']['action'])) {
               ?>
  			     <button class="btn-update" onclick="window.location.href='<?php echo base_url('vaccine_purchase/add'); ?>'">
               ...
               ?>
                ...
                <a href="<?php echo base_url('vaccine_purchase/vaccination_purchase_excel'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-excel-o"></i> Excel
                </a>

                <a href="<?php echo base_url('vaccine_purchase/vaccination_purchase_csv'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-word-o"></i> CSV
                </a>

                <a href="<?php echo base_url('vaccine_purchase/pdf_vaccination_purchase'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-pdf-o"></i> PDF
                </a>

                <!-- <a href="javascript:void(0)" class="btn-anchor m-b-2" id="deleteAll" onClick="return openPrintnewWindow('< ?php echo base_url("vaccine_purchase/print_vaccination_purchase"); ?>', 'windowTitle', 'width=820,height=600');">
                <i class="fa fa-print"></i> Print
                </a> -->

                 <a href="javascript:void(0)" class="btn-anchor m-b-2"  onClick="return print_window_page('<?php echo base_url("vaccine_purchase/print_vaccination_purchase"); ?>');"> <i class="fa fa-print"></i> Print</a>
               ...
               <?php } ?>
               <?php if(in_array('1080',$users_data['permission']['action'])) {
               ?>
  			     <button class="btn-update" onclick="window.location.href='<?php echo base_url('vaccine_purchase/archive'); ?>'">
...
function clear_form_elements(ele) {
   $.ajax({url: "<?php echo base_url();?>vaccine_purchase/reset_search/", 
      success: function(result)
      { 
...
function reset_search()
 ...
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('vaccine_purchase/delete/'); ?>"+id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
...
$('documnet').ready(function(){
 <?php if(isset($_GET['status']) && $_GET['status']=='print'){?>
  ...
  .one('click', '#cancel', function(e)
    { 
        window.location.href='<?php echo base_url('vaccine_purchase');?>'; 
    }) ;
...
function openPrintWindow(url, name, specs,id) {
    ...
    if(url==123){
          url12='< ?php echo base_url("vaccine_purchase/print_purchase_recipt"); ?>/'+name;
          //alert(url12);
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <!-- <a type="button" data-dismiss="modal" class="btn-anchor" id="delete" onClick="return openPrintnewWindow('< ?php echo base_url("vaccine_purchase/print_purchase_recipt"); ?>', 'windowTitle', 'width=820,height=600');" target="_blank">Print</a> -->

            <a  data-dismiss="modal" class="btn-anchor"  onClick="return print_window_page('<?php echo base_url("vaccine_purchase/print_purchase_recipt"); ?>');">Print</a>
...
$modal.load('<?php echo base_url().'vaccine_purchase/advance_search/' ?>',
{ 
},
function(){
$modal.modal('show');
