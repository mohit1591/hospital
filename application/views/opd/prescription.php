          ...
          <?php }*/ ?>
                ...
                <div class="row m-t-10">
                    ...
                    foreach ($prescription_medicine_tab_setting as $med_value) { ?>
                        ...
                        {
                        ?>
                        <td><input type="text" name="medicine_name[]"  class="" placeholder="Click to add Medicine" onkeyup="get_medicine_autocomplete(<?php echo $l; ?>);" id="medicine_name<?php echo $l; ?>" >
                        <input type="hidden" name="medicine_id[]" id="medicine_id1" value=""><p style="color:green" id="medicine_total"></p></td>
                        <?php 
                        }
                ...
                <input type="text" name="next_appointment_time" class="w-65px datepicker3 m_input_default" placeholder="Time" value="<?php echo $form_data['next_appointment_time']; ?>">
                    ...
                    <?php } ?>
                    <!--Ended By Nitin Sharma 03/02/2024-->
                        </div>
    ...
    {/*<a href="javascript:void(0)" class="btn-w-60 addprescriptionrow">Add</a>*/
      ...
      $.each(obj, function (index, value) {       
         pres += '<tr><?php foreach ($prescription_medicine_tab_setting as $tab_value) 
                        ...
                        if(strcmp(strtolower($tab_value->setting_name),'medicine')=='0')
                        {
                        ?><td><input type="text" name="medicine_name[]" onkeyup="get_medicine_autocomplete('+i+');" id="medicine_name'+i+'"  class="" value="'+obj[index].medicine_name+'" placeholder="Click to add Medicine"><input type="hidden" name="medicine_id[]"  value="'+obj[index].medicine_id+'" id="medicine_id'+i+'" ><p style="color:green" id="medicine_total"></p></td>                        <?php 
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'salt')=='0')
                        {
...
$(document).ready(function(){
    // Added By Nitin Sharma for add consultent
...
$(".addprescriptionrow").click(function(){ 
  ...
  var i=$('#prescription_name_table tr').length;
        $("#prescription_name_table").append('<tr><?php foreach ($prescription_medicine_tab_setting as $tab_value) 
                        ...
                        if(strcmp(strtolower($tab_value->setting_name),'medicine')=='0')
                        {
                        ?><td><input type="text" name="medicine_name[]" class="'+i+'" placeholder="Click to add Medicine" onkeyup="get_medicine_autocomplete('+i+');" id="medicine_name'+i+'"><input type="hidden" name="medicine_id[]" id="medicine_id'+i+'"><p  style="color:green" id="medicine_total'+i+'"></p></td>                        <?php 
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'salt')=='0')
                        {
    ...
    function get_medicine_bytemp()
         {
           ...
           var i=$('#prescription_name_table tr').length;
            ...
            if(strcmp(strtolower($tab_value->setting_name),'medicine')=='0')
            {
            ?><td><input type="text" name="medicine_name[]" class="'+i+'" onkeyup="get_medicine_autocomplete('+i+');" id="medicine_name'+i+'"><input type="hidden" name="medicine_id[]" id="medicine_id'+i+'"></td>                        <?php 
            }
            if(strcmp(strtolower($tab_value->setting_name),'brand')=='0')
            {
