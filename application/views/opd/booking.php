...
<body onLoad="set_tpa(<?php echo $form_data['pannel_type']; ?>) <?php if(empty($form_data['data_id']) && !empty($form_data['specialization_id']) && !empty($form_data['attended_doctor']) ){ ?> ,set_default_doct(<?php echo $form_data['specialization_id']; ?>, <?php echo $form_data['attended_doctor']; ?>) <?php } ?>">
...
<input type="hidden" name="patient_id" id="patient_id" value="<?php echo $form_data['patient_id']; ?>" id="patient_id"/>
    ...
    <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-8" id="opd_type">
           <input type="radio" name="opd_type" value="0" onclick="update_doctor_charges('0');get_unique_booking_code(this.value);" <?php if($form_data['opd_type']==0){ echo 'checked="checked"'; } ?>> Normal &nbsp;
            <input type="radio"  name="opd_type"  onclick="update_doctor_charges('1');get_unique_booking_code(this.value);" value="1" <?php if($form_data['opd_type']==1){ echo 'checked="checked"'; } ?>> <?php echo $charge_name = get_setting_value('DOCTOR_CHARGE_NAME');  ?>
 ...
 <div class="row m-b-5">
   ...
   <div class="col-md-8">
     <select class="mr m_mr alpha_space"  name="simulation_id" id="simulation_id" onchange="find_gender(this.value)">
        ...
        <input type="text" name="patient_name" id="patient_name" style="width:108px!important;" value="<?php echo $form_data['patient_name']; ?>" class="mr-name m_name txt_firstCap"  autofocus/>
    ...
    <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-8">
           ...
           <input type="text" maxlength="10" id="mobile_no" name="mobile_no"  data-toggle="tooltip"  title="Allow only numeric." class="tooltip-text tool_tip numeric number m_number" placeholder="eg.9897221234" value="<?php echo $form_data['mobile_no']; ?>" onkeyup="get_patient_detail_by_mobile();">
              <?php if(!empty($field_list)){
                         if($field_list[0]['mandatory_field_id']=='25' && $field_list[0]['mandatory_branch_id']==$users_data['parent_id']){
...
<?php } ?>
  ...
  <div class="row m-b-5">
    <div class="col-md-12">
       <div class="row">
         <div class="col-md-5"><b>Specialization<?php if(!empty($field_list)){
...
<script>
  function get_unique_booking_code(val)
  {
    ...
    var opd_type=  val
      $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>opd/get_emergency_booking_code/", 
  ...
  //neha 25-2-2019
    $(document).ready(function(){
        ...
        $("#proceed").click(function(){
            ...
            {
              var action_url = '<?php echo site_url('opd/booking/'); ?>'
