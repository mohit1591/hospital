...
//end of address
  ...
  $img_barcode = '<img class="barcode" alt="'.$all_detail['opd_list'][0]->booking_code.'" src="'.base_url('barcode.php').'?text='.$all_detail['opd_list'][0]->booking_code.'&codetype=code128&orientation=horizontal&size=20&print=true"/>'; ;
