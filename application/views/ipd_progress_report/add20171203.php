                ...
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        ...
                        <div class="row m-b-5 m-b-5">
                            <div class="col-xs-4"><strong>Pateint Reg. No.</strong></div>
                            <div class="col-xs-8">
                                <input type="text"  name="patient_code" value="<?php echo $form_data['patient_code']; ?>">
                            </div>
                        </div>
                        <div class="row m-b-5">
                            <div class="col-xs-4"><strong>Pateint Name</strong></div>
                            <div class="col-xs-8">
                    ...
                    <div class="col-xs-5">
                        ...
                        <label><b>Date</b></label></div>
                            <div class="col-xs-8">
                            <input type="text" name="report_date" id="report_date" class="" value="<?php echo $form_data['report_date']; ?>">
                            <input type="text" name="report_time" id="report_time" class="input-tiny" value="<?php echo $form_data['report_time']; ?>">
                     </div>
                        </div>
