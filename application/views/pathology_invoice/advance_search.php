                ...
                ?> 
                      ...
                      <div class="inner">
                        ...
                        <div class="grp">
                          ...
                          <input type="text" name="lab_invoice_no" id="lab_invoice_no" value="<?php echo $form_data['lab_invoice_no']; ?>" >
                        </div>
                      <?php
                      if($users_data['users_role']==1 || $users_data['users_role']==2)
                      {
                    ...
                    ?>      
                        ...
                        <div class="grp">
                          ...
                          <div class="rslt">
                            <input type="radio" name="complation_status" value="1" <?php if(isset($form_data['complation_status']) && $form_data['complation_status']==1){ echo 'checked="checked"'; } ?>> Confirmed &nbsp;
