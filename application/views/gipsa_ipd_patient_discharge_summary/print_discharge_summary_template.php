...
if($test_list!=""){
    $template_data = str_replace("{investigation}",$test_list,$template_data);
}
else{
     $template_data = str_replace("{investigation}",'',$template_data);
}
    /************Investigation Detail *************/
   ...
   // echo "<pre>";print_r($discharge_labels_setting_list); exit;
    ...
    if(strcmp(strtolower($value['setting_name']),'cheif_complaints')=='0')
    {
        ...
        if(!empty($value['setting_value'])) { $cheif_complaints_name =  $value['setting_value']; } else { $cheif_complaints_name =  $value['var_title']; }
            ...
            $chief_complaints.= '<div style="float:left;width:100%;margin:1em 0 0;">
              <div style="font-size:small;line-height:18px;"><b>'.$cheif_complaints_name.' :</b><br>
    ...
    {   
        ...
        $on_examination = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;"><b>'.$on_examination_name.':</b><br>
...
if(strcmp(strtolower($value['setting_name']),'past_history')=='0')
   ...
   /* if(strcmp(strtolower($value['setting_name']),'vitals')=='0')
    ...
    if(strcmp(strtolower($value['setting_name']),'ho_past_illness')=='0')
              {
               if(!empty($value['setting_value'])) { $ho_past_illness_name =  $value['setting_value']; } else { $ho_past_illness_name =  $value['var_title']; }
               if(!empty($all_detail['discharge_list'][0]->h_o_past)){ 
                $ho_past_illness = '<div style="float:left;width:100%;margin:1em 0 0;">
                <div style="font-size:small;line-height:18px;"><b>'.$ho_past_illness_name.':</b><br>
                '.nl2br($all_detail['discharge_list'][0]->h_o_past).'
                </div>
                </div>';
                 }
              ...
              {
                if(!empty($value['setting_value'])) { $ho_any_allergy_name =  $value['setting_value']; } else { $ho_any_allergy_name =  $value['var_title']; }
               if(!empty($all_detail['discharge_list'][0]->ho_any_allergy)){ 
                $ho_any_allergy = '<div style="float:left;width:100%;margin:1em 0 0;">
                <div style="font-size:small;line-height:18px;"><b>'.$ho_any_allergy_name.':</b><br>
                '.nl2br($all_detail['discharge_list'][0]->ho_any_allergy).'
                </div>
                </div>';
                 } 
              ...
              {
                if(!empty($value['setting_value'])) { $admission_reason_name =  $value['setting_value']; } else { $admission_reason_name =  $value['var_title']; }
               if(!empty($all_detail['discharge_list'][0]->admission_reason)){ 
                $admission_reason = '<div style="float:left;width:100%;margin:1em 0 0;">
                <div style="font-size:small;line-height:18px;"><b>'.$admission_reason_name.':</b><br>
                '.nl2br($all_detail['discharge_list'][0]->admission_reason).'
                </div>
                </div>';
                 }
              ...
              {
                if(!empty($value['setting_value'])) { $procedure_performedand_name =  $value['setting_value']; } else { $procedure_performedand_name =  $value['var_title']; }
               if(!empty($all_detail['discharge_list'][0]->procedure_performedand)){ 
                $procedure_performedand = '<div style="float:left;width:100%;margin:1em 0 0;">
                <div style="font-size:small;line-height:18px;"><b>'.$procedure_performedand_name.':</b><br>
                '.nl2br($all_detail['discharge_list'][0]->procedure_performedand).'
                </div>
                </div>';
                 } 
                ...
                if(strcmp(strtolower($value['setting_name']),'family_history')=='0')
              {
               ...
               if(!empty($all_detail['discharge_list'][0]->family_history)){ 
                ...
                <div style="font-size:small;line-height:18px;"><b>'.$family_history_name.':</b><br>
              ...
              {
                if(!empty($value['setting_value'])) { $alcohol_history_name =  $value['setting_value']; } else { $alcohol_history_name =  $value['var_title']; }
               if(!empty($all_detail['discharge_list'][0]->alcohol_history)){ 
                $alcohol_history = '<div style="float:left;width:100%;margin:1em 0 0;">
                <div style="font-size:small;line-height:18px;"><b>'.$alcohol_history_name.':</b><br>
                '.nl2br($all_detail['discharge_list'][0]->alcohol_history).'
                </div>
                </div>';
                 }
              ...
              {
                if(!empty($value['setting_value'])) { $nutritional_advice_name =  $value['setting_value']; } else { $nutritional_advice_name =  $value['var_title']; }
               if(!empty($all_detail['discharge_list'][0]->nutritional_advice)){ 
                $nutritional_advice = '<div style="float:left;width:100%;margin:1em 0 0;">
                <div style="font-size:small;line-height:18px;"><b>'.$nutritional_advice_name.':</b><br>
                '.nl2br($all_detail['discharge_list'][0]->nutritional_advice).'
                </div>
                </div>';
                 }
                ...
                if(strcmp(strtolower($value['setting_name']),'icd_code')=='0')
              {
                ...
                if(!empty($value['setting_value'])) { $icd_code_name =  $value['setting_value']; } else { $icd_code_name =  $value['var_title']; }
               if(!empty($all_detail['discharge_list'][0]->icd_code)){ 
                $icd_code = '<div style="float:left;width:100%;margin:1em 0 0;">
                <div style="font-size:small;line-height:18px;"><b>'.$icd_code_name.':</b><br>
                '.nl2br($all_detail['discharge_list'][0]->icd_code).'
                </div>
                </div>';
                 }
              ...
              {
                if(!empty($value['setting_value'])) { $consultants =  $value['setting_value']; } else { $consultants =  $value['var_title']; }
               if(!empty($all_detail['discharge_list'][0]->consultants_name)){ 
                $consultants_name = '<div style="float:left;width:100%;margin:1em 0 0;">
                <div style="font-size:small;line-height:18px;"><b>'.$consultants.':</b><br>
                '.nl2br($all_detail['discharge_list'][0]->consultants_name).'
                </div>
                </div>';
                 }
    ...
    if(strcmp(strtolower($value['setting_name']),'final_diagnosis')=='0')
    {
        ...
        $final_diagnosis = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;"><br>
    ...
    { 
        ...
        $course_in_hospital = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;">
            <b>'.$course_in_hospital_name.' :</b><br>
    ...
    { 
        ...
        $condition_at_discharge_time = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;">
            <b>'.$discharge_time_condition_name.' :</b><br>
    ...
    { 
        ...
        $advise_on_discharge = '<div style="float:left;width:100%;margin:1em 0 0;">
          <div style="font-size:small;line-height:18px;">
            <b>'.$discharge_time_condition_name.' :</b><br>
...
//seprated vitals
    ...
    $template_data = str_replace("{advise_on_discharge}",$advise_on_discharge,$template_data);
    ...
    $template_data = str_replace("{medical_history}",$all_detail['medicine_list'][0]->medicine_name,$template_data);
