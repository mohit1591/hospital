...
<form id="prescription_setting_form">
    ...
    ?>
      ...
      <div class="col-xs-12 m-b-5 m12">
        <div class="row">
          ...
          <div class="col-xs-3">
          <?php if($setting_list->setting_name=='ADVANCE_EYE_PRESCRIPTION_REPORT_PRINT_SETTING') { ?>
          </div>
        </div>
    ...
    <!--neha 14-2-2019 end-->
      ...
      <!--Divya 13-6-2019 start-->
      <div  class="row">
        <div class="col-xs-2" style="padding-top:0.7%; padding-bottom:0.4%;"><b>Doctor Signature Text</b></div>
        <div class="col-xs-5" style="padding-top:0.9%; padding-bottom:0.4%;">
          <input type="checkbox" name="signature_text" <?php if($setting_list->doctor_signature_text==1){ echo 'checked="checked"'; } ?> value="1" /> 
      ...
      <div  class="row m-b-5">
        ...
        <div class="col-xs-8">
          <div style="margin-left:-1.2%;padding-right: 4.8em;">
            <textarea readonly="" class="form-control" cols="" rows="6">{patient_reg_no},{patient_name},{patient_age},{mobile_no},{booking_date},{app_id},{doctor_name},{prescription_data},{signature_report_data},{ref_doctor},{ref_mobile},{ref_address}. </textarea>
...
for (instance in CKEDITOR.instances) {
  ...
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>advance_eye_report_setting/",
    type: "post",
    data: $(this).serialize(),
