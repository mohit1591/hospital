	...
	<section style="float:left;width:100%;">
			<div style="float:left;width:48.5%;padding:0px 5px;color:<?php echo $exam_conjtv['examnsn_conjtv_l_update'];?>">
				...
				<strong style="float:left;width:100%;">CONJUNCTIVA: </strong>
				    <?php 
				    //echo $exam_conjtv['examnsn_conjtv_l_consn_sub']; die;
...
if($form_data['diagnosis_flag']==1){
	...
	<?php } ?>
      ...
      <?php } }  //echo $advice_comm['planmanagement']; die;
      if(!empty(trim($advice_comm['planmanagement']))){ ?>
      	 <hr style="margin: 2px !important;">
...
<?php  if(!empty($advice_medication)){
 ...
 ?>
		...
		<?php if(!empty($advice_adv)){ if(!empty($advice_adv['doctor_name'])){ ?>
			<span><b>For Followup :</b> - Visit <b><?php  echo 'Dr. '.$advice_adv['doctor_name'];?></b> <?php if(!empty($advice_adv['days'])){ echo 'after '.$advice_adv['days'].' Days'; }?>  </span>
		<?php } } if(!empty($advice_referral)){ 
			foreach ($advice_referral as $key => $referral) { ?>
			<br><span><?php if(!empty($referral->doctor)){ ?><b>For Referral :</b> - Visit <b><?php  echo 'Dr. '.$referral->doctor; ?></b> at <b> <?php echo $referral->location.' on '; ?></b>  <b><?php if(!empty($referral->date)) { echo date('D M d, Y', strtotime($referral->date));} ?></b>
	...
	if(!empty($advice_adv)){ if(!empty($advice_adv['advice_txt'])){ ?>
			<span><b>Advice :</b> <?php  echo $advice_adv['advice_txt'];?></span>
		<?php } } ?>
