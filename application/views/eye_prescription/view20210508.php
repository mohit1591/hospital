...
<body style="font:12px 'Arial';">
	<page size="A4">
	  ...
	  <?php } ?>
		<ul style="list-style:none;margin:5px 0 0px;padding:0px;font-size:13px;">
			<?php if($history_radios_data['general_checkup'] > 0){?>
			<li style=""> <strong>Visit:</strong> <?php if($history_radios_data['general_checkup']==1){ echo ' General Checkup, ';}else if($history_radios_data['general_checkup']==2){ echo 'Routine Checkup, ';} else if($history_radios_data['general_checkup']==3){ echo 'PostOp Checkup, ';} echo $history['visit_comm'] ; ?></li>

			<?php } if($chief_complaints['bdv_m']==1){?>
			<li style=""> Blurring/Diminution of vision in <strong> <?php if(!empty($chief_complaints['history_chief_blurr_side'])){ echo $chief_complaints['history_chief_blurr_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_blurr_dur'])){ echo 'since '.$chief_complaints['history_chief_blurr_dur'].' ';} if(!empty($chief_complaints['history_chief_blurr_unit'])){ echo $chief_complaints['history_chief_blurr_unit'];}if(!empty($chief_complaints['history_chief_blurr_comm'])){ echo ' - '.$chief_complaints['history_chief_blurr_comm'];} if($chief_complaints['history_chief_blurr_dist']==1){echo ' - Distant, ';}if($chief_complaints['history_chief_blurr_near']==1){echo ' Near,';}if($chief_complaints['history_chief_blurr_pain']==1){echo ' Pain and ';}if($chief_complaints['history_chief_blurr_ug']==1){echo ' Using Glasses, ';}?>  </li>
		<?php } if($chief_complaints['pain_m']==1){?></strong>
			<li style=""> Pain in <strong> <?php if(!empty($chief_complaints['history_chief_pains_side'])){ echo $chief_complaints['history_chief_pains_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_pains_dur'])){ echo 'since '.$chief_complaints['history_chief_pains_dur'].' ';} if(!empty($chief_complaints['history_chief_pains_unit'])){ echo $chief_complaints['history_chief_pains_unit'];}if(!empty($chief_complaints['history_chief_pains_comm'])){ echo ' - '.$chief_complaints['history_chief_pains_comm'].', ';}?>
				</strong></li>
		<?php } if($chief_complaints['redness_m']==1){?>
			<li style=""> Redness in  <strong> 
				<?php if(!empty($chief_complaints['history_chief_rednes_side'])){ echo $chief_complaints['history_chief_rednes_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_rednes_dur'])){ echo 'since '.$chief_complaints['history_chief_rednes_dur'].' ';} if(!empty($chief_complaints['history_chief_rednes_unit'])){ echo $chief_complaints['history_chief_rednes_unit'];}if(!empty($chief_complaints['history_chief_rednes_comm'])){ echo ' - '.$chief_complaints['history_chief_rednes_comm'].', ';}?>
					</strong>  </li>
		<?php } if($chief_complaints['injury_m']==1){?>
			<li style=""> Injury in  <strong>
			<?php if(!empty($chief_complaints['history_chief_injuries_side'])){ echo $chief_complaints['history_chief_injuries_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_injuries_dur'])){ echo 'since '.$chief_complaints['history_chief_injuries_dur'].' ';} if(!empty($chief_complaints['history_chief_injuries_unit'])){ echo $chief_complaints['history_chief_injuries_unit'];}if(!empty($chief_complaints['history_chief_injuries_comm'])){ echo ' - '.$chief_complaints['history_chief_injuries_comm'].', ';}?>
			</strong>  </li>
		<?php } if($chief_complaints['water_m']==1){?>
			<li style=""> Watering in  <strong>
			<?php if(!empty($chief_complaints['history_chief_waterings_side'])){ echo $chief_complaints['history_chief_waterings_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_waterings_dur'])){ echo 'since '.$chief_complaints['history_chief_waterings_dur'].' ';} if(!empty($chief_complaints['history_chief_waterings_unit'])){ echo $chief_complaints['history_chief_waterings_unit'];}if(!empty($chief_complaints['history_chief_waterings_comm'])){ echo ' - '.$chief_complaints['history_chief_waterings_comm'].', ';}?>
			</strong>  </li>
		<?php } if($chief_complaints['discharge_m']==1){?>
			<li style=""> Discharge in  <strong> 
				<?php if(!empty($chief_complaints['history_chief_discharges_side'])){ echo $chief_complaints['history_chief_discharges_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_discharges_dur'])){ echo 'since '.$chief_complaints['history_chief_discharges_dur'].' ';} if(!empty($chief_complaints['history_chief_discharges_unit'])){ echo $chief_complaints['history_chief_discharges_unit'];}if(!empty($chief_complaints['history_chief_discharges_comm'])){ echo ' - '.$chief_complaints['history_chief_discharges_comm'].', ';}?>
					
				</strong>  </li>
		<?php } if($chief_complaints['dryness_m']==1){?>
			<li style=""> Dryness in  <strong>
				<?php if(!empty($chief_complaints['history_chief_dryness_side'])){ echo $chief_complaints['history_chief_dryness_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_dryness_dur'])){ echo 'since '.$chief_complaints['history_chief_dryness_dur'].' ';} if(!empty($chief_complaints['history_chief_dryness_unit'])){ echo $chief_complaints['history_chief_dryness_unit'];}if(!empty($chief_complaints['history_chief_dryness_comm'])){ echo ' - '.$chief_complaints['history_chief_dryness_comm'].', ';}?>
					</strong>  </li>
		<?php } if($chief_complaints['itch_m']==1){?>
			<li style=""> Itching in  <strong> 
				<?php if(!empty($chief_complaints['history_chief_itchings_side'])){ echo $chief_complaints['history_chief_itchings_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_itchings_dur'])){ echo 'since '.$chief_complaints['history_chief_itchings_dur'].' ';} if(!empty($chief_complaints['history_chief_itchings_unit'])){ echo $chief_complaints['history_chief_itchings_unit'];}if(!empty($chief_complaints['history_chief_itchings_comm'])){ echo ' - '.$chief_complaints['history_chief_itchings_comm'].', ';}?>
				</strong>  </li>
		<?php } if($chief_complaints['fbd_m']==1){?>
			<li style=""> Fbsensation in  <strong>
				<?php if(!empty($chief_complaints['history_chief_fbsensation_side'])){ echo $chief_complaints['history_chief_fbsensation_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_fbsensation_dur'])){ echo 'since '.$chief_complaints['history_chief_fbsensation_dur'].' ';} if(!empty($chief_complaints['history_chief_fbsensation_unit'])){ echo $chief_complaints['history_chief_fbsensation_unit'];}if(!empty($chief_complaints['history_chief_fbsensation_comm'])){ echo ' - '.$chief_complaints['history_chief_fbsensation_comm'].', ';}?>
			   </strong>  </li>
		<?php } if($chief_complaints['devs_m']==1){?>	
			<li style=""> Deviation Squint in  <strong>
				<?php if(!empty($chief_complaints['history_chief_dev_squint_side'])){ echo $chief_complaints['history_chief_dev_squint_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_dev_squint_dur'])){ echo 'since '.$chief_complaints['history_chief_dev_squint_dur'].' ';} if(!empty($chief_complaints['history_chief_dev_squint_unit'])){ echo $chief_complaints['history_chief_dev_squint_unit'];}if(!empty($chief_complaints['history_chief_dev_squint_comm'])){ echo ' - '.$chief_complaints['history_chief_dev_squint_comm'];}
		...
		<?php } if($chief_complaints['heads_m']==1){?>
			<li style=""> Headache Strain in  <strong>
				<?php if(!empty($chief_complaints['history_chief_head_strain_side'])){ echo $chief_complaints['history_chief_head_strain_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_head_strain_dur'])){ echo 'since '.$chief_complaints['history_chief_head_strain_dur'].' ';} if(!empty($chief_complaints['history_chief_head_strain_unit'])){ echo $chief_complaints['history_chief_head_strain_unit'];}if(!empty($chief_complaints['history_chief_head_strain_comm'])){ echo ' - '.$chief_complaints['history_chief_head_strain_comm'].', ';}?>
				</strong>  </li>
		<?php } if($chief_complaints['canss_m']==1){?>
			<li style=""> Change In Size Shape in  <strong>
				<?php if(!empty($chief_complaints['history_chief_size_shape_side'])){ echo $chief_complaints['history_chief_size_shape_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_size_shape_dur'])){ echo 'since '.$chief_complaints['history_chief_size_shape_dur'].' ';} if(!empty($chief_complaints['history_chief_size_shape_unit'])){ echo $chief_complaints['history_chief_size_shape_unit'];}if(!empty($chief_complaints['history_chief_size_shape_comm'])){ echo ' - '.$chief_complaints['history_chief_size_shape_comm'].', ';}?>
				</strong>  </li>
		<?php } if($chief_complaints['ovs_m']==1){?>
			<li style=""> Other Visual Symptoms in <strong>  
				<?php if(!empty($chief_complaints['history_chief_ovs_side'])){ echo $chief_complaints['history_chief_ovs_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_ovs_dur'])){ echo 'since '.$chief_complaints['history_chief_ovs_dur'].' ';} if(!empty($chief_complaints['history_chief_ovs_unit'])){ echo $chief_complaints['history_chief_ovs_unit'];}if(!empty($chief_complaints['history_chief_ovs_comm'])){ echo ' - '.$chief_complaints['history_chief_ovs_comm'];}
		...
		<?php } if($chief_complaints['sdv_m']==1){?>
			<li style=""> Shadow Defect In Vision in  <strong>
				<?php if(!empty($chief_complaints['history_chief_sdiv_side'])){ echo $chief_complaints['history_chief_sdiv_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_sdiv_dur'])){ echo 'since '.$chief_complaints['history_chief_sdiv_dur'].' ';} if(!empty($chief_complaints['history_chief_sdiv_unit'])){ echo $chief_complaints['history_chief_sdiv_unit'];}if(!empty($chief_complaints['history_chief_sdiv_comm'])){ echo ' - '.$chief_complaints['history_chief_sdiv_comm'].', ';}?>
				</strong>  </li>
		<?php } if($chief_complaints['doe_m']==1){?>
			<li style=""> Discoloration Of Eye in  <strong>
				<?php if(!empty($chief_complaints['history_chief_doe_side'])){ echo $chief_complaints['history_chief_doe_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_doe_dur'])){ echo 'since '.$chief_complaints['history_chief_doe_dur'].' ';} if(!empty($chief_complaints['history_chief_doe_unit'])){ echo $chief_complaints['history_chief_doe_unit'];}if(!empty($chief_complaints['history_chief_doe_comm'])){ echo ' - '.$chief_complaints['history_chief_doe_comm'].', ';}?>
					
				</strong>  </li>
		<?php } if($chief_complaints['swel_m']==1){?>
			<li style=""> Swelling in  <strong>
				<?php if(!empty($chief_complaints['history_chief_swell_side'])){ echo $chief_complaints['history_chief_swell_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_swell_dur'])){ echo 'since '.$chief_complaints['history_chief_swell_dur'].' ';} if(!empty($chief_complaints['history_chief_swell_unit'])){ echo $chief_complaints['history_chief_swell_unit'];}if(!empty($chief_complaints['history_chief_swell_comm'])){ echo ' - '.$chief_complaints['history_chief_swell_comm'].', ';}?>
				</strong>  </li>
		<?php } if($chief_complaints['burns_m']==1){?>
			<li style=""> Sensation Burning in  <strong>
				<?php if(!empty($chief_complaints['history_chief_sen_burn_side'])){ echo $chief_complaints['history_chief_sen_burn_side'].' Eye ';}?></strong>    <strong> <?php if(!empty($chief_complaints['history_chief_sen_burn_dur'])){ echo 'since '.$chief_complaints['history_chief_sen_burn_dur'].' ';} if(!empty($chief_complaints['history_chief_sen_burn_unit'])){ echo $chief_complaints['history_chief_sen_burn_unit'];}if(!empty($chief_complaints['history_chief_sen_burn_comm'])){ echo ' - '.$chief_complaints['history_chief_sen_burn_comm'].', ';}?>
				</strong>  </li>
		<?php } if($chief_complaints['history_chief_comm'] !=''){?>
			<li style="margin-top:8px;">  <strong> <?php echo '- ' .$chief_complaints['history_chief_comm'];?></strong>  </li>
		<?php }?>	

		<?php if($ophthalmic['gla_m']==1){?>
			<li style=""> Known cases of Glaucoma <strong>
				<?php if(!empty($ophthalmic['history_ophthalmic_glau_l_dur'])){ echo 'Left Eye since '.$ophthalmic['history_ophthalmic_glau_l_dur'].' '.$ophthalmic['history_ophthalmic_glau_l_unit'];}?></strong> <strong> <?php if(!empty($ophthalmic['history_ophthalmic_glau_r_dur'])){ echo ' & Right Eye since '.$ophthalmic['history_ophthalmic_glau_r_dur'].' '.$ophthalmic['history_ophthalmic_glau_r_unit'];} if(!empty($ophthalmic['history_ophthalmic_glau_comm'])){ echo ' - '.$ophthalmic['history_ophthalmic_glau_comm'].', ';}?>
			</strong></li>
		<?php } if($ophthalmic['reti_m']==1){?>
			<li style=""> Retinal Detachment <strong>
				<?php if(!empty($ophthalmic['history_ophthalmic_renti_d_l_dur'])){ echo 'Left Eye since '.$ophthalmic['history_ophthalmic_renti_d_l_dur'].' '.$ophthalmic['history_ophthalmic_renti_d_l_unit'];}?></strong> <strong> <?php if(!empty($ophthalmic['history_ophthalmic_renti_d_r_dur'])){ echo ' & Right Eye since '.$ophthalmic['history_ophthalmic_renti_d_r_dur'].' '.$ophthalmic['history_ophthalmic_renti_d_r_unit'];} if(!empty($ophthalmic['history_ophthalmic_renti_d_comm'])){ echo ' - '.$ophthalmic['history_ophthalmic_renti_d_comm'].', ';}?>
		<?php } if($ophthalmic['glass_m']==1){?>
			<li style=""> Glasses <strong>
				<?php if(!empty($ophthalmic['history_ophthalmic_glas_l_dur'])){ echo 'Left Eye since '.$ophthalmic['history_ophthalmic_glas_l_dur'].' '.$ophthalmic['history_ophthalmic_glas_l_unit'];}?></strong> <strong> <?php if(!empty($ophthalmic['history_ophthalmic_glas_r_dur'])){ echo ' & Right Eye since '.$ophthalmic['history_ophthalmic_glas_r_dur'].' '.$ophthalmic['history_ophthalmic_glas_r_unit'];} if(!empty($ophthalmic['history_ophthalmic_glas_comm'])){ echo ' - '.$ophthalmic['history_ophthalmic_glas_comm'].', ';}?>
				</strong></li>
		<?php } if($ophthalmic['eyedi_m']==1){?>
			<li style=""> Eye Disease <strong>
				<?php if(!empty($ophthalmic['history_ophthalmic_eye_d_l_dur'])){ echo 'Left Eye since '.$ophthalmic['history_ophthalmic_eye_d_l_dur'].' '.$ophthalmic['history_ophthalmic_eye_d_l_unit'];}?></strong> <strong> <?php if(!empty($ophthalmic['history_ophthalmic_eye_d_r_dur'])){ echo ' & Right Eye since '.$ophthalmic['history_ophthalmic_eye_d_r_dur'].' '.$ophthalmic['history_ophthalmic_eye_d_r_unit'];} if(!empty($ophthalmic['history_ophthalmic_eye_d_comm'])){ echo ' - '.$ophthalmic['history_ophthalmic_eye_d_comm'].', ';}?>
				</strong></li>
		<?php } if($ophthalmic['eyesu_m']==1){?>
			<li style=""> Eye Surgery <strong> 
				<?php if(!empty($ophthalmic['history_ophthalmic_eye_s_l_dur'])){ echo 'Left Eye since '.$ophthalmic['history_ophthalmic_eye_s_l_dur'].' '.$ophthalmic['history_ophthalmic_eye_s_l_unit'];}?></strong> <strong> <?php if(!empty($ophthalmic['history_ophthalmic_eye_s_r_dur'])){ echo ' & Right Eye since '.$ophthalmic['history_ophthalmic_eye_s_r_dur'].' '.$ophthalmic['history_ophthalmic_eye_s_r_unit'];} if(!empty($ophthalmic['history_ophthalmic_eye_s_comm'])){ echo ' - '.$ophthalmic['history_ophthalmic_eye_s_comm'].', ';}?>
			</strong></li>
		<?php } if($ophthalmic['uve_m']==1){?>
			<li style=""> Uveitis <strong>
				<?php if(!empty($ophthalmic['history_ophthalmic_uvei_l_dur'])){ echo 'Left Eye since '.$ophthalmic['history_ophthalmic_uvei_l_dur'].' '.$ophthalmic['history_ophthalmic_uvei_l_unit'];}?></strong> <strong> <?php if(!empty($ophthalmic['history_ophthalmic_uvei_r_dur'])){ echo ' & Right Eye since '.$ophthalmic['history_ophthalmic_uvei_r_dur'].' '.$ophthalmic['history_ophthalmic_uvei_r_unit'];} if(!empty($ophthalmic['history_ophthalmic_uvei_comm'])){ echo ' - '.$ophthalmic['history_ophthalmic_uvei_comm'].', ';}?>
			</strong></li>
		<?php } if($ophthalmic['retil_m']==1){?>
			<li style=""> Retinal Laser <strong>
			<?php if(!empty($ophthalmic['history_ophthalmic_renti_l_l_dur'])){ echo 'Left Eye since '.$ophthalmic['history_ophthalmic_renti_l_l_dur'].' '.$ophthalmic['history_ophthalmic_renti_l_l_unit'];}?></strong> <strong> <?php if(!empty($ophthalmic['history_ophthalmic_renti_l_r_dur'])){ echo ' & Right Eye since '.$ophthalmic['history_ophthalmic_renti_l_r_dur'].' '.$ophthalmic['history_ophthalmic_renti_l_r_unit'];} if(!empty($ophthalmic['history_ophthalmic_renti_l_comm'])){ echo ' - '.$ophthalmic['history_ophthalmic_renti_l_comm'].', ';}?> 
			</strong></li>
		<?php } if($ophthalmic['history_ophthalmic_comm'] !=''){?>
			<li style="margin-top:8px;"> <strong> <?php echo $ophthalmic['history_ophthalmic_comm'];?></strong> </li>
		<?php }?>
	
		<?php if($systemic['dia_m']==1){?>
		<li style=""> Diabetes <strong>
		...
		<li style=""> Smoking Tobacco   <strong><?php if(!empty($systemic['history_systemic_smokt_dur'])){ echo 'since '.$systemic['history_systemic_smokt_dur'].' '.$systemic['history_systemic_smokt_unit'];} if(!empty($systemic['history_systemic_smokt_comm'])){ echo ' - '.$systemic['history_systemic_smokt_comm'].', ';}?>
			
		</strong></li>
		<?php } if($systemic['card_m']==1){?>
		<li style=""> Cardiac Disorder   <strong>
		...
		<li style=""> Steroid Intake   <strong>
		...
		<li style=""> Cns Disorder Stroke   <strong>
		...
		<li style=""> Hypothyroidism   <strong>
		...
		<li style=""> Hyperthyroidism   <strong>
		...
		<li style=""> Hepatitis Cirrhosis   <strong>
		...
		<li style=""> Renal Disorder   <strong>
		...
		<li style=""> On Aspirin Blood Thinners   <strong>
		...
		<li style=""> Thyroid Disorder   <strong>
		...
		<li style=""> Chewing Tobacco   <strong>
		...
		<?php } if($systemic['history_systemic_comm'] !=''){?>
			...
			<li style="margin-top:8px;">  <strong> <?php echo $systemic['history_systemic_comm'];?> </strong> </li>
		<?php }?>

		<?php if($history['family'] !=''){?>
			<li style="">  <strong> <?php echo 'Family history of '.$history['family'];?></strong>  </li>
		<?php } if($history['medical'] !=''){?>
			<li style="">  <strong> <?php echo 'Medical history of '.$history['medical'];?></strong>  </li>
		<?php }?>

		<?php if($drug_allergies['antimi_agen_m']==1){?>
			<?php if($drug_allergies['ampic_m']==1){?>
				<li style=""> Ampicillin since  <strong>
			...
			<?php } if($drug_allergies['amox_m']==1){?>
				<li style=""> Amoxicillin since  <strong>
			...
			<li style=""> Ceftriaxone since  <strong> 
			...
			<li style=""> Ciprofloxacin since  <strong>
			...
			<li style=""> Clarithromycin since  <strong>
			...
			<li style=""> Co Trimoxazole since  <strong>
			...
			<li style=""> Ethambutol since  <strong>
			...
			<li style=""> Isoniazid since  <strong>
			...
			<li style=""> Metronidazole since  <strong>
			...
			<li style=""> Penicillin since  <strong>
			...
			<li style=""> Rifampicin since  <strong>
			...
			<li style=""> Streptomycin since  <strong>
		...
		<?php if($drug_allergies['antif_agen_m']==1){?>
			<?php if($drug_allergies['ketoc_m']==1){?>
				<li style=""> Ketoconazole since  <strong>
			...
			<?php } if($drug_allergies['fluco_m']==1){?>
				<li style=""> Fluconazole since  <strong>
			...
			<li style=""> Itraconazole since  <strong>
		...
		<?php if($drug_allergies['ant_agen_m']==1){?>
			<?php if($drug_allergies['acyclo_m']==1){?>
				<li style=""> Acyclovir since  <strong> 
			...
			<?php } if($drug_allergies['efavir_m']==1){?>
				<li style=""> Efavirenz since  <strong>
			...
			<li style=""> Enfuvirtide since  <strong>
			...
			<li style=""> Nelfinavir since  <strong>
			...
			<li style=""> Nevirapine since  <strong>
		...
		<?php if($drug_allergies['nsaids_m']==1){?>
			...
			<?php } if($drug_allergies['paracet_m']==1){?>
				<li style=""> Paracetamol since  <strong>
			...
			<li style=""> Ibuprofen since  <strong> 
			...
			<li style=""> Diclofenac since  <strong>
			...
			<li style=""> Aceclofenac since  <strong>
			...
			<li style=""> Naproxen since  <strong>
		...
		<?php if($drug_allergies['eye_drops_m']==1){?>
			<?php if($drug_allergies['tropip_m']==1){?>
				<li style=""> Tropicamide P since  <strong>
			...
			<?php } if($drug_allergies['tropi_m']==1){?>
				<li style=""> Tropicamide since  <strong>
			...
			<li style=""> Brimonidine since  <strong>
			...
			<li style=""> Latanoprost since  <strong>
			...
			<?php } if($drug_allergies['travo_m']==1){?>
				<li style=""> Travoprost since  <strong>
			...
			<li style=""> Tobramycin since  <strong>
			...
			<li style=""> Moxifloxacin since  <strong>
			...
			<li style=""> Homatropine since  <strong>
			...
			<li style=""> Pilocarpine since  <strong> 
			...
			<?php } if($drug_allergies['cyclop_m']==1){?>
				<li style=""> Cyclopentolate since  <strong>
			...
			<li style=""> Atropine since  <strong> 
			...
			<li style=""> Phenylephrine since  <strong> 
			...
			<li style=""> Tropicacyl since  <strong> 
			...
			<li style=""> Paracain since  <strong> 
		...
		<li style=""> Allergic to Alcohal since  <strong>
		...
		<?php } if($contact_allergies['betad_m']==1){?>
			<li style=""> Betadine since  <strong>
		...
		<?php } if($contact_allergies['adhes_m']==1){?>
			<li style=""> Adhesive Tape since  <strong>
		...
		<?php } if($contact_allergies['tegad_m']==1){?>
			<li style=""> Tegaderm since  <strong>
		...
		<?php } if($contact_allergies['trans_m']==1){?>
			<li style=""> Transpore since  <strong>
		...
		<li style=""> All Seafood since  <strong>
		...
		<?php } if($food_allergies['milk_m']==1){?>
			<li style=""> Milk Proteins since  <strong>
		...
		<?php } if($food_allergies['shell_m']==1){?>
			<li style=""> Shellfish Only since  <strong>
		...
		<?php } if($food_allergies['soy_m']==1){?>
			<li style=""> Soy Protein since  <strong>
		...
		<?php } if($food_allergies['mush_m']==1){?>
			<li style=""> Mushroom since  <strong>
		...
		<?php } if($food_allergies['history_food_comm'] !=''){?>
			...
			<li style="margin-top:8px;">  <strong> <?php echo ' - '.$food_allergies['history_food_comm'].', ';?>  </strong></li>
		<?php }?>
        ...
        if($his==1){?>	
		<strong style="float:left;width:100%;">VITAL SIGNS/ ANTHROPOMETRY</strong>
		<hr style="margin: 2px !important;">
		...
		<section style="float:left;width:100%;">
			<strong style="float:left;width:100%;margin-top: 150px;">CONTACT LENS PRESCRIPTIONS</strong>
		      <hr style="margin: 2px !important;">
			<div style="float:left;width:48.5%;padding:0px 5px;">
				<div style="text-align:center;background:#ddd;padding:3px;">R/OD</div>
				<table border="1" cellpadding="0" cellspacing="0" width="100%" style=";font-size:12px;border-collapse:collapse;">
					<tr>
				...
				<table width="100%" style="font-size:11px">
					<tr>
						...
						<td style="padding:3px;" valign="top">Color : <strong><?php echo $refrtsn_cntct_lns['refraction_clp_l_clr'];?> </strong></td>
						<?php } if(!empty($refrtsn_cntct_lns['refraction_clp_l_tp'])){?>
						<td style="padding:3px;" valign="top">Type : <strong><?php echo $refrtsn_cntct_lns['refraction_clp_l_tp'];?></strong></td>
						<?php } ?>
					</tr>
					<tr>
						<?php if(!empty($refrtsn_cntct_lns['refraction_clp_l_advice'])){?>
						<td style="padding:3px;" valign="top">Advice :  <strong><?php echo $refrtsn_cntct_lns['refraction_clp_l_advice'];?></strong> </td>
						<?php } if(!empty($refrtsn_cntct_lns['refraction_clp_l_rv_date'])){?>
						<td style="padding:3px;" valign="top">Revisit Date :  <strong><?php if(!empty($refrtsn_cntct_lns['refraction_clp_l_rv_date'])){ echo date('d/m/Y',strtotime($refrtsn_cntct_lns['refraction_clp_l_rv_date']));}?></strong></td>
						<?php } ?>
					</tr>
				</table>
			</div>
			<div style="float:right;width:48.5%;padding:0px 5px;">
				...
				<table width="100%" style="font-size:11px">
					<tr>
						...
						<td style="padding:3px;" valign="top">Color : <strong><?php echo $refrtsn_cntct_lns['refraction_clp_r_clr'];?> </strong></td>
						<?php } if(!empty($refrtsn_cntct_lns['refraction_clp_r_tp'])){?>
						<td style="padding:3px;" valign="top">Type : <strong><?php echo $refrtsn_cntct_lns['refraction_clp_r_tp'];?></strong></td>
						<?php } ?>
					</tr>
					<tr>
						<?php if(!empty($refrtsn_cntct_lns['refraction_clp_r_advice'])){?>
						<td style="padding:3px;" valign="top">Advice :  <strong><?php echo $refrtsn_cntct_lns['refraction_clp_r_advice'];?></strong> </td>
						<?php } if(!empty($refrtsn_cntct_lns['refraction_clp_r_rv_date'])){?>
						<td style="padding:3px;" valign="top">Revisit Date :  <strong><?php if(!empty($refrtsn_cntct_lns['refraction_clp_r_rv_date'])){ echo date('d/m/Y',strtotime($refrtsn_cntct_lns['refraction_clp_r_rv_date']));}?></strong></td>
						<?php } ?>
					</tr>
				</table>
			</div>
	...
	<?php } } if($form_data['glassesprescriptions_flag']==1){ 
		...
		<section style="float:left;width:100%;">
			<strong>GLASSES PRESCRIPTIONS</strong>
		      <hr style="margin: 2px !important;">
			<div style="float:left;width:48.5%;padding:0px 5px;">
				<div style="text-align:center;background:#ddd;padding:3px;">R/OD</div>
				<table border="1" cellpadding="0" cellspacing="0" width="100%" style=";font-size:12px;border-collapse:collapse;">
		...
		<section style="float:left;width:100%;">
			<strong>INTERMEDIATE GLASSES PRESCRIPTIONS</strong>
			<hr style="margin: 2px !important;">
			<div style="float:left;width:48.5%;padding:0px 5px;">
				<div style="text-align:center;background:#ddd;padding:3px;">R/OD</div>
				<table border="1" cellpadding="0" cellspacing="0" width="100%" style=";font-size:12px;border-collapse:collapse;">
				...
				<div style="font-size:11px;">
					<?php if(!empty($refrtsn_inter_glass['refraction_itgp_l_advs'])){ echo 'Advice : <strong> '.$refrtsn_inter_glass['refraction_itgp_l_advs'].' | </strong>';}
						if(!empty($refrtsn_inter_glass['refraction_itgp_l_tol'])){ echo 'Type of Lens- <strong> '.$refrtsn_inter_glass['refraction_itgp_l_tol'].' | </strong>';} 
						if(!empty($refrtsn_inter_glass['refraction_itgp_l_ipd'])){ echo 'IPD - <strong> '.$refrtsn_inter_glass['refraction_itgp_l_ipd'].'mm | </strong>';}
						if(!empty($refrtsn_inter_glass['refraction_itgp_l_lns_mat'])){ echo 'Lens Material- <strong> '.$refrtsn_inter_glass['refraction_itgp_l_lns_mat'].' | </strong>';}
						if(!empty($refrtsn_inter_glass['refraction_itgp_l_lns_tnt'])){ echo 'Lens Tint- <strong> '.$refrtsn_inter_glass['refraction_itgp_l_lns_tnt'].' | </strong>';}
						if(!empty($refrtsn_inter_glass['refraction_itgp_l_fm'])){ echo 'Frame Material- <strong> '.$refrtsn_inter_glass['refraction_itgp_l_fm'].' | </strong>';}?>
				</div>
			...
			<div style="float:right;width:48.5%;padding:0px 5px;">
				...
				<br>
				<div style="font-size:11px;">
					<?php if(!empty($refrtsn_inter_glass['refraction_itgp_r_advs'])){ echo 'Advice : <strong> '.$refrtsn_inter_glass['refraction_itgp_r_advs'].' | </strong>';}
						if(!empty($refrtsn_inter_glass['refraction_itgp_r_tol'])){ echo 'Type of Lens- <strong> '.$refrtsn_inter_glass['refraction_itgp_r_tol'].' | </strong>';} 
						if(!empty($refrtsn_inter_glass['refraction_itgp_r_ipd'])){ echo 'IPD - <strong> '.$refrtsn_inter_glass['refraction_itgp_r_ipd'].'mm | </strong>';}
						if(!empty($refrtsn_inter_glass['refraction_itgp_r_lns_mat'])){ echo 'Lens Material- <strong> '.$refrtsn_inter_glass['refraction_itgp_r_lns_mat'].' | </strong>';}
						if(!empty($refrtsn_inter_glass['refraction_itgp_r_lns_tnt'])){ echo 'Lens Tint- <strong> '.$refrtsn_inter_glass['refraction_itgp_r_lns_tnt'].' | </strong>';}
						if(!empty($refrtsn_inter_glass['refraction_itgp_r_fm'])){ echo 'Frame Material- <strong> '.$refrtsn_inter_glass['refraction_itgp_r_fm'].' | </strong>';}?>
				</div>
			</div>
		</section>	
       ...
       // if($vl_act==1){?>
		...
		<strong>EXAMINATION</strong>
		   <hr style="margin: 2px !important;">
			<div style="float:left;width:48.5%;padding:0px 5px;">
				...
				<div style="font-size:11px;">
					<strong>VA: </strong><?php if($refrtsn_vl_act['refraction_va_ua_l'] !='0'){ echo 'UA - '.$refrtsn_vl_act['refraction_va_ua_l'];} if(!empty($refrtsn_vl_act['refraction_va_ua_l_p'])){ echo '('.$refrtsn_vl_act['refraction_va_ua_l_p'].') ';} if(!empty($refrtsn_vl_act['refraction_va_ua_l_txt'])){ echo '('.$refrtsn_vl_act['refraction_va_ua_l_txt'].')';} ?> 
					...
					<strong><?php if(!empty($refrtsn_vl_act['refraction_va_l_comm'])){ echo '('.$refrtsn_vl_act['refraction_va_l_comm'].')';}?><?php if(!empty($refrtsn_vl_act['refraction_va_ua_l_pr_s']) || !empty($refrtsn_vl_act['refraction_va_ua_l_pr_i']) || !empty($refrtsn_vl_act['refraction_va_ua_l_pr_n']) || !empty($refrtsn_vl_act['refraction_va_ua_l_pr_t'])){ ?> PR(UA): 
			...
			<div style="float:right;width:48.5%;padding:0px 5px;">
				...
				<div style="font-size:11px;">
					<strong>VA: </strong><?php if($refrtsn_vl_act['refraction_va_ua_r'] !='0'){ echo 'UA - '.$refrtsn_vl_act['refraction_va_ua_r'];} if(!empty($refrtsn_vl_act['refraction_va_ua_r_p'])){ echo '('.$refrtsn_vl_act['refraction_va_ua_r_p'].') ';} if(!empty($refrtsn_vl_act['refraction_va_ua_r_txt'])){ echo '('.$refrtsn_vl_act['refraction_va_ua_r_txt'].')';} ?> 
					...
					<strong><?php if(!empty($refrtsn_vl_act['refraction_va_r_comm'])){ echo '('.$refrtsn_vl_act['refraction_va_r_comm'].')';}?> <?php if(!empty($refrtsn_vl_act['refraction_va_ua_r_pr_s']) || !empty($refrtsn_vl_act['refraction_va_ua_r_pr_i']) || !empty($refrtsn_vl_act['refraction_va_ua_r_pr_n']) || !empty($refrtsn_vl_act['refraction_va_ua_r_pr_t']) ){ ?> PR(UA): 
		...
		<section style="float:left;width:100%;">
			<div style="float:left;width:48.5%;padding:0px 5px;">
			<strong style="float:left;width:100%;">Keratometry:</strong>
				<table border="1" cellpadding="0" cellspacing="0" width="100%" style=";font-size:12px;border-collapse:collapse;">
					<tr>
						<td style="padding:3px;" valign="top"></td>
						<td style="padding:3px;" valign="top"></td>
	 ...
	 <?php }
		...
		<section style="float:left;width:100%;">
			<div style="float:left;width:48.5%;padding:0px 5px;">
			<strong style="float:left;width:100%;">PGP:<?php if(!empty($refrtsn_pgp['refraction_pgp_l_lens'])){ echo 'Type of Lens- '.$refrtsn_pgp['refraction_pgp_l_lens']; } ?> </strong>
				<table border="1" cellpadding="0" cellspacing="0" width="100%" style=";font-size:12px;border-collapse:collapse;">
					<tr>
						<td style="padding:3px;" valign="top"></td>
						<td style="padding:3px;" valign="top">Sph</td>
			...
			<div style="float:right;width:48.5%;padding:0px 5px;">
			<strong style="float:left;width:100%;">PGP:<?php if(!empty($refrtsn_pgp['refraction_pgp_r_lens'])){ echo 'Type of Lens- '.$refrtsn_pgp['refraction_pgp_r_lens']; } ?> </strong>
				<table border="1" cellpadding="0" cellspacing="0" width="100%" style=";font-size:12px;border-collapse:collapse;">
					<tr>
						<td style="padding:3px;" valign="top"></td>
						<td style="padding:3px;" valign="top">Sph</td>
	   ...
	   <?php }
		...
		<section style="float:left;width:100%;">
			<div style="float:left;width:48.5%;padding:0px 5px;">
			<strong style="float:left;width:100%;">Auto Refraction: </strong>
				<table border="1" cellpadding="0" cellspacing="0" width="100%" style=";font-size:12px;border-collapse:collapse;">
					<tr>
						<td style="padding:3px;" valign="top"></td>
						<td style="padding:3px;" valign="top">Sph</td>
		...
		<section style="float:left;width:100%;">
			<div style="float:left;width:48.5%;padding:0px 5px;">
			<strong style="float:left;width:100%;">Dry Refraction: </strong>
				<table border="1" cellpadding="0" cellspacing="0" width="100%" style=";font-size:12px;border-collapse:collapse;">
					<tr>
						<td style="padding:3px;" valign="top"></td>
						<td style="padding:3px;" valign="top">Sph</td>
		...
		<section style="float:left;width:100%;">
			<div style="float:left;width:48.5%;padding:0px 5px;">
			<strong style="float:left;width:100%;">Refraction (Dilated): </strong>
				<table border="1" cellpadding="0" cellspacing="0" width="100%" style=";font-size:12px;border-collapse:collapse;">
					<tr>
						<td style="padding:3px;" valign="top"></td>
						<td style="padding:3px;" valign="top">Sph</td>
		...
		<section style="float:left;width:100%;">
			<div style="float:left;width:48.5%;padding:0px 5px;">
			<strong style="float:left;width:100%;">Retinoscopy: </strong>
		...
		<section style="float:left;width:100%;">
			<div style="float:left;width:48.5%;padding:0px 5px;">
			<strong style="float:left;width:100%;">PMT: </strong>
				<table border="1" cellpadding="0" cellspacing="0" width="100%" style=";font-size:12px;border-collapse:collapse;">
					<tr>
						<td style="padding:3px;" valign="top"></td>
						<td style="padding:3px;" valign="top">Sph</td>
		...
		<section style="float:left;width:100%;">
		  ...
		  <strong style="float:left;width:100%;">Appearance: </strong>
				<?php if($exam_aprnc['examnsn_aprnc_l_phthisis'] !='No'){ echo 'Phthisis Bulbi, ';}
				if($exam_aprnc['examnsn_aprnc_l_anthms'] !='No'){ echo 'Anophthalmos, ';}
				if($exam_aprnc['examnsn_aprnc_l_mcrthms'] !='No'){ echo 'Micropththalmos, ';}
				if($exam_aprnc['examnsn_aprnc_l_artfsl'] !='No'){ echo 'Artificial, ';}
				if($exam_aprnc['examnsn_aprnc_l_prptsis'] !='No'){ echo 'Proptosis, ';}
				if($exam_aprnc['examnsn_aprnc_l_dsptpa'] !='No'){ echo 'Dystopia, ';}
				if($exam_aprnc['examnsn_aprnc_l_injrd'] !='No'){ echo 'Injured, ';}
				if($exam_aprnc['examnsn_aprnc_l_swln'] !='No'){ echo 'Swollen, ';}
			...
			<div style="float:right;width:48.5%;padding:0px 5px; color:<?php echo $exam_aprnc['examnsn_aprnc_r_update'];?>">
				<strong style="float:left;width:100%;">Appearance: </strong>
				<?php if($exam_aprnc['examnsn_aprnc_r_phthisis'] !='No'){ echo 'Phthisis Bulbi, ';}
				if($exam_aprnc['examnsn_aprnc_r_anthms'] !='No'){ echo 'Anophthalmos, ';}
				if($exam_aprnc['examnsn_aprnc_r_mcrthms'] !='No'){ echo 'Micropththalmos, ';}
				if($exam_aprnc['examnsn_aprnc_r_artfsl'] !='No'){ echo 'Artificial, ';}
				if($exam_aprnc['examnsn_aprnc_r_prptsis'] !='No'){ echo 'Proptosis, ';}
				if($exam_aprnc['examnsn_aprnc_r_dsptpa'] !='No'){ echo 'Dystopia, ';}
				if($exam_aprnc['examnsn_aprnc_r_injrd'] !='No'){ echo 'Injured, ';}
				if($exam_aprnc['examnsn_aprnc_r_swln'] !='No'){ echo 'Swollen, ';}
		...
		<section style="float:left;width:100%;">
		  ...
		  <strong style="float:left;width:100%;"> Appendages: </strong>
				<?php if($exam_apnds['examnsn_apndgs_l_eyelids'] !='0'){ 
					if($exam_apnds['examnsn_apndgs_l_eyelids_chzn'] !='No'){ echo 'Chalazion, ';}
					if($exam_apnds['examnsn_apndgs_l_eyelids_ptss'] !='No'){ echo 'Ptosis, ';}
					if($exam_apnds['examnsn_apndgs_l_eyelids_swln'] !='No'){ echo 'Swelling, ';}
					if($exam_apnds['examnsn_apndgs_l_eyelids_intrpn'] !='No'){ echo 'Entropion, ';}
					if($exam_apnds['examnsn_apndgs_l_eyelids_ectrpn'] !='No'){ echo 'Ectropion, ';}
					if($exam_apnds['examnsn_apndgs_l_eyelids_mass'] !='No'){ echo 'Mass, ';}
					if($exam_apnds['examnsn_apndgs_l_eyelids_mbts'] !='No'){ echo 'Meibomitis, ';}
				}
				if($exam_apnds['examnsn_apndgs_l_eyelshs'] !='0'){ 
					if($exam_apnds['examnsn_apndgs_l_eyelshs_tchs'] !='No'){ echo 'Trichiasis, ';}
					if($exam_apnds['examnsn_apndgs_l_eyelshs_dtchs'] !='No'){ echo 'Dystrichiasis, ';}
				}
				if($exam_apnds['examnsn_apndgs_l_lcmlc'] !='0'){ 
					if($exam_apnds['examnsn_apndgs_l_lcmlc_swln'] !='No'){ echo 'Swelling, ';}
					if($exam_apnds['examnsn_apndgs_l_lcmlc_regusn'] !='No'){ echo 'Regurgitation, ';}
				}
				if($exam_apnds['examnsn_apndgs_l_syrn'] !='0'){ 
					if($exam_apnds['examnsn_apndgs_l_syrn_syrn'] !='No'){ echo 'Blocked, ';}else{ echo 'Patent, ';}
				}
	...
	<section style="float:left;width:100%;">
		  ...
		  <strong style="float:left;width:100%;">CONJUNCTIVA: </strong>
				<?php if($exam_conjtv['examnsn_conjtv_l_consn'] !='No'){ 
				if($exam_conjtv['examnsn_conjtv_l_consn_sub'] !=''){ echo 'Congestion - '.$exam_conjtv['examnsn_conjtv_l_consn_sub'].', ';} else{ echo 'Congestion, ';}}
				if($exam_conjtv['examnsn_conjtv_l_tear'] !='No'){ echo 'Tear, ';}
				if($exam_conjtv['examnsn_conjtv_l_cbleb'] !='No'){ echo 'Conjuctival Bleb, ';}
				if($exam_conjtv['examnsn_conjtv_l_sbhrg'] !='No'){ echo 'SubConjunctival Haemorrhage, ';}
				if($exam_conjtv['examnsn_conjtv_l_fbd'] !='No'){ echo 'Foreign Body, ';}
				if($exam_conjtv['examnsn_conjtv_l_flcls'] !='No'){ echo 'Follicles, ';}
				if($exam_conjtv['examnsn_conjtv_l_paple'] !='No'){ echo 'Papillae, ';}
				if($exam_conjtv['examnsn_conjtv_l_pngcla'] !='No'){ echo 'Pinguecula, ';}
				if($exam_conjtv['examnsn_conjtv_l_ptrgm'] !='No'){ echo 'Pterygium, ';}
				if($exam_conjtv['examnsn_conjtv_l_phctn'] !='No'){ echo 'Phlycten, ';}
				if($exam_conjtv['examnsn_conjtv_l_dseg'] !='No'){ echo 'Discharge, ';}
			...
			<div style="float:right;width:48.5%;padding:0px 5px;color:<?php echo $exam_conjtv['examnsn_conjtv_r_update'];?>">
				<strong style="float:left;width:100%;">CONJUNCTIVA: </strong>
				<?php if($exam_conjtv['examnsn_conjtv_r_consn'] !='No'){ echo 'Congestion, ';}
				if($exam_conjtv['examnsn_conjtv_r_tear'] !='No'){ echo 'Tear, ';}
				if($exam_conjtv['examnsn_conjtv_r_cbleb'] !='No'){ echo 'Conjuctival Bleb, ';}
				if($exam_conjtv['examnsn_conjtv_r_sbhrg'] !='No'){ echo 'SubConjunctival Haemorrhage, ';}
				if($exam_conjtv['examnsn_conjtv_r_fbd'] !='No'){ echo 'Foreign Body, ';}
				if($exam_conjtv['examnsn_conjtv_r_flcls'] !='No'){ echo 'Follicles, ';}
				if($exam_conjtv['examnsn_conjtv_r_paple'] !='No'){ echo 'Papillae, ';}
				if($exam_conjtv['examnsn_conjtv_r_pngcla'] !='No'){ echo 'Pinguecula, ';}
				if($exam_conjtv['examnsn_conjtv_r_ptrgm'] !='No'){ echo 'Pterygium, ';}
				if($exam_conjtv['examnsn_conjtv_r_phctn'] !='No'){ echo 'Phlycten, ';}
				if($exam_conjtv['examnsn_conjtv_r_dseg'] !='No'){ echo 'Discharge, ';}
		...
		<?php if($exam_general['examnsn_lod_normal']=='Normal'){ ?>
			<div style="float:left;width:48.5%;padding:0px 5px;">
				<strong style="float:left;width:100%;">CONJUNCTIVA: </strong> Normal
			</div>
		...
		<section style="float:left;width:100%;">
		  ...
		  <strong style="float:left;width:100%;">Cornea:</strong>
			...
			//	if($exam_cornea['examnsn_cornea_l_srfs_nrml'] !='Normal')
				//{ 
					echo 'Surface-';
					if($exam_cornea['examnsn_cornea_l_srfs_epcdft'] !=''){ echo 'Epi defect, ';}
					if($exam_cornea['examnsn_cornea_l_srfs_think'] !=''){ echo 'Thinning, ';}
					if($exam_cornea['examnsn_cornea_l_srfs_scar'] !=''){ echo 'Scarring, ';}
					if($exam_cornea['examnsn_cornea_l_srfs_vascu'] !=''){ echo 'Vascularisation, ';}
					if($exam_cornea['examnsn_cornea_l_srfs_dgensn'] !=''){ echo 'Degeneration, ';}
					if($exam_cornea['examnsn_cornea_l_srfs_dstph'] !=''){ echo 'Dystrophy, ';}
					if($exam_cornea['examnsn_cornea_l_srfs_fbd'] !=''){ echo 'Foreign Body, ';}
					if($exam_cornea['examnsn_cornea_l_srfs_tear'] !=''){ echo 'Tear, ';}
					if($exam_cornea['examnsn_cornea_l_srfs_kp'] !=''){ echo 'KP, ';}
					if($exam_cornea['examnsn_cornea_l_srfs_opct'] !=''){ echo 'Opacity, ';}
					if($exam_cornea['examnsn_cornea_l_srfs_ulcr'] !=''){ echo 'Ulcer, ';}
			//	}
			...
			<div style="float:right;width:48.5%;padding:0px 5px;color:<?php echo $exam_cornea['examnsn_cornea_r_update'];?>">
				  <strong style="float:left;width:100%;">Cornea:</strong>
					<?php 
				if($exam_cornea['examnsn_cornea_r_sz'] !='Normal'){ echo 'Size-'.$exam_cornea['examnsn_cornea_r_sz'].', ';}
				if($exam_cornea['examnsn_cornea_r_shp'] !='Normal'){ echo 'Shap-'.$exam_cornea['examnsn_cornea_r_shp'].', ';}
				//if($exam_cornea['examnsn_cornea_r_srfs_nrml'] !='Normal')
				//{ 
					echo 'Surface-';
					if($exam_cornea['examnsn_cornea_r_srfs_epcdft'] !=''){ echo 'Epi defect, ';}
					if($exam_cornea['examnsn_cornea_r_srfs_think'] !=''){ echo 'Thinning, ';}
					if($exam_cornea['examnsn_cornea_r_srfs_scar'] !=''){ echo 'Scarring, ';}
					if($exam_cornea['examnsn_cornea_r_srfs_vascu'] !=''){ echo 'Vascularisation, ';}
					if($exam_cornea['examnsn_cornea_r_srfs_dgensn'] !=''){ echo 'Degeneration, ';}
					if($exam_cornea['examnsn_cornea_r_srfs_dstph'] !=''){ echo 'Dystrophy, ';}
					if($exam_cornea['examnsn_cornea_r_srfs_fbd'] !=''){ echo 'Foreign Body, ';}
					if($exam_cornea['examnsn_cornea_r_srfs_tear'] !=''){ echo 'Tear, ';}
					if($exam_cornea['examnsn_cornea_r_srfs_kp'] !=''){ echo 'KP, ';}
					if($exam_cornea['examnsn_cornea_r_srfs_opct'] !=''){ echo 'Opacity, ';}
					if($exam_cornea['examnsn_cornea_r_srfs_ulcr'] !=''){ echo 'Ulcer, ';}
				//}
	   ...
	   <?php } 	  
		...
		<?php if($exam_general['examnsn_lod_normal']=='Normal'){ ?>
			<div style="float:left;width:48.5%;padding:0px 5px;">
				<strong style="float:left;width:100%;">Cornea: </strong> Size/Shape/Surface Normal 
			</div>
			<?php } if($exam_general['examnsn_rod_normal']=='Normal'){ ?>
			<div style="float:right;width:48.5%;padding:0px 5px;">
			   <strong style="float:left;width:100%;">Cornea: </strong> Size/Shape/Surface Normal 
		...
		<section style="float:left;width:100%;">
		  ...
		  <strong style="float:left;width:100%;">Anterior Chamber:</strong>
				
				<?php 
				if($exam_atrch['examnsn_ac_l_defth'] !='Normal'){ echo 'Depth-'.$exam_atrch['examnsn_ac_l_defth'].' '.$exam_atrch['examnsn_ac_l_defth_txt1'].' '.$exam_atrch['examnsn_ac_l_defth_txt2'].', ';}
				
					if($exam_atrch['examnsn_ac_l_cells'] !='No'){ echo 'Cells '.$exam_atrch['examnsn_ac_l_cells_txt'].', ';}
					if($exam_atrch['examnsn_ac_l_flar'] !='No'){ echo 'Flare '.$exam_atrch['examnsn_ac_l_flar_txt'].', ';}
					if($exam_atrch['examnsn_ac_l_hyfma'] !='No'){ echo 'Hyphema '.$exam_atrch['examnsn_ac_l_hyfma_txt'].', ';}
					if($exam_atrch['examnsn_ac_l_hypn'] !='No'){ echo 'Hypopyon '.$exam_atrch['examnsn_ac_l_hypn_txt'].', ';}
					if($exam_atrch['examnsn_ac_l_fbd'] !='No'){ echo 'Foreign Body '.$exam_atrch['examnsn_ac_l_fbd_txt'].', ';}
	   ...
	   <?php }	    
		...
		<?php if($exam_general['examnsn_lod_normal']=='Normal'){ ?>
			<div style="float:left;width:48.5%;padding:0px 5px;">
				<strong style="float:left;width:100%;">Anterior Chamber: </strong> Normal depth, No cells/flare 
			</div>
				<?php } if($exam_general['examnsn_rod_normal']=='Normal'){ ?>
			<div style="float:right;width:48.5%;padding:0px 5px;">
			   <strong style="float:left;width:100%;">Anterior Chamber: </strong> Normal depth, No cells/flare 
		...
		<section style="float:left;width:100%;">
		  ...
		  <strong style="float:left;width:100%;">Pupil:</strong>
		...
		<?php if($exam_general['examnsn_lod_normal']=='Normal'){ ?>
			<div style="float:left;width:48.5%;padding:0px 5px;">
				<strong style="float:left;width:100%;">Pupil: </strong> Round shape, Normal direct & Consensual reflex  
			</div>
				<?php } if($exam_general['examnsn_rod_normal']=='Normal'){ ?>
			<div style="float:right;width:48.5%;padding:0px 5px;">
			   <strong style="float:left;width:100%;">Pupil: </strong>Round shape, Normal direct & Consensual reflex  
		...
		<section style="float:left;width:100%;">
		  ...
		  <strong style="float:left;width:100%;">Iris: </strong>
		...
		<?php if($exam_general['examnsn_lod_normal']=='Normal'){ ?>
			<div style="float:left;width:48.5%;padding:0px 5px;">
				<strong style="float:left;width:100%;">Iris: </strong> Within normal Limits  
			</div>	
		<?php } if($exam_general['examnsn_rod_normal']=='Normal'){ ?>
			<div style="float:right;width:48.5%;padding:0px 5px;">
			   <strong style="float:left;width:100%;">Iris: </strong>Within normal Limits  
		...
		<section style="float:left;width:100%;">
			...
			<?php 
				if($exam_lens['examnsn_lens_l_ntr'] !='Clear'){ echo '<strong style="float:left;width:100%;">Lens: </strong> Nature- '.$exam_lens['examnsn_lens_l_ntr'].', ';}				
			...
			<div style="float:right;width:48.5%;padding:0px 5px;color:<?php echo $exam_lens['examnsn_lens_r_update'];?>">
				<?php 
				if($exam_lens['examnsn_lens_r_ntr'] !='Clear'){ echo '<strong style="float:left;width:100%;">Lens: </strong> Nature- '.$exam_lens['examnsn_lens_r_ntr'].', ';}
		...
		<?php if($exam_general['examnsn_lod_normal']=='Normal'){ ?>
			<div style="float:left;width:48.5%;padding:0px 5px;">
				<strong style="float:left;width:100%;">Lens: </strong> Clear   
			</div>
				<?php } if($exam_general['examnsn_rod_normal']=='Normal'){ ?>
			<div style="float:right;width:48.5%;padding:0px 5px;">
			   <strong style="float:left;width:100%;">Lens: </strong> Clear   
		...
		<section style="float:left;width:100%;">
		  ...
		  <strong style="float:left;width:100%;">Extra Ocular Movements: </strong>
		...
		<?php if($exam_general['examnsn_lod_normal']=='Normal'){ ?>
			<div style="float:left;width:48.5%;padding:0px 5px;">
				<strong style="float:left;width:100%;">Extra Ocular Movements: </strong> Uniocular and Binocular movements full and normal    
			</div>
				<?php } if($exam_general['examnsn_rod_normal']=='Normal'){ ?>
			<div style="float:right;width:48.5%;padding:0px 5px;">
			   <strong style="float:left;width:100%;">Extra Ocular Movements: </strong> Uniocular and Binocular movements full and normal    
		...
		<section style="float:left;width:100%;">
			<div style="float:left;width:48.5%;padding:0px 5px;display:flex;color:<?php echo $exam_gnscp['examnsn_gonispy_l_update'];?>">
			 <strong style="float:left;width:100%;">Gonioscopy:</strong>
				<table style="width:100%">
					<tbody>
						<tr>
							<td width="33.33%"></td>
						...
						<tr>
							...
							<td class="plus_symbol" align="center" style="font-size:40px;"> &chi;</td>
		...
		<section style="float:left;width:100%;">
		  ...
		  <strong style="float:left;width:100%;">Fundus:</strong>
...
if($form_data['diagnosis_flag']==1){
	...
	<section style="float:left;width:100%;">
		  <strong style="float:left;width:100%;">DIAGNOSIS: </strong>
		  <hr style="margin: 2px !important;">
		...
		<section style="float:left;width:100%;">
		  <strong style="float:left;width:100%;">PROVISIONAL DIAGNOSIS: </strong>
		  <hr style="margin: 2px !important;">
				<ul style="list-style:none;margin:5px 0 10px;">
	...
	<?php } ?>
		...
		<section style="float:left;width:100%;">
		  <strong style="float:left;width:100%;">OPHTHAL INVESTIGATIONS: </strong>
		  <hr style="margin: 2px !important;">
					...
					<?php
						if(!empty($ophthal_data['ophthal_set'])){ $i=0;
							foreach ($ophthal_data['ophthal_set'] as $key => $opthal) {
								$i++;
							echo ' <strong> '.$i.'- </strong> '.$opthal->test_name.'('.$opthal->eye_side.')';} }
						if(!empty($ophthal_data['ophthal_test'])){ $i++;
							foreach ($ophthal_data['ophthal_test'] as $keys => $opthal_test) {
							echo ' <strong> '.$i.'- </strong> '.$opthal_test->test_name.'('.$opthal_test->eye_side.')';}} ?>
		...
		<section style="float:left;width:100%;">
		  <strong style="float:left;width:100%;">RADIOLOGY INVESTIGATIONS: </strong>
		  <hr style="margin: 2px !important;">
				<div style="float:left;width:100%;margin-bottom:5px;">
					<?php 
		...
		<section style="float:left;width:100%;">
		  <strong style="float:left;width:100%;">LABORATORY INVESTIGATIONS: </strong>
		  <hr style="margin: 2px !important;">
				<div style="float:left;width:100%;margin-bottom:5px;">
					<?php
      ...
      if(!empty($advice_comm['planmanagement'])){ ?>
		...
		<section style="float:left;width:100%;">
		  ...
		  <strong style="float:left;width:100%;">PROCEDURE: </strong>
		  <hr style="margin: 2px !important;">
				<div style="float:left;width:100%;margin-bottom:5px;">
					<?php $l=0;
							foreach ($advice_procedure as $key => $procedure) {
								$l++;
							echo ' <strong> '.$l.'- </strong> '.$procedure->test_name.'('.$procedure->eye_side.') - '.$procedure->p_comm;} }
						?>
...
<?php  if(!empty($advice_medication)){
 ...
 ?>
		<section style="float:left;width:100%;">
			<?php if(count($medi)>0){ ?>
			<strong style="float:left;width:100%;">ADVICE: </strong>
			<hr style="margin: 2px !important;">
			...
			<table width="100%" border="1" style="border-collapse:collapse;font:12px 'Arial';text-align:center;margin-bottom:10px;">
				<thead>
					<tr>
						...
						<th style="padding:3px;" class="text-center">Frequency</th>
						<th style="padding:3px;">Duration</th>
						<th style="padding:3px;">Eye</th>
						<th style="padding:3px;">Instruction</th>
					</tr>
				</thead>
				<tbody>
					<?php  $n=0;
					...
					<tr>
						<td style="padding:3px;"><?php echo $n;?></td>
						<td style="padding:3px;"><b><?php echo $medicine->mname;?></b></td>
						<td style="padding:3px;"> <b><?php echo $medicine->mqty;?> </td>
						<td style="padding:3px;"> <b><?php echo $medicine->mfrq;?> </td>
						<td style="padding:3px;"> <b><?php echo $medicine->mdur.' '.$medicine->mdurd;?> </td>
						<td style="padding:3px;"> <?php echo $medicine->eside;?> </td>
						<td style="padding:3px;"> <?php echo $medicine->minst;?></td>
					</tr>
						...
						<td colspan="7" style="padding:4px;">
							<table width="100%" border="1" style="border-collapse:collapse;font:12px 'Arial';text-align:center;background:#fff;">
								<thead>
									<tr>
										<th style="padding:3px;">Sr No.</th>
										<th style="padding:3px;">No of Days</th>
										<th style="padding:3px;">Start Date</th>
										<th style="padding:3px;">End Date</th>
										<th style="padding:3px;">Start Time</th>
										<th style="padding:3px;">End Time</th>
										<th style="padding:3px;" width="16%">Frequency</th>
										<th style="padding:3px;" width="16%">Interval</th>
									</tr>
								</thead>
								<tbody>
									<?php $x=0; foreach ($medicine_datas as $key => $medicine) { $x++; ?>
									<tr class="taper_row">
										<td style="padding:3px;"><?php echo $x;?></td>
										<td style="padding:3px;"><?php echo $medicine['day'];?></td>
										<td style="padding:3px;"><?php echo $medicine['st_date'];?></td>
										<td style="padding:3px;"><?php echo $medicine['en_date'];?> </td>
										<td style="padding:3px;"><?php echo $medicine['st_time'];?></td>
										<td style="padding:3px;"><?php echo $medicine['en_time'];?></td>
										<td style="padding:3px;"><?php echo $medicine['freq'];?> times a day</td>
										<td style="padding:3px;">Every <?php echo $medicine['intvl'];?> hours</td>
									</tr>
								<?php } ?>
								</tbody>
							</table>
		...
		<?php } if(!empty($advice_comm['medi_comm'])){
			echo '<b>Medication Comments : </b>'.$advice_comm['medi_comm'].'<br>';
		} ?>
		<?php if($advice_comm['appear_check']==1 && !empty($advice_comm['appear_box'])){
			echo '<b>Glasses Comments : </b>'.$advice_comm['appear_box'].'<br>';
		} ?>
		<?php if(!empty($advice_adv)){?>
			<span><b>For Followup :</b> - Visit <b><?php if(!empty($advice_adv['doctor_name'])){ echo 'Dr. '.$advice_adv['doctor_name'];}?></b> <?php if(!empty($advice_adv['days'])){ echo 'after '.$advice_adv['days'].' Days'; }?>  </span>
		<?php } if(!empty($advice_referral)){ 
			foreach ($advice_referral as $key => $referral) { ?>
			<br><span><b>For Referral :</b> - Visit <b><?php if(!empty($referral->doctor)){ echo 'Dr. '.$referral->doctor; }?></b> at <b> <?php echo $referral->location.' on '; ?></b>  <b><?php if(!empty($referral->date)) { echo date('D M d, Y', strtotime($referral->date));} ?></b>
				<br>
				<b> Note : </b><?php if(!empty($referral->note)) { echo $referral->note;} ?></span>
		<?php }}?>
		</section>
	<?php } } ?>
	...
	<section>
       ...
       <b> Refferal Doctor Details : </b> <br/> <div style="padding-left:30px;"> <b>Name :</b> <?php echo $form_data['ref_doctor_name'];?> <br/> <b> Contact No. : </b>  <?php echo $form_data['ref_mobile_no'];?><br/>  <b> Address : </b><?php echo $ref_address;
   }?> </div>
	</section>  
</page>
</body>
