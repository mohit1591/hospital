	...
	$pay_mode = array('0'=>'','1'=>'Cash', '2'=>'Cheque', '3'=>'Card', '4'=>'NEFT');
		 ...
		 $users_data = $this->session->userdata('auth_users'); 
          ...
          if (array_key_exists("permission",$users_data)){
			...
			if(!empty($self_opd_collection_list) || !empty($self_pathology_collection_list) || !empty($self_billing_collection_list) || !empty($self_medicine_collection_list) || !empty($self_medicine_return_collection_list ||!empty($self_ambulance_collection_list) ||	!empty($self_dialysis_collection_list) || !empty($self_inventory_collection_list) ||	!empty($self_vacci_collection_list) || !empty($self_ot_collection_list) || !empty($self_eye_collection_list) || !empty($self_pedit_collection_list) ||	!empty($self_dental_collection_list) ||	!empty($self_gyni_collection_list) |	!empty($self_day_care_collection_list) ) )
                {
                	$grand_total=0;
