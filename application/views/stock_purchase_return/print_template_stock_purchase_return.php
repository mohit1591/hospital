...
$template_data->template = str_replace("Purchase Order",'Purchase Return Order',$template_data->template);
...
if($template_data->printer_id==2)
{
	...
	{ 
	  ...
	  $serial_no=array();
        $purchase_item_serial =get_purchase_return_serial_no_item($purchases_list->return_id,$purchases_list->item_id);
