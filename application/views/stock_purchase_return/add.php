...
<!--<link  href="< ?php echo ROOT_CSS_PATH; ?>bootstrap-datepicker.standalone.min.css" rel="stylesheet" type="text/css"/>--> 
<script type="text/javascript">

function view_medicine_entry(id)
{
  var $modal = $('#load_add_modal_popup');
  $modal.load('<?php echo base_url().'stock_purchase_return/view/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('stock_purchase_return/deleteall');?>",
                      data: {row_id: allVals},
      ...
      <div class="row">
        <div class="col-md-4">
		 ...
		 <div class="row m-b-5">
          <input type="hidden" class="m_input_default" value="<?php echo $form_data['data_id'] ?>" name="data_id" />
            ...
            <div class="col-md-8">
			<input type="text" name="purchase_code" id="purchase_code" placeholder="Purchase Code" class="m_input_default purchase_code" value="<?php echo $form_data['purchase_code'] ?>">
       ...
       <input type="hidden" value="" id="category_id"/>
        ...
        {?>
          ...
          <div class="col-md-8">
		   <input type="hidden" value=" <?php echo $form_data['vendor_code'];?>" id="vendor_code" name="vendor_code"/>
        ...
        {?>
          ...
          <div class="col-md-8"> 
		  <input type="hidden" value=" <?php echo $form_data['vendor_name'];?>" id="vendor_name" name="vendor_name"/>
		  <?php echo $form_data['vendor_name'];?>
          </div>
          </div>
        <?php }?>
        ...
        {?>
            ...
            <div class="col-md-8">
            <input type="hidden" value=" <?php echo $form_data['address'];?>" id="address" name="address"/>			
			<?php echo $form_data['address']; ?> </div>
            </div>
...
<script>
 ...
 function payment_function(value,error_field){
    $('#updated_payment_detail').html('');
     $.ajax({
        type: "POST",
        url: "<?php echo base_url('stock_purchase_return/get_payment_mode_data')?>",
...
{
    $.ajax({
          url: "<?php echo base_url('stock_purchase_return/get_vandor_data/'); ?>"+vendor_id, 
          success: function(result)
          {
...
function reset_search()
  { 
    ...
    $('#invoice_id').val('');
    $('#branch_id').val('');
    $.ajax({url: "<?php echo base_url(); ?>stock_purchase_return/reset_search/", 
      success: function(result)
      { 
        reload_table();
      } 
 ...
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('stock_purchase_return/delete/'); ?>"+id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a  data-dismiss="modal" class="btn-anchor"  onClick="return print_window_page('<?php echo base_url("stock_purchase_return/print_purchase_recipt"); ?>');">Print</a>
  ...
  function payment_new_calc_all(update_row)
  {
     ...
     var data_id= '<?php echo $form_data['data_id'];?>';
      ...
      var pay_amount = $('#pay_amount').val();
        $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>stock_purchase_return/payment_calc_all/", 
        dataType: "json",
...
function remove_item(allVals)
  { 
   if(allVals!="")
   {
      $.ajax({
              type: "POST",
              url: "<?php echo base_url('stock_purchase_return/remove_stock_purchase_item_list');?>",
               dataType: "json",
...
<!--     <script type="text/javascript">
    ...
    var getData = function (request, response) { 
        row = i ;
        $.ajax({
        url : "<?php // echo base_url('stock_purchase_return/get_item_values/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
       data: {
...
//add 2 may 20
    ...
    var getData = function (request, response) { 
        row = i ;
        $.ajax({
        url : "<?php echo base_url('stock_purchase_return/search_purchase/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
        data: {
         name_startsWith: request.term,
    ...
    {  
      ...
      $('#purchase_date').val(names[13]);
      $('#vendor_id').val(names[14]);
      $('#vendor_code').val(names[15]);
      $('#vendor_name').val(names[16]);
      $('#address').val(names[17]);

      set_purchase_item(names[1]);
      return false;
    }

    $("#purchase_code").autocomplete({
        source: getData,
        select: selectItem,
        minLength: 1,
        change: function() {  
 ...
 //alert(allVals );  
     if(allVals!="")
     {
        ...
        $.ajax({
              type: "POST",
              url: "<?php echo base_url('stock_purchase_return/get_purchase_item');?>",
              data: {item_id: allVals},
              dataType: "json",
              success: function(result) 
              {
...
{  
   ...
   // var vat = $('#vat').val();
    ...
    $.ajax({
       type: "POST",
       url: "<?php echo base_url('stock_purchase_return/ajax_list_item')?>",
...
function child_item_vals() 
 ...
 function send_item(allVals)
  {   
       ...
       if(allVals!="")
       {
        //alert(allVals);
          ...
          $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('stock_purchase_return/set_item');?>",
  ...
  {
    $.ajax({
            url: "<?php echo base_url(); ?>stock_purchase_return/ajax_added_item", 
            dataType: "json",
           success: function(result)
            {
  ...
  { 
   if(allVals!="")
   {
      $.ajax({
              type: "POST",
              url: "<?php echo base_url('stock_purchase_return/remove_item_list');?>",
               dataType: "json",
              data: {item_id: allVals},
              success: function(result) 
              {  
 ...
 function payment_cal_perrow(ids){
   ...
   // if(unit1 <= max_qty)
    //{
        ...
        $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>stock_purchase_return/payment_cal_perrow/", 
                dataType: "json",
...
$('documnet').ready(function(){
 <?php if(isset($_GET['status']) && isset($purchase_id) && $_GET['status']=='print'){?>
  ...
  .one('click', '#cancel', function(e)
    { 
        window.location.href='<?php echo base_url('stock_purchase_return/add');?>'; 
    }) ;
...
{ 
    var issue_allot_id = '<?php echo $form_data['data_id'];?>';
      ...
      var getData = function (request, response) { 
      $.ajax({
        url : "<?php echo base_url('stock_purchase_return/search_serial_no/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
      data: {
         name_startsWith: request.term,
