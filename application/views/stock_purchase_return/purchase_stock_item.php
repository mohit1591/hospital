     ...
     <form >
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="row m-b-5">
            <div class="col-md-5">
              <label>Cheque Date <span class="star">*</span></label>
            </div>
            <div class="col-md-7">
              <input type="text" name="item_code" value="">
            </div>
          ...
          <div class="row m-b-5">
            <div class="col-md-5">
              <label>Cheque No. <span class="star">*</span></label>
            </div>
            <div class="col-md-7">
              <input type="text" name="item_code" value="">
            </div>
        ...
        <table class="table  purchase_stock_item_list_lower">
          <tbody class="no-bg">
            <tr class="no-bg">
              ...
              <td><input type="text" class="w-100px" value="800"></td>
            </tr>
          </tbody>
        </table>
