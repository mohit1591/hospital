...
$template_data->setting_value = str_replace("{particulars}",$all_detail['expense_list'][0]->expenses_type.' ('.$all_detail['expense_list'][0]->patient_name.' '.$all_detail['expense_list'][0]->book_code.')',$template_data->setting_value);
