    ...
    $(document).ready(function() {
     var $modal = $('#load_test_master_import_modal_popup');
        $('#update_open_model').on('click', function(){
              ...
              $modal.load('<?php echo base_url().'path_panel_price/import_update_test_master_excel' ?>',
              { 
              },
              function(){
              $modal.modal('show');
     ...
     <div class="userlist-right">
       ...
       <div class="permission-btns" style="float:left;">
  		<div class="btns">
             ...
             { ?>
               <!--<button class="btn-exit m-t-30px" >
                    <i class="fa fa-save"></i> Save
               </button>-->
               <a  href="javascript:void(0)" class="btn-anchor m-b-2" onclick="return price_list_form()">
                <i class="fa fa-save"></i> Save
                </a>
               <?php }?>
               ...
               <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item update_data" title="Export data for update" href="<?php echo base_url('path_panel_price/update_panel_test_excel'); ?>" > <i class="fa fa-file-excel-o"></i> Export Data</a><br>
