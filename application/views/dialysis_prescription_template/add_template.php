...
<input type="hidden" name="data_id" id="type_id" value="<?php echo $form_data['data_id']; ?>" /> 
  ...
  <button class="btn-save" type="button" name="" data-dismiss="modal" onclick="window.location.href='<?php echo base_url('dialysis_prescription_template'); ?>'"><i class="fa fa-sign-out"></i> Exit</button>
  </div>
...
function delete_prescription_medicine(val,temp_id)
{
  ...
  $.ajax({url: "<?php echo base_url(); ?>dialysis_prescription_template/delete_pres_medicine/"+prescription_medicine_id+'/'+templ_id, 
