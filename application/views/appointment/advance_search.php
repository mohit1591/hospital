 <div class="modal-dialog advance-search-modal">
  ...
  <div class="modal-content"> 
      <form  id="search_form_app" class="form-inline"> 
                    ...
                    <div class="advance-search">
                      <div class="inner">
                        ...
                        <div class="grp">
                          ...
                          <input type="text" class="inputFocus" name="appointment_code" value="<?php echo $form_data['appointment_code']; ?>">
                        </div>
                        <!-- <div class="grp">
                        ...
                        <div class="grp">
                          ...
                          <input type="text" class="datepicker start_datepicker" name="appointment_from_date" value="<?php echo $form_data['appointment_from_date']; ?>">
                        </div>
                        ...
                        <div class="grp">
                          ...
                          <input type="text" class="datepicker3" name="start_time" value="<?php if(isset($form_data['start_time'])) { echo $form_data['start_time']; } ?>">
                        </div>
                        ...
                        <select name="branch_id" id="branch_id" class="">
                           <option value="" style="width:200px">Select Branch</option>
                           
                           <option  selected="selected" value="<?php echo $users_data['parent_id'];?>" style="width:200px">Self</option>';
                             <?php 
                        ...
                        <div class="grp">
                          ...
                          <input type="text" name="patient_code"  value="<?php if(isset($form_data['patient_code'])){ echo $form_data['patient_code']; } ?>">
                        </div>
                        ...
                        <div class="grp">
                          ...
                          <div class="rslt">
                                  ...
                                  if(!empty($simulation_list))
                                  {
                                    foreach($simulation_list as $simulation)
                                    {
                                      $selected_simulation = '';
                                       ...
                                       elseif(isset($form_data['simulation_id'])){
                              ...
                              <input type="text" name="patient_name" id="patient_name" value="<?php if(isset($form_data['patient_name'])){ echo $form_data['patient_name']; } ?>" class="p-name">
                          </div>
                        </div>
                        
                        <div class="grp">
                          <label>Mobile No. </label>
                          <input type="text" maxlength="10" name="mobile_no" value="<?php if(isset($form_data['mobile_no'])) { echo $form_data['mobile_no']; } ?>" onkeypress="return isNumberKey(event);">
                        </div>
                        ...
                        <div class="grp">
                           <label>Age</label>
                          <div class="rslt">
                           <input type="text" name="age_y" class="input-tiny" onkeypress="return isNumberKey(event);" maxlength="2" value="<?php if(!empty($form_data['age_y'])) { echo $form_data['age_y']; } ?>"> To
                            <input type="text" name="age_m" class="input-tiny" onkeypress="return isNumberKey(event);" maxlength="2" value="<?php if(!empty($form_data['age_m'])) { echo $form_data['age_m']; } ?>"> 
                          </div>
                        </div>
                        ...
                        <div class="grp">
                          ...
                          <input type="text" name="pincode" id="pincode" value="<?php  if(!empty($form_data['pincode'])) { echo $form_data['pincode']; } ?>" maxlength="6" onkeypress="return isNumberKey(event);">
                        </div>
                      ...
                      <div class="inner">
                        ...
                        <div class="grp">
                          ...
                          <input type="text" name="patient_email" id="patient_email" value="<?php echo $form_data['patient_email']; if(!empty($form_data['pincode'])) { echo $form_data['pincode']; } ?>" />
                        </div>

                         <div class="grp">
                          <label>Aadhaar No.</label>
                          <input type="text" name="adhar_no" id="adhar_no" class="numeric" value="<?php if(!empty($form_data['adhar_no'])) { echo $form_data['adhar_no']; } ?>" />
                        </div>
                       <!--  <div class="grp">
                        ...
                        <div class="grp">
                          ...
                          <input type="text" class="datepicker datepicker_to end_datepicker" name="appointment_to_date" value="<?php echo $form_data['appointment_to_date']; ?>">
                        </div>
                        ...
                        <div class="grp">
                          <label>Time To</label>
                          <input type="text" class="datepicker3" name="end_time" value="<?php if(isset($form_data['end_time'])){ echo $form_data['end_time']; } ?>">
                        </div> 

 <div class="grp">
                          <label>Disease</label>
                          <input type="text" name="disease" id="disease" class="" value="<?php if(!empty($form_data['disease'])) { echo $form_data['disease']; } ?>" />
                        </div>
                        <div class="grp">
                          <label>ICD-10</label>
                          <input type="text" name="disease_code" id="disease_code" class="" value="<?php if(!empty($form_data['disease_code'])) { echo $form_data['disease_code']; } ?>" />
                        </div>  
...
$("#search_form_app").on("submit", function(event) { 
