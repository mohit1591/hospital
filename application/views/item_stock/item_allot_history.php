...
$(document).ready(function() { 
  form_submit();
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('item_stock/item_allot_history_ajax')?>",
            "type": "POST",
            "data": function(d){
                d.item_id = getUrlData('id');
...
function allbranch_delete(allVals)
 ...
 function reset_search()
  { 
    ...
    $.ajax({url: "<?php echo base_url(); ?>item_stock?>/reset_search/", 
      success: function(result)
      { 
        reload_table();
      } 
...
<section class="userlist">
    ...
    <div class="col-xs-12">
      <div class="row">
        <div class="col-xs-6">
         ...
         <input type="radio" name="types" <?php if($type==3){ echo 'checked=""'; } ?> class="types" value="2" onclick="return type_set(3)" /> Issue/Allot 
         <input type="radio" name="types" <?php if($type==4){ echo 'checked=""'; } ?> class="types" value="2" onclick="return type_set(4)" /> Issue/Alot Return
   ...
   <div class="userlist-right">
        ...
        <button class="btn-exit" onclick="window.location.href='<?php echo base_url('item_stock');?>'">
...
{ 
   window.location.href='<?php echo base_url('item_stock/item_allot_history').'/?id='.$id; ?>&type='+vals;
} 
...
function load_allot_model()
{
     ...
     $modal.load('<?php echo base_url('item_stock/allotement_to_branch/'); ?>',{'item_ids':allVals},function(){
          $modal.modal('show');
     });
