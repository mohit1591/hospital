...
function load_allot_model()
{
     ...
     $modal.load('<?php echo base_url('item_stock/allotement_to_branch/'); ?>',{'inventory_ids':allVals,'batch_no':batchNo},function(){
          $modal.modal('show');
     });
          ...
          function show_serial(serials, k, status)
          {
              if(serials!='')
              {
                  ...
                  tr="<thead class='bg-theme'><tr><td>S.No.</td><td>Serial No.</td></tr></thead>";
