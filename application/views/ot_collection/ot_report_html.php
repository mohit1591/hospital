<html><head>
<title>OT Collection Report</title>
<?php
if($print_status==1)
{
?>
...
<table width="100%" cellpadding="0" cellspacing="0" border="1px" style="font:13px Arial !important;">
  <tr><td colspan="9" align="center"><h3>OT Collection Report <?php 
   ...
   if(!empty($data_list))
   {
    ...
    $grand_balance_amount=0;
     ...
     $tot_data=count($data_list);
        ...
        $grand_total_discount = $grand_total_discount + $data->discount_amount;
