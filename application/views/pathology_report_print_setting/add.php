 ...
 <div class="row">
        <div class="col-sm-12 br-h-small m12">
            <div class="row">
                ...
                <div class="col-sm-7"><select name="template_id" id="template_id" onchange="get_template(this.value);">
                    <option <?php if($temp_id==0){ echo 'selected="selected"';} ?> value="0"> Default</option>
                    <option <?php if($temp_id==1){ echo 'selected="selected"';} ?> value="1"> Template1</option>
                    <option <?php if($temp_id==2){ echo 'selected="selected"';} ?> value="2"> Template2</option>
                    <option <?php if($temp_id==3){ echo 'selected="selected"';} ?> value="3"> Template3</option>
                    <option <?php if($temp_id==4){ echo 'selected="selected"';} ?> value="4"> Template4</option>
                </select></div>
    ...
    <!--Divya 23-4-2019 end-->
      ...
      ?>
<input type="hidden" name="temp_id" value="<?php  echo $temp_id; ?>" id="temp_id">
      <div  class="row m-b-5">
...
for (instance in CKEDITOR.instances) {
  ...
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>pathology_report_print_setting/",
    type: "post",
    data: $(this).serialize(),
...
function get_template(ids)
 {
    if(ids!='')
    {
      window.location.href='<?php echo current_url(); ?>?temp_id='+ids;
    }
 }
