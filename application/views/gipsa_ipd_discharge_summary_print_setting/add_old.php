...
<form id="prescription_setting_form">
  ...
  <div class="row">
    ...
    <?php
      ...
      {
        if(!empty($discharge_setting_list))
        {
          foreach($discharge_setting_list as $setting_list)
          {
    ...
    ?>
      ...
      <div class="col-xs-12 m-b-5 m12">
        <div class="row">
          ...
          <div class="col-xs-4">
          <?php if($setting_list->setting_name=='DISCHARGE_SUMMARY_PRINT_SETTING') { ?>
          </div>
        </div>
