  ...
  <page size="A4">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
      ...
      <div style="float:left;width:100%;border:1px solid #111;font-size:13px;border-bottom: none;">
        ...
        <div style="float:left;width:15%;font-weight:600;padding:4px;"><u>Amount</u></div>
        <div style="float:left;width:15%;font-weight:600;padding:4px 1em 4px 4px;text-align:right;"><u>Date</u></div>
  ...
  <?php if(!empty($self_branch_bank_list)&& isset($self_branch_bank_list)) { ?>
    ...
    //print '<pre>';print_r($branchs);
      ...
      <div style="float:left;width:20%;padding:1px 4px;"><?php echo $branchs->account_holder; ?></div> 
        <div style="float:left;width:15%;padding:1px 4px;"><?php echo $branchs->amount; ?></div>
  ...
  <?php if(!empty($banking_according_total[$parent_id]) && isset($banking_according_total[$parent_id])) {?>
    <div style="float:left width:100%;">
       ...
       <div style="float:left; width:40%;font-weight:bold;">Bank A/C No.</div>
         <div style="float:right; width:60%;font-weight:bold;text-align: right;padding-right:1em;">Total Amount</div>
         <?php foreach($banking_according_total[$parent_id] as $bank_tot){ ?>
          ...
          <div style="float:right; width:40%;text-align: right;padding-right:1em;"><?php echo $bank_tot->total_amount;?></div>
        <?php }?>
       </div>
