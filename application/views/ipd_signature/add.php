  ...
  <div class="modal-content modal-top"> 
    ...
    <input type="hidden" name="old_sign_img" value="<?php echo $form_data['old_sign_img']; ?>">
      ...
      <div class="modal-body">    
              ...
              <div class="row m-b1">
                <div class="col-xs-5">
                    <label>Sign Image<span class="star">*</span></label>
                </div>
                <div class="col-xs-7">
...
$("#signature_form").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('ipd_signature/'); ?>"+path,
    type: "post", 
    ...
    success: function(result) {
      if(result==1)
      {
        $('#load_add_ipd_signature_modal_popup').modal('hide');
        reload_table();
        flash_session_msg(msg); 
      } 
      else
            {
        $("#load_add_ipd_signature_modal_popup").html(result);
      }       
      $('#overlay-loader').hide();
    }
  });
