    ...
    <div class="row">
        <div class="col-sm-12 br-h-small m12">
            <div class="row">
                ...
                <div class="col-sm-1"><strong>Margin</strong></div> 
            </div>
        </div> <!-- 12 -->
    </div> <!-- row -->
    ...
    ?>
      ...
      <div class="col-xs-12 m-b-5 m12">
        <div class="row">
          ...
          <div class="col-xs-3">
          <?php if($setting_list->setting_name !='') { ?>
          </div>
        </div>
      ...
      <textarea type="text" name="messageh" class="messageh" id="messageh" cols="30"><?php echo $setting_list->page_header; ?></textarea><br/>
        ...
        <div class="col-xs-1">
          <input type="checkbox" name="header_print" <?php if($setting_list->header_print==1){ echo 'checked="checked"'; } ?> value="1" />
        </div>
        <div class="col-xs-1">
      ...
      <div  class="row m-b-5">
        ...
        <div class="col-xs-8">
          ...
          <div style="margin-left:-1.2%;padding-right: 4.8em;">
            <textarea readonly="" class="form-control" cols="" rows="6">{vendor_name},{sales_name},{date},{invoice_no},{s_no}, {medicine_name},{quantity}, {mrp},{s_no}, {medicine_name},{total_amount}, {gross_total_amount}, {vat}, {discount}, {net_amount}, {paid_amount}, {balance},{start_loop},{end_loop},{tot_discount},{vat_percent},{payment_mode},{gender_age},{sgst},{cgst},{igst},{cgst_amount},{igst_amount},{sgst_amount},{email_id},{address},{purchase_no}. </textarea>
            
            </div>
          <?php } elseif($type==5 || $type==6){?>
              <div style="margin-left:-1.2%;padding-right: 4.8em;">
            <textarea readonly="" class="form-control" cols="" rows="6">{patient_name},{sales_name},{date},{invoice_no},{s_no}, {medicine_name},{quantity}, {mrp},{s_no}, {medicine_name},{gross_total_amount}, {vat}, {tot_discount}, {net_amount}, {tot_discount},{paid_amount}, {balance},{start_loop},{end_loop},{discount_percent},{vat_percent},{payment_mode},{gender_age},{sgst},{cgst},{igst},{patient_code},{mobile_no},{refered_by},{remarks},{aadhaar_no},{anniversary},{marital_status},{religion},{address},{pincode},{city},{state},{country},{father_husband},{mother},{guardian_name},{guardian_email},{relation},{patient_email},{monthly_income},{occupation},{insurance_company},{policy_no},{remarks},{parent_relation_type},{parent_relation_name},{address}</textarea>
...
for (instance in CKEDITOR.instances) {
  ...
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>print_letterhead_setting/template/"+type,
    type: "post",
    data: $(this).serialize(),
