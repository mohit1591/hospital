...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('nursingnotes/suggestion/ajax_list')?>",
            "type": "POST",
        }, 
        "columnDefs": [
        { 
...
{
  var $modal = $('#load_add_suggestion_modal_popup');
  $modal.load('<?php echo base_url().'nursingnotes/suggestion/edit/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        .one('click', '#delete', function(e)
        {
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('nursingnotes/suggestion/deleteall');?>",
                      data: {row_id: allVals},
    ...
    <div class="userlist-right">
      <div class="btns">
        ...
        <button class="btn-update" id="deleteAll" onclick="return checkboxValues();">
          ...
          ?>
        <button class="btn-exit" onclick="window.location.href='<?php echo base_url('nursingnotes/suggestion/archive'); ?>'">
...
<script>  
 ...
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('nursingnotes/suggestion/delete/'); ?>"+rate_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
