...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('nursingnotes/medicine/get_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$("#medicine").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('nursingnotes/medicine/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
...
{
   $.ajax({url: "<?php echo base_url(); ?>nursingnotes/medicine/medicine_dropdown/", 
    success: function(result)
    {
