                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="row m-b-5">
                                ...
                                <div class="col-sm-7"> <input type="text" readonly="readonly" id="payment_date" name="payment_date" value="<?php echo date('d-m-Y'); ?>" class="paydatepicker"/>
                                        </div>
                            </div> <!-- innerRow -->
                        </div> <!-- 4 -->
                        <div class="col-sm-4">
      ...
      <div class="b_doc_pay">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a href="javascript:void(0)" onClick="return doctor_commission_excel();" class="dropdown-item update_data">
            <i class="fa fa-money"></i> Excel
          </a>
          
          <br><a href="javascript:void(0)" onClick="return print_letter_head_doctor_commission();" class="dropdown-item update_data">
            <i class="fa fa-file-excel-o"></i> PDF</a>
            <br>
                   <a  href="javascript:void(0)" onClick="return doctor_commission_details();" class="dropdown-item update_data">
        ...
        ?>
          <button type="button" onClick="return receive_now(1)" class="btn-anchor m-b-2">
           ...
           <?php } ?>
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item update_data" title="Export data for update" href="javascript:void(0)" onClick="return all_doctor_commission_excel();"> <i class="fa fa-file-excel-o"></i> Excel</a><br><a data-toggle="tooltip"  title="Download list in pdf"  href="javascript:void(0)" onClick="return total_doctor_comission_pdf();" class="dropdown-item update_data"><i class="fa fa-file-pdf-o"></i> PDF </a><br><a data-toggle="tooltip"  title="Print patient list" href="javascript:void(0)" class="dropdown-item update_data"  onClick="return all_doctor_commission_details();"><i class="fa fa-print"></i> Print
                </a> 
...
//overall excel
function all_doctor_commission_excel()
{
  ...
  var printer_id = $('#printer_id').val();
   ...
   window.open('<?php echo base_url('billing/total_doctor_comission_excel?doctor_id=') ?>'+doctor_id+'&branch_id='+branch_id+'&start_date='+start_date+'&end_date='+end_date+'&printer_id='+printer_id,'mywin','width=800,height=600');
 
 }
 

function all_doctor_commission_details()
{
  ...
  var printer_id = $('#printer_id').val();
   ...
   window.open('<?php echo base_url('billing/total_doctor_comission_print?doctor_id=') ?>'+doctor_id+'&branch_id='+branch_id+'&start_date='+start_date+'&end_date='+end_date+'&printer_id='+printer_id,'mywin','width=800,height=600');
  
  
 } 
 function total_doctor_comission_pdf()
{
  ...
  var printer_id = $('#printer_id').val();
   ...
   window.open('<?php echo base_url('billing/total_doctor_comission_pdf?doctor_id=') ?>'+doctor_id+'&branch_id='+branch_id+'&start_date='+start_date+'&end_date='+end_date+'&printer_id='+printer_id,'mywin','width=800,height=600');
...
function doctor_paid_commission_list()
{
  ...
  ?> 
   var doctors_id = $("input[type='radio'][name='doctors_id']:checked").val();
 if(doctor_id<0)
 {
...
function doctor_commission_final_step(){
    ...
    if(doctor_id<0)
    {
      var doctor_id = $("input[type='radio'][name='doctors_id']:checked").val();  
    }
    ...
    var printer_id = $('#printer_id').val();
     ...
     $.ajax({
          ...
          data: { from_date: from_date, to_date : to_date, doctor_id : doctor_id, branch_id : branch_id,printer_id:printer_id,total_due:total_due,balance:balance,department_type:department_type,pay_mode:pay_mode,pay_amount:pay_amount,remarks:remarks,payment_date:payment_date} ,  
          success: function(result) 
          {
               var doctor_id = $('#doctor_id').val();
               if(doctor_id>0)
               {
                   var doctorsid = doctor_id;
               }
               else
               {
                   var doctor_id = $("input[type='radio'][name='doctors_id']:checked").val();
...
function get_indivisual_doctor(doctor_id,start_date,end_date,branch_id)
{
