...
$total_balance = number_format($all_detail['booking_list'][0]->balance,2);
$total_paid = number_format($all_detail['booking_list'][0]->debit,2);
$total_amount = $total_balance+$total_paid; 
...
if($template_data->printer_id==2)
{
        ...
        $template_data->template = str_replace("{payment_mode}",$payment_mode_arr[$all_detail['booking_list'][0]->payment_mode],$template_data->template); 
        ...
        $template_data->template = str_replace("{paid_amount}",$total_paid,$template_data->template);
        $template_data->template = str_replace("{balance}",$total_balance,$template_data->template);
...
if($template_data->printer_id==3)
{
    ...
    $template_data->template = str_replace("{total_net}",$total_amount,$template_data->template);
    $template_data->template = str_replace("{paid_amount}",$total_paid,$template_data->template);
    $template_data->template = str_replace("{total_gross}",$total_amount,$template_data->template);
...
if($template_data->printer_id==1)
{
    ...
    $template_data->template = str_replace("{total_discount}",'0.00',$template_data->template);
    $template_data->template = str_replace("{net_amount}",$total_amount,$template_data->template);
    $template_data->template = str_replace("{paid_amount}",$total_paid,$template_data->template);
    $template_data->template = str_replace("{gross_total_amount}",$total_amount,$template_data->template);
    $template_data->template = str_replace("{balance}",$total_balance,$template_data->template);
