...
<body style="background: rgb(204,204,204);font-family:Arial;color:#333;font-size:13px;">
		<page size="A4">
		  <table width="100%" class="m-b-5">
			<tbody>
				...
				?>
					<tr>
					  	<td colspan="4"><h2 align="center">Doctor Payment List</h2></td>
					</tr>
					<tr>
			...
			<div style="display:block;border-top:2px solid black;">&nbsp;</div>
		 		<div style="float:left;width:100%;margin-top:20px;">
					...
					<div style="float:left;width:100%;display:inline-flex;">
                        <div style="width:15%;font-weight:bold;padding-bottom:10px;padding-left:5px;"> Bill No. </div>
                        <div style="width:20%;font-weight:bold;padding-bottom:10px;"> Patient Name</div>
                        <div style="width:10%;font-weight:bold;padding-bottom:10px;"> Date</div> 
                        <div style="width:20%;font-weight:bold;padding-bottom:10px;"> Department</div>
                        <div style="width:15%;font-weight:bold;padding-bottom:10px;"> Bill Amt.</div>
                        <div style="width:20%;font-weight:bold;padding-bottom:10px;text-align:right;padding-right:1em;">Commission</div>
	...
	<?php
	 ...
	 { 
	  ...
	  ?>
		<div style="float:left;width:100%;display:inline-flex;">
        <div style="width:15%;padding-bottom:10px;padding-left:5px;"><?php echo $data->patient_code; ?></div>
        <div style="width:20%;padding-bottom:10px;"><?php echo $data->patient_name; ?></div>
        <div style="width:10%;padding-bottom:10px;"><?php echo date('d-m-Y',strtotime($data->booking_date)); ?></div> 
        <div style="width:20%;padding-bottom:10px;"><?php echo $data->commission_type; ?></div>
        <div style="width:15%;padding-bottom:10px;"><?php echo $data->bill_amount; ?></div>
