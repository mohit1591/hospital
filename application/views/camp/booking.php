...
$('document').ready(function(){
 ...
 $opd_booking_id = $this->session->userdata('opd_booking_id');
  ...
  .one('click', '#cancel', function(e)
    { 
        //window.location.href='<?php echo base_url('camp/booking');?>'; 
    }); 
...
<div class="col-xs-4">
  ...
  <div class="row m-b-5">
    <div class="col-md-12">
       <div class="row">
         <div class="col-md-4"><b>Camp Booking No.</b></div>
         <div class="col-md-8">
 ...
 <div class="row m-b-5">
   ...
   <div class="col-md-8">
     <select class="mr m_mr alpha_space"  name="simulation_id" id="simulation_id" onchange="find_gender(this.value)">
        ...
        <input type="text" name="patient_name" id="patient_name" value="<?php echo $form_data['patient_name']; ?>" class="mr-name m_name txt_firstCap" style="width:129px!important;"  autofocus/>
  ...
  <div class="row m-b-5" id="pedic_spec" >
    <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-8">
           <input type="text" class="datepicker_dob" readonly="" name="dob" id="dob" value="<?php if(strtotime($form_data['dob'])>86400){echo $form_data['dob'];}else{echo '';} ?>"  onchange="showAge(this.value);"/> 
         </div>
       </div>
    </div>
  </div>
...
<div class="row m-b-5">
     <div class="col-md-12">
       <div class="row">
         <div class="col-md-5"><b>Camp<span class="star">*</span></b></div>
        <div class="col-md-7">
            <select name="camp_id" id="camp_id" class="w-150px m_select_btn">
              ...
              if(!empty($camp_list))
              {
                ...
                {
                  ?>
                    <option <?php if($form_data['camp_id']==$camp->id){ echo 'selected="selected"'; } ?> value="<?php echo $camp->id; ?>"><?php echo $camp->camp_name; ?></option>
            ...
            <?php if(in_array('1899',$users_data['permission']['action'])) { ?>
            <a  class="btn-new" id="patient_camp_add_modal"><i class="fa fa-plus"></i> New</a>
            <?php } ?>
            <?php if(!empty($form_error)){ echo form_error('camp_id'); } ?>
         </div>
       </div>
    </div>
  </div> <!-- row -->
 <?php /* }else{ ?> <input type="hidden" name="camp_id" value="0"> <?php } */ ?> 
 ...
 <!--  <div class="row m-b-5">
    <div class="col-md-12">
       <div class="row">
         <div class="col-md-5"><b>Referred By</b></div>
         <div class="col-md-7">
           <select name="referral_doctor" id="refered_id" class="w-150px"  onChange="return get_other(this.value)">
  ...
  <div class="row m-b-5">
    <div class="col-md-12">
       <div class="row">
         <div class="col-md-5"><b>Specialization<span class="star">*</span></b></div>
  ...
  <div class="row m-b-5">
    <div class="col-md-12">
       <div class="row">
         <div class="col-md-5"><b>Consultant </b>
    ...
    <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-7" id="pannel_type">
           <input type="radio" name="pannel_type" value="0" onclick="update_doctor_panel_charges(); set_tpa(0);" <?php if($form_data['pannel_type']==0){ echo 'checked="checked"'; } ?>> Normal &nbsp;
            <input type="radio" name="pannel_type" value="1" onclick="update_doctor_panel_charges();set_tpa(1);" <?php if($form_data['pannel_type']==1){ echo 'checked="checked"'; } ?>> Panel
    ...
    <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-7">
              ...
              <a href="<?php echo base_url('camp');?>" class="btn-anchor"><i class="fa fa-sign-out"></i> Exit</a>
         </div>
       </div>
    </div>
  </div> <!-- row -->
                    ...
                    if(!empty($vitals_list))
                    {
                      ...
                      foreach ($vitals_list as $vitals) 
                      {
                        ...
                        <div class="grp">
                              ...
                              <input   name="data[<?php echo $vitals->id; ?>][name]" value="<?php echo $vital_val; ?>"  type="text" class=" w-50px m_tiny" style="width:70px !important;">
...
function change_validity_date(vals)
{
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>camp/get_validate_date/", 
        dataType: "json",
...
var $modal2 = $('#load_add_camp_modal_popup');
$('#patient_camp_add_modal').on('click', function(){
$modal2.load('<?php echo base_url().'eye/camp_details/add/' ?>',
{
  //'id1': '1',
  //'id2': '2'
  },
...
$modal.modal('show');
 ...
 function payment_function(value,error_field){
    $('#updated_payment_detail').html('');
     $.ajax({
        type: "POST",
        url: "<?php echo base_url('camp/get_payment_mode_data')?>",
...
<?php if(empty($form_data['data_id'])){ ?>
      $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>camp/generate_token/", 
              dataType: "json",
...
<?php if(empty($form_data['data_id'])){ ?>
  ...
  { 
          ...
          $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>camp/doctor_rate/", 
              dataType: "json",
        ...
        else if(doctor_id!='' && opd_type=='1')
        {
          ...
          $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>camp/doctor_emergency_rate/", 
              dataType: "json",
              data: 'branch_id='+branch_id+'&doctor_id='+doctor_id+'&total_amount='+total_amount+'&discount='+discount+'&paid_amount='+paid_amount+'&kit_amount='+kit_amount+'&panel_type='+panel_type+'&ins_company_id='+ins_company_id+'&opd_type='+opd_type,
              success: function(result)
              {
  ...
  function get_validity_date_in_between(vals)
  {
     ...
     $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>camp/get_validity_date_in_between/", 
              dataType: "json",
              data: 'doctor_id='+doctor_id+'&booking_date='+booking_date+'&patient_id='+patient_id,
                  success: function(result)
                  {
   ...
   if(panel_type=='1')
    {
        ...
        $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>camp/doctor_panel_rate/", 
              dataType: "json",
  ...
  function kit_charge(vals)
  {
      ...
      $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>camp/package_rate/", 
          dataType: "json",
 ...
 function update_kit_amount(val)
 {
     if(val!='')
     {
        ...
        var discount = $('#discount').val();
         ...
         $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>camp/update_amount/", 
            dataType: "json",
 ...
 function update_amount(val)
 {
  ...
  function payment_calc()
  {
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>camp/calculate_payment/", 
            dataType: "json",
...
$('#branch_id').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>camp/get_branch_data/"+branch_id, 
        success: function(result)
        {
           load_values(result);
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>camp/get_simulation_data/"+branch_id, 
    success: function(result)
    {
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>camp/get_referral_doctor_data/"+branch_id, 
    success: function(result)
    {
  ...
  function more_patient_info()
 {
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>camp/get_specialization_data/"+branch_id, 
    success: function(result)
    {
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>camp/get_attended_doctor_data/"+branch_id, 
    success: function(result)
    {
      $('#attended_doctor').html(result); 
    } 
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>camp/get_source_from_data/"+branch_id, 
    success: function(result)
    {
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>camp/get_diseases_data/"+branch_id, 
    success: function(result)
    {
  ...
  {
      $.ajax({url: "<?php echo base_url(); ?>camp/get_package_data/"+branch_id, 
      success: function(result)
      {
...
$(document).ready(function() {
  $('#load_add_camp_modal_popup').on('shown.bs.modal', function(e){
    $('.inputFocus').focus();
  });
});
...
<div id="load_add_camp_modal_popup" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false"></div> 
