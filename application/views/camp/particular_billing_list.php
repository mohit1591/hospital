...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('opd/ajax_particular_billing_list')?>",
            "type": "POST",
        }, 
        "columnDefs": [
        { 
...
<section class="userlist">
    ...
    <form>
  	...
  	<div class="userlist-right">
  		<div class="btns">
  			<button class="btn-update" onclick="window.location.href='<?php echo base_url('opd/billing'); ?>'">
        ...
        <button class="btn-update" onclick="reload_table()">
          <i class="fa fa-refresh"></i> Reload
  			...
  			<button class="btn-exit" onclick="window.location.href='<?php echo base_url('opd/billing_archive'); ?>'">
...
<script>  
 ...
 ?>
  ...
  {
    var $modal = $('#load_add_modal_popup');
    $modal.load('<?php echo base_url().'opd/confirm_billing/' ?>'+id,
    {
      //'id1': '1',
      //'id2': '2'
      },
 ...
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('opd/delete_billing/'); ?>"+billing_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
