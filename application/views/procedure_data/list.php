...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('procedure_data/ajax_list')?>",
            "type": "POST",
...
{
  var $modal = $('#load_add_religion_modal_popup');
  $modal.load('<?php echo base_url().'procedure_data/edit/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        .one('click', '#delete', function(e)
        {
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('procedure_data/deleteall');?>",
                      data: {row_id: allVals},
    ...
    <form>
  	...
  	<div class="userlist-right">
       ...
       <button class="btn-update" onclick="reload_table()">
        ...
        {
        ?>
        <button class="btn-exit" onclick="window.location.href='<?php echo base_url('procedure_data/archive'); ?>'">
...
<script>  
 ...
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('procedure_data/delete/'); ?>"+rate_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
