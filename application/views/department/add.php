...
<div class="overlay-loader" id="overlay-loader">
  ...
  <form  id="department" class="form-inline">
...
$("#department").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('department/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
    success: function(result) {
      if(result==1)
      {
        $('#load_add_department_modal_popup').modal('hide');
      ...
      {
        $("#load_add_department_modal_popup").html(result);
      }       
      $('#overlay-loader').hide();
    }
  });
...
{
   $.ajax({url: "<?php echo base_url(); ?>department/department_dropdown/", 
    success: function(result)
    {
