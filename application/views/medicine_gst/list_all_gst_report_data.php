<?php //print '<pre>'; print_r($branch_gst_list['purchasedata']);die; ?>
...
<body style="background: rgb(204,204,204);font-family:sans-serif, Arial;color:#333;">
  ...
  <b>Purchase GST Report</b>
    <div style="float:left;width:100%;border:1px solid #111;font-size:13px;">
      ...
      <div style="float:left;width:20%;font-weight:600;padding:4px;text-align:right;"><u>Tot.Amt.</u></div>
  ...
  <?php if(!empty($branch_gst_list['purchasedata'])) { ?>

    <?php 

    $i = 1;   
  
      foreach($branch_gst_list['purchasedata'] as $branchs)
      {   
      ...
      <div style="float:left;width:20%;padding:1px 4px;text-align:right;"><?php echo $branchs->total_amount; ?></div>
 ...
 <div>
  <b>Purchase Return GST Report</b>
  <div style="float:left;width:100%;border:1px solid #111;font-size:13px;">
  
      <div style="float:left;width:10%;font-weight:600;padding:4px;"><u>Sr.No.</u></div>
      <div style="float:left;width:20%;font-weight:600;padding:4px;"><u>Return No.</u></div>
      <div style="float:left;width:20%;font-weight:600;padding:4px;"><u>Vendor Name</u></div>
      <div style="float:left;width:20%;font-weight:600;padding:4px;text-align:right;"><u>Tot.Amt.</u></div>
  ...
  <?php if(!empty($branch_gst_list['purchase_return'])) { ?>

    <?php 

    $i = 1;   
  
      foreach($branch_gst_list['purchase_return'] as $branchs)
      {   
     
      ?>    
      <div style="float:left; width: 100%">
      <div style="float:left;width:10%;padding:1px 4px;text-indent:15px;"><?php echo $i; ?></div>
      <div style="float:left;width:20%;padding:1px 4px;"><?php echo $branchs->return_no; ?></div>
      <div style="float:left;width:20%;padding:1px 4px;"><?php echo $branchs->vendor_name; ?></div>
      <div style="float:left;width:20%;padding:1px 4px;text-align:right;"><?php echo $branchs->total_amount; ?></div>
      <div style="float:left;width:10%;padding:1px 4px;text-align:right;"><?php echo $branchs->cgst;  //$pay_mode[$branchs->pay_mode]; ?></div>
      <div style="float:left;width:10%;padding:1px 4px;text-align:right;"><?php echo $branchs->sgst;  //$pay_mode[$branchs->pay_mode]; ?></div>
  ...
  <!--sale report -->
 <div><b>Sale GST Report</b>
   <div style="float:left;width:100%;border:1px solid #111;font-size:13px;">
   
      <div style="float:left;width:10%;font-weight:600;padding:4px;"><u>Sr.No.</u></div>
      <div style="float:left;width:20%;font-weight:600;padding:4px;"><u>Sale No.</u></div>
  ...
  <?php if(!empty($branch_gst_list['sale_report'])) { ?>

    <?php 

     $i = 1;   
  
      foreach($branch_gst_list['sale_report'] as $branchs)
      {   
     
      ?>    
      <div style="float:left; width: 100%">
      <div style="float:left;width:10%;padding:1px 4px;text-indent:15px;"><?php echo $i; ?></div>
      <div style="float:left;width:20%;padding:1px 4px;"><?php echo $branchs->sale_no; ?></div>
  ...
  <!--sale return report -->
 <div> <b>Sale Return GST Report</b>
   <div style="float:left;width:100%;border:1px solid #111;font-size:13px;">
  ...
  <?php if(!empty($branch_gst_list['sale_return_report'])) { ?>

    <?php 

    $i = 1;   
  
      foreach($branch_gst_list['sale_return_report'] as $branchs)
      {   
