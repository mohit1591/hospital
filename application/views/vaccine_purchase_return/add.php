    ...
    <div class="row">
        <div class="col-md-12">
            <?php if(!empty($form_data['vendor_id'])){?>
                 <span class="new_vendor"><input type="radio" name="new_vendor" onClick="window.location='<?php echo base_url('vaccine_purchase_return/');?>add/';"> <label>New Vendor</label></span>
               ...
               <?php  }else{?>
                 <span class="new_vendor"><input type="radio" name="new_vendor" checked onClick="window.location='<?php echo base_url('vaccine_purchase_return/');?>add/';"> <label>New Vendor</label></span>
            ...
            <div class="purchase_medicine_left">
             ...
             <div class="purchase_medicine_left">
                <div class="grp m-t-5">
                    ...
                    <input type="text" class="alpha_numeric_space m_input_default" name="name" value="<?php echo $form_data['name'];?>">
       ...
       <div class="box_scroll">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <tr id="previours_row">
                       <td colspan=""></td>
                        <td colspan=""><input type="text" name="vaccine_name" id="vaccine_name" class="w-150px" onkeyup="search_func(this.value);" /></td>
                        <td colspan=""><input type="text" name="vaccine_code" id="vaccine_code" class="w-60px" onkeyup="search_func(this.value);" /></td>
                         <td colspan=""><input type="text" name="hsn_no" id="hsn_no" onkeyup="search_func(this.value);" class="w-60px"/></td>
                        <td colspan=""><input type="text" name="vaccine_company" id="vaccine_company" onkeyup="search_func(this.value);" class="w-150px"/></td>
                        <td colspan=""><input type="text" name="packing" id="packing"  onkeyup="search_func(this.value);"/></td>
                        <td colspan=""><input type="text" name="batch_number" id="batch_number"  class="w-60px" onkeyup="search_func(this.value);" /></td>
                        <td colspan=""><input type="text" name="bar_code" id="bar_code"  onkeyup="search_func(this.value);" class="w-60px"/></td>
                        <td colspan=""><input type="text" name="conv" id="conv" onkeyup="search_func(this.value);" class="w-60px"/></td>
                        ...
                        <td colspan=""><input type="text" name="mrp" id="mrp" onkeyup="search_func(this.value);" class="w-60px"/></td>
                        <td colspan=""><input type="text" name="p_rate" id="p_rate"  onkeyup="search_func(this.value);" class="w-60px"/></td>
                        ...
                        <td colspan=""><input type="text" name="discount" id="discount_search"  onkeyup="search_func(this.value);" class="w-60px"/></td>
                        <td colspan=""><input type="text" name="cgst" id="cgst_search" onkeyup="search_func(this.value);" class="w-60px"/></td>
                        <td colspan=""><input type="text" name="sgst" id="sgst_search" onkeyup="search_func(this.value);" class="w-60px"/></td>
                        <td colspan=""><input type="text" name="igst" id="igst_search" onkeyup="search_func(this.value);" class="w-60px"/></td>
        ...
        <div class="right relative">
            <div class="fixed">
                ...
                <a href="<?php echo base_url('vaccine_purchase_return');?>" class="btn-anchor"><i class="fa fa-sign-out"></i> Exit</a>
            </div>
...
{  
  ...
  //  alert(val1);
    ...
    var vaccine_company = $('#vaccine_company').val();
   ...
   // var vat = $('#vat_search').val();
    ...
    $.ajax({
       type: "POST",
       url: "<?php echo base_url('vaccine_purchase_return/ajax_list_medicine')?>",
       data: {'vaccine_name' : vaccine_name,'batch_number':batch_number,'vaccine_code':vaccine_code,'vaccine_company':vaccine_company,'conv':conv,'unit1':unit1,'unit2':unit2,'mrp':mrp,'hsn_no':hsn_no,'p_rate':p_rate,'discount':discount,'cgst':cgst,'igst':igst,'sgst':sgst,'packing':packing,'bar_code':bar_code},
       dataType: "json",
       success: function(msg){
       // alert(msg.data);
        $(".append_row").remove();
...
//alert();
 ...
 function toggle(source) 
  ...
  {   
   ...
   if(allVals!="")
   {
      $.ajax({
              type: "POST",
              url: "<?php echo base_url('vaccine_purchase_return/set_medicine');?>",
  ...
  {
    $.ajax({
                    url: "<?php echo base_url(); ?>vaccine_purchase_return/ajax_added_medicine", 
                    dataType: "json",
                   success: function(result)
                    {
                      $('#medicine_select').html(result.data); 
  ...
  { 
   if(allVals!="")
   {
      $.ajax({
              type: "POST",
              url: "<?php echo base_url('vaccine_purchase_return/remove_medicine_list');?>",
               dataType: "json",
              data: {vaccine_id: allVals},
              success: function(result) 
              {  
 ...
 function payment_cal_perrow(ids){
   ...
   var conversion = $('#conversion_'+ids).val();
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>vaccine_purchase_return/payment_cal_perrow/", 
            dataType: "json",
            data: 'mbid='+mbid+'&purchase_rate='+purchase_rate+'&batch_no='+batch_no+'&mrp='+mrp+'&conversion='+conversion+'&manuf_date='+manuf_date+'&unit1='+unit1+'&unit2='+unit2+'&freeunit1='+freeunit1+'&freeunit2='+freeunit2+'&vaccine_id='+vaccine_id+'&expiry_date='+expiry_date+'&cgst='+cgst+'&igst='+igst+'&sgst='+sgst+'&discount='+discount+'&hsn_no='+hsn_no+'&bar_code='+bar_code,
            success: function(result)
            {
   ...
   function payment_calc_all(pay)
    ...
    var igst = $('#igst_percent').val();
      $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>vaccine_purchase_return/payment_calc_all/", 
      dataType: "json",
  ...
  function validation_check(unit,id,m_id){
    ...
    var unit2= $('#unit2_'+id).val();
     var unit1= $('#unit1_'+id).val();
      $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>vaccine_purchase_return/check_stock_avability/", 
      dataType: "json",
