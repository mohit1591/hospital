...
$(document).ready(function(){
 ...
 /*function get_data(value){
     $("#profile_lists tbody").html('<tr><td colspan="6" align="center"><font color="#b64a30">Test not available.</font></td></tr>');
     ...
     else if(value==1)
     {
          ...
          $.post('<?php //echo base_url('path_profile_panel_price/get_transactional_doctors_list/'); ?>',{},function(result)
              {
               if(result!='')
               {
 ...
 //     $("#profile_lists tbody").html('<tr><td colspan="6" align="center"><font color="#b64a30">Test not available.</font></td></tr>');
 //     if(value!=''){
 //          $.post('<?php echo base_url('path_profile_panel_price/get_test_heads_list/'); ?>',{'department_id':value},function(result){
