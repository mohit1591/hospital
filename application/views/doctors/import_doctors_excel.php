...
?>
 <div class="modal-dialog">
  ...
  <div class="modal-content"> 
      <form  id="doctors_opening" class="form-inline" enctype="multipart/form-data">
          <div class="modal-header">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                 ...
                 <div class="col-md-7">
                     <input type="file" accept=".xls"  name="doctor_list" id="doctor_list"/>
                     <p id="msg"></p> 
                     <input type="hidden" name="name" id="name" value="0"/>
                      <?php if(!empty($form_error)){ echo form_error('doctor_list'); } ?>
                 </div> <!-- 8 -->
              </div> <!-- row -->
...
$("button[data-number=2]").click(function(){
  <?php //$this->session->unset_userdata('alloted_medicine_ids'); ?>
    $('#load_doctors_import_modal_popup').modal('hide'); 
}); 

$("#doctors_opening").on("submit", function(event) { 
     event.preventDefault(); 
     $('.overlay-loader').show();
  
     var path = 'import_doctors_excel/';
     var msg = 'Doctors successfully added.';
     var allVals = [];
     $.ajax({
          ...
          success: function(result) {
               ...
               {
                    $("#load_doctors_import_modal_popup").html(result);
               }
               $('.overlay-loader').hide();       
          }
     });
