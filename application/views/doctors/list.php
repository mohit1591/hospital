...
<div class="row m-b-5">
  ...
  <table class="ptl_tbl">
    ...
    <tr>
      <td><label><b>Doctor Reg. No.</b></label><input name="doctor_code" value="<?php echo $form_data['doctor_code'];?>" id="doctor_code" onkeyup="return list_form_submit();" class="upper_case m_input_default m_input_default"  value="" type="text" autofocus></td>
    ...
    <form>
      ...
      <div class="fixed">
  		<div class="btns">
               ...
               ?>
  			     <button class="btn-update" id="doctor_add_modal" data-toggle="tooltip"  title="Add Doctor">
...
?>
<script>
function doctor_report(testid)
 {
   $.ajax({
        url: "<?php echo base_url('doctors/doctor_report'); ?>/"+testid,
