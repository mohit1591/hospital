...
<div class="row">
  <div class="col-md-12 add_opd_print_setting">
    <form action="<?php echo base_url('daycare_discharge_medicine_print_setting/add'); ?>" method="post">
...
<textarea type="text" name="short_code" class="print_textarea"  id="" cols="45" readonly>{patient_name},{mobile_no},{gender_age},{patient_address},{daycare_no},{date_admission},{date_discharge},{doctor_incharge},{discharge_medicine_list},{signature}
</textarea>
      </div>
    </div> <!-- rowClose -->
   ...
   <div class="row m-b-5">
      ...
      <div class="col-xs-10">
       <button class="btn-save" type="submit" name="remove_levels" onClick=" validateForm();" ><i class="fa fa-floppy-o"></i> Save</button>
             <button type="button" class="btn-update" onclick="window.location.href='<?php echo base_url('day_care'); ?>'">
