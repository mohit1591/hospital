          ...
          <div class="row">
            <div class="col-md-12 m-b1">
              ...
              <div class="row m-b-5">
                ...
                <div class="col-md-8">
                    <input type="text" name="salt"   class="alpha_numeric_space" value="<?php echo $form_data['salt']; ?>">
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('admissionnotes/medicine/get_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$("#medicine").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('admissionnotes/medicine/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
...
{
   $.ajax({url: "<?php echo base_url(); ?>admissionnotes/medicine/medicine_dropdown/", 
    success: function(result)
    {
