...
<script>
      function room_no_select(value_room,room_no_id)
      {
        if(value_room=='All')
        {
            ...
            $.ajax({
                    url: "<?php echo base_url('ipd_room_list/select_all_bed_number/'); ?>",
                    type: "post",
     ...
     function select_no_bed(value_bed,bed_id){
        ...
        $.ajax({
                url: "<?php echo base_url('ipd_room_list/select_bed_no_number/'); ?>",
                type: "post",
      ...
      if(confirmation){
        ...
        $.ajax({
                url: "<?php echo base_url('ipd_room_list/free_room/'); ?>",
                type: "post",
     ...
     {
         $.ajax({
                url: "<?php echo base_url('ipd_room_list/search_filled/'); ?>",
                type: "post",
     ...
     function all_search_filled(status)
      {
            ...
            $.ajax({
                    url: "<?php echo base_url('ipd_room_list/all_search_filled/'); ?>",
                    type: "post",
                    data: {status:status},
                    success: function(result) 
                    {
