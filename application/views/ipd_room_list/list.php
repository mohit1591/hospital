...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('ipd_room_list/ajax_list')?>",
            "type": "POST",
...
$(document).ready(function(){
var $modal = $('#load_add_ipd_room_list_modal_popup');
     ...
     <?php } ?>
  	...
  	<div class="userlist-right">
  		<div class="btns">
              ...
              <?php if(in_array('670',$users_data['permission']['action'])) {
               ?>
             <a href="<?php echo base_url('ipd_room_list/room_list_excel'); ?>" class="btn-anchor m-b-2">
              <i class="fa fa-file-excel-o"></i> Excel
              </a>

              <a href="<?php echo base_url('ipd_room_list/room_list_csv'); ?>" class="btn-anchor m-b-2">
              <i class="fa fa-file-word-o"></i> CSV
              </a>

              <a href="<?php echo base_url('ipd_room_list/pdf_room_list'); ?>" class="btn-anchor m-b-2">
             ...
             <!--  <a href="javascript:void(0)" class="btn-anchor m-b-2" id="deleteAll" onClick="return openPrintWindow('< ?php echo base_url("medicine_entry/print_medicine_entry"); ?>', 'windowTitle', 'width=820,height=600');">
              ...
              <a href="javascript:void(0)" class="btn-anchor m-b-2"  onClick="return print_window_page('<?php echo base_url("ipd_room_list/print_room_list"); ?>');"> <i class="fa fa-print"></i> Print</a>
               ...
               ?>
  			  <button class="btn-update" onclick="window.location.href='<?php echo base_url('ipd_room_list/archive'); ?>'">
 ...
 function reset_search()
  ...
  $("#room_list_data").on("submit", function(event) { 
   ...
   $('#overlay-loader').show();
    ...
    $.ajax({
        url: "<?php echo base_url(); ?>ipd_room_list/advance_search/",
        type: "post",
        data: $(this).serialize(),
        success: function(result) 
        {
            $('#load_add_ipd_room_list_modal_popup').modal('hide'); 
            reload_table();       
            $('#overlay-loader').hide();
        }
    });
...
$(document).ready(function(){
  $('#load_add_ipd_room_list_modal_popup').on('shown.bs.modal', function(e){
    $('.inputFocus').focus();
  });
});
...
<div id="load_add_ipd_room_list_modal_popup" class="modal fade modal-50" role="dialog" data-backdrop="static" data-keyboard="false"></div>
