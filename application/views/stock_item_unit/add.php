      ...
      <div class="modal-body">   
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row">
                ...
                <div class="col-md-8">
                    <input type="text" name="stock_item_unit" class="inputFocus" value="<?php echo $form_data['stock_item_unit']; ?>">
          ...
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row">
                <div class="col-md-4">
                 <label>Stock second unit</label>
                </div>
                <div class="col-md-8">
                   <select name="second_unit">
                      <option value="">Select Second Unit</option>
                      <?php foreach($get_stock_item_list as $vacination_list){ ?>
                      <option value="<?php echo $vacination_list->id;?>" <?php if(isset($form_data['second_unit']) && $form_data['second_unit']== $vacination_list->id){echo 'selected';}?>><?php echo $vacination_list->unit; ?></option>
...
$("#stock_item_unit_new").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('stock_item_unit/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
