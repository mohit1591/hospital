...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "order": [], 
        "ajax": {
            "url": "<?php echo base_url('stock_item_unit/archive_ajax_list')?>",
            "type": "POST",
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('stock_item_unit/restoreall');?>",
                      data: {row_id: allVals},
 ...
 <div class="col-md-12">
    ...
    <form>
       ...
       <!-- bootstrap data table -->
        <table id="table" class="table table-striped table-bordered unit_archive" cellspacing="0" width="100%">
  	...
  	<div class="userlist-right">
        ...
        <?php
          ...
          <?php } ?> 
        <button class="btn-update" onclick="window.location.href='<?php echo base_url('stock_item_unit'); ?>'">
...
<script> 
 ...
 function restore_unit(employee_type_id)
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('stock_item_unit/restore/'); ?>"+employee_type_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
...
{         
 ...
 {     
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('stock_item_unit/trash/'); ?>"+unit_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('stock_item_unit/trashall');?>",
                      data: {row_id: allVals},
                      success: function(result) 
                      {
                            flash_session_msg(result);
