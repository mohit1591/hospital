      ...
      <div class="modal-body">   
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row">
                <div class="col-md-4">
                    <label>Medicine Kit Name<span class="star">*</span></label>
                </div>
                <div class="col-md-8">
                    <input type="text" name="medicine_kit_name"  value="<?php echo $form_data['medicine_kit_name']; ?>">
                    
                    <?php if(!empty($form_error)){ echo form_error('medicine_kit_name'); } ?>
                </div>
              </div> <!-- innerrow -->
              <div class="row">
                <div class="col-md-4">
...
$("#medicine_kit_add").on("submit", function(event) { 
  ...
  // { 
    ...
    var msg = 'Medicine Kit Quantity successfully Add.';
  // }
  // else
  // {
  //   var path = 'add/';
  ...
  $.ajax({
    url: "<?php echo base_url('packages/add_medicine_kit_quantity'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
      ...
      if(result==1)
      {
        ...
        if(opt=='add'){
           reload_table();
            ...
            window.location.href="<?php echo base_url(); ?>packages/add_medicine_kit_qty_manage/"+ids;
        }
      } 
      else
      {
