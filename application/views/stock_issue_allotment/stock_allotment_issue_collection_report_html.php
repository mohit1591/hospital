<html><head>
<title>Stock Allotment Item Collection Inventory Report</title>
<?php
if($print_status==1)
{
?>
...
<table width="100%" cellpadding="0" cellspacing="0" colspan="10" border="1px" style="font:13px Arial;">
    <tr><td colspan="9" align="center"><h3>Stock Allotment Item Collection Inventory Report <?php 
...
if(!empty($search['start_date'])){ echo $search['start_date']; } ?><?php if(!empty($search['end_date'])){ echo ' To  '.$search['end_date']; } ?></h3></td></tr>
 <tr>
    <th> Sr.No.</th>
    <th> Issue Code</th>
    <th> Employee / Patient / Doctor Name</th>
    <th> Total Amount </th>
    <th> Discount </th>		  
    <th> Net Amount </th> 
    <th> Paid Amount </th> 
