...
$template_data->template = str_replace("{customer_code}",$all_detail['sales_list'][0]->customer_code,$template_data->template);
...
if($template_data->printer_id==2)
{
	...
	$template_data->template = str_replace("{issue_no}",$all_detail['sales_list'][0]->issue_no,$template_data->template);
	...
	{
	    $serial_no=array();
        $purchase_item_serial =get_serial_no_item($ids,$sales_list->item_id);
