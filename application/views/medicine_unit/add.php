          ...
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row">
                ...
                <div class="col-md-8">
                    <input type="text" name="medicine_unit"  class=" inputFocus" value="<?php echo $form_data['medicine_unit']; ?>">
                    
                    <?php if(!empty($form_error)){ echo form_error('medicine_unit'); } ?>
                </div>
              </div> <!-- innerrow -->
            </div> <!-- 12 -->
          </div> <!-- row -->  
...
$("#medicine_unit").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('medicine_unit/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
