...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "aaSorting": [],
        "ajax": {
            "url": "<?php echo base_url('billing_part_summary_report/ajax_list')?>",
            "type": "POST"
        }, 
        "columnDefs": [
        { 
...
function reset_date_search()
  {
      ...
      $('#employee').val('');
      $.ajax({
         url: "<?php echo base_url('billing_part_summary_report/reset_date_search/'); ?>",  
...
<!-- bootstrap data table -->
    ...
    <div class="userlist-right relative" id="example_wrapper">
      <div class="fixed">
      <div class="btns"> 
               <a href="<?php echo base_url('billing_part_summary_report/part_summary_report_excel'); ?>" class="btn-anchor m-b-2">
                    <i class="fa fa-file-excel-o"></i> Excel
               </a>
               <a href="<?php echo base_url('billing_part_summary_report/pdf_summary_report'); ?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-pdf-o"></i> PDF
               </a>
            <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("billing_part_summary_report/print_summary_report"); ?>');">
...
function clear_form_elements(ele) {
   $.ajax({url: "<?php echo base_url(); ?>billing_part_summary_report/reset_date_search/",
      success: function(result)
      {
...
function form_submit(){
    ...
    $.ajax({
           url: "<?php echo base_url('billing_part_summary_report/search_data/'); ?>", 
           type: 'POST',
           data: { start_date: start_date, end_date : end_date,branch_id:branch_id,particulars:particulars} ,
           success: function(result)
           { 
              reload_table(); 
           }
