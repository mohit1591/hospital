...
<page size="A4">
    ...
    <div style="float:left; margin-top:10px; width:100%;border:1px solid #111;border-top:none;font-size:13px;">       
          ...
          <div style="float:left;width:100%;border:1px solid #111;border-left:none;border-right:none;font-size:13px;">
            ...
            <div style="float:left;width:30%;font-weight:600;padding:4px;"><u>Bill No.</u></div> 
...
//print_r($report_list);die();
       ...
       <div style="float:left;width:100%;border:1px solid #111;border-left:none;border-right:none;font-size:13px;">
            ...
            <div style="float:left;width:15%;font-weight:600;padding:4px;"><?php if($list->c_date !='0000-00-00 00:00:00'){ echo date('d-m-Y',strtotime($list->c_date)).' '.date('h:i A',strtotime($list->purchase_time));}?></div>
            <div style="float:left;width:30%;font-weight:600;padding:4px;"><?php echo $list->bill_no;?></div> 
            <div style="float:left;width:10%;font-weight:600;padding:4px;"><?php echo $list->payment_mode;?></div> 
            <div style="float:left;width:13%;font-weight:600;padding:4px;"><?php echo '0';//number_format($list->blnce,2);$credit_total=$credit_total+$list->blnce;?></div>
        ...
        foreach($return_report_list as $list)
        {  ?>
       <div style="float:left;width:100%;border:1px solid #111;border-left:none;border-right:none;font-size:13px;">
            <div style="float:left;width:5%;font-weight:600;padding:4px;"><?php echo $i;?></div>
            <div style="float:left;width:15%;font-weight:600;padding:4px;"><?php if($list->c_date !='0000-00-00 00:00:00'){ echo date('d-m-Y',strtotime($list->c_date)).' '.date('h:i A',strtotime($list->purchase_time));}?></div>
            <div style="float:left;width:30%;font-weight:600;padding:4px;"><?php echo $list->bill_no;?></div> 
            <div style="float:left;width:10%;font-weight:600;padding:4px;"><?php echo $list->payment_mode;?></div> 
            <div style="float:left;width:13%;font-weight:600;padding:4px;"><?php echo number_format($list->blnce,2);
            
            $credit_total=$credit_total+$list->blnce;?></div>
            <div style="float:left;width:12%;font-weight:600;padding:4px;"><?php echo number_format($list->paid_amount,2);$debit_total=$debit_total+$list->paid_amount;?></div>
            <div style="float:left;width:15%;font-weight:600;padding:4px;"><?php if($list->balance>0){ echo '-'.number_format($list->balance,2); }else{ echo '0.00';}
            
            $blns_total=$blns_total-$list->balance;?></div>
          </div>  
          <?php $i++; }
          ...
          <div style="float:left;width:100%;border:1px solid #111;border-left:none;border-right:none;font-size:13px;">
            ...
            <div style="float:left;width:30%;font-weight:600;padding:4px;"><b>Total</b></div> 
            <div style="float:left;width:10%;font-weight:600;padding:4px;"></div> 
            ...
            <div style="float:left;width:15%;font-weight:600;padding:4px;"><?php echo number_format($blns_total,2);?></div>
          </div>  
         <?php 
         ...
         if(empty($report_list) || empty($return_report_list))
         {
          ?>  
