      ...
      $(document).ready(function(){
                    ...
                    success: function(result) 
                    {
                         ...
                         if(!isNaN(result))
                         {
                              ...
                              get_balance_clearance_list(<?php echo $this->uri->segment('4'); ?>);
                               //print_bill(result,'<?php echo $this->uri->segment('4'); ?>');
          ...
          $('.cheque_date').datepicker({
           ...
           function print_bill(id,type)
           {
              ...
              /*var printWindow = openPrintWindow('< ?php echo base_url(); ?>vendor_payment/print_patient_balance_receipt/'+id+'/'+type, 'windowTitle', 'width=820,height=600');
