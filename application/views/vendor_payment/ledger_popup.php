          ...
          <div class="row">
               <div class="col-md-12">
                    <div class="row m-b-5">
                         ...
                         <div class="col-md-7">
                              <input type="text" id="exp_start_date" name="from_date" class="datepicker start_datepicker" value="<?php echo date('d-m-Y'); ?>">
                         </div>
                    </div>
                    <div class="row">
                         <div class="col-md-5">      
                         ...
                         <div class="col-md-7">
                              <input type="text" name="to_date" id="exp_end_date" class="datepicker datepicker_to end_datepicker" value="<?php echo date('d-m-Y'); ?>">
                         </div>
                    </div>
                     ...
                     <div class="row m-t-5">
                         ...
                         <div class="col-md-7">
                            <input type="radio" checked name="vendor_type" class="vendor_type" value="1"> Medicine
...
{ 
   ...
   window.open('<?php echo base_url('vendor_payment/ledger_print?') ?>branch_id='+branch_id+'&start_date='+start_date+'&end_date='+end_date+'&type='+cat_id+'&v_id='+vendor_id,'mywin','width=800,height=600');
}  
