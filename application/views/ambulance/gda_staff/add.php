                                              ...
                                              <div class="col-md-6">
                                                   <div class="row">
                                                        ...
                                                        <div class="col-md-8">
                                                             ...
                                                             <?php if(in_array('2377',$users_data['permission']['action'])) {
                                                             ?>
...
$("#emp_form").on("submit", function(event) { 
  ...
  { 
    var path = 'edit/'+ids;
    var msg = 'GDA Staff successfully updated.';
  }
  else
  {
    var path = 'add/';
    var msg = 'GDA Staff successfully created.';
  }   

  $.ajax({
    url: "<?php echo base_url(); ?>ambulance/gda_staff/"+path,
    type: "post",
    data: $(this).serialize(),
    success: function(result) {
      if(result==1)
