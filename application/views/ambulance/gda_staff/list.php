...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('ambulance/gda_staff/ajax_list')?>",
            "type": "POST",
...
{
  var $modal = $('#load_add_emp_modal_popup');
  $modal.load('<?php echo base_url().'ambulance/gda_staff/edit/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('ambulance/gda_staff/deleteall');?>",
                      data: {row_id: allVals},
...
<section class="userlist">
    <div class="userlist-box">
  	...
  	<div class="userlist-right">
  		<div class="btns">
      <?php
       if(in_array('2466',$users_data['permission']['action'])) 
       {
        ?>
       ...
       {
        ?>
        <button class="btn-exit" onclick="window.location.href='<?php echo base_url('ambulance/gda_staff/archive'); ?>'">
...
<script>  
 ...
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('ambulance/gda_staff/delete/'); ?>"+emp_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
