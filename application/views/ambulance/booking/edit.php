                ...
                <div id="payment_detail">
                              ...
                              <div class="row m-b-5">	
                               ...
                               if($discount_val_setting==1)
                               {
                                ...
                                <div class="row mb-2">
                                 ...
                                 <div class="col-md-8">
                                  <input type="text" name="discount" onchange="discount_vals_edit();" class="price_float m_input_default" id="discount" value="<?php  echo number_format($form_data['discount'],2,'.', '');  ?>">
                                </div>
                          ...
                          <div class="row mb-2">
                           ...
                           <div class="col-md-8">
                            ...
                            onchange="total_balance_edit(this.value);">
<input type="hidden" name="initial_paid_amount" id="initial_paid_amount" value="<?php echo number_format($form_data['paid_amount'],2,'.', ''); ?>">
                         ...
                         <div class="row mb-2">
                           ...
                           <div class="col-md-8">
                            <input type="text" name="total_paid_amount" class="price_float m_input_default total_paid_amount" id="paid_amount" value="<?php if(!empty($form_data['total_paid_amount'])){echo number_format($form_data['total_paid_amount'],2,'.', '');}?>" 
                             ...
                             <input type="hidden" name="initial_t_paid" id="initial_t_paid" value="<?php if(!empty($form_data['total_paid_amount'])){echo number_format($form_data['total_paid_amount'],2,'.', '');}?>">
                       ...
                       <input type="hidden" name="initial_balance" id="initial_balance" class="" value="<?php echo number_format($form_data['balance'],2,'.', ''); ?>" readonly="">
       ...
       {	
        ...
        $.ajax({	
          ...
          {	
            ...
            <?php // if(empty($form_data['data_id'])){ ?>  <?php //} ?>
  ...
  function get_vendor_charge(val)
    ...
    <script>
       ...
       {	
        ...
        $.ajax({	
          ...
          {	
            ...
            $('#total_amount').val(result.total_amount);	
            $("#net_amount").val(result.net_amount);	
            <?php if(empty($form_data['data_id'])){ ?> $("#paid_amount").val(result.net_amount); <?php }else{   ?>  $("#paid_amount").val(parseInt(result.consultants_charge)+parseInt(result.particulars_charges)); $('#balance').val('0.00'); <?php }  ?>
            //$("#paid_amount").val(result.net_amount);	
            } 	
         });
      }
      ...
      function total_balance_edit(val)
      {
       if(val!='')
       {
            ...
            var initial_t_paid = $('#initial_t_paid').val();
            var initial_balance = $('#initial_balance').val();
            //alert(initial_t_paid);
             //+parseFloat(total_paid_amount)
            
            if(parseInt(paid_amount) > parseInt(initial_paid_amount))
            {
                
                if(parseFloat(initial_paid_amount)=='NaN')
                {
                    
                   if(parseFloat(initial_t_paid)=='NaN')
                    {
                        var tot_paid_amt = parseFloat(paid_amount); 
                        
                    }
                    else
                    {
                       var tot_paid_amt = parseFloat(paid_amount)+parseFloat(initial_t_paid);
                ...
                else
                {
                    ...
                    if(parseFloat(initial_t_paid)=='NaN')
                    {
                        ...
                        {
                            var tot_paid_amt = (parseFloat(paid_amount)-parseFloat(initial_paid_amount));
                        }
                    ...
                    else
                    {
                       ...
                       if(initial_paid_amount!='0.00')
                       {
                          var tot_paid_amt = (parseFloat(paid_amount)-parseFloat(initial_paid_amount))+parseFloat(initial_t_paid); 
                       }
                       else
                       {
                           if(initial_t_paid!='')
               ...
               if(refund_amount!='0.00' || refund_amount!='')
               {
                   var bsl =  (parseInt(net_amount)-parseInt(tot_paid_amt))+parseInt(refund_amount);
               }
               else
               {
                   var bsl =  (parseInt(net_amount)-parseInt(tot_paid_amt));
               }
                
                //alert(tot_paid_amt);
                $('.total_paid_amount').val(Number(tot_paid_amt).toFixed(2));
                $('#balance').val(Number(bsl).toFixed(2));
                //alert('innn');
            }
            else if(parseInt(paid_amount) < parseInt(initial_paid_amount))
            { 
                
                
                //alert('innn');
                var tot_paid_amt = (parseFloat(initial_t_paid)-parseFloat(initial_paid_amount))+parseFloat(paid_amount); 
                var bsl =  (parseInt(net_amount)-parseInt(tot_paid_amt))+parseInt(refund_amount);
                $('.total_paid_amount').val(Number(tot_paid_amt).toFixed(2));
                $('#balance').val(Number(bsl).toFixed(2));
                
                
                /*var tot_paid_amt = (parseFloat(total_paid_amount)-parseFloat(initial_paid_amount))-parseFloat(paid_amount); 
                var bsl =  (parseInt(net_amount)-parseInt(tot_paid_amt))+parseInt(refund_amount);
                $('.total_paid_amount').val(Number(tot_paid_amt).toFixed(2));
                $('#balance').val(Number(bsl).toFixed(2));*/
            ...
            else //if(parseInt(paid_amount) == parseInt(initial_paid_amount))
            {
                ...
                var bsl =  (parseInt(net_amount)-parseInt(total_paid_amount))+parseInt(refund_amount);
                $('.total_paid_amount').val(initial_t_paid);
                //$('#balance').val(Number(bsl).toFixed(2)); //18 july 2020
                //for same amount
                if(parseInt(paid_amount)==parseInt(initial_paid_amount))
                {
                     var bsl = (parseInt(net_amount)-parseInt(initial_t_paid))+parseInt(refund_amount); 
                    
                    //alert(bsl);
                }
                else
                {
                    var bsl = initial_balance;
                }
            ...
            {
                var balance = parseInt(net_amount)-parseInt(tot_paid_amt)+parseInt(refund_amount);
                var bsl = Number(balance).toFixed(2);
   ...
   function check_paid_amount()
{
  ...
  function payment_calc()
  {
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ambulance/booking/calculate_payment_on_edit/", 
            dataType: "json",
