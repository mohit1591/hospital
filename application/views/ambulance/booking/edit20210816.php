             ...
             <div class="row mb-2">
                ...
                <article class="">
                  <div class="row m-t-5">
                   ...
                   <div class="row mb-2">
                     <label class="col-md-4">Hospital ID </label>
                     <div class="col-md-8">
 ...
 <div class="row m-b-5" id="pedic_spec" >
    <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-8">
           <input type="text" class="datepicker_dob" name="dob" id="dob" value="<?php echo $form_data['dob']; ?>"  /> <!-- onchange="showAge(this.value);"-->
         </div>
       </div>
    </div>
  </div>
...
<div class="row m-b-5">	
  ...
  <div class="col-xs-8">	
    ...
    <?php if(in_array('546',$users_data['permission']['action'])) {	
     ?>	
     <a href="javascript:void(0)" onclick="return add_particulars();"  class="btn-new"><i class="fa fa-plus"></i>  New</a>	
   <?php } ?>  	
