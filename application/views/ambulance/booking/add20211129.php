...
<div class="row m-b-5">	
  ...
  <div class="col-xs-8">	
    <select name="particulars" id="particulars" class="m_select_btn w-150px" onchange="return get_particulars_data(this.value);">	
  ...
  <div class="col-xs-8">	
    ...
    <div class="row m-b-5" id="amount_id">	
      ...
      <div class="col-xs-8">	
        ...
        <a href="javascript:void(0);" title="Add Charge" class="btn-new" onclick="particular_payment_calculation(0);"> Add </a>	
      </div>	
    </div> <!-- row -->	
    <!-- Particular op -->
