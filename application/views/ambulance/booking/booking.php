...
$('document').ready(function(){
 ...
 if(isset($_GET['status']) && isset($opd_booking_id) && $_GET['status']=='print'){ ?>
  ...
  .one('click', '#cancel', function(e)
    { 
       // window.location.href='<?php echo base_url('ambulance/booking');?>'; 
    }); 
...
<?php } ?>
 ...
 <div class="row m-b-5">
    <div class="col-md-12">
       <div class="row">
        <div class="col-md-5"><b>Remarks</b> <?php if(!empty($field_list)){
                         if($field_list[4]['mandatory_field_id']=='86' && $field_list[4]['mandatory_branch_id']==$users_data['parent_id']){?><span class="text-danger">*</span><?php } ?></div>
         <div class="col-md-7">
