...
<div class="row">
  <div class="col-md-12 add_opd_print_setting">
    <form action="<?php echo base_url('ambulance/amb_balance_print/add'); ?>" method="post">
    <div class="row m-b-5">
      <div class="col-xs-2">
    ...
    <div class="row m-b-5">
      ...
      <div class="col-xs-9" >
      <textarea class="print_textarea"  type="text" name="short_code" cols="45" value="" readonly id="comment_data"/>{patient_reg_no}  ,     {patient_name}  ,  {hospital_receipt_no} ,  {mobile_no}  ,  {gender_age}  ,  {patient_address} ,  {booking_date}  ,   {booking_code}  , 
 {total_amount} ,  {total_discount}  , {net_amount}  ,  {paid_amount},  {balance} {Quantity_level} , {start_loop} ,  {s_no} ,  {particular}  ,  {quantity} ,  {amount}  , {end_loop}  ,  {payment_mode}  ,   {remarks}  ,   {referral_by}  ,   {email_address} , {vehicle_no} , {driver_name} , 
{location} , {remarks}   ,   {adhar_no}   ,   {marital_status}   ,   {religion_name}  ,   {father_husband}  ,   {mother} , {guardian_name}   ,   {guardian_email}  ,  {guardian_phone}   ,     {relation}   ,    {monthly_income}   ,  {parent_relation_type}  ,   {parent_relation_name}</textarea>
      </div>
    </div> <!-- rowClose -->
...
<script>
  function get_template_according(value){
    ...
    $.ajax({
      type:"POST",
      url: "<?php echo base_url(); ?>ambulance/amb_balance_print/opd_printtemplate_dropdown/", 
      data: {value: value},
      datatype:'JSON',
