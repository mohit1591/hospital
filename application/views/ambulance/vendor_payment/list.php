...
<script>
  ...
  { 
     $.post('<?php echo base_url('ambulance/vendor_payment/get_allsub_branch_list/'); ?>',{},function(result){
...
function get_balance_clearance_list(vals)
{
    ...
    $.post('<?php echo base_url('ambulance/vendor_payment/balance_list/'); ?>',{'sub_branch_id':sub_branch_id,'patient_name':patientName,'mobile_no':mobileNo,'type':vals,'vendor_name':vendorName,'vendor_mobile_no':vendorMobileNo},function(result)
    { 
          if(result!='')
          {
...
{ 
      ...
      $.ajax({
                 type: "POST",
                 url: "<?php echo base_url('ambulance/vendor_payment/pay_delete/'); ?>", 
...
{ 
 ...
 $.ajax({
   url: "<?php echo base_url('ambulance/vendor_payment/advance_search'); ?>", 
   type: 'POST',
...
function show_ledger_report(id)
{
  var $modal = $('#load_add_eye_app_type');
  $modal.load('<?php echo base_url().'ambulance/vendor_payment/ledger_show/' ?>'+id,
  {
  },
  function(){
  $modal.modal('show');
