    ...
    <div class="modal-content"> 
       ...
       function payment_function(value,error_field){
           $('#updated_payment_detail').html('');
                $.ajax({
                     type: "POST",
                     url: "<?php echo base_url('ambulance/vendor_payment/get_payment_mode_data')?>",
      ...
      $(document).ready(function(){
                    ...
                    success: function(result) 
                    {
                         if(!isNaN(result))
                         {
                              ...
                              get_balance_clearance_list(<?php echo $this->uri->segment('4'); ?>);
                               print_window_page('<?php echo base_url(); ?>ambulance/vendor_payment/print_patient_balance_receipt/'+result+'/'+<?php echo $this->uri->segment('4'); ?>);
          ...
          $('.cheque_date').datepicker({
           ...
           {
              print_window_page('<?php echo base_url(); ?>ambulance/vendor_payment/print_patient_balance_receipt/'+id+'/'+type);
           }
          </script>  
     </div><!-- /.modal-content -->
     </div><!-- /.modal-dialog -->
