...
<section class="userlist">
    <div class="userlist-box">
         ...
         <form>
               ...
               <div class="row m-b-5">
                     <div class="col-md-3" id="selection_criteria">Searching Criteria<select id="selection_criteria_list" name="selection_criteria_list" onchange="get_selected_value(this.value);"><option value=''>Select Option</option><option value="patient_name">Patient Name</option><option value="mobile_no">Mobile No.</option></select></div>
                     <div class="col-md-3" id="search_box_patient_name" style="display:none;"><input type="text" name="patient_name"  id="patient_name"/></div>
                      <?php if(!empty($form_error)){ echo form_error('patient_name'); } ?>
                     <div class="col-md-3" id="search_box_mobile_no" style="display:none;"><input type="text" name="mobile_no" class="numeric" id="mobile_no"/></div> 
                      <?php if(!empty($form_error)){ echo form_error('mobile_no'); } ?>
                    <div class="col-md-3" id="branch_list"> <div id="child_branch" class=""></div>  </div>
...
function pay_now_to_branch(patient_id,balance)
{
  alert(patient_id);
