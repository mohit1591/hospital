...
//echo "<pre>";print_r($all_detail['ambulance_list'][0]);die();
$template_data->template = str_replace("{opd_code}",$all_detail['ambulance_list'][0]->booking_code,$template_data->template);
$mlc='';
...
$template_data->template = str_replace("{booking_code}",$all_detail['ambulance_list'][0]->booking_code,$template_data->template);
   ...
   // $patient_address = $address.' - '.$pincode;
    ...
    $template_data->template = str_replace("{referral_by}",$all_detail['ambulance_list'][0]->referral_doctor_name,$template_data->template);
    ...
    //$template_data->template = str_replace("{booking_code}",$all_detail['ambulance_list'][0]->booking_code,$template_data->template);
    //$template_data->template = str_replace("{opd_reg_date}",date('d-m-Y',strtotime($all_detail['ambulance_list'][0]->booking_date)),$template_data->template);


    if(!empty($all_detail['ambulance_list'][0]->reciept_code))
    {
        $template_data->template = str_replace("{booking_level}",'OPD No. :',$template_data->template);
        $template_data->template = str_replace("{booking_code}",$all_detail['ambulance_list'][0]->reciept_code,$template_data->template);
    }
    else
    {
    ...
    if(!empty($all_detail['ambulance_list'][0]->mlc) && $all_detail['ambulance_list'][0]->mlc_status !=0)
    {
        $template_data->template = str_replace("{booking_level}",'MLC No. :',$template_data->template);
        $template_data->template = str_replace("{mlc_no}",$all_detail['ambulance_list'][0]->mlc,$template_data->template);
    }
    else{
...
if($template_data->printer_id==3)
{
   ...
   //  }
    ...
    //$template_data->template = str_replace("{booking_code}",$all_detail['ambulance_list'][0]->booking_code,$template_data->template);
   // $template_data->template = str_replace("{opd_reg_date}",date('d-m-Y',strtotime($all_detail['ambulance_list'][0]->booking_date)),$template_data->template);
    //$template_data->template = str_replace("{doctor_name}",'Dr.'.get_doctor_name($all_detail['ambulance_list'][0]->attended_doctor),$template_data->template);
    /*$template_data->template = str_replace("{specialization}",get_specilization_name($all_detail['ambulance_list'][0]->specialization_id),$template_data->template);*/
    ...
    {
        $receipt_code = '<div><br><b>OPD No.</b>'.$all_detail['ambulance_list'][0]->booking_code.'</div>';
        $template_data->template = str_replace("{booking_code}",$receipt_code,$template_data->template);
    }
     if(!empty($all_detail['ambulance_list'][0]->mlc) && $all_detail['ambulance_list'][0]->mlc_status !=0)
    {
        $mlc = '<div><br><b>MLC No.</b>'.$all_detail['ambulance_list'][0]->mlc.'</div>';
    ...
    if(!empty($all_detail['ambulance_list'][0]->booking_date))
    {
        $booking_date = '<br><b>Booking Date</b>'.date('d-m-Y',strtotime($all_detail['ambulance_list'][0]->booking_date));
 ...
 $template_data->template = str_replace("{row_data}",$tr_html,$template_data->template);
    ...
    if(!empty($all_detail['ambulance_list'][0]->card_no))
    {
     ...
     $template_data->template = str_replace("{payment_mode}",ucfirst($all_detail['ambulance_list'][0]->payment_mode).$card_no,$template_data->template);
    //$template_data->template = str_replace("{payment_mode}",ucfirst($all_detail['ambulance_list'][0]->payment_mode),$template_data->template);
    if(!empty($all_detail['ambulance_list'][0]->remarks))
    {
       $template_data->template = str_replace("{remarks}",$all_detail['ambulance_list'][0]->remarks,$template_data->template);
    }
   ...
   //  }
     ...
     if(!empty($all_detail['ambulance_list'][0]->mlc) && $all_detail['ambulance_list'][0]->mlc_status !=0)
    {
        $mlc = '<div style="width:100%;display:inline-flex;">
            ...
            <div style="width:60%;line-height:19px;">'.$all_detail['ambulance_list'][0]->mlc.'</div>
            </div>';
    }
    ...
    if(!empty($all_detail['ambulance_list'][0]->booking_date))
    {
        $booking_date = '<div style="width:100%;display:inline-flex;">
            ...
            <div style="width:60%;line-height:19px;">'.date('d-m-Y',strtotime($all_detail['ambulance_list'][0]->booking_date)).'</div>
            </div>';
        $template_data->template = str_replace("{booking_date}",$booking_date,$template_data->template);
    }
    ...
    {	 
       // echo "dd";
        ...
        $tr = $row_loop;
        $tr = str_replace("{s_no}",2,$tr);
        //$tr = str_replace("{particular}",'Per km Charges',$tr);
       //  $tr = str_replace("{particular}",'Min Distance',$tr);
          $tr = str_replace("{quantity}",$all_detail['ambulance_list'][0]->distance,$tr);
        if($all_detail['ambulance_list'][0]->distance_type==0)
        {
            $distance_type='Local Distance Charge';
          $tr = str_replace("{particular}",$distance_type,$tr);
        }
        elseif($all_detail['ambulance_list'][0]->distance_type==1)
        {
             $distance_type='Outstation Distance Charge';
          $tr = str_replace("{particular}",$distance_type,$tr);
        }
    ...
    $template_data->template = str_replace("{row_data}",$tr_html.$tr_html1,$template_data->template);
