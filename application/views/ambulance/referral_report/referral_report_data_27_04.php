...
<!--             <div style="float:left;width:10%;font-weight:600;padding:4px;text-align:right;border-left:none;border-right:none;"><u>Booking Date</u></div> -->
            <div style="float:left;width:15%;font-weight:600;padding:4px;text-align:right;border-left:none;border-right:none;"><u>Location</u></div>
      ...
      <div style="float:left;width:100%;border:1px solid #111;border-top:none;font-size:13px;">
       <div style="float:left;width:100%;font-weight:600;padding:4px;">
        ...
        <div style="float:left; width: 100%">
         ...
         <!--    <div style="float:left;width:12%;padding:1px 4px;text-align:right;border-left:none;border-right:none;"><?php echo date('d-m-Y',strtotime($source_report['booking_date'])); ?></div> -->

            <div style="float:left;width:15%;padding:1px 4px;text-align:right;border-left:none;border-right:none;"><?php echo $source_report['city']; //state ?></div>
