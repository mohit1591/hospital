          ...
          <div class="row">
               <div class="col-md-12">
                    ...
                    <div class="row m-b-5">
                         ...
                         <div class="col-md-7">
                              <input type="text" id="from_g_date" name="from_g_date" class="ref_collection_datepicker" value="<?php echo date('d-m-Y'); ?>">
                         </div>
                    </div>
                    <div class="row m-b-5">
                         <div class="col-md-5">      
                         ...
                         <div class="col-md-7">
                              <input type="text" name="to_g_date" id="to_g_date" class="ref_collection_datepicker_to" value="<?php echo date('d-m-Y'); ?>">
                         </div>
                    </div>
                   ...
                   <input type="hidden" name="branch_id" value="<?php echo $users_data['parent_id'];?>" id="branch_id">
                        ...
                        <div class="row m-b-5" id="doctor_div">
                          <div class="col-md-12">
                             <div class="row">
                               ...
                               <div class="col-md-7">
                                 <select name="referral_doctor" id="referral_doctor" class="m_select_btn" >
                    ...
                    <div class="row m-b-5">
                     ...
                     <div class="row m-b-5">
                         ...
                         <div class="col-md-7">
                             <select name="locations" id="locations" class="m_select_btn">
                                    <option value="">All</option>
                                    <?php
...
var pickup = $('#pickup').val();
 ...
 var driver_id = $('#driver_id').val(); 
  ...
  var branch_id = $('#branch_id option:selected').val();
   window.open('<?php echo base_url('ambulance/ambulance_referral_reports/get_appointment_data?') ?>start_date='+start_date+'&end_date='+end_date
   +'&branch_id='+branch_id+'&ref_type='+ref_type+'&reffer_by='+reffer_by+'&staff_id='+staff_id+'&vehicle_id='+vehicle_id+'&driver_id='+driver_id+'&drop='+drop
   +'&pickup='+pickup+'&location='+location+'&remark='+remark,'mywin','width=800,height=600');
}  
