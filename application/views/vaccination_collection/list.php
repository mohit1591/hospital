...
var save_method; 
var table; 
<?php if(in_array('1247',$users_data['permission']['action'])): ?>
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "aaSorting": [],
        "ajax": {
            "url": "<?php echo base_url('vaccination_collection_report/ajax_list')?>",
            "type": "POST"
        }, 
        "columnDefs": [
        { 
...
function reset_date_search()
  {
      ...
      $('#end_date').val('');
      $.ajax({
         url: "<?php echo base_url('vaccination_collection_report/reset_date_search/'); ?>",  
...
$modal.load('<?php echo base_url().'vaccination_collection_report/advance_search/' ?>',
{
//'id1': '1',
//'id2': '2'
},
...
if(in_array('1',$permission_section)): ?> 
      ...
      <div class="fixed">
          ...
          <?php if(in_array('560',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('vaccination_collection_report/vaccination_report_excel');?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-excel-o"></i> Excel
               </a>
          <?php endif;?>
          <?php if(in_array('561',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('vaccination_collection_report/vaccination_report_csv');?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-word-o"></i> CSV
               </a>
          <?php endif;?>
         <?php if(in_array('562',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('vaccination_collection_report/pdf_vaccination_report'); ?>" class="btn-anchor m-b-2">
          ...
          <?php if(in_array('563',$users_data['permission']['action'])): ?>
              ...
              <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("vaccination_collection_report/print_vaccination_report"); ?>');">
              <i class="fa fa-print"></i> Print
              </a> 
...
$("#new_search_form").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url(); ?>vaccination_collection_report/advance_search/",
    type: "post",
    data: $(this).serialize(),
    success: function(result) 
    {
