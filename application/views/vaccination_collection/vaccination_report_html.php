<html><head>
<title>Vaccination Collection Report</title>
<?php
if($print_status==1)
{
?>
...
<table width="100%" cellpadding="0" cellspacing="0" border="1px" style="font:13px Arial !important;">
    <tr><td colspan="9" align="center"><h3>Vaccination Collection Report <?php 
$search_data = $this->session->userdata('vaccination_collection_resport_search_data');
