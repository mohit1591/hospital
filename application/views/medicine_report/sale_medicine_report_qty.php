...
{ 
    $('#start_date').val('');
    $('#end_date').val('');
    $.ajax({url: "<?php echo base_url(); ?>medicine_reportr2_qty/reset_search/", 
...
<section class="userlist">
    ...
    <div class="userlist-right relative">
      <div class="fixed">
      <div class="btns">
        <a href="<?php echo base_url('medicine_reportr2_qty/gstr2_qty_excel'); ?>" class="btn-anchor m-b-2"><i class="fa fa-file-excel-o"></i> Excel</a>
        <!-- <a href="<?php echo base_url('medicine_report/gstr1_qty_csv'); ?>" class="btn-anchor m-b-2"><i class="fa fa-file-word-o"></i> CSV</a> -->
        <a href="<?php echo base_url('medicine_reportr2_qty/gstr2_qty_pdf'); ?>" class="btn-anchor m-b-2"><i class="fa fa-file-pdf-o"></i> PDF</a>
        <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("medicine_reportr2_qty/gstr2_qty_print"); ?>');"><i class="fa fa-print"></i> Print</a> 
...
{   
    ...
    $.ajax({
      url: "<?php echo base_url('medicine_reportr2_qty/advance_search/'); ?>",
      type: "post",
...
var table;
     $(document).ready(function() { 
         table = $('#table').DataTable({  
             ...
             "pageLength": '100',
             "ajax": {
                 "url": "<?php echo base_url('medicine_reportr2_qty/gstr2_qty_list')?>",
                 "type": "POST",
