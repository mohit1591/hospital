...
{ 
    $('#start_date').val('');
    $('#end_date').val('');
    $.ajax({url: "<?php echo base_url(); ?>medicine_consolidated/reset_search/", 
...
{   
    ...
    $.ajax({
      url: "<?php echo base_url('medicine_consolidated/advance_search/'); ?>",
      type: "post",
...
var table;
     $(document).ready(function() { 
         table = $('#table').DataTable({  
             ...
             "pageLength": '100',
             "ajax": {
                 "url": "<?php echo base_url('medicine_consolidated/consolidated_list')?>",
                 "type": "POST",
