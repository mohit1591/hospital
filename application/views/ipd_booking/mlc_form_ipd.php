...
<body style="background: rgb(204,204,204);font-family:Arial;color:#333;line-height:22px;">
	...
	<page size="A4">
		...
		<table width="100%" cellpadding="4px" cellspacing="0" border="0" style="border-collapse:collapse;margin: 1em auto;">
			...
			<tr>
				<td valign="top">1. IPD No. <span style="display:inline-block;width:30%;border-bottom:1px dashed #333;"><b><?php echo  $get_by_id_data['ipd_list'][0]->ipd_no; ?></b></span>
					&nbsp; 2. Date and time of examination <span style="display:inline-block;width:31%;border-bottom:1px dashed #333;"><b><?php echo date('d-m-y',strtotime($get_by_id_data['ipd_list'][0]->admission_date)); ?></b></span>
					
					&nbsp; 2. MLC No. <span style="display:inline-block;width:31%;border-bottom:1px dashed #333;"><b><?php echo $get_by_id_data['ipd_list'][0]->mlc; ?></b></span>

				</td>
			</tr>
			<tr>
				<td valign="top">3. Name  <span style="display:inline-block;width:50%;border-bottom:1px dashed #333;"><b><?php echo ucfirst($get_by_id_data['ipd_list'][0]->patient_name); ?></b></span>
					Age  <span style="display:inline-block;width:10%;border-bottom:1px dashed #333;"><b><?php echo  ucfirst($get_by_id_data['ipd_list'][0]->age_y); ?></b></span>years, Sex : <span style="display:inline-block;width:17%;border-bottom:1px dashed #333;"><b><?php if($get_by_id_data['ipd_list'][0]->gender==1){ echo 'Male'; } if($get_by_id_data['ipd_list'][0]->gender==2){ echo 'Female';} if($get_by_id_data['ipd_list'][0]->gender==2){ echo 'Others';} ?></b></span>
				</td>
			</tr>
			<tr>
				<td valign="top">4. Address  <span style="display:inline-block;width:90.2%;border-bottom:1px dashed #333;"><b><?php echo  $get_by_id_data['ipd_list'][0]->address; ?></b></span>
