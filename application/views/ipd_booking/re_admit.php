            ...
            <div class="row">
              ...
              <div class="row m-b-5">
               ...
               <select name="bed_no_id" id="bed_no_id">
                ...
                <div class="row m-b-5">
                <div class="col-sm-5"> <label> Re-admit Date <span class="star">*</span></label> </div>
                ...
                <div class="row m-b-5">
                <div class="col-sm-5"> <label> Re-admit Time <span class="star">*</span></label> </div>
                ...
                <div class="row m-b-5">
                   ...
                   <div class="col-sm-7"><button class="btn-save"> <i class="fa fa-floppy-o"></i> Re-admit</button></div>
                </div>
