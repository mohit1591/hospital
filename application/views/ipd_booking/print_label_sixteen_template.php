	...
	<page size="A4" style="display:block;margin:0px auto;border:1px solid #ccc;font-size:12px;">
		<div style="display: flex; justify-content: center; flex-wrap: wrap;">
	        ...
	        for($i=1;$i<=$total_no;$i++){ ?>
				...
				<div style="display:block;padding:1px 4px;"><b>Admission Date:</b> <?php echo $admission_dates; ?></div>
				
				<div style="display:block;padding:1px 4px;"><b>Admission Time:</b> <?php echo $admission_times; ?></div>
