...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('gynecology/opdprescriptionhistory/ajax_list/'.$patient_id)?>",
            "type": "POST",
        }, 
        "columnDefs": [
        { 
...
<section class="userlist">
    ...
    <form>
  	...
  	<div class="userlist-right">
  		<div class="btns">
  			<!--<button class="btn-update" onclick="window.location.href='<?php echo base_url('opd/booking/'.$patient_id); ?>'">
