                                    ...
                                    <div class="row m-b-4 col-md-3" style="height: 25px;">
                                      ...
                                      <table class="table table-bordered input-center" id='patient_right_ovary_list'>
                                        ...
                                        <?php }
                                           ...
                                           { ?>
                                        <tr>
                                           <td colspan="18" align="center" class=" text-danger ">
                                ...
                                <div class="col-md-12" style="display:flex;flex-wrap:wrap;">
                                   ...
                                   <div class="row m-b-3 col-md-3">
                                       ...
                                       <div class="col-md-7">
                                           ...
                                           <input type="text" name="left_folli_date" id="left_folli_date"  class="datepicker"  data-date-format="dd-mm-yyyy" style="width:140px;"  value="<?php if(!empty($left_ovary_data_edit[0]['left_folli_date']) && trim($left_ovary_data_edit[0]['left_folli_date'])!='0000-00-00'){ echo date('d-m-Y', strtotime($left_ovary_data_edit[0]['left_folli_date'])); } ?>"/> 
                                        </div>
                                     </div>
                                   ...
                                   <div class="row m-b-3 col-md-3">
                                       ...
                                       <div class="col-md-7">
                                          <input type="text" class="" name="left_folli_day" id='left_folli_day' style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['left_folli_day']; ?>">
                                        ...
                                        <div class="row m-b-3 col-md-3">
                                           ...
                                           <div class="col-md-7">
                                              ...
                                              <input type="text" class="" name="left_folli_protocol" id='left_folli_protocol' style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['left_folli_protocol']; ?>">
                                           </div>
                                        </div>
                                        ...
                                        <div class="row m-b-3 col-md-3">
                                           ...
                                           <div class="col-md-7">
                                              <input type="text" class="" name="left_folli_pfsh" id='left_folli_pfsh' style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['left_folli_pfsh']; ?>">
                                           </div>
                                        </div>
                                          <div class="row m-b-3 col-md-3">
                                             <div class="col-md-5">
                                             ...
                                             <div class="col-md-7">
                                                <input type="text" class="" name="left_folli_recfsh" id='left_folli_recfsh' style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['left_folli_recfsh']; ?>">
                                             </div>
                                          </div>
                                          <div class="row m-b-3 col-md-3">
                                             <div class="col-md-5">
                                             ...
                                             <div class="col-md-7">
                                                ...
                                                <input type="text" id="left_folli_hmg" name="left_folli_hmg" style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['left_folli_hmg']; ?>">
                                             </div>
                                          </div>
                                          ...
                                          <div class="row m-b-3 col-md-3">
                                             ...
                                             <div class="col-md-7">
                                                ...
                                                <input type="text" id="left_folli_hp_hmg" name="left_folli_hp_hmg" style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['left_folli_hp_hmg']; ?>">
                                             </div>
                                          </div>
                                          ...
                                          <div class="row m-b-3 col-md-3">
                                             ...
                                             <div class="col-md-7">
                                                 ...
                                                 <input type="text" id="left_folli_agonist" name="left_folli_agonist" style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['left_folli_agonist']; ?>">
                                             </div>
                                          </div>
                                          ...
                                          <div class="row m-b-3 col-md-3">
                                             ...
                                             <div class="col-md-7">
                                                ...
                                                <input type="text" id="left_folli_antiagonist" name="left_folli_antiagonist" style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['left_folli_antiagonist']; ?>">
                                             </div>
                                          </div>
                                          ...
                                          <div class="row m-b-3 col-md-3">
                                             ...
                                             <div class="col-md-7">
                                                <input type="text" id="left_folli_trigger" name="left_folli_trigger" style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['left_folli_trigger']; ?>">
                                             </div>
                                          </div>
                                       ...
                                       <div class="row m-b-3 col-md-3">
                                             ...
                                             <div class="col-md-7">
                                                <input type="text" id="endometriumothers" name="endometriumothers" style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['endometriumothers']; ?>">
                                             </div>
                                          </div>
                                          ...
                                          <div class="row m-b-3 col-md-3">
                                             ...
                                             <div class="col-md-7">
                                                <input type="text" id="e2" name="e2" style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['e2']; ?>">
                                             </div>
                                          </div>
                                          ...
                                          <div class="row m-b-3 col-md-3">
                                             ...
                                             <div class="col-md-7">
                                                <input type="text" id="p4" name="p4" style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['p4']; ?>">
                                             </div>
                                          </div>
                                           ...
                                           <div class="row m-b-3 col-md-3">
                                             ...
                                             <div class="col-md-7">
                                                <input type="text" id="risk" name="risk" style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['risk']; ?>">
                                             </div>
                                          </div>
                                           ...
                                           <div class="row m-b-3 col-md-3">
                                             ...
                                             <div class="col-md-7">
                                                <input type="text" id="others" name="others"  style="width:140px;" value="<?php echo $left_ovary_data_edit[0]['others']; ?>">
                                             </div>
                                          </div>
                                   ...
                                   <div class="table-box">
                                      <table class="table table-bordered" id='patient_left_ovary_list'>
                                         <thead>
                                            <tr>
                                               <th align="center" width="">
                                                  <input name="selectall" class="" id="selectall" value="" type="checkbox"  onclick="toggle_left_ovary(this);">
                                                  <?php echo $check_script = "<script>$('#selectall').on('click', function () { 
                                                     if ($(this).hasClass('allChecked')) {
                                                     $('.checklist').prop('checked', false);
                                                     } else {
                                         ...
                                         <tr name="patient_left_overy_row" id="<?php echo $i; ?>">
                                            ...
                                            <td><?php echo $patient_left_ovary_val['left_folli_date']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['left_folli_day']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['left_folli_protocol']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['left_folli_pfsh']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['left_folli_recfsh']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['left_folli_hmg']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['left_folli_hp_hmg']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['left_folli_agonist']; ?></td>

                                            <td><?php echo $patient_left_ovary_val['left_folli_antiagonist']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['left_folli_trigger']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['left_follic_size']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['endometriumothers']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['e2']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['p4']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['risk']; ?></td>
                                            <td><?php echo $patient_left_ovary_val['others']; ?></td>
                                         </tr>
                                         <?php
                                            $i++;
                                            }
                                         ...
                                         <?php
                                            ...
                                            ?> 
                                         <a class="btn-custom m-b-5 m1" id="deleteAll" onclick="delete_left_ovary_vals();">
                                         <i class="fa fa-trash"></i> Delete
                                         </a>
                                      </table>
                                   </div>
