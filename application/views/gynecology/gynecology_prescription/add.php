...
<html>
   ...
   <body>
         ...
         <section class="userlist">
               ...
               <div class="row">
                  ...
                  <div class="col-xs-5">
                     ...
                     <div class="row m-b-5">
                        <div class="col-xs-4"><strong>Weight (Kg)</strong></div>
                        <div class="col-xs-8">
                           <input name="weight" id="weight"  class="m_tiny" value="<?php echo $form_data['weight'];?>" type="text" numeric onKeyUp="myFunction()">
                        </div>
                     </div>


                     <div class="row m-b-5">
                        <div class="col-xs-4"><strong>Height (cm)</strong></div>
                        <div class="col-xs-8">
                          <input name="height" id="height" class="m_tiny" value="<?php echo $form_data['height'];?>" type="text" numeric onKeyUp="myFunction()">
                        </div>
                     </div>


                     <div class="row m-b-5">
                        <div class="col-xs-4"><strong>BMI (Kg/m2)</strong></div>
                        <div class="col-xs-8">
                         <input name="bmi" id="bmi_calculate"  class="m_tiny" value="<?php echo $form_data['bmi'];?>" type="text"> 
                        </div>
                     </div>
                     
                     <div class="row m-b-5">
                        <div class="col-xs-4"><strong>Confirm Delivery Date</strong></div>
                        <div class="col-xs-8">
                         <input name="confirm_delivery_date" id="confirm_delivery_date"  class="datepicker date m_tiny" value="<?php echo $form_data['confirm_delivery_date'];?>" type="text" readonly> 
                        </div>
                     </div>
                  ...
                  <div class="col-xs-5">
                    ...
                    <div class="row m-b-5" style="color:brown;">
                        <div class="col-xs-4"><strong>Risk</strong></div>
                        <div class="col-xs-8">
                                        <textarea  name="common_fertility_risk" style="height:100px;" id="common_fertility_risk"><?php echo $form_data['common_fertility_risk']; ?></textarea>
                        </div>
                     </div>
    ...
    <div class="col-md-10 col-sm-10">
      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_patient_history_flag" <?php if($form_data['print_patient_history_flag']==1){ echo 'checked';}?> id="checkboxhistory" value="1">
        <label for="checkboxhistory">Patient History</label>
      </div>

      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_disease_flag" id="checkboxcontactlens" <?php if($form_data['print_disease_flag']==1){ echo 'checked';}?> value="1">
         <label for="checkboxcontactlens">Disease</label>
      </div>
      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_complaints_flag" id="checkboxglasses" <?php if($form_data['print_complaints_flag']==1){ echo 'checked';}?> value="1"> 
        <label for="checkboxglasses">Complaints</label>
      </div>

      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_allergy_flag" <?php if($form_data['print_allergy_flag']==1){ echo 'checked';}?> id="checkboxinterglasses" value="1"> 
        <label for="checkboxinterglasses">Allergy</label>
      </div>

      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_general_examination_flag" <?php if($form_data['print_general_examination_flag']==1){ echo 'checked';}?> id="checkboxexamination" value="1">             
         <label for="checkboxexamination">General Examination</label>
      </div>
      
      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_clinical_examination_flag" <?php if($form_data['print_clinical_examination_flag']==1){ echo 'checked';}?> id="checkboxexamination" value="1">             
      ...
      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_investigations_flag" <?php if($form_data['print_investigations_flag']==1){ echo 'checked';}?> id="checkboxinvestigations" value="1">       
         <label for="checkboxinvestigations">Investigations</label>
      </div>
      
      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_medicine_flag" <?php if($form_data['print_medicine_flag']==1){ echo 'checked';}?> id="checkboxdiagnosis" value="1">                  
        <label for="checkboxdiagnosis">Medicine</label>
      </div>

      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_advice_flag" id="checkboxadvice" <?php if($form_data['print_advice_flag']==1){ echo 'checked';}?> value="1">
        <label for="checkboxadvice">Advice</label>
      </div>   
      
      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_next_app_flag" id="checkboxadvice" <?php if($form_data['print_next_app_flag']==1){ echo 'checked';}?> value="1">
        <label for="checkboxadvice">Next Appointment</label>
      </div>   
      
      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_gpla_flag" id="checkboxadvice" <?php if($form_data['print_gpla_flag']==1){ echo 'checked';}?> value="1">
        <label for="checkboxadvice">GPLA</label>
      </div>   
      
      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_follicular_flag" id="checkboxadvice" <?php if($form_data['print_follicular_flag']==1){ echo 'checked';}?> value="1">
        <label for="checkboxadvice">Follicular Scanning</label>
      </div>   
      
      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_icsilab_flag" id="checkboxadvice" <?php if($form_data['print_icsilab_flag']==1){ echo 'checked';}?> value="1">
        <label for="checkboxadvice">ICSI lab</label>
      </div>   
      
      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_fertility_flag" id="checkboxadvice" <?php if($form_data['print_fertility_flag']==1){ echo 'checked';}?> value="1">
        <label for="checkboxadvice">Fertility</label>
      </div>   
      
      <div class="ckbox ckbox-default col-md-3 col-sm-3">
        <input <?php echo $form_data['data_id'] == ""? "checked":"";?> type="checkbox" name="print_antenatal_flag" id="checkboxadvice" <?php if($form_data['print_antenatal_flag']==1){ echo 'checked';}?> value="1">
   ...
   <div class="row m-t-10">
                  <div class="col-xs-9">
                     ...
                     &nbsp;
                     <a href="<?=base_url('gynecology/patient_template/add')?>" target="_blank" class="btn btn-success"><i class="fa fa-plus"></i> Add new</a>
                  </div>
                  <div class="col-xs-3">
                        <label for="">
                            <b>Date Time</b>
               ...
               if(!empty($vitals_list))
                    {
                      ...
                      foreach ($vitals_list as $vitals) 
                      {
                          ...
                          else
                          {
                                ...
                                //echo "<pre>"; print_r($vital_val); exit;
                          }
                        
                        if(!empty($vital_val))
                        {
                            $vital_vals = $vital_val;
                        }
                        ?>
                          <label>
                            <b><?php echo $vitals->vitals_name; ?></b> 
                            <input type="text" name="data[<?php echo $vitals->id; ?>][name]"  class="w-50px input-tiny" value="<?php echo $vital_vals; ?>"> 
                               ...
                               <div class="col-md-4 ">
                                  <div class="box-left">
                                     <div class="row m-b-5">
                                        ...
                                        <div class="col-md-7">
                                           <select name="marriage_status" class="m_select_btn" id="marriage_status" onchange="check_marriage_status(this.value);">
                                     ...
                                     <div id="marriage_columns">
                                        ...
                                        <div class="row m-b-5">
                                           <div class="col-md-5">
                                              <label>Marriage Details <sup class="info"><a href="javascript:void(null)" class="small info"> ?<span>Please fill the marriage details like date and duration of the marriage etc.  </span></a></sup></label>
                                           </div>
                                           <div class="col-md-7">
                                        ...
                                        <div id="check_previous_delivery">
                                          ...
                                          <div class="row m-b-5">
                                             <div class="col-md-5">
                                                <label>Delivery Details<sup class="info"><a href="javascript:void(null)" class="small info"> ?<span>Please fill the Delivery Details like date and duration of the Delivery etc.  </span></a></sup></label>
                                             </div>
                                             <div class="col-md-7">
                                     ...
                                     <div class="row m-b-5">
                                        ...
                                        <div class="col-md-7">
                                           ...
                                           <select name="family_duration_type" class="m_select_btn" id="family_duration_type" style="width:131px;">
                                              <option value="">Select Disease Duration </option>
                                              <option value="Days">Days</option>
                                              <option value="Week">Week</option>
                                              <option value="Month">Month</option>
                                              <option value="Year">Year</option>
                               ...
                               <div class="row">
                                  ...
                                  <div class="col-md-4">
                                     ...
                                     <div class="row m-b-5">
                                        ...
                                        <div class="col-md-7">
                                           <input class="w-213px numeric" id="tb_rx" name="tb_rx" placeholder="Rx" type="text">
                                        </div>
                                     </div>
                                     <div class="row m-b-5">
                                        <div class="col-md-5">
                                     ...
                                     <div class="row m-b-5">
                                        ...
                                        <div class="col-md-7">
                                           <input type="text" class="w-213px numeric" id='dm_years' name="dm_years" placeholder='Years'>
                                        </div>
                                     </div>
                                     <div class="row m-b-5">
                                        <div class="col-md-5">
                                        ...
                                        <div class="col-md-7">
                                           <input type="text" class="w-213px" id='dm_rx' name="dm_rx" placeholder='Rx'>
                                        </div>
                                     </div>
                                     <div class="row m-b-5">
                                        <div class="col-md-5">
                               ...
                               <div class="row">
                                  <div class="col-md-4">
                                     ...
                                     <div class="row m-b-5">
                                        ...
                                        <div class="col-md-7">
                                           <input class="full-width" id="obestetric_e" name="obestetric_e"  type="text">
                                        </div>
                                     </div>
                                     <div class="row m-b-5">
                                        <div class="col-md-5">
                                     ...
                                     <div class="row m-b-5">
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <textarea id="obestetric_remarks" name="obestetric_remarks" style="height:100px;"></textarea>
                                     ...
                                     <div class="table-box">
                                        <table class="table table-bordered" id='patient_obestetric_history_list'>
                                           ...
                                           <tr name="patient_obestetric_history_row" id="<?php echo $i; ?>">
                                              ...
                                              <td><?php echo $patient_obestetric_history_val['obestetric_e']; ?></td>
                                              
                                              

                                              <td><?php echo $patient_obestetric_history_val['obestetric_l']; ?></td>
                                              <td><?php echo $patient_obestetric_history_val['obestetric_mtp']; ?></td>
                                              <td><?php echo $patient_obestetric_history_val['obestetric_remarks']; ?></td>
                                           </tr>
                                           <?php
                                              $i++;
                                                }
                           ...
                           <div class="col-md-5" >
                              <div class="box-left">
                                 <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       <select name="patient_disease_name" style="width:100%" class=" m_select_btn" id="patient_disease_id">
                           ...
                           <div class="col-md-5" >
                              <div class="box-left">
                                 <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       <select name="patient_complaint_name" class="w-200px m_select_btn" id="patient_complaint_id">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-10">
                                       ...
                                       <select name="patient_complaint_type" class="m_select_btn" id="patient_complaint_type" style="width:200px;">
                                          <option value="">Select Duration </option>
                                          <option value="Days">Days</option>
                                          <option value="Week">Week</option>
                                          <option value="Month">Month</option>
                           ...
                           <div class="col-md-5" >
                              <div class="box-left">
                                 <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       <select name="patient_allergy_name" class="w-200px m_select_btn" id="patient_allergy_id">
                           ...
                           <div class="col-md-5" >
                              <div class="box-left">
                                 <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       <select name="patient_general_examination_name" class="w-200px m_select_btn" id="patient_general_examination_id">
                           ...
                           <div class="col-md-5" >
                              <div class="box-left">
                                 <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       <select name="patient_clinical_examination_name" class="w-200px m_select_btn" id="patient_clinical_examination_id">
                                          <option value="">Select Exam</option>
                                          <?php
                           ...
                           <div class="col-md-5" >
                              <div class="box-left">
                                 <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       <select name="patient_investigation_name" class="w-200px m_select_btn" style="width:100%" id="patient_investigation_id" onchange="get_std_value(this.value);">
                                          <option value="">Select Investigation</option>
                                          <?php
                                             // print_r($investigation_list);
                                             if(!empty($investigation_list))
                                             {
                                              foreach($investigation_list as $investigation)
                                              {
                                                ?>
                                          <option <?php if($form_data['disease_id']==$investigation['id']){ echo 'selected="selected"'; } ?> value="<?php echo $investigation['id']; ?>"><?php echo $investigation['name']; ?> (<?php echo $investigation['is_profile'] == true ? 'Profile':''; ?>)</option>
                                          <?php
                                             }
                                             }
                                             ?>
                              ...
                              <div class="box-left">
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <select name="patient_advice_master" class="w-200px m_select_btn" id="patient_advice_master" onchange="get_advice_master_value(this.value);">
                                        ...
                                        <textarea id="patient_advice_id" name="patient_advice_name" class="ckeditor" style="height:100px;"></textarea>
                                    </div>
                                    <div class="col-md-2">
                                 ...
                                 <div class="row" id="date_time_next" style="<?php echo $display; ?>">
                                    ...
                                    <div class="col-md-6">
                                      <input type="text" name="nxt_days" id="nxt_days" style="width:60px;" /> &emsp;
                                       ...
                                       <input type="text" name="next_appointment_date" id="next_appointment_date"  class=""   value="<?php echo $form_data['next_appointment_date']; ?>" style="width:135px;"/> 
           ...
           <div id="tab_follicularscaning" class="inner_tab_box tab-pane fade  <?php if($j==1){ ?> in active <?php  } ?>">
                 ...
                 <div class="col-md-12 tab-content dental-chart" style="border:1px solid #ccc;">
                    <div class="tab-pane fade in active" id="chief" style="padding:0 10px;">
                          ...
                          <div class="col-md-11">
                              ...
                              <div class="" style="display:flex;flex-wrap:wrap;">
                                 ...
                                 <div id="marriage_columns">
                                    ...
                                    <div class="col-md-8">
                                       ...
                                       <input type="text" name="right_folli_date" id="right_folli_date"  class="datepicker"  data-date-format="dd-mm-yyyy" style="width:140px;"  value="<?php if(!empty($right_ovary_data[0]['right_folli_date']) && trim($right_ovary_data[0]['right_folli_date'])!='0000-00-00' && trim($right_ovary_data[0]['right_folli_date'])!='1970-01-01'){ echo date('d-m-Y', strtotime($right_ovary_data[0]['right_folli_date'])); } ?>"/> 
                                    </div>
                                 </div>
                                    ...
                                    <div class="row m-b-4 col-md-3" style="height: 25px;">
                                      ...
                                      <div class="row m-b-4 col-md-3" style="height: 25px;">
                                       ...
                                       <div class="row m-b-4 col-md-3" style="height: 25px;">
                                             ...
                                             <div class="col-md-8">
                                                <input type="text" id="endometriumothers" name="endometriumothers" style="width:140px;" value="<?php echo $right_ovary_data[0]['endometriumothers']; ?>">
                                             </div>
                                          </div>
                                          ...
                                          <div class="row m-b-4 col-md-3" style="height: 25px;">
                                             ...
                                             <div class="col-md-8">
                                                <input type="text" id="e2" name="e2" style="width:140px;" value="<?php echo $right_ovary_data[0]['e2']; ?>">
                                             </div>
                                          </div>
                                          ...
                                          <div class="row m-b-4 col-md-3" style="height: 25px;">
                                             ...
                                             <div class="col-md-8">
                                                <input type="text" id="p4" name="p4" style="width:140px;" value="<?php echo $right_ovary_data[0]['p4']; ?>">
                                             </div>
                                          </div>
                                           ...
                                           <div class="row m-b-4 col-md-3" style="height: 25px;">
                                             ...
                                             <div class="col-md-8">
                                                <input type="text" id="risk" name="risk" style="width:140px;" value="<?php echo $right_ovary_data[0]['risk']; ?>">
                                             </div>
                                          </div>
                                           ...
                                           <div class="row m-b-4 col-md-3" style="height: 25px;">
                                             ...
                                             <div class="col-md-8">
                                                <input type="text" id="others" name="others"  style="width:140px;" value="<?php echo $right_ovary_data[0]['others']; ?>">
                                             </div>
                                          </div>
                                 ...
                                 <div class="row m-b-4 col-md-3" style="margin-top:15px;">
                                         ...
                                         <div class="col-md-8">
                                             <input type="radio" name="right_radio_fol_div" id="right_radio_fol_div" value="1"> Right
                                             
                                             <input type="radio" name="right_radio_fol_div" id="right_radio_fol_div" value="2"> Left 
                                 ...
                                 <script>
                                     $(document).ready(function() {
                                        $("input[name$='right_radio_fol_div']").click(function() 
                                        {
                                          var test = $(this).val();
                            ...
                            <div class="row m-b-4 col-md-3" style="margin-top:15px;display:none;" id="right_fol_div">
                                         <div class="col-md-4">
                                      ...
                                      <div class="row m-b-4 col-md-3" style="margin-top:15px;margin-left:0px;display:none;"  id="left_fol_div">
                                             <div class="col-md-4">
                                      ...
                                      <table class="table table-bordered input-center" id='patient_right_ovary_list'>
                                        <thead>
                                           <tr>
                                              <th align="center" width="">
                                                 <input name="selectall" class="" id="selectall" value="" type="checkbox"  onclick="toggle_pat(this);">
                                        ...
                                        <tr name="patient_right_ovary_row" id="<?php echo $i; ?>">
                                           ...
                                           <td><?php echo $i; ?></td>
                                           <input type="hidden" id="unique_id" name="unique_id" value="<?php echo $i; ?>">
                                           <td><?php echo $patient_right_ovary_val['right_folli_date']; ?></td>
                                           <td><?php echo $patient_right_ovary_val['right_folli_day']; ?></td>
                                           <td><?php echo $patient_right_ovary_val['right_folli_protocol']; ?></td>
                                           <td><?php echo $patient_right_ovary_val['right_folli_pfsh']; ?></td>
                                           <td><?php echo $patient_right_ovary_val['right_folli_recfsh']; ?></td>
                                           <td><?php echo $patient_right_ovary_val['right_folli_hmg']; ?></td>
                                           <td><?php echo $patient_right_ovary_val['right_folli_hp_hmg']; ?></td>

                                           <td><?php echo $patient_right_ovary_val['right_folli_agonist']; ?></td>
                                           <td><?php echo $patient_right_ovary_val['right_folli_antiagonist']; ?></td>
                                           <td><?php echo $patient_right_ovary_val['right_folli_trigger']; ?></td>
                                        
                                        <td><?php echo $patient_right_ovary_val['endometriumothers']; ?></td>
                                        
                                        <td><?php echo $patient_right_ovary_val['e2']; ?></td>
                                        <td><?php echo $patient_right_ovary_val['p4']; ?></td>
                                        <td><?php echo $patient_right_ovary_val['risk']; ?></td>
                                        <td><?php echo $patient_right_ovary_val['others']; ?></td>
                                        
                                         <td><?php echo $patient_right_ovary_val['right_follic_size']; ?></td>
                                         
                                        <td><?php echo $patient_right_ovary_val['left_follic_size']; ?></td>
                                        ...
                                        <?php }
                                           ...
                                           { ?>
                                        <tr>
                                           <td colspan="19" align="center" class=" text-danger ">
                                        ...
                                        <?php }
                                           ?> 
                                           <div class="col-md-4">
                                        <a class="btn-custom m-b-5 m1" id="deleteAll" onclick="delete_right_ovary_vals();">
                                        <i class="fa fa-trash"></i> Delete
                                        </a></div>
                              ...
                              <div class="box-left">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <!--&nbsp;
                                       <input style="width: 50px;" placeholder="days" name="days" id="days"  class="" value="" type="text" numeric onKeyUp="myFunction()">-->
                                    </div>
                               </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-4">
                                       <label>Ultrasound Images/Video <span style="color:brown;">(Max filesize 20 MB) </span></label>
                                    </div>
                                    <div class="col-md-6">
                           ...
                           <div class="col-md-4" >
                              <div class="box-left">
                               ...
                               <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="fertility_risk" name="fertility_risk" style="height:100px;"><?php echo $fertillity_risk; ?></textarea>
            ...
            <div class="col-md-1 btn-box text-right">
              <div class="prescription_btns">
                ...
                <button class="btn-save" type="button" name="" data-dismiss="modal" onclick="window.location.href='<?php echo base_url('prescription'); ?>'"><i class="fa fa-sign-out"></i> Exit</button>
              </div>
            </div>
      <!-- row -->
      </form>
      ...
      <script type="text/javascript">
         ...
         function load_allergy_values(template_id="")
             ...
             function load_gpla_values(template_id="")
             {
                if(template_id=="")
                {
                    $.ajax({url: "<?php echo base_url(); ?>gynecology/gynecology_prescription/load_gpla_values/"+0, 
                       success: function(result)
                       {
                          get_gpla_data('');
                       } 
                ...
                {
                    $.ajax({url: "<?php echo base_url(); ?>gynecology/gynecology_prescription/load_gpla_values/"+template_id, 
                     success: function(result)
                     {
                        //alert(result);
                        get_gpla_data(result);
                     } 
                   });
                }
             ...
             function get_gpla_data(result)
             {
               ...
               var m = 1;
               $.each(obj, function (index, value) {
                arr +='<tr><input type="hidden" name="unique_id_patient_advice" value="'+index+'"><td><input type="checkbox"name="id[]" class="part_checkbox_advice booked_checkbox" value="'+index+'"></td><td>'+ m++  +'</td><td>'+obj[index].dog_value+'</td><td>'+obj[index].mode_value+'</td><td>'+obj[index].monthyear_value+'</td></tr>'
         
                });
                if(arr=="")
                {
                  arr = '<tr><td colspan="5" align="center" class=" text-danger "><div class="text-center">Advice not available.</div></td></tr>';
                } 
               $("#row_id_patient_gpla").val(m);
               $("#patient_gpla_list tbody").html(arr);
             }
         ...
         m++;
           ...
           //  load_patient_family_history_data
            ...
            function get_patient_obestetric_history_data(result)
            {
              ...
              var m = 1;
              $.each(obj, function (index, value) {
              arr +='<tr><input type="hidden" name="unique_id_obestetric_history" value="'+index+'"><td><input type="checkbox"name="id[]" class="part_checkbox_obestetric_history booked_checkbox" value="'+index+'"></td><td>'+ m++  +'</td><td>'+obj[index].obestetric_g+'</td><td>'+obj[index].obestetric_p+'</td><td>'+obj[index].obestetric_l+'</td><td>'+obj[index].obestetric_e+'</td><td>'+obj[index].obestetric_mtp+'</td><td>'+obj[index].obestetric_remarks+'</td></tr>'
   ...
   $.ajax({
            ...
            function get_gestational_date()
            {
               ...
               $.ajax({
                        ...
                        type: 'POST',
                        data: 'confirm_delivery='+confirm_delivery+'&antenatal_expected_date='+antenatal_expected_date+'&antenatal_care_period='+antenatal_care_period,
                        success: function(result)
                        {
      ...
      <script>
        ...
        function add_right_ovary ()
        {
             ...
             var right_folli_date = $('#right_folli_date').val();
             var right_folli_day = $('#right_folli_day').val();
             var right_folli_protocol = $('#right_folli_protocol').val();
             var right_folli_pfsh = $('#right_folli_pfsh').val();
             var right_folli_recfsh = $('#right_folli_recfsh').val();
             var right_folli_hmg = $('#right_folli_hmg').val();
             var right_folli_hp_hmg = $('#right_folli_hp_hmg').val();
             var right_folli_agonist=$('#right_folli_agonist').val();
             var right_folli_antiagonist=$('#right_folli_antiagonist').val();
             var right_folli_trigger=$('#right_folli_trigger').val();
             var right_follic_size= $('#right_follic_size option:selected').text();
             ...
             $.ajax({
                     ...
                     //data:'right_follic_size='+right_follic_size+'&rec_count='+rec_count+'&unique_id='+rec_count,
                       ...
                       data:'right_folli_date='+right_folli_date+'&right_folli_day='+right_folli_day+'&right_folli_protocol='+right_folli_protocol+'&right_folli_pfsh='+right_folli_pfsh+'&right_folli_recfsh='+right_folli_recfsh+'&right_folli_hmg='+right_folli_hmg+'&right_folli_hp_hmg='+right_folli_hp_hmg+'&right_folli_agonist='+right_folli_agonist+'&right_folli_antiagonist='+right_folli_antiagonist+'&right_folli_trigger='+right_folli_trigger
                       
                       +'&endometriumothers='+endometriumothers
                       +'&e2='+e2
                       +'&p4='+p4
                       +'&risk='+risk
                       +'&others='+others
                       +'&left_follic_size='+left_follic_size
                       +'&right_follic_size='+right_follic_size+'&rec_count='+rec_count+'&unique_id='+rec_count,
                     success: function(result)
                     {
        ...
        function add_left_ovary ()
        {
         ...
         //add for patient history
           ...
           function add_patient_obestetric_history_listdata()
           {
             ...
             var obestetric_e = $("#obestetric_e").val();
             var obestetric_remarks = $("#obestetric_remarks").val();
           
             $.ajax({
                     type: "POST",
                     url: "<?php echo base_url(); ?>gynecology/gynecology_prescription/patient_obestetric_history_list/", 
                     dataType: "json",
                     data:'obestetric_g='+obestetric_g+'&obestetric_p='+obestetric_p+'&obestetric_l='+obestetric_l+'&obestetric_mtp='+obestetric_mtp+'&obestetric_e='+obestetric_e+'&obestetric_remarks='+obestetric_remarks+'&unique_id_obestetric_history='+rec_count,
                     success: function(result)
                     {
           ...
           { 
             ...
             $.ajax({
                    ...
                    data: form_data, 
                     ...
                     {
                       //
                       $('#common_fertility_risk').val(fertility_risk);
              ...
              $.ajax({
                    ...
                    success: function(result)
                    {
                      ...
                      { 
                        ...
                        CKEDITOR.instances['patient_advice_id'].setData(result);
...
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    ...
    <script>
      ...
      $('#patient_investigation_id').select2();
    </script>