...
<input type="hidden" name="data_id" id="type_id" value="<?php echo $form_data['data_id']; ?>" /> 
                ...
                <div class="row">
                  <div class="col-md-12 dental-chart ">
                   ...
                   <?php 
                      $i=1; 
                      //print_r($prescription_tab_setting);die;
      ...
      ?>
       <div class="tab-content"  style="" >
        ...
        <input type="hidden" value="<?php echo $row_count; ?>" name="row_id" id="row_id">
          <div class="row">
            <div class="col-md-12 tab-contentt dental-chart">
              ...
              <div class="col-md-4 ">
                <div class="box-left">
                  ...
                  <div class="row m-b-5">
                    ...
                    <div class="col-md-7">
                      <select name="previous_delivery" id='previous_delivery' class="m_select_btn">
                ...
                <div class="col-md-8 p-r-0">
                      ...
                      <thead>
                        <tr>
                          <th align="center" width="">
                            <input name="selectall" class="" id="selectall" value="" type="checkbox"  onclick="toggle_pat(this);" style="margin-left:10px;">
                  ...
                  else
                  {
                    ...
                    { ?>
                        <tr>  
                          <td colspan="9" align="center" class=" text-danger "><div class="text-center">Patient History not available.</div></td>
                        </tr>
                    <?php }
                    ?> 
                       ...
                       <div class="table-box">
                          <table class="table table-bordered" id='patient_family_history_list'>
                             <thead>
                                <tr>
                                   <th align="center" width="">
                                      <input name="selectall" class="" id="selectall" value="" type="checkbox"  onclick="toggle_family_history(this);" style="margin-left: 10px;">
                                      <?php echo $check_script = "<script>$('#selectall').on('click', function () { 
                                         if ($(this).hasClass('allChecked')) {
                                         $('.checklist').prop('checked', false);
                                         } else {
                             ...
                             <?php 
                               ...
                               <?php
                                ...
                                { ?>
                                    <tr>  
                                      <td colspan="6" align="center" class=" text-danger "><div class="text-center">Patient Family History not available.</div></td>
                                    </tr>
                                <?php
                                }
                                ?> 
                ...
                <input type="hidden" value="<?php echo $row_count_personal_history; ?>" name="row_id_personal_history" id="row_id_personal_history">
                  <div class="col-md-4">
                    ...
                    <div class="row m-b-5">
                       ...
                       <div class="col-md-7">
                          <select name="br_discharge" class="m_select_btn full-width" id="br_discharge">
                    ...
                    <div class="row m-b-5">
                       ...
                       <div class="col-md-7">
                          <select name="white_discharge" class="m_select_btn full-width" id="white_discharge" >
                   ...
                   <div class="table-box">
                      <table class="table table-bordered" id='patient_personal_history_list'>
                         <thead>
                            <tr>
                               <th align="center" width="">
                                  <input name="selectall" class="" id="selectall" value="" type="checkbox"  onclick="toggle_personal_history(this);" style="margin-left: 10px;">
                                  <?php echo $check_script = "<script>$('#selectall').on('click', function () { 
                                     if ($(this).hasClass('allChecked')) {
                                     $('.checklist').prop('checked', false);
                                     } else {
                         ...
                         <?php 
                           ...
                           <?php
                            ...
                            { ?>
                                <tr>  
                                  <td colspan="9" align="center" class=" text-danger "><div class="text-center">Patient Personal History not available.</div></td>
                                </tr>
                            <?php
                            }
                            ?> 
              ...
              <div class="row">
                  <div class="col-md-4">
                    ...
                    <div class="row m-b-5">
                       ...
                       <div class="col-md-7">
                          <input type="text" name="lmp_date" id="lmp_date"  class="datepicker date"  data-date-format="dd-mm-yyyy" style="width:186px;" value="<?php //echo $form_data['next_appointment_date']; ?>" readonly/> 
                       </div>
                    </div>
                    ...
                    <div class="row m-b-5">
                       ...
                       <div class="col-md-7">
                          <select name="dysmenorrhea" class="m_select_btn full-width" id="dysmenorrhea" >
                   ...
                   <div class="table-box">
                      <table class="table table-bordered" id='patient_menstrual_history_list'>
                         <thead>
                            <tr>
                               <th align="center" width="">
                                  <input name="selectall" class="" id="selectall" value="" type="checkbox"  onclick="toggle_menstrual_history(this);" style="margin-left:10px;">
                                  <?php echo $check_script = "<script>$('#selectall').on('click', function () { 
                                     if ($(this).hasClass('allChecked')) {
                                     $('.checklist').prop('checked', false);
                                     } else {
                         ...
                         <?php 
                           ...
                           <?php
                            ...
                            { ?>
                                <tr>  
                                  <td colspan="10" align="center" class=" text-danger "><div class="text-center">Patient Menstrual History not available.</div></td>
                                </tr>
                            <?php
                            }
                            ?> 
                ...
                <input type="hidden" value="<?php echo $row_count_medical_history; ?>" name="row_id_medical_history" id="row_id_medical_history">
                  <div class="col-md-4">
                    ...
                    <div class="row m-b-5">
                       ...
                       <div class="col-md-7">
                          <input type="text" class="w-185px numeric" id='dm_years' name="dm_years" placeholder='Rx'>
                       </div>
                    </div>
                   ...
                   <div class="table-box">
                      <table class="table table-bordered" id='patient_medical_history_list'>
                         <thead>
                            <tr>
                               <th align="center" width="">
                                  <input name="selectall" class="" id="selectall" value="" type="checkbox"  onclick="toggle_medical_history(this);" style="margin-left: 10px;">
                                  <?php echo $check_script = "<script>$('#selectall').on('click', function () { 
                                     if ($(this).hasClass('allChecked')) {
                                     $('.checklist').prop('checked', false);
                                     } else {
                         ...
                         <?php 
                           ...
                           <?php
                            ...
                            { ?>
                                <tr>  
                                  <td colspan="10" align="center" class=" text-danger "><div class="text-center">Patient Medical History not available.</div></td>
                                </tr>
                            <?php
                            }
                            ?> 
                   ...
                   <div class="table-box">
                      <table class="table table-bordered" id='patient_obestetric_history_list'>
                         <thead>
                            <tr>
                               <th align="center" width="">
                                  <input name="selectall" class="" id="selectall" value="" type="checkbox"  onclick="toggle_obestetric_history(this);" style="margin-left:10px;">
                                  <?php echo $check_script = "<script>$('#selectall').on('click', function () { 
                                     if ($(this).hasClass('allChecked')) {
                                     $('.checklist').prop('checked', false);
                                     } else {
                         ...
                         <?php 
                            ...
                            if(!empty($patient_obestetric_history_data))
                            {
                              ...
                              { ?>
                                  <tr>  
                                    <td colspan="6" align="center" class=" text-danger "><div class="text-center">Patient Obestetric History not available.</div></td>
                                  </tr>
                              <?php
                              }
                            ?> 
                        ...
                        <tbody>
                            <tr>
                              ...
                              foreach ($prescription_medicine_tab_setting as $med_value) { ?>
                               ...
                               <tr>
                                 <?php
                                  ...
                                  <input type="text" name="prescription_history[<?php echo $l; ?>][medicine_name]" class="w-100px medicine_val<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_name; ?>">
                                  ...
                                  {
                                  ?>
                                  <td><input type="text" name="prescription_history[<?php echo $l; ?>][medicine_brand]" class="w-100px" id="brand<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_brand; ?>"></td>
                                  <?php 
                                  } 
                                  ...
                                  {
                                  ?>
                                  <td><input type="text" name="prescription_history[<?php echo $l; ?>][medicine_salt]" id="salt<?php echo $l; ?>" class="w-100px" value="<?php echo $prescription_presc->medicine_salt; ?>"></td>
                                  <?php 
                                  } 

                                  if(strcmp(strtolower($tab_value->setting_name),'type')=='0')
                                  { ?>
                                  <td><input type="text" name="prescription_history[<?php echo $l; ?>][medicine_type]" id="type<?php echo $l; ?>" class="input-small medicine_type_val<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_type; ?>"></td>
                                  <?php 
                                  }
                                  if(strcmp(strtolower($tab_value->setting_name),'dose')=='0')
                                  { ?>
                                  <td><input type="text" name="prescription_history[<?php echo $l; ?>][medicine_dose]" class="w-100px input-small dosage_val<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_dose; ?>"></td>
                                  <?php 
                                  } 
                                  if(strcmp(strtolower($tab_value->setting_name),'duration')=='0')
                                  {  ?>
                                  <td><input type="text" name="prescription_history[<?php echo $l; ?>][medicine_duration]" class="w-100px medicine-name duration_val<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_duration; ?>"></td>
                                  <?php 
                                  }
                                  if(strcmp(strtolower($tab_value->setting_name),'frequency')=='0')
                                  {
                                  ?>
                                  <td><input type="text" name="prescription_history[<?php echo $l; ?>][medicine_frequency]" class="w-100px medicine-name frequency_val<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_frequency; ?>"></td>
                                  <?php 
                                  } 
                                  if(strcmp(strtolower($tab_value->setting_name),'advice')=='0')
                                  { 
                                  ?>
                                  <td><input type="text" name="prescription_history[<?php echo $l; ?>][medicine_advice]" class="w-100px medicine-name advice_val<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_advice; ?>"></td>
                                  <?php } }
                                  ?>
                              ...
                              <tr>
                                  ...
                                  {
                                  ?>
                                  <td><input type="text" name="prescription_history[1][medicine_brand]" class=""></td>
                                  <?php 
                                  } 
                                  ...
                                  {
                                  ?>
                                  <td><input type="text" name="prescription_history[1][medicine_salt]" class="" ></td>
                                  <?php 
                                  }

                                  if(strcmp(strtolower($tab_value->setting_name),'type')=='0')
                                  { ?>
                                  <td><input type="text" name="prescription_history[1][medicine_type]" class="input-small" id="type0" onkeyup="get_medicine_type_autocomplete(0,1);"></td>
                                  <?php 
                                  }
                                  if(strcmp(strtolower($tab_value->setting_name),'dose')=='0')
                                  { ?>
                                  <td><input type="text" name="prescription_history[1][medicine_dose]" class="input-small" id="dose0" onkeyup="get_medicine_dose_autocomplete(0,1);"></td>
                                  <?php 
                                  } 
                                  if(strcmp(strtolower($tab_value->setting_name),'duration')=='0')
                                  {  ?>
                                  <td><input type="text" name="prescription_history[1][medicine_duration]" class="medicine-name" id="duration0" onkeyup="get_medicine_duration_autocomplete(0,1);"></td>
                                  <?php 
                                  }
                                  if(strcmp(strtolower($tab_value->setting_name),'frequency')=='0')
                                  {
                                  ?>
                                  <td><input type="text" name="prescription_history[1][medicine_frequency]" class="medicine-name" id="frequency0" onkeyup="get_medicine_frequency_autocomplete(0,1);"></td>
                                  <?php 
                                  } 
                                  if(strcmp(strtolower($tab_value->setting_name),'advice')=='0')
                                  { 
                                  ?>
                                  <td><input type="text" name="prescription_history[1][medicine_advice]" class="medicine-name" id="advice0" onkeyup="get_medicine_advice_autocomplete(0,1);"></td>
                                  <?php } 
                                }
                             ?>
                              <td width="80">
              ...
              <div class="row tab-pane fade in active" id="chief">
                ...
                <div class="col-md-7" >
                  ...
                  <div class="table-box">
                    ...
                    { ?>
                        <tr>  
                          <td colspan="5" align="center" class=" text-danger "><div class="text-center">Disease History not available.</div></td>
                        </tr>
                    <?php
                    }
                    ?> 
              ...
              <div class="row tab-pane fade in active" id="chief">
                ...
                <div class="col-md-7" >
                  ...
                  <div class="table-box">
                    ...
                    { ?>
                        <tr>  
                          <td colspan="5" align="center" class=" text-danger "><div class="text-center">Compaints not available.</div></td>
                        </tr>
                    <?php
                    }
                    ?> 
              ...
              <div class="row tab-pane fade in active" id="chief">
                ...
                <div class="col-md-7" >
                  ...
                  <div class="table-box">
                    ...
                    { ?>
                        <tr>  
                          <td colspan="5" align="center" class=" text-danger "><div class="text-center">Allergy not available.</div></td>
                        </tr>
                    <?php
                    }
                    ?> 
              ...
              <div class="row tab-pane fade in active" id="chief">
                ...
                <div class="col-md-7" >
                  ...
                  <div class="table-box">
                    ...
                    { ?>
                        <tr>  
                          <td colspan="5" align="center" class=" text-danger "><div class="text-center">General Exam not available.</div></td>
                        </tr>
                    <?php
                    }
                    ?> 
              ...
              <div class="row tab-pane fade in active" id="chief">
                ...
                <div class="col-md-7" >
                  ...
                  <div class="table-box">
                    ...
                    { ?>
                        <tr>  
                          <td colspan="5" align="center" class=" text-danger "><div class="text-center">Clinical Exam not available.</div></td>
                        </tr>
                    <?php
                    }
                    ?> 
              ...
              <div class="row tab-pane fade in active" id="chief">
                <div class="col-md-5" >
                  <div class="box-left">
                    ...
                    <!-- <div class="row">
                      ...
                      <div class="col-md-2">
                        <button type="button" onclick="add_patient_investigation_listdata();" class="theme-color">Add</button>
                      </div>
                    </div> -->
                ...
                <div class="col-md-7" >
                  ...
                  <div class="table-box">
                    ...
                    { ?>
                        <tr>  
                          <td colspan="3" align="center" class=" text-danger "><div class="text-center">Investigation not available.</div></td>
                        </tr>
                    <?php
                    }
                    ?> 
                        ...
                        <tbody>
                            <tr>
                              ...
                              foreach ($prescription_medicine_tab_setting as $med_value) { ?>
                               ...
                               <tr>
                                 <?php
                                  ...
                                  <input type="text" name="prescription[<?php echo $l; ?>][medicine_name]" class="w-100px medicine_val_patient<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_name; ?>">
                                  ...
                                  {
                                  ?>
                                  <td><input type="text" name="prescription[<?php echo $l; ?>][medicine_brand]" class="w-100px" id="brand_patient<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_brand; ?>"></td>
                                  <?php 
                                  } 
                                  ...
                                  {
                                  ?>
                                  <td><input type="text" name="prescription[<?php echo $l; ?>][medicine_salt]" id="salt_patient<?php echo $l; ?>" class="w-100px" value="<?php echo $prescription_presc->medicine_salt; ?>"></td>
                                  <?php 
                                  } 

                                  if(strcmp(strtolower($tab_value->setting_name),'type')=='0')
                                  { ?>
                                  <td><input type="text" name="prescription[<?php echo $l; ?>][medicine_type]" id="type_patient<?php echo $l; ?>" class="input-small medicine_type_val_patient<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_type; ?>"></td>
                                  <?php 
                                  }
                                  if(strcmp(strtolower($tab_value->setting_name),'dose')=='0')
                                  { ?>
                                  <td><input type="text" name="prescription[<?php echo $l; ?>][medicine_dose]" class="w-100px input-small dosage_val_patient<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_dose; ?>"></td>
                                  <?php 
                                  } 
                                  if(strcmp(strtolower($tab_value->setting_name),'duration')=='0')
                                  {  ?>
                                  <td><input type="text" name="prescription[<?php echo $l; ?>][medicine_duration]" class="w-100px medicine-name duration_val_patient<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_duration; ?>"></td>
                                  <?php 
                                  }
                                  if(strcmp(strtolower($tab_value->setting_name),'frequency')=='0')
                                  {
                                  ?>
                                  <td><input type="text" name="prescription[<?php echo $l; ?>][medicine_frequency]" class="w-100px medicine-name frequency_val_patient<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_frequency; ?>"></td>
                                  <?php 
                                  } 
                                  if(strcmp(strtolower($tab_value->setting_name),'advice')=='0')
                                  { 
                                  ?>
                                  <td><input type="text" name="prescription[<?php echo $l; ?>][medicine_advice]" class="w-100px medicine-name advice_val_patient<?php echo $l; ?>" value="<?php echo $prescription_presc->medicine_advice; ?>"></td>
                                  <?php } }
                                  ?>
                                  <script type="text/javascript">
                              ...
                              <tr>
                                  ...
                                  if(strcmp(strtolower($tab_value->setting_name),'type')=='0')
                                  { ?>
                                  <td><input type="text" name="prescription[1][medicine_type]" class="input-small" id="type_patient0" onkeyup="get_medicine_type_autocomplete(0,2);"></td>
                                  <?php 
                                  }
                                  if(strcmp(strtolower($tab_value->setting_name),'dose')=='0')
                                  { ?>
                                  <td><input type="text" name="prescription[1][medicine_dose]" class="input-small" id="dose_patient0" onkeyup="get_medicine_dose_autocomplete(0,2);"></td>
                                  <?php 
                                  } 
                                  if(strcmp(strtolower($tab_value->setting_name),'duration')=='0')
                                  {  ?>
                                  <td><input type="text" name="prescription[1][medicine_duration]" class="medicine-name" id="duration_patient0" onkeyup="get_medicine_duration_autocomplete(0,2);"></td>
                                  <?php 
                                  }
                                  if(strcmp(strtolower($tab_value->setting_name),'frequency')=='0')
                                  {
                                  ?>
                                  <td><input type="text" name="prescription[1][medicine_frequency]" class="medicine-name" id="frequency_patient0" onkeyup="get_medicine_frequency_autocomplete(0,2);"></td>
                                  <?php 
                                  } 
                                  if(strcmp(strtolower($tab_value->setting_name),'advice')=='0')
                                  { 
                                  ?>
                                  <td><input type="text" name="prescription[1][medicine_advice]" class="medicine-name" id="advice_patient0" onkeyup="get_medicine_advice_autocomplete(0,2);"></td>
                                  <?php } 
                                }
                             ?>
                              <td width="80">
              ...
              <div class="row tab-pane fade in active" id="chief">
                ...
                <div class="col-md-7" >
                  ...
                  <div class="table-box">
                    ...
                    { ?>
                        <tr>  
                          <td colspan="3" align="center" class=" text-danger "><div class="text-center">Advice not available.</div></td>
                        </tr>
                    <?php
                    }
                    ?> 
...
$(".addprescriptionrow").click(function(){
  ...
  var i=$('#prescription_name_table tr').length;
        $("#prescription_name_table").append('<tr><?php foreach ($prescription_medicine_tab_setting as $tab_value) 
                        ...
                        if(strcmp(strtolower($tab_value->setting_name),'medicine')=='0')
                        {
                        ?><td><input type="text" name="prescription_history['+i+'][medicine_name]" class="w-100px medicine_val'+i+'"><input type="hidden" name="medicine_id[]" id="medicine_id'+i+'"></td>                        <?php 
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'brand')=='0')
                        {
                        ?>   <td><input type="text" name="prescription_history['+i+'][medicine_brand]" id="brand'+i+'"  class="w-100px" ></td>                        <?php 
                        } 

                        if(strcmp(strtolower($tab_value->setting_name),'salt')=='0')
                        {
                        ?>  <td><input type="text" id="salt'+i+'"  name="prescription_history['+i+'][medicine_salt]" class="w-100px"  ></td>                        <?php 
                        } 
                        if(strcmp(strtolower($tab_value->setting_name),'type')=='0')
                        { ?>  <td><input type="text" id="type'+i+'"  name="prescription_history['+i+'][medicine_type]" class="w-100px input-small" id="type'+i+'" onkeyup="get_medicine_type_autocomplete('+i+',1);"></td>                        <?php 
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'dose')=='0')
                        { ?> <td><input type="text" name="prescription_history['+i+'][medicine_dose]" class="w-100px input-small dosage_val'+i+'"></td>                        <?php 
                        } 
                        if(strcmp(strtolower($tab_value->setting_name),'duration')=='0')
                        {  ?>  <td><input type="text" name="prescription_history['+i+'][medicine_duration]" class="w-100px medicine-name duration_val'+i+'"></td>                        <?php 
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'frequency')=='0')
                        {
                        ?> <td><input type="text" name="prescription_history['+i+'][medicine_frequency]" class="w-100px medicine-name frequency_val'+i+'"></td>                        <?php 
                        } 
                        if(strcmp(strtolower($tab_value->setting_name),'advice')=='0')
                        { 
                        ?>  <td><input type="text" name="prescription_history['+i+'][medicine_advice]" class="w-100px medicine-name advice_val'+i+'"></td>                        <?php 
                        } 
...
$(".addprescriptionrow_patient").click(function(){
  ...
  var i=$('#prescription_name_table_patient tr').length;
        $("#prescription_name_table_patient").append('<tr><?php foreach ($prescription_medicine_tab_setting as $tab_value) 
                        ...
                        if(strcmp(strtolower($tab_value->setting_name),'medicine')=='0')
                        {
                        ?><td><input type="text" name="prescription['+i+'][medicine_name]" class="w-100px medicine_val_patient'+i+'"><input type="hidden" name="medicine_id[]" id="medicine_id_patient'+i+'"></td>                        <?php 
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'brand')=='0')
                        {
                        ?>   <td><input type="text" name="prescription['+i+'][medicine_brand]" id="brand_patient'+i+'"  class="w-100px" ></td>                        <?php 
                        } 

                        if(strcmp(strtolower($tab_value->setting_name),'salt')=='0')
                        {
                        ?>  <td><input type="text" id="salt_patient'+i+'"  name="prescription['+i+'][medicine_salt]" class="w-100px"  ></td>                        <?php 
                        } 
                        if(strcmp(strtolower($tab_value->setting_name),'type')=='0')
                        { ?>  <td><input type="text" id="type_patient'+i+'"  name="prescription['+i+'][medicine_type]" class="w-100px input-small" id="type_patient'+i+'" onkeyup="get_medicine_type_autocomplete('+i+',2);"></td>                        <?php 
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'dose')=='0')
                        { ?> <td><input type="text" name="prescription['+i+'][medicine_dose]" class="w-100px input-small dosage_val_patient'+i+'"></td>                        <?php 
                        } 
                        if(strcmp(strtolower($tab_value->setting_name),'duration')=='0')
                        {  ?>  <td><input type="text" name="prescription['+i+'][medicine_duration]" class="w-100px medicine-name duration_val_patient'+i+'"></td>                        <?php 
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'frequency')=='0')
                        {
                        ?> <td><input type="text" name="prescription['+i+'][medicine_frequency]" class="w-100px medicine-name frequency_val_patient'+i+'"></td>                        <?php 
                        } 
                        if(strcmp(strtolower($tab_value->setting_name),'advice')=='0')
                        { 
                        ?>  <td><input type="text" name="prescription['+i+'][medicine_advice]" class="w-100px medicine-name advice_val_patient'+i+'"></td>                        <?php 
                        } 
...
$(function () 
{
    ...
    var selectItem = function (event, ui) {
          ...
          $('#medicine_company_patient'+i).val(names[3]);
...
$(function () 
{
    ...
    var selectItem = function (event, ui) {
          ...
          $('#type_patient').val(names[1]);
          $('#medicine_company_patient').val(names[3]);
          $('#salt_patient').val(names[2]);
        //$(".medicine_val").val(ui.item.value);
        return false;
    }
...
<script> 
  ...
  function add_patient_personal_history_listdata()
  {
    ...
    $.ajax({
            ...
            dataType: "json",
            data:'br_discharge='+br_discharge+'&side='+side+'&hirsutism='+hirsutism+'&white_discharge='+white_discharge+'&type='+type+'&dyspareunia='+dyspareunia+'&personal_details='+personal_details+'&unique_id_personal_history='+rec_count,
            success: function(result)
            {
