...
<section class="userlist">
    ...
    <div class="overlay-loader">
     ...
     <form id="prescription_tab_setting_form">
      ...
      <?php
        if(in_array('1859',$users_data['permission']['action']))
        {
        if(!empty($patient_tab_setting_list))
        {
          foreach($patient_tab_setting_list as $tab_setting_list)
          {
        ?>
      <div class="row">
        <div class="col-xs-4 br-h-small">
...
$("#prescription_tab_setting_form").on("submit", function(event) { 
  ...
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>gynecology/patient_tab_setting/",
    type: "post",
    data: $(this).serialize(),
