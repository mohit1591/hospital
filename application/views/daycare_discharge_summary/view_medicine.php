...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "ajax": {
            "url": "<?php echo base_url('daycare_discharge_summary/medicine_ajax_list/'.$summary_id)?>",
            "type": "POST",
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        .one('click', '#delete', function(e)
        {
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('daycare_discharge_summary/deleteall_medicine');?>",
                      data: {row_id: allVals},
  ...
  <div class="row m-b-5">
    ...
    <div class="userlist-right">
      <div class="btns">
            ...
            <a href="javascript:void(0)" class="btn-anchor m-b-2"  onClick="return print_window_page('<?php echo base_url("daycare_discharge_summary/print_discharge_summary_medicine/".$summary_id); ?>');"> <i class="fa fa-print"></i> Print</a>
