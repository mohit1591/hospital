...
<div class="container-fluid">
 ...
 <section class="userlist">
  ...
  <input type="hidden" name="daycare_id" id="daycare_id" value="<?php echo $summary_data['daycare_id']; ?>" /> 
...
<div class="modal-body" style="padding-left:3em;">   
  ...
  <a href="<?php echo base_url('daycare_discharge_summary'); ?>" class="btn-anchor"><i class="fa fa-sign-out"></i> Exit</a>
      </div>
</form>     
