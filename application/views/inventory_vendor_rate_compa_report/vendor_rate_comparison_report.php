...
{ 
    ...
    $.ajax({url: "<?php echo base_url(); ?>inventory_vendor_rate_compa_report/reset_search/", 
...
<section class="userlist">
    ...
    <div class="userlist-right relative">
      <div class="fixed">
      <div class="btns">
        <a href="<?php echo base_url('inventory_vendor_rate_compa_report/vendor_rate_comparison_excel'); ?>" class="btn-anchor m-b-2"><i class="fa fa-file-excel-o"></i> Excel</a>
        <a href="<?php echo base_url('inventory_vendor_rate_compa_report/vendor_rate_comparison_pdf'); ?>" class="btn-anchor m-b-2"><i class="fa fa-file-pdf-o"></i> PDF</a>
        <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("inventory_vendor_rate_compa_report/vendor_rate_comparison_print"); ?>');"><i class="fa fa-print"></i> Print</a> 
...
{   
    ...
    $.ajax({
      url: "<?php echo base_url('inventory_vendor_rate_compa_report/advance_search/'); ?>",
      type: "post",
...
var table;
     $(document).ready(function() { 
         table = $('#table').DataTable({  
             ...
             "pageLength": '100',
             "ajax": {
                 "url": "<?php echo base_url('inventory_vendor_rate_compa_report/ajax_list')?>",
                 "type": "POST",
