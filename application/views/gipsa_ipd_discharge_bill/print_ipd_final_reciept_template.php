...
//$payment_mode=$all_detail['ipd_list'][0]->payment_mode;
                        ...
                        /*$total_amount='';
                        if(!empty($all_charge_detail['CHARGES']))
                        {
                            foreach($all_charge_detail['CHARGES'] as  $details_data)
                            {  
                    ...
                    if(!empty($all_charge_detail['medicine_payment']))
                    {
                            $net_medicine_payment_data=array();
                            foreach($all_charge_detail['medicine_payment'] as $payment )
                            {
                    ...
                    if(!empty($all_charge_detail['pathology_payment']))
                    {
                            $net_pathology_payment_data=array();
                            foreach($all_charge_detail['pathology_payment'] as $payment )
                            {
                    ...
                    if(!empty($all_charge_detail['advance_payment']))
                    {
                            $net_advance_data=array();
                            foreach($all_charge_detail['advance_payment'] as $payment )
                            {
