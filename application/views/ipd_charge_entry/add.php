...
<div class="row">
  ...
  <div class="row m-b-5">
      ...
      <div class="col-xs-8">
        <select name="particulars" id="particular_id" class="" 
        <?php
              if($patient_details['patient_type'] == 2){
                ?>
                    onchange="return get_particulars_panel_data(this.value,<?=$patient_details['panel_name']?>);"
                <?php
              } else {
                ?>
                  onchange="return get_particulars_data(this.value);"
                <?php
              }
        ?>
...
function get_particulars_data(particulars_id)
{
  ...
  function get_particulars_panel_data(particulars_id,panel_id)
{
    var charges = $('#charges').val();
    var amount = $('#amount').val();
    var quantity = $('#quantity').val();
    $.ajax({url: "<?php echo base_url(); ?>general/ipd_particulars_panel/"+particulars_id+'/'+panel_id, 
      success: function(result)
      {
        console.log(result);
        var result = JSON.parse(result);
  ...
  function calculate_hrs()
  {
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>ipd_charge_entry/calculate_hrs/", 
            dataType: "json",
