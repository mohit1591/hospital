...
if(empty($_POST))
{
if((empty($particulars_list)) || (empty($ipd_particular_charge_billing)))
{
  
?>  

 
  $('#ipd_charge_count').modal({
     backdrop: 'static',
      keyboard: false
        })
<?php 
...
<div id="ipd_charge_count" class="modal fade dlt-modal">
      <div class="modal-dialog">
        <div class="modal-content bg-r-border">
          ...
          <div class="modal-footer  text-l">
           <?php if(empty($ipd_particular_charge_billing)) {
          ?> <p><i class="fa fa-star" aria-hidden="true"></i><span class="text1">Particular is required.</span></p><?php } ?>
