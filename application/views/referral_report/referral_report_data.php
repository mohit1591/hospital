...
?>          
          ...
          <div style="float:left;width:100%;border:1px solid #111;border-left:none;border-right:none;font-size:13px;">
            ...
            <div style="float:left;width:10%;font-weight:600;padding:4px;border-left:none;border-right:none;"><u>Date</u></div>
            <div style="float:left;width:10%;font-weight:600;padding:4px;border-left:none;border-right:none;"><u>Patient Name</u></div>
            <div style="float:left;width:5%;font-weight:600;padding:4px;border-left:none;border-right:none;"><u>Age</u></div> 
            
            <div style="float:left;width:10%;font-weight:600;padding:4px;border-left:none;border-right:none;"><u>Diseases</u></div>
            <div style="float:left;width:10%;font-weight:600;padding:4px;text-align:right;border-left:none;border-right:none;"><u>Mobile No.</u></div>
            <div style="float:left;width:10%;font-weight:600;padding:4px;text-align:right;border-left:none;border-right:none;"><u>Reference</u></div>
            <div style="float:left;width:10%;font-weight:600;padding:4px;text-align:right;border-left:none;border-right:none;"><u>App.Date</u></div>
            <div style="float:left;width:10%;font-weight:600;padding:4px;text-align:right;border-left:none;border-right:none;"><u>Patient Loc.</u></div>
            <div style="float:left;width:10%;font-weight:600;padding:4px;text-align:right;border-left:none;border-right:none;"><u>Branch</u></div>
      ...
      <div style="float:left;width:100%;border:1px solid #111;border-top:none;font-size:13px;">
       <div style="float:left;width:100%;font-weight:600;padding:4px;">
        ...
        //echo "<pre>";print_r($appointment_list);
        $date_array = array_unique(array_column($appointment_list,'appointment_date'));
        //print_r($date_array); die;
              
        foreach($appointment_list as $source_report)
        { 
          if(in_array($source_report['appointment_date'],$date_array))
          {
          ?>
           <div style="float:left; width: 100%">
            <div style="float:left;width:%;padding:1px 4px;text-indent:15px;"><b><?php echo date('d-m-Y',strtotime($source_report['appointment_date'])); ?></b></div>

            </div> 
          <?php   
           $used_date = array_search($source_report['appointment_date'],$date_array);
        ...
        <div style="float:left; width: 100%">
            ...
            <div style="float:left;width:10%;padding:1px 4px;"><?php echo $source_report['patient_name']; ?></div>
            <div style="float:left;width:5%;padding:1px 4px;"><?php echo $source_report['age_y']; ?></div>
            <div style="float:left;width:10%;padding:1px 4px;"><?php echo $source_report['disease_name']; ?></div>

            <div style="float:left;width:10%;padding:1px 4px;text-align:right;border-left:none;border-right:none;"><?php echo $source_report['mobile_no']; ?></div>
            <div style="float:left;width:10%;padding:1px 4px;text-align:right;border-left:none;border-right:none;"><?php echo $source_report['referral_doctor']; ?></div>

            <div style="float:left;width:10%;padding:1px 4px;text-align:right;border-left:none;border-right:none;">df</div>
            ...
            <div style="float:left;width:10%;padding:1px 4px;text-align:right;border-left:none;border-right:none;"><?php echo $source_report['branch_name']; ?></div>
            <div style="float:left;width:10%;padding:1px 4px;text-align:right;border-left:none;border-right:none;">Rem</div>
        </div>
                 <?php
                 $l++;  
                 } 
