...
?>
 <div class="modal-dialog">
  ...
  <div class="modal-content"> 
      <form  id="pacakge_opening" class="form-inline" enctype="multipart/form-data">
...
$("button[data-number=2]").click(function(){
  <?php //$this->session->unset_userdata('alloted_medicine_ids'); ?>
    $('#load_pacakge_import_modal_popup').modal('hide'); 
}); 

$("#pacakge_opening").on("submit", function(event) { 
     event.preventDefault(); 
     $('.overlay-loader').show();
  
     var path = 'import_dialysis_pacakge_excel/';
     var msg = 'dialysis pacakge successfully added.';
     var allVals = [];
     $.ajax({
          ...
          success: function(result) {
               ...
               {
                    $("#load_pacakge_import_modal_popup").html(result);
               }
               $('.overlay-loader').hide();       
          }
     });
