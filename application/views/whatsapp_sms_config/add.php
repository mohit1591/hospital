     ...
     <form id="sms_setting_form">
      ...
      <div class="row">
        <div class="col-xs-7 br-h-small">
          ...
          <div class="row">
              <div class="col-xs-3">
                  <strong>Whatsapp Username</strong> 
              </div>
              <div class="col-xs-9">
                  <input type="text" name="whatsapp_username" value="<?php echo $whatsapp_username; ?>">
              </div>
          </div>
        ...
        <div class="col-xs-7 br-h-small">
          ...
          <div class="row">
              <div class="col-xs-3">
                  <strong>Whatsapp Password</strong> 
              </div>
              <div class="col-xs-9">
                  <input type="password" name="whatsapp_password" value="<?php echo $whatsapp_password; ?>">
              </div>
          </div>
...
$("#sms_setting_form").on("submit", function(event) { 
  ...
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>whatsapp_sms_config/",
    type: "post",
    data: $(this).serialize(),
