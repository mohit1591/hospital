                    ...
                    <label></label>  
                      ...
                      if(in_array('60',$permission_section))
                       ...
                       <?php } 
                        ...
                        { ?>
                       <input type="radio" name="section_id[]" <?php if(!empty($refund_search_data) && in_array('15',$refund_search_data['section_id'])){ echo 'checked="checked"'; } ?> onclick="return form_submit()" value="15"> Dialysis
                       <?php } 
