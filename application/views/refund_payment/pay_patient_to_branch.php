       ...
       <table id="dataTable" class="table table-striped table-bordered refund_payment_list dataTable no-footer" role="grid" aria-describedby="table_info" cellspacing="0">
        ...
        <?php }else{ ?>
          ...
          <?php 
           ...
           elseif($form_data['section_id']==15)
           {
               //echo "<pre>"; print_r($dialysis_booking_data); die;
               
               $i=1;  
               if(!empty($dialysis_booking_data)){ ?>
                <tr>
                <td><?php echo $i++;?></td>
                <td><?php echo $dialysis_booking_data['booking_code']; ?></td>
                <td><?php echo date("d-m-Y", strtotime($dialysis_booking_data['dialysis_date']) ); ?></td>
                 <td><?php echo $dialysis_booking_data['net_amount']; ?></td>
                  <?php $x=0;
                 $dialysis_booking_data['net_amount']=$x+$dialysis_booking_data['net_amount']; 
                 $amount=$dialysis_booking_data['net_amount'];
            ?>
               </tr>
            <?php }else{ ?>
