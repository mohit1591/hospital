                    ...
                    <table class="table table-bordered table-striped" id="test_name_table">
                        <tbody>
                            ...
                            <tr id="del<?php echo $y; ?>">
                                <td><input type="text" name="test_name[]" class="w-100 test_val<?php echo $y; ?>" value="<?php echo $prescription_test->test_name; ?>" placeholder="Click to add Test">
                    ...
                    foreach ($prescription_medicine_tab_setting as $med_value) { ?>
                     ...
                     <tr id="prescription_tr_<?php echo $l; ?>">
                       <?php
                        ...
                        <input type="text" name="medicine_name[]" value="<?php echo $prescription_presc->medicine_name; ?>" onkeyup="get_medicine_autocomplete(<?php echo $l; ?>);" id="medicine_name<?php echo $l; ?>" placeholder="Click to add Medicine">
    ...
    function get_prescription_values(result)
    {
      ...
      $.each(obj, function (index, value) {       
         pres += '<tr><?php foreach ($prescription_medicine_tab_setting as $tab_value) 
                        ...
                        if(strcmp(strtolower($tab_value->setting_name),'medicine')=='0')
                        {
                        ?><td><input type="text" name="medicine_name[]" class="" value="'+obj[index].medicine_name+'" placeholder="Click to add Medicine"><input type="hidden" name="medicine_id[]" class="" value="'+obj[index].medicine_id+'"></td> <?php 
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'brand')=='0')
                        {
