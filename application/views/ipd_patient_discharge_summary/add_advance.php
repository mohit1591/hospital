   ...
   <div class="col-md-6">
     <!-- ============================ -->
        <div class="row m-b-5">
          ...
          <div class="col-md-8"> 
            <select name="template_id" onchange="return set_template(this.value)">
               <option value="">Select Template</option>
               <?php
               if(!empty($adv_template_list))
               {
                 foreach($adv_template_list as $template)
                 {
                 ?>
                 <option <?php if($_GET['tid']==$template['id']){ echo 'selected=""'; } ?> value="<?php echo $template['id']; ?>"><?php echo $template['name']; ?></option>
                 <?php
                 }
               }
               ?>
        ...
        <div class="col-xs-8">
          ...
          <div class="row m-b-5">
             ...
             <div class="col-xs-8 font-default">
                <label class="font-default"><input type="radio" name="summery_type" id="summery_type" <?php if($form_data['summery_type']==0){ echo 'checked="checked"'; } ?> value="0" onchange="check_status(0);"> LAMA</label> &nbsp;
                <label class="font-default"><input type="radio" name="summery_type" id="summery_type" <?php if($form_data['summery_type']==1){ echo 'checked="checked"'; } ?> value="1" onchange="check_status(0);"> REFERRAL</label> &nbsp;
                <label class="font-default"><input type="radio" name="summery_type" id="summery_type" <?php if($form_data['summery_type']==2){ echo 'checked="checked"'; } ?> value="2" onchange="check_status(0);"> DISCHARGE</label> &nbsp;
                <label class="font-default"><input type="radio" name="summery_type" id="summery_type" <?php if($form_data['summery_type']==3){ echo 'checked="checked"'; } ?> value="3" onchange="check_status(0);"> D.O.P.R</label> &nbsp;
                <label class="font-default"><input type="radio" name="summery_type" id="summery_type" <?php if($form_data['summery_type']==4){ echo 'checked="checked"'; } ?> value="4" onchange="check_status(0);"> NORMAL</label>&nbsp;
                <label class="font-default"><input type="radio" name="summery_type" id="summery_type" <?php if($form_data['summery_type']==5){ echo 'checked="checked"'; } ?> value="5" onchange="check_status(1);"> Death</label>
             </div>
          </div> <!-- row --> 
...
<div id="content">
              ...
              if(strcmp(strtolower($value['setting_name']),'cheif_complaints')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     ...
                     <div class="col-xs-8">
                        <textarea class="textarea-100" id="chief_complaints" name="chief_complaints" style="height: 78.5px; width: 300px;"><?php echo $form_data['chief_complaints']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'ho_presenting_illness')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea id="h_o_presenting" name="h_o_presenting" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['h_o_presenting']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'on_examination')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea name="on_examination" id="on_examination" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['on_examination']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'past_history')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea id="past_history" name="past_history" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['past_history']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'menstrual_history')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea id="menstrual_history" name="menstrual_history" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['menstrual_history']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'obstetric_history')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea id="obstetric_history" name="obstetric_history" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['obstetric_history']; ?></textarea>
        ...
        <div class="row m-b-5">
              ...
              if(strcmp(strtolower($value['setting_name']),'provisional_diagnosis')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea name="provisional_diagnosis" id="provisional_diagnosis" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['provisional_diagnosis']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'final_diagnosis')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                     <textarea name="final_diagnosis" id="final_diagnosis" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['final_diagnosis']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'course_in_hospital')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea name="course_in_hospital" id="course_in_hospital" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['course_in_hospital']; ?></textarea>
               ...
               if(strcmp(strtolower($value['setting_name']),'surgery_preferred')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea name="surgery_preferred" id="surgery_preferred" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['surgery_preferred']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'operation_notes')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea name="operation_notes" id="operation_notes" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['operation_notes']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'treatment_given')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea name="treatment_given" id="treatment_given" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['treatment_given']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'investigation')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea name="investigations" id="investigations" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['investigations']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'condition_at_discharge_time')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                       <textarea name="discharge_time_condition" id="discharge_time_condition" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['discharge_time_condition']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'advise_on_discharge')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                      <textarea name="discharge_advice" id="discharge_advice" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['discharge_advice']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'diagnosis')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                        <textarea class="textarea-100" id="diagnosis" name="diagnosis" style="height: 78.5px; width: 300px;"><?php echo $form_data['diagnosis']; ?></textarea>
              ...
              if(strcmp(strtolower($value['setting_name']),'family_history')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                        <textarea class="textarea-100" id="family_history" name="family_history" style="height: 78.5px; width: 300px;"><?php echo $form_data['family_history']; ?></textarea>
               ...
               if(strcmp(strtolower($value['setting_name']),'birth_history')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                        <textarea class="textarea-100" id="birth_history" name="birth_history" style="height: 78.5px; width: 300px;"><?php echo $form_data['birth_history']; ?></textarea>
               ...
               if(strcmp(strtolower($value['setting_name']),'general_history')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                        <textarea class="textarea-100" id="general_history" name="general_history" style="height: 78.5px; width: 300px;"><?php echo $form_data['general_history']; ?></textarea>
               ...
               if(strcmp(strtolower($value['setting_name']),'systemic_examination')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                        <textarea class="textarea-100" id="systemic_examination" name="systemic_examination" style="height: 78.5px; width: 300px;"><?php echo $form_data['systemic_examination']; ?></textarea>
               ...
               if(strcmp(strtolower($value['setting_name']),'local_examination')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                        <textarea class="textarea-100" id="local_examination" name="local_examination" style="height: 78.5px; width: 300px;"><?php echo $form_data['local_examination']; ?></textarea>
               ...
               if(strcmp(strtolower($value['setting_name']),'specific_findings')=='0')
              {
                ?>
                  <div class="row m-b-5">
                     <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                     <div class="col-xs-8">
                        <textarea class="textarea-100" id="specific_findings" name="specific_findings" style="height: 78.5px; width: 300px;"><?php echo $form_data['specific_findings']; ?></textarea>
                  ...
                  if(strcmp(strtolower($value['setting_name']),'pulse')=='0')
                  {
                    ?>
                      <div class="row m-b-5">
                         ...
                         <textarea name="vitals_pulse" id="vitals_pulse" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['vitals_pulse']; ?></textarea>
                          <?php if(!empty($form_error)){ echo form_error('vitals_pulse'); } ?>
                       </div>
                      </div> <!-- row -->
                  ...
                  if(strcmp(strtolower($value['setting_name']),'chest')=='0')
                  {
                    ?>
                      <div class="row m-b-5">
                        ...
                        <textarea name="vitals_chest" id="vitals_chest" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['vitals_chest']; ?></textarea>
                           <?php if(!empty($form_error)){ echo form_error('vitals_chest'); } ?>
                       </div>
                      </div> <!-- row -->
                  ...
                  if(strcmp(strtolower($value['setting_name']),'bp')=='0')
                  {
                    ?>
                      <div class="row m-b-5">
                        ...
                        <textarea name="vitals_bp" id="vitals_bp" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['vitals_bp']; ?></textarea>
                  ...
                  if(strcmp(strtolower($value['setting_name']),'cvs')=='0')
                  {
                    ?>
                      <div class="row m-b-5">
                         <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                         <div class="col-xs-8">
                         <textarea name="vitals_cvs" id="vitals_cvs" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['vitals_cvs']; ?></textarea>
                  ...
                  if(strcmp(strtolower($value['setting_name']),'temp')=='0')
                  {
                    ?>
                      <div class="row m-b-5">
                         <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                         <div class="col-xs-8">
                         <textarea name="vitals_temp" id="vitals_temp" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['vitals_temp']; ?></textarea>
                  ...
                  if(strcmp(strtolower($value['setting_name']),'cns')=='0')
                  {
                    ?>
                      <div class="row m-b-5">
                         <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                         <div class="col-xs-8">
                         <textarea name="vitals_cns" id="vitals_cns" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['vitals_cns']; ?></textarea>
                  ...
                  if(strcmp(strtolower($value['setting_name']),'p_a')=='0')
                  {
                    ?>
                      <div class="row m-b-5">
                         <div class="col-xs-4"><label><?php if(!empty($value['setting_value'])) { echo $value['setting_value']; } else { echo $value['var_title']; } ?></label></div>
                         <div class="col-xs-8">
                         <textarea name="vitals_p_a" id="vitals_p_a" class="textarea-100" style="height: 78.5px; width: 300px;"><?php echo $form_data['vitals_p_a']; ?></textarea>
          ...
          <div class="row m-b-5" id="remarks_d">
                     ...
                     <div class="col-xs-8">
                        <textarea class="textarea-100" id="remarks" name="remarks" style="height: 78.5px; width: 300px;"><?php  echo $form_data['remarks']; ?></textarea>
   ...
   <div class="col-md-6">
     <!-- ======================== -->
      ...
      <div class="row m-b-5">
          ...
          <div class="col-xs-8">
           <?php //echo $patient_details['discharge_date']; //if(!empty($patient_details['discharge_date']) && $patient_details['discharge_date']!='0000-00-00 00:00:00'){ echo date('d-m-Y h:i A',strtotime($patient_details['discharge_date'])); } 
           echo $dischargetime;
           ?>
            <input type="dischargedate" name="dischargedate" class="datepicker w-130px" value="<?php if(!empty($form_data['dischargedate']) && $form_data['dischargedate']!='0000-00-00'){ echo $form_data['dischargedate']; }elseif(!empty($patient_details['discharge_date']) && $patient_details['discharge_date']!='0000-00-00 00:00:00'){ echo date('d-m-Y',strtotime($patient_details['discharge_date'])); } ?>">
           
            <input type="dischargetime" name="dischargetime" class="datepicker3 w-65px" value="<?php if(!empty($form_data['dischargetime'])){ echo $form_data['dischargetime'];}elseif(!empty($patient_details['discharge_date']) && $patient_details['discharge_date']!='0000-00-00 00:00:00'){ echo date('h:i A',strtotime($patient_details['discharge_date'])); } ?>">
          </div>
      </div>
         ...
         <div class="col-xs-4">
          ...
          <div class="col-xs-8 ">
           <?php  echo $patient_details['address']; ?>
              ...
              <div class="row m-b-5">
                <div class="col-xs-12">
               <table class="table table-bordered table-striped" id="prescription_name_table" style="margin-top: 100px; margin-left:-115px;">
              ...
              <tbody>
                    ...
                    foreach ($prescription_medicine_tab_setting as $med_value) { ?>
                      ...
                      if(!empty($prescription_presc_med_list))
                      { 
                           $l=1;
                         //echo "<pre>"; print_r($prescription_presc_med_list);die;
                          foreach ($prescription_presc_med_list as $prescription_presc) 
                          {
             ...
             <!--- Investigation Section ---->
               <div class="row m-b-5">
                <div class="col-xs-12">
                  ...
                  <?php //if(1==2){ ?>
               <table class="table table-bordered table-striped" id="test_name_table" style="margin-left:-115px;">
              ...
              <tbody>
                    ...
                    <td>Result</td>
                      ...
                      { 
                           $l=1;
                         //  print_r($prescription_presc_med_list);die;
      ...
      <div class="modal-footer r-btn-cntr"> 
         ...
         <button type="button" onclick="window.location.href='<?php echo base_url('ipd_booking'); ?>'" class="btn-cancel" data-number="1">Exit</button>
      </div>
</form>     
