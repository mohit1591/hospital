                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                  <input type="radio" name="merital_status" <?php if($form_data['merital_status']==1){ echo 'checked="checked"'; } ?> id="merital_status" value="1" /> Single 
                                  <input type="radio" name="merital_status" <?php if($form_data['merital_status']==0){ echo 'checked="checked"'; } ?> id="merital_status" value="2" /> Married  
                            </div>
                          </div>
                      </div>
