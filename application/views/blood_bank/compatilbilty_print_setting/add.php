...
<div class="row">
  <div class="col-md-12 add_opd_print_setting">
    <form action="<?php echo base_url('blood_bank/compatilbilty_print_setting/add'); ?>" method="post">
  <input type="hidden" name="data_id" value="<?php echo $form_data['data_id'];?>" />
    <div class="row m-b-5">
     ...
     <div class="row m-b-5">
      ...
      <div class="col-xs-9">
        <textarea type="text"  class="print_textarea"  name="short_code" class="" id="" cols="45" readonly>{patient_name} {patient_reg_no} {age} {gender} {vital_table}
</textarea>
      </div>
    </div> <!-- rowClose -->
   ...
   <div class="row m-b-5">
      ...
      <div class="col-xs-10">
       <button class="btn-save" type="submit" name="remove_levels" onClick=" validateForm();" ><i class="fa fa-floppy-o"></i> Save</button>
             <button type="button" class="btn-update" onclick="window.location.href='<?php echo base_url('/'); ?>'">
