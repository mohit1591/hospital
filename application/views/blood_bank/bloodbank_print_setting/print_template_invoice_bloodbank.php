...
$template_data->template = str_replace("{vat}",$all_detail['blood_print_list'][0]->vat,$template_data->template);

$template_data->template = str_replace("{vat_amount}",$all_detail['blood_print_list'][0]->vat_amount,$template_data->template);

$date_req = date('d-m-Y',strtotime($all_detail['blood_print_list'][0]->requirement_date));


$template_data->template = str_replace("Blood Bank Receipt","Invoice",$template_data->template);

$template_data->template = str_replace("Received :","Total Amount",$template_data->template);
...
$template_data->template = str_replace("Received with Thanks a sum of AED","",$template_data->template);
...
$template_data->template = str_replace("{net_paid_amount}"," ",$template_data->template);
$template_data->template = str_replace("{balance}","",$template_data->template);
 $div_head='';
      $div_val='';
      $div_head='Discount:';
...
if($template_data->printer_id==1)
{
  ...
  $template_data->template = str_replace("{pateint_reg_no}",$all_detail['blood_print_list'][0]->patient_code,$template_data->template);
    ...
    $template_data->template = str_replace("{recipient_uid}",$all_detail['blood_print_list'][0]->recipient_uid,$template_data->template);
