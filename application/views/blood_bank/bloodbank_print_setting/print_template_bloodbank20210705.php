...
$date_req = date('d-m-Y',strtotime($all_detail['blood_print_list'][0]->requirement_date));
...
$date=date('d-m-Y');
  ...
  //$template_data->template = str_replace("{blood_group}",$all_detail['blood_print_list'][0]->blood_group,$template_data->template);
    ...
    $template_data->template = str_replace("{blood_groups}",$all_detail['blood_print_list'][0]->blood_group,$template_data->template);
...
//////////////////////// 
$isid = $all_detail['blood_print_list'][0]->issue_code;

$client_name =$all_detail['blood_print_list'][0]->relation_name;
        if(!empty($all_detail['blood_print_list'][0]->cat_spec))
        {
          $commom_s =$all_detail['blood_print_list'][0]->cat_spec;
        }
        else
        {
          $commom_s =$all_detail['blood_print_list'][0]->dog_spec;
        }
...
{ 
    ...
    $tr = str_replace("{date}",$date_req,$tr);
    $tr = str_replace("{patient_id}",$isid,$tr);
     $tr = str_replace("{patient_code}",$all_detail['blood_print_list'][0]->recipient_uid,$tr);
    ...
    $tr = str_replace("{blood_group}",$all_detail['blood_print_list'][0]->blood_group,$tr);
    
    $tr = str_replace("{component}",$component_list->component_name,$tr);
...
if(!empty($particular_data))
{
  ...
  foreach($particular_data as $particular)
  {
    ...
    $tr = str_replace("{patient_code}",'',$tr);
    $tr = str_replace("{bar_code}",'',$tr);

    $tr = str_replace("{client}",'',$tr);

    $tr = str_replace("{species}",'',$tr);

    $tr = str_replace("{blood_group}",'',$tr);
    
    $tr = str_replace("{component}",$particular->particular,$tr);
    $tr = str_replace("{qty}",$particular->quantity+0,$tr);
...
$template_data->template = str_replace("{net_paid_amount}",$patient_detail['paid_amount'],$template_data->template);
