...
$template_data->template = str_replace("{ref_doctor}",$all_detail['blood_print_list'][0]->doctor_name,$template_data->template);

$template_data->template = str_replace("{ref_hospital}",$all_detail['blood_print_list'][0]->hospital_name,$template_data->template);
