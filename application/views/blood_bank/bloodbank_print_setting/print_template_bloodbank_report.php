...
$address_re=array();
	...
	$template_data->template = str_replace("{hospital_receipt_no}",$all_detail['blood_print_list'][0]->patient_code,$template_data->template);
...
$date=date('d-m-Y');
  $template_data->template = str_replace("{created_date}",$date,$template_data->template);
    ...
    $template_data->template = str_replace("{doctor_name}",$all_detail['blood_print_list'][0]->doctor_name,$template_data->template);
    
    $template_data->template = str_replace("{hospital_name}",$all_detail['blood_print_list'][0]->hospital_name,$template_data->template);
...
$get_unite_data=get_component_unite($recipient_id,$component_list->component_id);
$comp_unite = $get_unite_data[0]->comp_unite;
$tr = $row_loop;
...
$template_data->template = str_replace("{component_name}",$component_list->component_name,$template_data->template);
//change due to requirement 
//$component_list->donor_code
$template_data->template = str_replace("{donor_id}",$comp_unite,$template_data->template);
}
