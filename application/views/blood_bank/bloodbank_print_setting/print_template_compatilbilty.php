...
$template_data->template = str_replace("{gender}",$gender,$template_data->template);
  ...
  $template_data->template = str_replace("{issue_date}",$issue_dates,$template_data->template);
   ...
   $template_data->template = str_replace("{patient_relation}",$pat_data['patient_relation'],$template_data->template);
  ...
  $issue_datas ='<table border="1" cellpadding="0" cellspacing="0" width="100%">
            <thead>
                   <tr>
      <td align="center">S.No.</td>
      <td align="center">Bag/Unit No.</td>
      <td align="center">Blood Component</td>
      <td align="center">Blood Group</td>
      <td align="center">Date of Collection</td>
      <td align="center">Expiry Date</td>
      <td align="center">Compatibility Testing</td>
    </tr></thead>
                    <tbody>';
  ...
  $template_data->template = str_replace("{issue_data}",$issue_datas,$template_data->template);
  //end issue
