...
<div class="row">
  <div class="col-md-12 add_opd_print_setting">
    <form action="<?php echo base_url('blood_bank/bloodbank_print_setting/add'); ?>" method="post">
    <div class="row m-b-5">
      <div class="col-xs-2">
...
<script>
  function get_template_according(value){
    ...
    $.ajax({
      type:"POST",
      url: "<?php echo base_url(); ?>blood_bank/bloodbank_print_setting/bloodbank_printtemplate_dropdown/", 
      data: {value: value},
      datatype:'JSON',
