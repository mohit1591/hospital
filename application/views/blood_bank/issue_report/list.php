...
function reset_date_search()
  {
      ...
      $('#end_date').val('');
      $.ajax({
         url: "<?php echo base_url('blood_bank/issue_report/reset_date_search/'); ?>",  
...
$modal.load('<?php echo base_url().'blood_bank/issue_report/advance_search/' ?>',
{
//'id1': '1',
//'id2': '2'
},
     ...
     <!-- <div class="grp">
      ...
      <div class="fixed">
          ...
          <?php if(in_array('1568',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('blood_bank/issue_report/issue_report_excel');?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-excel-o"></i> Excel
               </a>
          <?php endif;?>
          
         <?php if(in_array('1569',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('blood_bank/issue_report/issue_pdf_report'); ?>" class="btn-anchor m-b-2">
          ...
          <?php if(in_array('1569',$users_data['permission']['action'])): ?>
              ...
              <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("blood_bank/issue_report/issue_print_report"); ?>');">
...
$("#new_search_form").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url(); ?>blood_bank/issue_report/advance_search/",
    type: "post",
    data: $(this).serialize(),
    success: function(result) 
    {
...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "aaSorting": [],
        "ajax": {
            "url": "<?php echo base_url('blood_bank/issue_report/ajax_list')?>",
            "type": "POST"
        }, 
        "columnDefs": [
        { 
