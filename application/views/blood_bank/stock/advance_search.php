 ...
 <div class="modal-dialog advance-search-modal">
  ...
  <div class="modal-content"> 
      <form  id="advance_search_form" class="form-inline"> 
           ...
           <select name="component_id" class="m_input_default" id="component_id">
           ...
           <select name="status" class="m_input_default" id="status">
              <option value="">Select Status</option>

              <option value="1" <?php if(isset($form_data['status']) &&  $form_data['status']!="" && $form_data['status']==1){ echo 'selected="selected"'; } ?>>In Stock</option>
              <option value="2" <?php if(isset($form_data['status']) &&  $form_data['status']!="" && $form_data['status']==2){ echo 'selected="selected"'; } ?>>Awaiting Results </option>
              <option value="3" <?php if(isset($form_data['status']) &&  $form_data['status']!="" && $form_data['status']==3){ echo 'selected="selected"'; } ?>>Unfit to Donate</option>
              <option value="4" <?php if(isset($form_data['status']) &&  $form_data['status']!="" && $form_data['status']==4){ echo 'selected="selected"'; } ?>>Discarded (Test Failed)</option>
            </select>
                      ...
                      <div class="inner">
                        ...
                        <div class="grp">
                          ...
                          <input type="text" name="donor_id" class="" value="<?php echo $form_data['donor_id']; ?>" id="donor_id">
                        </div>

                           <div class="grp">
                          <label>Bar Code</label>
                          <input type="text" name="bar_code" class="" value="<?php echo $form_data['bar_code']; ?>" id="">
                        </div>
