...
<table width="100%" cellpadding="0" cellspacing="0" colspan="11" border="1px" style="font:12px Arial !important;">
    <tr><td colspan="10" align="center"><h3>Stock Allotment Item Return Inventory Report <?php 
