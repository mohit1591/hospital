...
if(!empty($prescription_list))
{
    ...
    foreach($prescription_list as $pres_detail)
    {
            ...
            if(!empty($pres_detail->validity_date) && $pres_detail->validity_date!='0000-00-00')
        {
            ...
            $template_data = str_replace("{opd_heading}","CONSOLIDATE SHEET",$template_data);
      ...
      $fertility_sperm_remarks = $patient_fertility_data[0]->fertility_sperm_remarks; 
            ...
            $extra= $all_detail['prescription_list'][0]->lmps.$all_detail['prescription_list'][0]->edd.$all_detail['prescription_list'][0]->pog;
             ...
             $users_data = $this->session->userdata('auth_users');
                ...
                $patient_vital .= '<table border="1px 4px" cellpadding="0" cellspacing="0" style="border-collapse:collapse;font-size:8px;" width="100%">
                ...
                <tbody>
                    ...
                    if(!empty($vitals_list))
                    {
                     $patient_vital .= '<th align="center" style="border-bottom:1px solid black;padding:0 5px;font-size:9px" valign="top">Weight</br>(Kg)</th>
                      <th align="center" style="border-bottom:1px solid black;padding:0 5px;font-size:9px" valign="top">Height</br>(cm)</th> 
                      <th align="center" style="border-bottom:1px solid black;padding:0 5px;font-size:9px" valign="top">BMI</br>(Kg/m2)</th>
                      <th align="center" style="border-bottom:1px solid black;padding:0 5px;font-size:9px" valign="top">MAP</th>
                      <th align="center" style="border-bottom:1px solid black;padding:0 5px;font-size:9px" valign="top">BP</th> ';            
                      foreach ($vitals_list as $vitals) 
                      {
                        $vital_val = get_vitals_value();
            
                        
                          $patient_vital .= '<th align="center" style="border-bottom:1px solid black;padding:0 5px;font-size:9px" valign="top">'.$vitals->vitals_name;
        ...
        $final_template_data = preg_replace('/(<br\s*\/?>\s*){2,}/i', '<br>', $final_template_data);
        $final_template_data = preg_replace('/<br\s*\/?>/i', '', $final_template_data);
