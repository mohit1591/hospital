...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('prescription/ajax_video_list/'.$prescription_id)?>",
            "type": "POST",
        }, 
        "columnDefs": [
        { 
...
<script>  
 ...
 ?>
 function delete_video(prescription_id)
 {    
    $('#confirm').modal({
      backdrop: 'static',
      keyboard: false
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('prescription/delete_video/'); ?>"+prescription_id, 
