   ...
   <div class="col-md-6">  <!--column 2-->
            ...
            <div class="row m-b-5">
              ...
              <div class="col-xs-8">
                ...
                <input type="text" id="patient_code" readonly="" name="patient_code" value="<?php if(!empty($data) && $data!="") { echo $data['patient_code']; } ?>" /> 
              </div>
            </div>
            ...
            <div class="row m-b-5">
              ...
              <div class="col-md-8">
                ...
                <select name="booking_code" id="booking_code">
                  ...
                  if(!empty($ot_booking_list))
                  {
                    foreach($ot_booking_list as $booking)
                    {
                      $selected_booking = '';
                      if($booking['booking_code']==$data['booking_code'])
                      {
                           $selected_booking ='selected="selected"';
                      }
                              
                      echo '<option value="'.$booking['booking_code'].'" '.$selected_booking.'>'.$booking['booking_code'].'</option>';
                    }
                  }
                  ?>
                </select>
          ...
          <div class="col-xs-4">
            ...
            <div class="col-xs-8">
              ...
              ?>
              <input type="text" name="patient_name" readonly id="patient_name" value="<?php echo $data['patient_name']; ?>" class="mr-name txt_firstCap" style="width:100%" autofocus/>
      ...
      <div class="row m-b-5">
        ...
        <div class="col-xs-8">
          <input type="text" name="age_y" id="age_y" readonly  class="input-tiny numeric" maxlength="3" value="<?php echo $data['age_y']; ?>"> Y &nbsp;
                <input type="text" name="age_m" id="age_m"  readonly class="input-tiny numeric" maxlength="2" value="<?php echo $data['age_m']; ?>"> M &nbsp;
                <input type="text" name="age_d" id="age_d" readonly class="input-tiny numeric" maxlength="2" value="<?php echo $data['age_d']; ?>"> D
        ...
        <div class="col-xs-8"> <br>
             ...
             <div class="row m-b-5">
              ...
              <div class="col-xs-8">
                 ...
                 <a href="<?=base_url('procedure_note_summary')?>" target="_blank" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add new</a>
              </div>
            </div>
   ...
   <div class="col-md-6"> <!--column 2-->
    ...
    <div class="row m-b-5">
      ...
      <div class="row m-b-5">
              ...
              <div class="col-xs-8">
                   <input type="text" readonly id="mobile_no" name="mobile_no" value="<?php if(!empty($data) && $data!='') { echo $data['mobile_no']; } ?>" /> 
    ...
    <div class="row m-b-5 m-b-5">
          ...
          <div class="col-xs-8"> 
                <select name="simulat" id="simulat" style="width: 60px;">
     ...
     <div class="modal-footer r-btn-cntr"> 
      ...
      <?php 
        $insertUpdateUrl = "";
        if($rec_id > 0) {
          $insertUpdateUrl = base_url('procedure_history/edit/'.$rec_id);
        } else { 
          $insertUpdateUrl = base_url('procedure_history/add');
        }
      ?>
          <input type="button" class="btn-update" name="form_sub" value="Submit" onclick="submit_ot_summary('<?=$insertUpdateUrl?>');">
...
<script type="text/javascript">
  function add_doctor_list(){
    ...
    var simulat= $('#simulat').val();

     $.ajax({
            url : "<?php echo base_url('operation_summary/append_doctor_list/'); ?>",
            method: 'post',
            data: {name : doc ,rowCount:rowCount,doctor_id:doctor_id,simulat:simulat},
...
function submit_ot_summary(url)
{
  ...
  $.ajax({
            ...
            success: function(result) 
            {
              ...
              else if(result.st==1)
              {
                 ...
                 setTimeout(function() {
                      window.location.href = "<?php echo base_url('procedure_history'); ?>";
                  }, 1000);
    ...
    $(this).find('.inputFocus').focus();
      ...
      <script>
        $("#booking_code").change(function(){
          ...
          $.ajax({
            url: "<?php echo base_url('procedure_history/get_ot_details')?>",
            type: 'POST',
            ...
            success: function(response){
              if(response != null) {
                ...
                // $("input[name='gender']").prop(data.patient_gender);
                $("input[name='gender'][value='" + data.gender + "']").prop('checked', true);
                $("#address").text(data.address);
                $("#mobile_no").val(data.mobile_no);
                // $("#patient_dob").val(data.patient_dob);
                // $("#patient_guardian_name").val(data.patient_guardian_name);
                // $("#patient_guardian_phone").val(data.patient_guardian_phone);
                // $("#patient_guardian_address").val(data.patient_guardian_address);
              }
            }
        })
      });
