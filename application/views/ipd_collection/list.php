...
$('#employee').val('');
      $.ajax({
         url: "<?php echo base_url('ipd_collection_report/reset_date_search/'); ?>",  
...
$modal.load('<?php echo base_url().'ipd_collection_report/advance_search/' ?>',
{
//'id1': '1',
//'id2': '2'
},
...
<th> Paid Date </th>  
      ...
      <div class="fixed">
          ...
          <?php if(in_array('768',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('ipd_collection_report/ipd_report_excel'); ?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-excel-o"></i> Excel
               </a>
          <?php endif;?>
          <?php if(in_array('769',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('ipd_collection_report/ipd_report_csv'); ?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-word-o"></i> CSV
               </a>
          <?php endif;?>
          <?php if(in_array('770',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('ipd_collection_report/pdf_ipd_report'); ?>" class="btn-anchor m-b-2">
          ...
          <?php if(in_array('771',$users_data['permission']['action'])): ?>
            ...
            <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("ipd_collection_report/print_ipd_report"); ?>');">
...
var employee = $('#employee').val();
    ...
    $.ajax({ 
           url: "<?php echo base_url('ipd_collection_report/search_data/'); ?>", 
           type: 'POST',
...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "aaSorting": [],
        "ajax": {
            "url": "<?php echo base_url('ipd_collection_report/ajax_list')?>",
            "type": "POST"
        }, 
        "columnDefs": [
        { 
