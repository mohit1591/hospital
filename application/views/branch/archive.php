...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "order": [], 
        "ajax": {
            "url": "<?php echo base_url('branch/archive_ajax_list')?>",
            "type": "POST",
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('branch/restoreall');?>",
                      data: {row_id: allVals},
...
<section class="userlist">
    ...
    ?>    
        ...
        <button class="btn-exit" onclick="window.location.href='<?php echo base_url('branch'); ?>'">
...
<script>  
 ...
 function restore_branch(branch_id)
 {    
    $('#confirm').modal({
      backdrop: 'static',
      keyboard: false, 
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('branch/restore/'); ?>"+branch_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
  ...
  function trash_branch(branch_id)
 {    
    $('#confirm').modal({
      backdrop: 'static',
      keyboard: false, 
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('branch/trash/'); ?>"+branch_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('branch/trashall');?>",
                      data: {row_id: allVals},
                      success: function(result) 
                      {
                            flash_session_msg(result);
