    ...
    <div class="userlist-box">  
      <div id="permission_section">
           ...
           <div>
            ...
            <?php } if(in_array('opd', $permited_section)){?>
              ...
              <li class="per_menu_tab _day_care">
               ...
               <?php } if(in_array('eye', $permited_section)){?>
        ...
        <?php } */ if(in_array('pediatrician', $permited_section)){?>
          ...
          <?php } if(in_array('dental', $permited_section)){?>
            ...
            <?php } /* if(in_array('opd dental', $permited_section)){?>
              ...
              <?php } */ if(in_array('gynecology', $permited_section)){?>
              ...
              <?php } 
              /*if(in_array('opd eye pediatrician dental', $permited_section)){?>
             ...
             <?php } if(in_array('ot', $permited_section)){?>
              <li class="per_menu_tab _ot">
                <strong>OT  </strong>
                <div>
                  <label><input type="radio"  class="tab_active" name="ot_radio" onClick="ot_eye_section_check(1);" id="ot_active" value="1"> Active</label>
                  <label><input type="radio"  class="tab_inactive" name="ot_radio" onClick="ot_eye_section_check(0);" id="ot_inactive" value="0"> Inactive</label>
                </div>
              </li>
            ...
            <?php } if(in_array('vaccination', $permited_section)){?>
              <li class="per_menu_tab _vaccination">
                <strong>Vaccination  </strong>
                <div>
                  <label><input type="radio"  class="tab_active" name="vaccination_pediatrician_radio" onClick="vaccination_pediatrician_section_check(1);" id="vaccination_active" value="1"> Active</label>
                  <label><input type="radio"  class="tab_inactive" name="vaccination_pediatrician_radio" onClick="vaccination_pediatrician_section_check(0);" id="vaccination_inactive" value="0"> Inactive</label>
                </div>
              </li>
            <?php } 
                
                if(in_array('ambulance', $permited_section)){?>
            ...
            <?php } 
            if(in_array('blood', $permited_section)){?>
            ...
            if(in_array('dialysis', $permited_section)){?>
            ...
            <?php }if(in_array('crm', $permited_section)){?>
            ...
            <?php }if(in_array('hmas_app', $permited_section)){?>
              <li class="per_menu_tab _hmas_app">
                <strong>Hmas App</strong>
                <div>
                  <label><input type="radio" class="tab_active" name="hmas_app_radio" onClick="hmas_app_section_check(1);" id="hmas_app_active" value="1"> Active</label>
            ...
            <?php } if(in_array('opd_token', $permited_section)){?>
              <li class="per_menu_tab _opd_token">
                <strong>OPD Token</strong>
                <div>
                  <label><input type="radio" class="tab_active" name="opd_token_radio" onClick="opd_token_section_check(1);" id="opd_token_active" value="1"> Active</label>
                  <label><input type="radio" class="tab_inactive" name="opd_token_radio" onClick="opd_token_section_check(0);" id="opd_token_inactive" value="0"> Inactive</label>
                </div>
              </li>

            <?php } if(in_array('pathology_token', $permited_section)){?>
              <li class="per_menu_tab _pathology_token">
                <strong>Pathology Token</strong>
                <div>
                  <label><input type="radio" class="tab_active" name="pathology_token_radio" onClick="pathology_token_section_check(1);" id="pathology_token_active" value="1"> Active</label>
                  <label><input type="radio" class="tab_inactive" name="pathology_token_radio" onClick="pathology_token_section_check(0);" id="pathology_token_inactive" value="0"> Inactive</label>
                </div>
              </li>
 ...
 function section_check(id,vals)
       ...
       function opd_eye_section_check(vals)
      {
       ...
       function ot_eye_section_check(vals)
        ...
        function opd_token_section_check(vals)
        {
           if(vals==1)
           {
               $("input:radio.opd_token").prop('checked', true);
           }
           else
           { 
            $("input:radio.opd_token").prop('checked', true);
        ...
        function pathology_token_section_check(vals)
        {
            //alert(vals);
           if(vals==1)
           {
               $("input:radio.pathology_token").prop('checked', true);
           }
           else
           { 
            $("input:radio.un_pathology_token").prop('checked', true);
           }
        }
</script>
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('._vaccination').click(function () {
      $('.prms_table').hide();
      $('.prms_table._vaccination').show();
    });
    $('._ot').click(function () {
      $('.prms_table').hide();
      $('.prms_table._ot').show();
    ...
    $('._pathology_token').click(function () {
      $('.prms_table').hide();
      $('.prms_table._pathology_token').show();
    });
    $('._opd_token').click(function () {
      $('.prms_table').hide();
      $('.prms_table._opd_token').show();
    });
