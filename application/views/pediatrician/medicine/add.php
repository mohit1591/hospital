...
<script>  
 ...
 //      $.getJSON(
 //      "<?php echo base_url('pediatrician/medicine/get_salt_vals/'); ?>" + request.term,
 //      function (data) {
 //      response(data);
 //      });
 //    };
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('pediatrician/medicine/get_unit_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
   var i=1;
    var getData = function (request, response) { 
        row = i ;
        $.ajax({
        url : "<?php echo base_url('pediatrician/medicine/get_company_vals/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
       data: {
...
$("#medicine").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('pediatrician/medicine/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
...
{
   $.ajax({url: "<?php echo base_url(); ?>pediatrician/medicine/medicine_dropdown/", 
    success: function(result)
    {
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('pediatrician/prescription_template/get_pediatrician_frequency_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('pediatrician/prescription_template/get_pediatrician_advice_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
