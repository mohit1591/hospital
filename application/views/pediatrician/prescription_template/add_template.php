...
<input type="hidden" name="data_id" id="type_id" value="<?php echo $form_data['data_id']; ?>" /> 
                            ...
                            <tbody>
                              ...
                              $(function () {
                                      var getData = function (request, response) { 
                                        row = <?php echo $y; ?>;
                                        $.ajax({
                                        url : "<?php echo base_url('pediatrician/prescription_template/get_test_vals/'); ?>" + request.term,
                                        dataType: "json",
                                        method: 'post',
                                      data: {
                    ...
                    /* script start */
                      $(function () 
                      {
                            var getData = function (request, response) { 
                              row = <?php echo $l; ?> ;
                              $.ajax({
                              url : "<?php echo base_url('pediatrician/prescription_template/get_medicine_auto_vals/'); ?>" + request.term,
                              dataType: "json",
                              method: 'post',
                            data: {
                               name_startsWith: request.term,
                      ...
                      $(function () {
                          var getData = function (request, response) { 
                              $.getJSON(
                                  "<?php echo base_url('pediatrician/prescription_template/get_dosage_vals/'); ?>" + request.term,
                                  function (data) {
                                      response(data);
                                  });
                          };
                      ...
                      $(function () {
                          var getData = function (request, response) { 
                              $.getJSON(
                                  "<?php echo base_url('pediatrician/prescription_template/get_duration_vals/'); ?>" + request.term,
                                  function (data) {
                                      response(data);
                                  });
                          };
                      ...
                      $(function () {
                          var getData = function (request, response) { 
                              $.getJSON(
                                  "<?php echo base_url('pediatrician/prescription_template/get_frequency_vals/'); ?>" + request.term,
                                  function (data) {
                                      response(data);
                                  });
                          };
                      ...
                      $(function () {
                          var getData = function (request, response) { 
                              $.getJSON(
                                  "<?php echo base_url('pediatrician/prescription_template/get_advice_vals/'); ?>" + request.term,
                                  function (data) {
                                      response(data);
                                  });
                          };
  ...
  ?>
        ...
        <div id="tab_remarks" class="inner_tab_box tab-pane fade <?php if($j==1){ ?> in active <?php  } ?>">
            ...
            <div class="row m-t-10">
                ...
                <div class="col-xs-11">
                    <textarea class="form-control" rows="8" name="remark"><?php echo $form_data['remark']; ?></textarea>
                </div>
            </div>
            </div>
        </div>
  ...
  <button class="btn-save" type="button" name="" data-dismiss="modal" onclick="window.location.href='<?php echo base_url('pediatrician/prescription_template'); ?>'"><i class="fa fa-sign-out"></i> Exit</button>
  </div>
...
function delete_prescription_medicine(val,temp_id)
{
  ...
  $.ajax({url: "<?php echo base_url(); ?>pediatrician/prescription_template/delete_pres_medicine/"+prescription_medicine_id+'/'+templ_id, 
...
function tab_links(vals)
  {
    ...
    $('#'+vals).addClass('class','active');
     ...
     $('#chief_complaints_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/prescription_template/complaints_name/"+complaints_id, 
        success: function(result)
        {
    ...
    $('#examination_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/prescription_template/examination_name/"+examination_id, 
        success: function(result)
        {
    ...
    $('#diagnosis_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/prescription_template/diagnosis_name/"+diagnosis_id, 
        success: function(result)
        {
  ...
  $('#suggestion_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/prescription_template/suggetion_name/"+suggetion_id, 
        success: function(result)
        {
           if(suggestion_val!='')
           {
     ...
     $('#personal_history_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/prescription_template/personal_history_name/"+personal_history_id, 
        success: function(result)
        {

           //$('#personal_history').html(result);

           if($.trim(personal_history_val)!='')
           {
  ...
  $('#prv_history_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/prescription_template/prv_history_name/"+prv_history_id, 
        success: function(result)
        {
