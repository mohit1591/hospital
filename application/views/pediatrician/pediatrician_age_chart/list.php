       ...
       ?>
        ...
        <table class="table table-striped table-bordered" cellspacing="0" width="100%" >
				<thead class="bg-theme font">
					<tr role="row">
						<th align="center" style="color:#fff;background: #e72b26; border: 1px solid #333 !important;">Age /Vaccine</th>
                     <?php
                     if(!empty($age_list)) 
                     {
                      ...
                      ?>
						<th align="center" id="<?php echo $age_list_data->id ?>" style="border: 1px solid #333 !important;"><?php echo $age_list_data->title ?></th>
