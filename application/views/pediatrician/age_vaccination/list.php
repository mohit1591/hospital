...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('pediatrician/age_vaccination/ajax_list')?>",
            "type": "POST",
        }, 
        "columnDefs": [
        { 
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        .one('click', '#delete', function(e)
        {
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('pediatrician/age_vaccination/deleteall');?>",
                      data: {row_id: allVals},
...
<section class="userlist">
    ...
    <form>
       ...
       <!-- bootstrap data table -->
        ...
        <table align="right" cellpadding="0" cellspacing="0" width="200px">
           <tbody><tr>
               <td><div class="m_alert_red_mark" style="background: #FDF585 none repeat scroll 0% 0%;"></div></td>
               <td>Range of recommended ages for all children</td>
           </tr>
           <tr>
               <td><div class="m_alert_orange_mark" style="background: #D1E48A none repeat scroll 0% 0%;"></div></td>
               <td>Range of recommended ages for catchup-immunization</td>
           </tr>
            <tr>
               <td><div class="m_alert_orange_mark" style="background: #3595DB none repeat scroll 0% 0%;"></div></td>
  	...
  	<div class="userlist-right">
  		<div class="btns">
          <?php if(in_array('1606',$users_data['permission']['action'])) {
          ?>
  			<button class="btn-update" id="modal_add">
  				<i class="fa fa-plus"></i> New
  			</button>
          <?php } ?>
          <?php if(in_array('1608',$users_data['permission']['action'])) {
          ?>
          ...
          ?>
  			<button class="btn-update" onclick="window.location.href='<?php echo base_url('pediatrician/age_vaccination/archive'); ?>'">
...
$('#selectAll').on('click', function () { 
 ...
 function delete_age_vaccination(rate_id)
 {    
    $('#confirm').modal({
      backdrop: 'static',
      keyboard: false
