          ...
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row">
                ...
                <div class="col-md-8">
                    <input type="text" name="test_name"  class="alpha_space inputFocus" value="<?php echo $form_data['test_name']; ?>">
...
$("#test_name").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('pediatrician/test_name/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
...
{
   $.ajax({url: "<?php echo base_url(); ?>pediatrician/test_name/test_name_dropdown/", 
    success: function(result)
    {
