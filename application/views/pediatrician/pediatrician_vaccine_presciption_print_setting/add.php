...
<div class="row">
  <div class="col-md-12 add_opd_print_setting">
    <form action="<?php echo base_url('pediatrician/pediatrician_vaccine_presciption_print_setting/add'); ?>" method="post">
    <div class="row m-b-5">
      <div class="col-xs-2">
    ...
    <div class="row m-b-5">
      ...
      <div class="col-xs-10">
       <button class="btn-save" type="submit" name="remove_levels" onClick=" validateForm();" ><i class="fa fa-floppy-o"></i> Save</button>
             <button type="button" class="btn-update" onclick="window.location.href='<?php echo base_url('pediatrician'); ?>'">
...
<script>
  function get_template_according(value){
    ...
    $.ajax({
      type:"POST",
      url: "<?php echo base_url(); ?>pediatrician/pediatrician_vaccine_presciption_print_setting/presciption_printtemplate_dropdown/", 
      data: {value: value},
      datatype:'JSON',
