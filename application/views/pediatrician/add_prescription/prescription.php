                ...
                <div class="row m-t-10">
                   ...
                   <select name="template_list"  id="template_list" >
                     ...
                     ?>
                        ...
                        <a href="<?=base_url('pediatrician/prescription_template/add')?>" target="_blank" class="btn btn-success"><i class="fa fa-plus"></i> Add new</a>
                    </div>
                </div>
          ...
          <?php }*/ ?>
                ...
                <div class="row m-t-10">
                                ...
                                <div class="row m-t-10">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="well tab-right-scroll">
                                            ...
                                            <div class="grp">DSHPT1</div>
                                            <div class="grp">DSHPT1</div> -->
                                            <input type="text" name="chief_complaints_search" data-appendId="examination_data" class="dropdown-box select-box-search-event" style="width: 300px;" placeholder="Type here for examination_data">
                    ...
                    foreach ($prescription_medicine_tab_setting as $med_value) { ?>
                        ...
                        {
                        ?>
                        <td><input type="text" name="medicine_name[]"  class="medicine_val">
                                ...
                                <div class="well tab-right-scroll" style="overflow-x: hidden;padding:5px 10px;">
                                    <div class="row m-t-10">
                                        ...
                                        <div class="col-xs-10">
                                            ...
                                            <input type="text" name="next_appointment_date"  id="appointment_date" class="datepicker date "  data-date-format="dd-mm-yyyy HH:ii"  value="<?php echo $form_data['next_appointment_date']; ?>" /> 
                                        </div>
                                    </div>
                                    <div class=" m-t-10">
                                             <div class="col-xs-8">
...
<script type="text/javascript">
  ...
  $('#template_list').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/add_prescription/get_template_data/"+template_id, 
  ...
  function load_values(jdata)
  {
    ...
    {
        $.ajax({url: "<?php echo base_url(); ?>pediatrician/add_prescription/get_template_test_data/"+template_id, 
        success: function(result)
        {
...
/*<a href="javascript:void(0)" class="btn-w-60 addrow">Add</a>*/
    ...
    var getData = function (request, response) { 
        row = i ;
        $.ajax({
        url : "<?php echo base_url('pediatrician/add_prescription/get_test_vals/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
      data: {
    ...
    {
        $.ajax({url: "<?php echo base_url(); ?>pediatrician/add_prescription/get_template_prescription_data/"+template_id, 
        success: function(result)
        {
    ...
    function get_prescription_values(result)
    {
      ...
      $.each(obj, function (index, value) {       
         pres += '<tr><?php foreach ($prescription_medicine_tab_setting as $tab_value) 
                        ...
                        if(strcmp(strtolower($tab_value->setting_name),'medicine')=='0')
                        {
                        ?><td><input type="text" name="medicine_name[]" class="" value="'+obj[index].medicine_name+'"><input type="hidden" name="medicine_id[]"  value="'+obj[index].medicine_id+'" ></td>                        <?php 
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'salt')=='0')
                        {
     ...
     $('#chief_complaints_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/add_prescription/complaints_name/"+complaints_id, 
        success: function(result)
        {
    ...
    $('#examination_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/add_prescription/examination_name/"+examination_id, 
        success: function(result)
        {
    ...
    $('#diagnosis_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/add_prescription/diagnosis_name/"+diagnosis_id, 
        success: function(result)
        {
     ...
     $('#suggestion_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/add_prescription/suggetion_name/"+suggetion_id, 
        success: function(result)
        {
           if(suggestion_val!='')
           {
     ...
     $('#personal_history_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/add_prescription/personal_history_name/"+personal_history_id, 
        success: function(result)
        {
     ...
     $('#prv_history_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>pediatrician/add_prescription/prv_history_name/"+prv_history_id, 
        success: function(result)
        {
...
$(document).ready(function(){
    $(".addrow").click(function(){ 
      var i=$('#test_name_table tr').length;
        ...
        $("#test_name_table").append('<tr><td><input type="text"  name="test_name[]" class="w-100 test_val'+i+'"><input type="hidden" id="test_id'+i+'" name="test_id[]" class="w-100" value=""></td><td width="80"><a href="javascript:void(0);" class="btn-w-60 remove_row">Delete</a></td></tr>');
...
$(function () 
{
      var getData = function (request, response) { 
        row = i ;
        $.ajax({
        url : "<?php echo base_url('pediatrician/add_prescription/get_medicine_auto_vals/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
      data: {
         name_startsWith: request.term,
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('pediatrician/add_prescription/get_dosage_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('pediatrician/add_prescription/get_type_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('pediatrician/add_prescription/get_duration_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('pediatrician/add_prescription/get_frequency_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('pediatrician/add_prescription/get_advice_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(".select-box-search-event").on('keyup', function() {
   ...
   $.ajax({
      url:"<?php echo base_url(); ?>pediatrician/add_prescription/search_box_data",
      method:"POST",
