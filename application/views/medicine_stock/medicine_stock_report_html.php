   	   ...
   	   ?>
   	    <tr>
            ...
            <td align="right" style="padding-right:5px;">
              <?php /*$quantity= get_batch_med_qty($data->id,$data->batch_no);
                if($quantity['total_qty']>0){
                  ...
                  echo '0';
                    ...
                    $medicine_total_qty = $data->stock_qty;
                    if($medicine_stock->min_alrt>=$data->stock_qty) //$qty_data['total_qty'])
                    {
                        $medicine_total_qty = $data->stock_qty;
                    }
            ...
            <td><?php echo $data->min_alrt; ?></td>
      		 	<td align="right" style="padding-right:5px;"><?php echo $data->mrp; ?></td>
