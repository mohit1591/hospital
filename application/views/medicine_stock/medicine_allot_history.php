...
$(document).ready(function() { 
  form_submit();
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('medicine_stock/medicine_allot_history_ajax')?>",
            "type": "POST",
            "data": function(d){
                d.medicine_id = getUrlData('id');
...
<section class="userlist">
    ...
    <div class="col-xs-12">
      <div class="row">
        <div class="col-xs-8">
         ...
         <input type="radio" name="types" <?php if($type==3){ echo 'checked=""'; } ?> class="types" value="2" onclick="return type_set(3)" /> Sale 
         <input type="radio" name="types" <?php if($type==4){ echo 'checked=""'; } ?> class="types" value="2" onclick="return type_set(4)" /> Sale Return
         ...
         <!-- <input type="radio" name="types" < ?php if($type==2){ echo 'checked=""'; } ?> class="types" value="2" onclick="return type_set(2)" /> Sale  -->
          ...
          <input type="radio" name="types" <?php if($type==6){ echo 'checked=""'; } ?> class="types" value="6" onclick="return type_set(6)" /> Medicine Opening Stock
        </div>
   ...
   <div class="userlist-right">
        ...
        <button class="btn-exit" onclick="window.location.href='<?php echo base_url('medicine_stock');?>'">
...
{ 
   window.location.href='<?php echo base_url('medicine_stock/medicine_allot_history').'/?id='.$id.'&batch_no='.$batch_no; ?>&type='+vals;
} 
