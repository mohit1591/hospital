     ...
     <div class="modal-body">   
        ...
        <div class="modal-footer">
            <div style="float:right;width:80%;display:inline-flex;">
                ...
                <button type="button" class="btn-update" id="advance_report" name="submit">Advance</button>
                ...
                <?php //if($users_data['parent_id']==110){ ?>
...
function print_options_report(print_option)
{
      ...
      if(print_option!='')
      {
          ...
          {
              $("#print").removeAttr("onClick");
              $("#print").attr("onClick","return openPrintWindows('<?php echo base_url('reports/opd_report_csv?') ?>start_date="+start_date+"&end_date="+end_date+"&employee="+employee_c+"&order_by="+order_by+'&dept='+xs+", 'windowTitle', 'width=820,height=600');");
          }
          else if(print_option==3)
          { 
              $("#print").removeAttr("onClick");
              $("#print").removeAttr("onClick");
              $("#print").attr("onClick","return openPrintWindows('<?php echo base_url('reports/opd_report_excel?') ?>start_date="+start_date+"&end_date="+end_date+"&order_by="+order_by+'&dept='+xs+"', 'windowTitle', 'width=820,height=600');");
...
{  
    ...
    if(module_type=='1')
    {
      window.open('<?php echo base_url('reports/print_hospital_collection_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by+'&dept='+xs,'mywin','width=800,height=600');
    }
    else
    {
      window.open('<?php echo base_url('reports/print_opd_collection_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by+'&dept='+xs,'mywin','width=800,height=600');    
    }
...
function collection_report_excel() //print excel report 
{
    ...
    window.location='<?php echo base_url('report_excel/collection_reports_excel?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by+'&dept='+xs+'&send=preview','mywin','width=800,height=600';  
    //$('#overlay-loader').show();
...
{    
    ...
    if(module_type=='1')
    {
      window.open('<?php echo base_url('reports/print_hospital_collection_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by+'&dept='+xs+'&send=preview','mywin','width=800,height=600');
    }
    else
    {
      window.open('<?php echo base_url('reports/print_opd_collection_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by+'&dept='+xs+'&send=preview','mywin','width=800,height=600');    
    }
...
$('#advance_report').click(function()
{
    ...
    var end_date = $('#to_c_date').val(); 
     var employee_c = $('#employee_c').val(); 
    window.open('<?php echo base_url('reports/print_advance_collection_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by+'&dept='+xs+'mywin','width=800,height=600');
})
</script>
