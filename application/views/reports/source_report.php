          ...
          <div class="row">
               <div class="col-md-12">
                    ...
                    <div class="row m-b-5">
                         ...
                         <div class="col-md-7">
                              <input type="text" id="from_s_date" name="from_c_date" class="collection_datepicker" value="<?php echo date('d-m-Y'); ?>"  onblur="reset_search_value()">
                         </div>
                    </div>
                    <div class="row m-b-5">
                         <div class="col-md-5">      
                         ...
                         <div class="col-md-7">
                              <input type="text" name="to_c_date" id="to_s_date" class="collection_datepicker_to" value="<?php echo date('d-m-Y'); ?>" onblur="reset_search_value()">
                         </div>
                    </div>
...
function print_options_report(print_option){
     ...
     var start_date = $('#from_s_date').val();

     var end_date = $('#to_s_date').val(); 
     if(print_option!=''){
          if(print_option==1){
               $("#print").attr("onClick","return source_report();");
          }else if(print_option==2){
               $("#print").removeAttr("onClick");
               $("#print").attr("onClick","return openPrintWindows('<?php echo base_url('reports/source_report_csv?') ?>start_date="+start_date+"&end_date="+end_date+"', 'windowTitle', 'width=820,height=600');");
          }else if(print_option==3){ 
               $("#print").removeAttr("onClick");

                $("#print").removeAttr("onClick");
               $("#print").attr("onClick","return openPrintWindows('<?php echo base_url('reports/source_report_excel?') ?>start_date="+start_date+"&end_date="+end_date+"', 'windowTitle', 'width=820,height=600');");
...
{    
  ...
  window.open('<?php echo base_url('reports/print_source_reports?') ?>start_date='+start_date+'&end_date='+end_date,'mywin','width=800,height=600');
}  
...
$(document).ready(function(){
 ...
 $("button[data-number=1]").click(function(){
    $('#load_add_enquiry_source_modal_popup').modal('hide');
});
</script>
