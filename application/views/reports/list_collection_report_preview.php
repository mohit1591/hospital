      ...
      {  
        ...
        if($names == $branchs->branch_name) 
        {
          ...
          <div style="float:left; width: 100%;display:flex;justify-content:space-around;">
            ...
            <!--- dialysis Collection start -->
                <?php if(!empty($branch_dialysis_collection_list['dialysis_collection'])) { ?>
                  <div style="float:left;width:100%;font-weight:600;padding:4px;">
                  ...
                  $n_bnc = '';
                  foreach($branch_dialysis_collection_list['dialysis_collection'] as $branchs)
                  { 
        ...
        if($names == $branchs->branch_name) 
        {
          ...
          <div style="float:left; width: 100%;display:flex;justify-content:space-around;">
            ...
            { 
              ...
              <?php
              $i++;
              $branch_dialysis_total = $branch_dialysis_total+$branchs->debit;
              }
            }
...
//20201014
              ...
              { //-1 sushant
                ?>
                <div style="float:left;width:10%;padding:1px 4px;text-align:left;"><?php if($collection->balance=='1.00' || $collection->balance=='0.00'){ echo '0.00'; }else{ echo number_format($collection->balance,2); } ?></div>
                <?php
              }
