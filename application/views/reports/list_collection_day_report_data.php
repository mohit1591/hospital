    ...
    $branch_names = []; 
          foreach($branch_collection_list['opd_collection_list'] as $names)  //opd
          {
           ...
           <div style="float:left;width:100%;border-bottom:1px solid #111;font-size:13px;display:flex;justify-content:space-around;">
            ...
            <div style="float:left;width:100%;border-bottom:1px solid #111;font-size:13px;display:flex;justify-content:space-around;">
              ...
              <div style="float:left;width:13%;font-weight:600;padding:4px;text-align:left;"><u>Booking Date</u></div>
              <div style="float:left;width:13%;font-weight:600;padding:4px;text-align:left;"><u>Total Amount</u></div>
              <div style="float:left;width:13%;font-weight:600;padding:4px;text-align:left;"><u> Discount</u></div>

              <div style="float:left;width:13%;font-weight:600;padding:4px;text-align:left;"><u> Balance</u></div>
              <div style="float:left;width:13%;font-weight:600;padding:4px;text-align:left;"><u> Net Amount</u></div>

              <div style="float:left;width:13%;font-weight:600;padding:4px;text-align:left;"><u> Paid Amount</u></div>
            </div>
            <?php } ?>
          ...
          foreach($branch_collection_list['opd_collection_list'] as $branchs_opd)
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo date('d-m-Y', strtotime($branchs_opd->booking_date)); ?></div>
             
               
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $branchs_opd->total_amount; ?></div>

                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $branchs_opd->discount_amount; ?></div>
             
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($branchs_opd->balance=='1.00' || $branchs_opd->balance=='0.00'){ echo '0.00'; }else{ echo number_format($branchs_opd->balance,2); $branch_balance1 += $branchs_opd->balance; } ?></div>
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $branchs_opd->net_amount; ?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $branchs_opd->debit; ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_amount1,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_discount1,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_balance1,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_netamount1,2);?></div>

                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_total1,2);?></div>
      ...
      { 
       if($names == $bill_branchs->branch_name) 
        ...
        <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo date('d-m-Y', strtotime($bill_branchs->booking_date)); ?></div>
             
               
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $bill_branchs->total_amount; ?></div>

                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $bill_branchs->discount_amount; ?></div>
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $bill_branchs->net_amount; ?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $bill_branchs->debit; ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_amount2,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_discount2,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_balance2,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_netamount2,2);?></div>

                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_total2,2);?></div>
      ...
      { 
       if($names == $ipd_branchs->branch_name) 
        ...
        <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo date('d-m-Y', strtotime($ipd_branchs->booking_date)); ?></div>
             
               
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $ipd_branchs->total_amount; ?></div>

                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($ipd_branchs->balance=='1.00' || $ipd_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($ipd_branchs->balance,2); $branch_balance3 += $ipd_branchs->balance; } ?></div>
                 
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $ipd_branchs->net_amount; ?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $ipd_branchs->debit; ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_amount3,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_discount3,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_balance3,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_netamount3,2);?></div>

                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_total3,2);?></div>
      ...
      <?php 
       ...
       foreach($branch_medicine_collection_list['medicine_collection_list'] as $medi_branchs) {
        ...
        <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo date('d-m-Y', strtotime($medi_branchs->booking_date)); ?></div>
             
               
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $medi_branchs->total_amount; ?></div>

                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $medi_branchs->discount_amount; ?></div>
             
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($medi_branchs->balance=='1.00' || $medi_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($medi_branchs->balance,2); $branch_balance4 += $medi_branchs->balance; } ?></div>
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $medi_branchs->net_amount; ?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $medi_branchs->debit; ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_amount4,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_discount4,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_balance4,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_netamount4,2);?></div>

                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_total4,2);?></div>
      ...
      <?php 
       ...
       foreach($branch_vaccination_collection_list['vaccination_collection'] as $vacc_branchs){
        ...
        <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo date('d-m-Y', strtotime($vacc_branchs->booking_date)); ?></div>
             
               
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $vacc_branchs->total_amount; ?></div>

                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $vacc_branchs->discount_amount; ?></div>
             
              
                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($vacc_branchs->balance=='1.00' || $vacc_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($vacc_branchs->balance,2); $branch_balance5 += $vacc_branchs->balance; } ?></div>
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $vacc_branchs->net_amount; ?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $vacc_branchs->debit; ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_amount5,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_discount5,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_balance5,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_netamount5,2);?></div>

                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_total5,2);?></div>
      ...
      <?php 
       ...
       foreach($branch_ot_collection_list['ot_collection'] as $ot_branchs){
        ...
        <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo date('d-m-Y', strtotime($ot_branchs->booking_date)); ?></div>
             
               
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $ot_branchs->total_amount; ?></div>

                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $ot_branchs->discount_amount; ?></div>
             
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($ot_branchs->balance=='1.00' || $ot_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($ot_branchs->balance,2); $branch_balance6 += $ot_branchs->balance; } ?></div>
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $ot_branchs->net_amount; ?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $ot_branchs->debit; ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_amount6,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_discount6,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_balance6,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_netamount6,2);?></div>

                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_total6,2);?></div>
      ...
      <?php 
       ...
       foreach($blood_bank_branch_collection_list['blood_bank_collection'] as $blood_bank_branchs){
        ...
        <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo date('d-m-Y', strtotime($blood_bank_branchs->booking_date)); ?></div>
             
               
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $blood_bank_branchs->total_amount; ?></div>

                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $blood_bank_branchs->discount_amount; ?></div>
             
              
               <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($blood_bank_branchs->balance=='1.00' || $blood_bank_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($blood_bank_branchs->balance,2); $branch_balance7 += $blood_bank_branchs->balance; } ?></div>
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $blood_bank_branchs->net_amount; ?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $blood_bank_branchs->debit; ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_amount7,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_discount7,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_balance7,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_netamount7,2);?></div>

                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_total7,2);?></div>
      ...
      <?php 
       ...
       foreach($pathology_branch_collection_list['pathalogy_collection'] as $path_branchs){
        ...
        <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo date('d-m-Y', strtotime($path_branchs->booking_date)); ?></div>
             
               
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $path_branchs->total_amount; ?></div>

                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $path_branchs->discount_amount; ?></div>
             
              
                  <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($path_branchs->balance=='1.00' || $path_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($path_branchs->balance,2); $branch_balance8 += $path_branchs->balance; } ?></div>
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $path_branchs->net_amount; ?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $path_branchs->debit; ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_amount8,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_discount8,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_balance8,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_netamount8,2);?></div>

                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_total8,2);?></div>
    ...
    if(!empty($branch_ambulance_collection_list['ambulance_collection_list'])) { ?>
      ...
      <?php 
        ...
        <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo date('d-m-Y', strtotime($amb_branchs->booking_date)); ?></div>
             
               
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $amb_branchs->total_amount; ?></div>

                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $amb_branchs->discount_amount; ?></div>
             
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($amb_branchs->balance=='1.00' || $amb_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($amb_branchs->balance,2); $branch_balance9 += $amb_branchs->balance; } ?></div>
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $amb_branchs->net_amount; ?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $amb_branchs->debit; ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_amount9,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_discount9,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_balance9,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_netamount9,2);?></div>

                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_total9,2);?></div>
            ...
            <div style="float:left;width:100%;padding:4px;text-align:right;font-weight: bold;border-top:1px solid #000;">
             <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                 ...
                 <div style="float:left;width:10%;padding:4px;text-align:left;">Grand Total</div>
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_grand_total_amount,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_grand_total_discount,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_grand_total_balance,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_grand_total_netamount,2);?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_grand_collection_total,2);?></div>
        ...
        <div style="float:left;width:100%;border-bottom:1px solid #111;font-size:13px;display:flex;justify-content:space-around;">
          ...
          if(!empty($self_opd_collection_list['self_opd_coll']))
          {
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($collection->balance=='1.00' || $collection->balance=='0.00'){ echo '0.00'; }else{ echo number_format($collection->balance,2);  $self_balance1 += $collection->balance; } ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_amount1,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_discount1,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_balance1,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_netamount1,2);?></div>

                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_total,2);?></div>
          ...
          if(!empty($branch_billing_collection_list['billing_array'])){ ?>
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($bill_branchs->balance=='1.00' || $bill_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($bill_branchs->balance,2); $self_balance2 += $bill_branchs->balance; } ?></div>
              ...
              <hr>
               <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_amount2,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_discount2,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_balance2,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_netamount2,2);?></div>

                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_bill_total,2);?></div>
          ...
          if(!empty($self_ipd_collection_list['ipd_coll'])){ ?>
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $ipd_branchs->total_amount; ?></div>
                 ...
                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $ipd_branchs->discount_amount; ?></div>
             
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($ipd_branchs->balance=='1.00' || $ipd_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($ipd_branchs->balance,2);  $self_balance3 += $ipd_branchs->balance; } ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                 ...
                 <div style="float:left;width:10%;padding:4px;text-align:left;">Total</div>
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_amount3,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_discount3,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_balance3,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_netamount3,2);?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_ipd_total,2);?></div>
...
//Medicine Sale Start 
           ...
           if(!empty($self_medicine_collection_list['med_coll'])){ ?>
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($medi_branchs->balance=='1.00' || $medi_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($medi_branchs->balance,2);  $self_balance4 += $medi_branchs->balance; } ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                 ...
                 <div style="float:left;width:10%;padding:4px;text-align:left;">Total</div>
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_amount4,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_discount4,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_balance4,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_netamount4,2);?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_medi_total,2);?></div>
...
//Vaccination Start 
           ...
           $branch_vaccination_total1 = 0; 
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($vacc_branchs->balance=='1.00' || $vacc_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($vacc_branchs->balance,2); $self_balance5 += $vacc_branchs->balance; } ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                 ...
                 <div style="float:left;width:10%;padding:4px;text-align:left;">Total</div>
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_amount5,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_discount5,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_balance5,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_netamount5,2);?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_vaccination_total,2);?></div>
...
//ot Collection Start 
      ...
      {   
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($ot_branchs->balance=='1.00' || $ot_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($ot_branchs->balance,2); $self_balance6 += $ot_branchs->balance; } ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                 ...
                 <div style="float:left;width:10%;padding:4px;text-align:left;">Total</div>
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_amount6,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_discount6,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_balance6,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_netamount6,2);?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_ot_total,2);?></div>
...
// blood bank  report
        ...
        {   
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($blood_bank_branchs->balance=='1.00' || $blood_bank_branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($blood_bank_branchs->balance,2);  $self_balance7 += $blood_bank_branchs->balance; } ?></div>
              ...
              <hr>
                ...
                <div style="float:left;width:10%;padding:4px;text-align:left;">Total</div>
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_amount7,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_discount7,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_balance7,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_netamount7,2);?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_blood_bank_total,2);?></div>
...
// Pathology collection report
          if(!empty($pathology_self_collection_list['path_coll']))
          {
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo date('d-m-Y', strtotime($branchs->booking_date)); ?></div>
             
               
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $branchs->total_amount; ?></div>

                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $branchs->discount_amount; ?></div>
             
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($branchs->balance=='1.00' || $branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($branchs->balance,2); $self_balance8 += $branchs->balance; } ?></div>
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $branchs->net_amount; ?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $branchs->debit; ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                 ...
                 <div style="float:left;width:10%;padding:4px;text-align:left;">Total</div>
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_amount8,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_discount8,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_balance8,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_netamount8,2);?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($branch_total,2);?></div>
...
// Ambulance Collection report
          if(!empty($self_ambulance_collection_list['self_ambulance_coll'])) { ?>
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($branchs->balance=='1.00' || $branchs->balance=='0.00'){ echo '0.00'; }else{ echo number_format($branchs->balance,2);  $self_balance9 += $branchs->balance; } ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                 ...
                 <div style="float:left;width:10%;padding:4px;text-align:left;">Total</div>
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_amount9,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_discount9,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_balance9,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_netamount9,2);?></div>
         ...
         if(!empty($self_purchase_return_collection_list['self_purchase_coll']))
          {
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($collection->balance=='1.00' || $collection->balance=='0.00'){ echo '0.00'; }else{ echo number_format($collection->balance,2);  $self_balance10 += $collection->balance; } ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                 ...
                 <div style="float:left;width:10%;padding:4px;text-align:left;">Total</div>
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_amount10,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_discount10,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_balance10,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_netamount10,2);?></div>
        ...
        if(!empty($self_billing_collection_list['self_bill_coll']))
        {
          ...
          { 
            ...
            <div style="float:left;width:100%;display:flex;justify-content:space-around;">
                ...
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo date('d-m-Y', strtotime($billing_collection->booking_date)); ?></div>
             
               
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $billing_collection->total_amount; ?></div>

                 <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $billing_collection->discount_amount; ?></div>
             
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php if($billing_collection->balance=='1.00' || $billing_collection->balance=='0.00'){ echo '0.00'; }else{ echo number_format($billing_collection->balance,2); $self_balance11 += $billing_collection->balance; } ?></div>
              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $billing_collection->net_amount; ?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo $billing_collection->debit; ?></div>
              ...
              <hr>
                <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                 ...
                 <div style="float:left;width:10%;padding:4px;text-align:left;">Total</div>
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_amount11,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_discount11,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_balance11,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_netamount11,2);?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($self_billing_total,2);?></div>
         ...
         <div style="float:left;width:100%;padding:4px;text-align:right;font-weight: bold;border-top:1px solid #000;">
             <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
                 ...
                 <div style="float:left;width:10%;padding:4px;text-align:left;">Grand Total</div>
                    ...
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($grand_total_amount,2);?></div>

                     <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($grand_total_discount,2);?></div>
                 
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($grand_total_balance,2);?></div>
                  
                    <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($grand_total_netamount,2);?></div>

              
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($grand_collection_total,2);?></div>
     ...
     <div style="float:left;width:100%;padding:4px;text-align:right;font-weight: bold;border-top:1px solid #000;">
        <div style="float:left;width:100%;display:flex;justify-content:space-around;font-weight:600;">
            ...
            <div style="float:left;width:10%;padding:4px;text-align:left;">All Grand Total</div>
               ...
               <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($full_grand_total_amount,2);?></div>
     
                <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($full_grand_total_discount,2);?></div>
            
             
               <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($full_grand_total_balance,2);?></div>
             
               <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($full_grand_total_netamount,2);?></div>
     
         
           <div style="float:left;width:13%;padding:4px;text-align:left;"><?php echo number_format($full_grand_collection_total,2);?></div>
                                      ...
                                      if(!empty($doc_com_list['doctor_commission']))
                                       {?>
                                        ...
                                        foreach($doc_com_list['doctor_commission'] as $expenses_doc)
                                        {
                                          ...
                                          <?php
                                          $tot_exp_doc = $tot_exp_doc+$expenses_doc->debit1;
                                          $i++;
                                        } ?>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <strong>Total:</strong>
                                            <span><?php echo number_format($tot_exp_doc,2); ?></span>
                                          </td>
                                        </tr>
                                      

                                    <?php $grand_tot = $grand_tot+$tot_exp_doc; } ?>
