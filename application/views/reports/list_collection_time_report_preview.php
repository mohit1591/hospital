        ...
        if($names == $branchs->branch_name) 
        {
          ...
          <div style="float:left; width: 100%;display:flex;justify-content:space-around;">
            ...
            { 
              ...
              {
                ?>
                <div style="float:left;width:10%;padding:1px 4px;text-align:left;"><?php echo date('d-m-Y h:i A', strtotime($branchs->created_date)); ?></div>
                <?php
              }
            ...
            { 
              ...
              {
                ?>
                <div style="float:left;width:10%;padding:1px 4px;text-align:left;"><?php echo date('d-m-Y h:i A', strtotime($bill_branchs->created_date)); ?></div>
                <?php
              }
              if(strcmp(strtolower($tab_value->setting_name),'doctor_name')=='0')
              {
...
//ipd start
            ...
            { 
              ...
              {
                ?>
                <div style="float:left;width:10%;padding:1px 4px;text-align:left;"><?php echo date('d-m-Y h:i A', strtotime($ipd_branchs->created_date)); ?></div>
                <?php
              }
              if(strcmp(strtolower($tab_value->setting_name),'doctor_name')=='0')
              {
...
//ipd end
            ...
            { 
              ...
              {
                ?>
                <div style="float:left;width:10%;padding:1px 4px;text-align:left;"><?php echo date('d-m-Y h:i A', strtotime($medi_branchs->created_date)); ?></div>
                <?php
              }
              if(strcmp(strtolower($tab_value->setting_name),'doctor_name')=='0')
              {
        ...
        if($names == $ot_branchs->branch_name)  
        {
          ...
          <div style="float:left; width: 100%;display:flex;justify-content:space-around;">
            ...
            { 
              ...
              {
                ?>
                <div style="float:left;width:10%;padding:1px 4px;text-align:left;"><?php echo date('d-m-Y h:i A', strtotime($ot_branchs->created_date)); ?></div>
                <?php
              }
              if(strcmp(strtolower($tab_value->setting_name),'doctor_name')=='0')
              {
        ...
        {   
          if($names == $blood_bank_branchs->branch_name)  
          {
            ...
            { 
              ...
              {
                ?>
                <div style="float:left;width:10%;padding:1px 4px;text-align:left;"><?php echo date('d-m-Y h:i A', strtotime($blood_bank_branchs->created_date)); ?></div>
                <?php
              }
              if(strcmp(strtolower($tab_value->setting_name),'doctor_name')=='0')
              {
        ...
        {  
          ...
          if(!empty($pathology_branch_collection_list['pathalogy_collection']))
          {
            ...
            <!--- Ambulance Collection start -->
                <?php if(!empty($branch_ambulance_collection_list['ambulance_collection_list'])) { ?>
                  <div style="float:left;width:100%;font-weight:600;padding:4px;">
...
<!--- day care collection \\--->
          ...
          if(!empty($self_day_care_collection_list['self_day_care_coll']))
          {
            ?>
            <div style="float:left;width:100%;font-weight:600;padding:4px;margin-top:10px;">
              <span style="border-bottom:1px solid #111;">Day_Care</span>
            </div>
            <?php 
            $k = 1 ;
            $self_total = 0;
            ...
            { 
              ...
              <div style="float:left;width:100%;padding:4px;text-align:right;">
                <div style="float:right;width:150px; font-weight: bold;<?php if($p_m_k==1){ ?> border-top:1px solid #000 <?php  } ?>;margin-right:15px;">
                  <span style="float:left;"><?php echo $payment_mode_day_care->mode; ?></span>
...
<!--- //end day care collection--->


            <!--- purchase_return 14-10-2019 --->
          ...
          if(!empty($self_purchase_return_collection_list['self_purchase_coll']))
          {
           ...
           // echo "hello";die;
            ?>
            <div style="float:left;width:100%;font-weight:600;padding:4px;margin-top:10px;">
              <span style="border-bottom:1px solid #111;">Purchase Return</span>
            </div>
            <?php 
            $k = 1 ;
            $self_total = 0;
  ...
  //echo "<pre>";print_r($self_ipd_collection_list);
                ...
                //echo "<pre>";print_r($self_collection_list);
                    ...
                    { 
                      ...
                      { 
                        ...
                        {
                          ?>
                          <div style="float:left;width:10%;padding:1px 4px;text-align:left;"><?php echo date('d-m-Y h:i A', strtotime($billing_collection->created_date)); ?></div>
                          <?php
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'doctor_name')=='0')
                        {
                ...
                //echo "<pre>";print_r($self_collection_list);
                    ...
                    { 
                      ...
                      { 
                        ...
                        {
                          ?>
                          <div style="float:left;width:10%;padding:1px 4px;text-align:left;"><?php echo date('d-m-Y h:i A', strtotime($med_collection->created_date)); ?></div>
                          <?php
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'doctor_name')=='0')
                        {
                    ...
                    { 
                      ...
                      { 
                        ...
                        {
                          ?>
                          <div style="float:left;width:12%;padding:1px 4px;text-align:left;"><?php echo date('d-m-Y h:i A', strtotime($collection->created_date)); ?></div>
                          <?php
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'doctor_name')=='0')
                        {
                      ...
                      { 
                        ...
                        {
                          ?>
                          <div style="float:left;width:10%;padding:1px 4px;text-align:left;"><?php echo date('d-m-Y h:i A', strtotime($vaccination_collection->created_date)); ?></div>
                          <?php
                        }
                        if(strcmp(strtolower($tab_value->setting_name),'doctor_name')=='0')
                        {
          ...
          if(!empty($self_ambulance_collection_list['self_ambulance_coll']))
          {
            ...
            ?>
                      ...
                      ?>
                       <div style="float:left;width:100%;padding:4px;text-align:right;">
                            <div style="float:right;width:150px; font-weight: bold;border-top:1px solid #000;margin-right:15px;">
                              <span style="float:left;">Grand Totral</span>
