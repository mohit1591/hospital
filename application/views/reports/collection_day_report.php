...
{    
    ...
    var employee_c = $('#employee_c').val(); 
    var order_by = $('#order_by').val();
      window.open('<?php echo base_url('reports/print_opd_collection_day_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by,'mywin','width=800,height=600');    
}
...
{    
    ...
    var employee_c = $('#employee_c').val(); 
    var order_by = $('#order_by').val();
      window.open('<?php echo base_url('reports/print_opd_collection_day_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by+'&send=preview','mywin','width=800,height=600');    
}
