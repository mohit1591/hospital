     ...
     <div class="modal-body">   
        ...
        <div class="modal-footer">
            <div style="float:right;width:80%;display:inline-flex;">
                ...
                <button type="button" class="btn-update" name="submit" id="print_return">Print</button>
...
function print_options_report(print_option){
  //alert(print_option);
     $("#print_return").removeAttr("onClick");
     document.getElementById("print_pdf").style.display = "none";
     document.getElementById("print_return").style.display = "block";
     ...
     if(print_option!=''){
          if(print_option==1){
               $("#print_return").attr("onClick","return inventory_report();");
          }else if(print_option==2){
                   $("#print_return").removeAttr("onClick");
              $("#print_return").removeAttr("onClick");
              $("#print_return").attr("onClick","return print_window_page('<?php echo base_url('inventory_report/inventory_purchase_report_excel?') ?>start_date="+start_date+"&end_date="+end_date+"&section_type=2&branch_id="+branch_id+"');");
          }else if(print_option==3){ 
               $("#print_return").removeAttr("onClick");
                $("#print_return").attr("onClick","return print_window_page('<?php echo base_url('inventory_report/inventory_purchase_report_pdf?') ?>start_date="+start_date+"&end_date="+end_date+"&section_type=2&branch_id="+branch_id+"');");
...
{   
  ...
  var branch_id = $('#branch_id option:selected').val();
   window.open('<?php echo base_url('inventory_report/print_inventory_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&section_type=2&branch_id='+branch_id,'mywin','width=800,height=600');
}  
...
$(document).ready(function(){
 ...
 $("button[data-number=1]").click(function(){
    $('#load_inventory_purchase_return_modal_popup').modal('hide');
});
</script>
