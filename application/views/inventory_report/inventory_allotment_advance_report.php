...
{   
  ...
  var branch_id = $('#branch_id option:selected').val();
   window.open('<?php echo base_url('inventory_report/print_inventory_advance_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&section_type=3&branch_id='+branch_id,'mywin','width=800,height=600');
}  
