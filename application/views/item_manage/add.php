    ...
    <div class="modal-content"> 
       ...
       <div class="modal-body"> 
               ...
               <div class="row m-b-5">
                  ...
                  <div class="col-md-8">
                     <input type="text" name="item" value="<?php echo $form_data['item'];?>" class="inputFocus Cap_item_name" placeholder="Enter Item"/>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8">
                         <input type="text" name="mrp" id="mrp" value="<?php echo $form_data['mrp']; ?>" data-toggle="tooltip"  title="Allow only numeric." class="tooltip-text price_float" placeholder="Enter MRP"/>
                          <?php 
                    if(!empty($form_error)){ echo form_error('mrp'); }
                    ?>
...
<!-- add jaj 20 -->
                <div class="row m-b-5">
                     ...
                     data-toggle="tooltip"  title="Allow only numeric." class="tooltip-text price_float" placeholder="Enter Unit 1 QTY"/>
                           <!-- <select name="stock_item_unit" class="m_select_btn" id="stock_item_unit">
                              <option value=""> Select Unit 1 </option>
                              < ?php
                              if(!empty($unit_list))
                              {
                                ...
                                {
                                 ?>
                                   <option value="< ?php echo $unit->id; ?>" < ?php if($unit->id==$form_data['stock_item_unit']){ echo 'selected="selected"'; } ?>>< ?php echo $unit->unit; ?></option>
                                 < ?php  
                                }
                              }
                              ?>
                              ...
                              ?>
                                   <a href="javascript:void(0)" onclick=" return add_stock_item_unit();"  class="btn-new">
                                        <i class="fa fa-plus"></i> New
                                   </a>
                              <?php } ?>
                  ...
                  <div class="row m-b-5">
                      <div class="col-md-12">
                        <div class="row">
                          <div class="col-md-4">
                            <label>Unit 2<span class="star">*</span></label>
                          </div> <!-- 4 -->
                          <div class="col-md-8">
                     ...
                     data-toggle="tooltip"  title="Allow only numeric." class="tooltip-text price_float" placeholder="Enter Unit 2 QTY"/>
                            <!--<select name="second_unit" class="m_select_btn" id="second_unit">
                              <option value=""> Select Unit 2 </option>
                              < ?php
                              if(!empty($unit_list))
                              {
                                ...
                                {
                                 ?>
                                  <option value="< ?php echo $unit_second->id; ?>" < ?php if($unit_second->id==$form_data['second_unit']){ echo 'selected="selected"'; } ?>>< ?php echo $unit_second->unit; ?></option>
                                 < ?php  
                                }
                              }
                              ?>
...
function add_second_unit(unit_id)
{
   $('#unit_second_detail').html('');
     $.ajax({
        type: "POST",
        url: "<?php echo base_url('item_manage/get_second_unit')?>",
