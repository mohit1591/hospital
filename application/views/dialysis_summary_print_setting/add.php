      ...
      <div class="col-xs-12 m-b-5 m12">
        <div class="row">
         <div class="col-xs-2">
           ...
           <div class="col-xs-9">
             <textarea cols="45" readonly="" class="print_textarea" >{patient_reg_no},{patient_name},{patient_age},{mobile_no},{address},{booking_code},{dialysis_date},{doctor_name}, {investigation_list} , {medicine_detail} , {vitals_pulse}{vitals_chest}{vitals_bp}{vitals_cvs}{vitals_temp}{vitals_cns}{vitals_p_a} {signature}  </textarea>
        </div>
...
function get_template(value){
  ...
  $.ajax({
      type:"POST",
      url: "<?php echo base_url(); ?>dialysis_summary_print_setting/get_according_to_section/", 
      data: {value: value},
...
for (instance in CKEDITOR.instances) {
  ...
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>dialysis_summary_print_setting/",
    type: "post",
    data: $(this).serialize(),
    success: function(result) 
    {
...
function preview_template(id)
{
  ...
  $modal.load('<?php echo base_url().'dialysis_summary_print_setting/preview/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
