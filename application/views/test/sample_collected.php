...
<div class="modal-dialog" role="document" style="width:30%">
  <div class="modal-content">
    ...
    <div class="modal-body">
        <lable>Sample collected date: <?php //echo $sample_date; ?></lable>
         <div class="col-sm-10">
        <input type="hidden" name="testid" value="<?php echo $testid;?>">
        <input type="text" placeholder="Select Date" name="sample_collected_date" class="datepicker" id="sample_collected_date" value="<?php if(!empty($sample_date) && date('d-m-Y', strtotime($sample_date))!='01-01-1970'){echo date('d-m-Y', strtotime($sample_date));}else{ echo date('d-m-Y'); }?>"style="width:130px;">
