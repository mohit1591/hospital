...
?>
					  ...
					  {  
						...
						?>	
							<tr>
							  ...
							  <td>
							  	<?php if($test->test_type_id==1){ ?> <input type="hidden"  name="result[<?php echo $test->test_id; ?>]" id="result-<?php echo $test->test_id; ?>" class="report_result result-box <?php if($test->formula_avl==1){ echo 'formula_avl ';}else{ echo 'result_keyup'; } ?> result_input result-<?php echo $test->test_id; ?> result_<?php echo $r; ?>" alt="<?php echo $test->test_id; ?>"  value="<?php echo $test->result; ?>" onchange="default_vals('<?php echo $test->test_id; ?>');check_result_range(this.value, '<?php echo $test->test_id; ?>'); " /> 
				  		...
				  		<?php  }else{
				  		 ...
				  		 ?>
				  		<input type="text"  name="result[<?php echo $test->test_id; ?>]" id="result-<?php echo $test->test_id; ?>" class="report_result result-box <?php if($test->formula_avl==1){ echo 'formula_avl ';}else{ echo 'result_keyup'; } ?> result_input result-<?php echo $test->test_id; ?> result_<?php echo $r; ?>" alt="<?php echo $test->test_id; ?>"  value="<?php echo $test->result; ?>"  onchange="default_vals('<?php echo $test->test_id; ?>');check_result_range(this.value, '<?php echo $test->test_id; ?>');" />
				  		<?php
				  		} } ?>
	...
	<td align="left"><input type="checkbox" <?php if($test->status==1 || !empty($test->result)){ ?> checked="checked" <?php } ?> value="<?php echo $test->test_id; ?>" class="status_checkbox status_<?php echo $r; ?>" name="status[]"></td>
	<td>
	<?php if($test->test_type_id==1){ ?> <input type="hidden"  name="result[<?php echo $test->test_id; ?>]" id="result-<?php echo $test->test_id; ?>" class="report_result result-box  <?php if($test->result_type==1){ echo 'numeric'; }else if($test->result_type==2){ echo 'alpha'; } ?> <?php if($test->formula_avl==1){ echo 'formula_avl ';}else{ echo 'result_keyup'; } ?>  result_input result-<?php echo $test->test_id; ?> result_<?php echo $r; ?>" alt="<?php echo $test->test_id; ?>"  value="<?php echo $test->result; ?>"  onchange="default_vals('<?php echo $test->test_id; ?>');check_result_range(this.value, '<?php echo $test->test_id; ?>'); " /><?php  }else{ 
		...
		?>
     <input type="text"  name="result[<?php echo $test->test_id; ?>]" id="result-<?php echo $test->test_id; ?>" class="report_result result-box  <?php if($test->result_type==1){ echo 'numeric'; }else if($test->result_type==2){ echo 'alpha'; } ?> <?php if($test->formula_avl==1){ echo 'formula_avl ';}else{ echo 'result_keyup'; } ?>  result_input result-<?php echo $test->test_id; ?> result_<?php echo $r; ?>" alt="<?php echo $test->test_id; ?>"  value="<?php echo $test->result; ?>"  onchange="default_vals('<?php echo $test->test_id; ?>');check_result_range(this.value, '<?php echo $test->test_id; ?>');" />  
         <?php 
         }
     } ?> </td>
	<td align="left"><input type="checkbox" value="<?php echo $test->test_id; ?>" <?php  if($test->print==1){ ?> checked="checked" <?php } ?>  name="print[]" class="print_checkbox"></td>
...
////////////////////////////////PATH TEST////////////////////////////////		
					  ...
					  {  
						...
						?>	
							<tr>
							  ...
							  <input type="hidden"  name="result[<?php echo $test->test_id; ?>]" id="result-<?php echo $test->test_id; ?>" class="report_result result-box  <?php if($test->formula_avl==1){ echo 'formula_avl ';}else{ echo 'result_keyup'; } ?> result_input result-<?php echo $test->test_id; ?> result_<?php echo $r; ?>" alt="<?php echo $test->test_id; ?>"  value="<?php echo $test->result; ?>"  onchange="default_vals('<?php echo $test->test_id; ?>');check_result_range(this.value, '<?php echo $test->test_id; ?>');" />
				...
				{
							   	?><input type="text"  name="result[<?php echo $test->test_id; ?>]" id="result-<?php echo $test->test_id; ?>" class=" result-box  <?php if($test->formula_avl==1){ echo 'formula_avl ';}else{ echo 'result_keyup'; } ?> result_input result-<?php echo $test->test_id; ?> result_<?php echo $r; ?> report_result" alt="<?php echo $test->test_id; ?>"  value="<?php echo $test->result; ?>" onchange="default_vals('<?php echo $test->test_id; ?>');check_result_range(this.value, '<?php echo $test->test_id; ?>'); " /> 
