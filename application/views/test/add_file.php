        ...
        <div class="modal-body">    
           <div class="row m-b1">
                ...
                <div class="col-xs-7">
                    ...
                    if(!empty($form_data['old_prescription_img']) && file_exists(DIR_UPLOAD_PATH.'test_prescription/'.$form_data['old_prescription_files']))
                    {
                        $prescription_files = ROOT_UPLOADS_PATH.'test_prescription/'.$form_data['old_prescription_files'];
...
$("#prescription_files_form").on("submit", function(event) { 
  ...
  var prescription_id  = $('#prescription_id').val();
     ...
     var msg = "Report file successfully added.";
  $.ajax({
