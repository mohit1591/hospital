    ...
    <div class="modal-body">
        <lable>Sample received date:</lable>
          <div class="col-sm-10">
            ...
            <input type="text" placeholder="Select Date" name="sample_received_date" class="datepicker" id="sample_received_date" value="<?php if(!empty($sample_receive_date) && $sample_receive_date!='2' && date('d-m-Y', strtotime($sample_receive_date))!='01-01-1970'){echo date('d-m-Y', strtotime($sample_receive_date));}else{ echo date('d-m-Y'); }?>" style="width:130px;">
             <input type="text" name="sample_received_time" class="w-65px datepicker3 m_input_default" placeholder="Time" value="<?php if(!empty($sample_receive_date) && date('d-m-Y', strtotime($sample_receive_date))!='01-01-1970'){echo date('h:i:A', strtotime($sample_receive_date));}elseif(!empty($sample_date) && date('d-m-Y', strtotime($sample_receive_date))!='01-01-1970'){ echo date('h:i:A', strtotime($sample_date)); }else{echo date("h:i:A");}?>">
           </div>
         <br>
         <br>
     </div> <!-- modal-body -->
