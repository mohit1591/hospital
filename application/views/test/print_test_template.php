...
$template_data->template = str_replace("{patient_category_name}",$all_detail['booking_list'][0]->patient_category_name,$template_data->template);

$template_data->template = str_replace("{authorize_person_name}",$all_detail['booking_list'][0]->authorize_person_name,$template_data->template);
