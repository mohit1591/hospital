...
?>
					...
					{ 
					  ...
					  { 
					     $test_list1 = display_test_advance_range($test->booking_id,$test->test_id,$test->result);
                              ...
                              {
                                  $range_val =  $test->range_from.' - '.$test->range_to;
                              }
        ...
        ?>
         <tr>
			  <th colspan="5" style="text-align: center; font-size: 14px; text-decoration: underline;"><?php echo $profile_name; ?></th><th>
                    	...
                    	foreach ($child_profile_list as $child_profile) 
                    	{
							...
							{  				  	
							  ...
							  { 
							      ...
							      $test_list1 = display_test_advance_range($cp_test->booking_id,$cp_test->test_id,$cp_test->result);
                                  ...
                                  {
                                      $range_val =  $cp_test->range_from.' - '.$cp_test->range_to; 
                                  }
