    ...
    <form>
  	...
  	<div class="userlist-right">
  		<div class="btns">
                ...
                <a href="<?php echo base_url('vendor/vendor_excel'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-excel-o"></i> Excel
                </a>

              

                <a href="<?php echo base_url('vendor/pdf_vendor'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-pdf-o"></i> PDF
                </a>


                 <a href="javascript:void(0)" class="btn-anchor m-b-2"  onClick="return print_window_page('<?php echo base_url("vendor/print_vendor"); ?>');"> <i class="fa fa-print"></i> Print</a>
  			     ...
  			     <button class="btn-exit" onclick="window.location.href='<?php echo base_url(); ?>/<?php echo $this->uri->segment(1)?>/archive'">
