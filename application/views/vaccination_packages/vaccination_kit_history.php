...
$(document).ready(function() { 
    ...
    ipd_table = $('#ipd_table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('vaccination_packages/vaccination_kit_history_ajax_list')?>",
            "type": "POST",
            "data":{'opt_id':'1'},
    ...
    <!-- // -->
      <div class="row m-b-5">
           <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
                         <input type="checkbox"  name="opt_type" id="opt_type" onclick="return get_vaccination_kit_history()" value="1"> OPD
                       <input type="checkbox" name="opt_type" id="opt_type" onclick="return get_vaccination_kit_history()" value="2"> Alocated Kit
...
function get_vaccination_kit_history(){
