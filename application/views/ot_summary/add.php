...
<div class="overlay-loader" id="overlay-loader">
  ...
  <input type="hidden" name="data_id" id="type_id" value="<?php echo $form_data['data_id']; ?>" /> 
      ...
      <div class="modal-body">   
          <div class="row">
            <div class="col-md-12 m-b1">
              ...
              <div class="row m-b-5" id="content">
                  <div class="col-xs-5"><strong>Pre Op Order</strong></div>
                  <div class="col-xs-7"> 
            ...
            <div class="row m-b-5">
              ...
              <div class="row m-b-5" id="content">
              <div class="col-xs-5"><strong>Blood Transfusion</strong></div>
              <div class="col-xs-7"> 
            ...
            <div class="row m-b-5" id="content">
              <div class="col-xs-5"><strong>Blood Loss</strong></div>
              <div class="col-xs-7"> 
          ...
          <div class="row m-b-5" id="content">
                  <div class="col-xs-5"><strong>Drain</strong></div>
                  <div class="col-xs-7"> 
           ...
           <div class="row m-b-5" id="content">
                  <div class="col-xs-5"><strong>Materials Submitted for Histopathological Exam</strong></div>
                  <div class="col-xs-7"> 
            ...
            <div class="row m-b-5" id="content">
                  <div class="col-xs-5"><strong>Materials Submitted for Microbiological Exam</strong></div>
                  <div class="col-xs-7"> 
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('ot_summary/get_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$("#ot_summary").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('ot_summary/'); ?>"+path,
    type: "post",
    data: function() {
...
{
   $.ajax({url: "<?php echo base_url(); ?>ot_summary/ot_summary_dropdown/", 
    success: function(result)
    {
