                                             ...
                                             //echo "<pre>"; print_r($pulse_bp_list);die();
                                                ...
                                                { $d++;
                                                    ...
                                                    <tr>
                                                      ...
                                                      <?php } else{?>
                                                           <td><input type="text" name="pb_test_value_low[]" class="w-40 numeric number nobp" readonly><input type="text" name="pb_test_value_high[]" class="w-40 numeric number nobp" readonly>
                                                         </td>
                                                         <?php } ?>
                                                        <td width="100">
