                      ...
                      <div class="row m-b-5">
                        <div class="col-md-12">
                          <div class="row">
                            ...
                            <div class="col-md-8">
                              <input type="text" name="medicine_name" id="medicine_name" value="<?php echo $form_data['medicine_name']; ?>" class="alpha_numeric_space inputFocus m_input_default Cap_medicine_entry" placeholder="Enter Medicine Name">
