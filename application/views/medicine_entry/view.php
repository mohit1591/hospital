...
<div class="modal-dialog modal-lg">
      ...
      <div class="modal-body">  
            ...
            <table class="medicine_entry_view">
              <tr>
                ...
                <td><?php 
                  if(isset($form_data['medicine_code']) && $form_data['medicine_code']!=''){
                                echo $form_data['medicine_code'];
                              }else{
                                echo '';
                              } ?></td>
                ...
                <td><?php 
                if(isset($form_data['medicine_name']) && $form_data['medicine_name']!=''){
                                echo $form_data['medicine_name'];
                              }else{
                                echo '';
                              }
                              ?></td>
                ...
                <td>
                  ...
                  if(isset($unit_listname[0]->medicine_unit) && $unit_listname[0]->medicine_unit!=''){
                ...
                <?php  $unit_second_listname=  unit_list($form_data['unit_second_id']);
                 if(isset($unit_second_listname[0]->medicine_unit) && $unit_second_listname[0]->medicine_unit!=''){
 ...
 if(isset($form_data['igst']) && $form_data['igst']!=''){
              ...
              <tr>
                <td><label>Medicine Type</label></td>
                <td>
                  <?php  echo $form_data['medicine_type_name']; ?> 
                </td>
                <td><label>Barcode </label></td>
                <td style="float:left;width: 100%;height:80px;background:yellow;margin-bottom:10px;clear:both;">
                <?php if(!empty($form_data['barcode_image'])){ ?>
               <img src="<?php echo MEDICINE_BARCODE_FS_PATH.$form_data['barcode_image']; ?>" style="width:100%; height: 100%; background: 100% 100%; background-repeat:no-repeat;">
               <?php } ?>
                </td>
              </tr>
