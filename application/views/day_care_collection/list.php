...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "aaSorting": [],
        "ajax": {
            "url": "<?php echo base_url('day_care_collection_report/ajax_list')?>",
            "type": "POST"
        }, 
        "columnDefs": [
        { 
...
function reset_date_search()
  {
      ...
      $('#employee').val('');
      $.ajax({
         url: "<?php echo base_url('day_care_collection_report/reset_date_search/'); ?>",  
...
$modal.load('<?php echo base_url().'day_care_collection_report/advance_search/' ?>',
{
//'id1': '1',
//'id2': '2'
},
    ...
    <?php  } ?>  
      ...
      <div class="fixed">
          ...
          <?php if(in_array('560',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('day_care_collection_report/day_care_report_excel'); ?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-excel-o"></i> Excel
               </a>
          <?php endif;?>
          <?php if(in_array('561',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('day_care_collection_report/day_care_report_csv'); ?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-word-o"></i> CSV
               </a>
          <?php endif;?>
          <?php if(in_array('562',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('day_care_collection_report/pdf_day_care_report'); ?>" class="btn-anchor m-b-2">
          ...
          <?php if(in_array('563',$users_data['permission']['action'])): ?>
            ...
            <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("day_care_collection_report/print_day_care_report"); ?>');">
              <i class="fa fa-print"></i> Print
              </a> 
...
$('.start_datepicker').datepicker({
  ...
  function form_submit(){
    ...
    $.ajax({ 
           url: "<?php echo base_url('day_care_collection_report/search_data/'); ?>", 
           type: 'POST',
