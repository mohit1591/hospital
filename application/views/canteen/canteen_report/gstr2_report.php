...
function reset_search_gstr2(ele)
{ 
    $('#start_date').val('');
    $('#end_date').val('');
    $.ajax({url: "<?php echo base_url(); ?>canteen/canteen_report/reset_search_gstr2/", 
...
<section class="userlist">
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <a class="btn-custom" id="reset_date" onclick="reset_search_gstr2(this.form);"><i class="fa fa-refresh"></i> Reset</a>
      </div> <!-- 4 -->
    </div> <!-- row -->
    ...
    <div class="userlist-right relative">
      <div class="fixed">
      <div class="btns">
        <a href="<?php echo base_url('canteen/canteen_report/gstr2_excel'); ?>" class="btn-anchor m-b-2"><i class="fa fa-file-excel-o"></i> Excel</a>
        <!--<a href="<?php echo base_url('canteen/canteen_report/gstr2_csv'); ?>" class="btn-anchor m-b-2"><i class="fa fa-file-word-o"></i> CSV</a>-->
        <a href="<?php echo base_url('canteen/canteen_report/gstr2_pdf'); ?>" class="btn-anchor m-b-2"><i class="fa fa-file-pdf-o"></i> PDF</a>
        <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("canteen/canteen_report/gstr2_print"); ?>');"><i class="fa fa-print"></i> Print</a> 
...
{   
    ...
    $.ajax({
      url: "<?php echo base_url('canteen/canteen_report/advance_search_gstr2/'); ?>",
      type: "post",
...
var table;
     $(document).ready(function() { 
         table = $('#table').DataTable({  
             ...
             "pageLength": '100',
             "ajax": {
                 "url": "<?php echo base_url('canteen/canteen_report/gstr2_lists')?>",
                 "type": "POST",
