...
<body style="background: rgb(204,204,204);font-family:sans-serif, Arial;color:#333;font-size: 10px;">
 ...
 -->
        ...
        ?>
            ...
            { 
              ...
              {
                ?>
                <td><?php echo $branchs->patient_name; ?></td>
                <?php
              }
              else
              {
        ...
        ?>
         ...
         <tbody>
            ...
            { 
              ...
              {
                ?>
                <td><?php echo $bill_branchs->patient_name; ?></td>
                <?php
              }
              else
              {
         ...
         <tbody>
          ...
          {   
            ...
            { 
              ...
              {
                ?>
                <td><?php echo $ipd_branchs->patient_name; ?></td>
                <?php
              }
              else
              {
        ...
        ?>
         ...
         <tbody>
            ...
            { 
              ...
              {
                ?>
                <td><?php echo $medi_branchs->patient_name; ?></td>
                <?php
              }
              else
              {
      ...
      {   
        if($names == $ot_branchs->branch_name)  
        {
            ...
            { 
              ...
              {
                ?>
                <td><?php echo $ot_branchs->patient_name; ?></td>
                <?php
              }
              else
              {
        ...
        {   
          if($names == $blood_bank_branchs->branch_name)  
          {
            ...
            { 
              ...
              {
                ?>
                <td><?php echo $blood_bank_branchs->patient_name; ?></td>
                <?php
              }
              else
              {
         ...
         if(!empty($self_billing_collection_list['self_bill_coll']))
         {
           ...
           <tbody>
            ...
            { 
              ...
              {
                ?>
                <td><?php if(!empty($billing_collection->reciept_prefix) || !empty($billing_collection->reciept_suffix)){ echo $billing_collection->reciept_prefix.$billing_collection->reciept_suffix; } ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $billing_collection->patient_name; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $billing_collection->mobile_no; ?></td>
                <?php
              }else
              {
              ...
              {
                ?>
                <td><?php echo $billing_collection->panel_type; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php if($billing_collection->balance=='1.00' || $billing_collection->balance=='0.00'){ echo '0.00'; }else{ echo number_format($billing_collection->balance-1,2); } ?></td>
                <?php
              }
              else
              {
        ...
        <table cellpadding="4" style="width:100%;font-size:10px;font-family: arial;"> 
          <tbody>
            ...
            { 
              ...
              {
                ?>
                <td><?php if(!empty($med_collection->reciept_prefix) || !empty($med_collection->reciept_suffix)){ echo $med_collection->reciept_prefix.$med_collection->reciept_suffix; } ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $med_collection->patient_name; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $med_collection->mobile_no; ?></td>
                <?php
              }else
              {
              ...
              {
                ?>
                <td><?php echo $med_collection->panel_type; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php if($med_collection->balance=='1.00' || $med_collection->balance=='0.00'){ echo '0.00'; }else{ echo number_format($med_collection->balance-1,2); } ?></td>
                <?php
              }
              else
              {
        ...
        ?>
         ...
         <tbody>
            ...
            { 
              ...
              {
                ?>
                <td><?php if(!empty($vaccination_collection->reciept_prefix) || !empty($vaccination_collection->reciept_suffix)){ echo $vaccination_collection->reciept_prefix.$vaccination_collection->reciept_suffix; } ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $vaccination_collection->patient_name; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $vaccination_collection->patient_code; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo date('d-m-Y', strtotime($vaccination_collection->created_date)); ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $vaccination_collection->doctor_name; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $vaccination_collection->doctor_hospital_name; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $vaccination_collection->mobile_no; ?></td>
                <?php
              }else
              {
              ...
              {
                ?>
                <td><?php echo $vaccination_collection->panel_type; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $vaccination_collection->booking_code; ?></td>
                <?php
              }
              else
              {
              ...
              if(strcmp(strtolower($tab_value->setting_name),'total_amount')=='0')
              {
                ...
                <td><?php echo $vaccination_collection->total_amount; ?></td>
              ...
              {
                ?>
                <td><?php echo $vaccination_collection->discount_amount; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $vaccination_collection->net_amount; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $vaccination_collection->debit; ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php if($vaccination_collection->balance=='1.00' || $vaccination_collection->balance=='0.00'){ echo '0.00'; }else{ echo number_format($vaccination_collection->balance-1,2); } ?></td>
                <?php
              }
              else
              {
              ...
              {
                ?>
                <td><?php echo $vaccination_collection->mode ?></td>
                <?php
              }
              else
              {
