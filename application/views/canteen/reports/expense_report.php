...
{ 
   ...
   window.open('<?php echo base_url('canteen/reports/print_opd_expenses_reports?') ?>branch_id='+branch_id+'&start_date='+start_date+'&end_date='+end_date,'mywin','width=800,height=600');
}  
