...
{    
    ...
    if(module_type=='1')
    {
      window.open('<?php echo base_url('reports/print_hospital_collection_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by,'mywin','width=800,height=600');
    }
    else
    {
      window.open('<?php echo base_url('reports/print_opd_collection_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by,'mywin','width=800,height=600');    
    }
...
{    
    ...
    if(module_type=='1')
    {
      window.open('<?php echo base_url('reports/print_hospital_collection_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by+'&send=preview','mywin','width=800,height=600');
    }
    else
    {
      window.open('<?php echo base_url('reports/print_opd_collection_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&employee='+employee_c+'&order_by='+order_by+'&send=preview','mywin','width=800,height=600');    
    }
