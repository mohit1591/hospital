                    ...
                    <div class="row" id="inner_table" style="display:none;">
                        ...
                        <div class="col-sm-4">
                            <div class="row m-b-5">
                                ...
                                <div class="col-sm-7"><input type="text" class="price_float" name="pay_amount" id="pay_amount" value=""/><div class="doctor_comission_msg" style="color:red;" id="pay_amount_msg"></div></div>
                            </div> <!-- innerRow -->
                        </div> <!-- 4 -->
                        <div class="col-sm-4">
                            <div id="cheque">
...
function doctor_paid_commission_list()
{
  ...
  ?> 
   ...
   window.open('<?php echo base_url('billing/doctor_paid_commission_list?') ?>doctor_id='+doctor_id+'&branch_id='+branch_id+'&start_date='+start_date+'&end_date='+end_date,'mywin','width=800,height=600');
}
...
$("#branch_doctor_form").on("submit", function(event) { 
     ...
     /*else if(Vals==2){
          if($("#bank_name").val()==''){
               receive_now(1);
               $("#bank_name_msg").html("The bank name is required");
          }
          
          if($("#cheque_date").val()==''){
               receive_now(1);
               $("#cheque_date_msg").html("The cheque date is required");
          }

          if($("#cheque_no").val()==''){
               receive_now(1);
               $("#cheque_no_msg").html("The cheque no is required");
          }
          if($("#pay_amount").val()==''){
               receive_now(1);
               $("#pay_amount_msg").html("the amount is required");
          }
          if($("#bank_name").val()!=='' && $("#cheque_no").val()!=='' && $("#pay_amount").val()!==''){
               $("#bank_name_msg").html("");
               $("#cheque_no_msg").html("");
               $("#pay_amount_msg").html("");
               doctor_commission_final_step();
          ...
          if($("#transection_no").val()==''){
               receive_now(1);
               $("#transaction_no_msg").html("The transaction no is required");
          }
          if($("#pay_amount").val()==''){
               receive_now(1);
               $("#pay_amount_msg").html("The amount is required");
          }
          if($("#transection_no").val()!=='' && $("#pay_amount").val()!==''){
               $("#transaction_no_msg").html("");
               $("#pay_amount_msg").html("");
               doctor_commission_final_step();
          }
...
function doctor_commission_details()
{
  ...
  if(doctor_id>0)
  {
   window.open('<?php echo base_url('billing/doctor_commission_details?doctor_id=') ?>'+doctor_id+'&branch_id='+branch_id+'&start_date='+start_date+'&end_date='+end_date,'mywin','width=800,height=600');
  } 
 } 
</script>
