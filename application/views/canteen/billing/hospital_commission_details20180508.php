...
<body style="background: rgb(204,204,204);font-family:Arial;color:#333;font-size:13px;">
		<page size="A4">
<h2 align="center">Hospital Commission List</h2>
<table width="100%" class="m-b-5">
<?php
$hospital = get_hospital_name($_GET['hospital_id']);
?>
  <tr>
  	 <td width="25%" align="left" class="text-left"><b>Hospital Name :</b> <?php echo $hospital; ?></td>
...
<!-- <table id="table" class="table table-striped table-bordered branch_hospital_list" width="100%" cellspacing="0">   
