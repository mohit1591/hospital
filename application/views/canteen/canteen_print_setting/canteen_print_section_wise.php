...
<?php if($sub_section==1){
 ...
 <div class="row m-b-5">
    ...
    <div class="row m-b-5">
      ...
      <div class="col-xs-9" >
      <textarea type="text" name="short_code" cols="45" value="" readonly id="comment_data" class="print_textarea"><?php echo $form_data['short_code'];?></textarea>
      </div>
    </div> <!-- rowClose -->
 ...
 <div class="row m-b-5">
    ...
    <div class="row m-b-5">
      ...
      <div class="col-xs-9" >
      <textarea type="text" name="short_code" cols="45" value="" readonly class="print_textarea" id="comment_data"><?php echo $form_data['short_code'];?></textarea>
      </div>
    </div> <!-- rowClose -->
...
function get_printer_section(value){
  $.ajax({
      type:"POST",
      url: "<?php echo base_url(); ?>medicine_print_setting/get_according_to_section/", 
      data: {value: value},
