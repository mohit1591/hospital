...
function print_options_report(print_option)
{
      ...
      if(print_option!='')
      {
          ...
          { 
              $("#print").removeAttr("onClick");
              $("#print").removeAttr("onClick");
              $("#print").attr("onClick","return openPrintWindows('<?php echo base_url('canteen/itemwise_report/report_excel?') ?>start_date="+start_date+"&end_date="+end_date+"&module_type="+module_type+"&vender="+vender+"', 'windowTitle', '');");
...
{    
    ...
    if(module_type=='1')
    {
      window.open('<?php echo base_url('canteen/itemwise_report/print_quantity_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&module_type='+module_type+'&vender='+vender,'mywin','width=800,height=600');
    }
    else
    {
      window.open('<?php echo base_url('canteen/itemwise_report/print_quantity_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&module_type='+module_type+'&vender='+vender,'mywin','width=800,height=600');    
