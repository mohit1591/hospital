...
$template_data->template = str_replace("{vendor_dl_1}",$all_detail['purchase_list'][0]->vendor_dl_1,$template_data->template);
$template_data->template = str_replace("{vendor_dl_2}",$all_detail['purchase_list'][0]->vendor_dl_2,$template_data->template);
...
$template_data->template = str_replace("{paid_amount}",$paid,$template_data->template);
...
$i=1;
$tr_html = "";
//print '<pre>'; print_r($all_detail['purchase_list']['medicine_list']);
foreach($all_detail['purchase_list']['medicine_list'] as $medicine_list)
{ 
