...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "aaSorting": [],
        "ajax": {
            "url": "<?php echo base_url('canteen/canteen_purchase_report/ajax_list')?>",
            "type": "POST"
        }, 
        "columnDefs": [
        { 
...
function reset_date_search()
  {
      ...
      $('#end_date').val('');
      $.ajax({
         url: "<?php echo base_url('canteen/canteen_purchase_report/reset_date_search/'); ?>",  
...
$modal.load('<?php echo base_url().'canteen/canteen_purchase_report/advance_search/' ?>',
{
//'id1': '1',
//'id2': '2'
},
    ...
    <div class="userlist-right relative" id="example_wrapper">
      ...
      <div class="btns media_btns"> 
          <?php //if(in_array('560',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('canteen/canteen_purchase_report/canteen_report_excel');?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-excel-o"></i> Excel
               </a>
          <?php //endif;?>
          <?php //if(in_array('561',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('canteen/canteen_purchase_report/canteen_report_csv');?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-word-o"></i> CSV
               </a>
          <?php //endif;?>
         <?php //if(in_array('562',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('canteen/canteen_purchase_report/pdf_canteen_report'); ?>" class="btn-anchor m-b-2">
                    <i class="fa fa-file-pdf-o"></i> PDF
               </a>
        
              <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("canteen/canteen_purchase_report/print_canteen_report"); ?>');">
...
$("#new_search_form").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url(); ?>canteen/canteen_purchase_report/advance_search/",
    type: "post",
    data: $(this).serialize(),
    success: function(result) 
    {
