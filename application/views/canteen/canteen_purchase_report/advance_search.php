                ...
                <div class="col-xs-12">
                    ...
                    <div class="advance-search">
                      <div class="inner">
                        ...
                        <div class="row m-b-5">
                          ...
                          <div class="col-md-8">
                          <input type="text" name="purchase_id" id="purchase_id" value="<?php echo $form_data['sale_no']; ?>" placeholder="Purchase No"/>
                          </div>
                        </div>
                        ...
                        <div class="row m-b-5">
                          ...
                          <div class="col-md-8">
                            <input type="text" maxlength="10" name="mobile_no" value="<?php echo $form_data['mobile_no']; ?>" onkeypress="return isNumberKey(event);" placeholder="Mobile No">
                          </div> 
                        </div> 
                      ...
                      <div class="inner">
                        ...
                        <div class="row m-b-5">
                          ...
                          <div class="col-md-8">
                            <input type="text" name="name" id="name" value="<?php echo $form_data['name']; ?>" placeholder="Vendor Name"/>
                          </div>  
                        </div>
                    ...
                    <?php } ?>
                        ...
                        <div class="row m-b-5">
                          ...
                          <div class="col-md-8">
                           <input type="text" name="medicine_company" id="medicine_company" value="<?php echo $form_data['medicine_company']; ?>" placeholder="Mfg Company"/>
                        </div>  
                        </div>  
...
function reset_search(ele)
{
  ...
  $.ajax({url: "<?php echo base_url(); ?>canteen/canteen_purchase_report/reset_date_search/", 
