...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="row m-b-5">
            ...
            <div class="col-sm-8">
                <input type="text" class="m_input_default" name="sale_no" value="<?php echo $form_data['sale_no'];?>">
            </div>
        </div>
		...
		<span class="star">*</span></label>
            ...
            <div class="col-sm-8">
                    <input type="text" name="name" class="alpha_numeric_space m_input_default txt_firstCap" id="ven_name" value="<?php if(!empty($form_data['patient_id'])){ echo $form_data['pname']; } else { echo $form_data['cname']; } ?>">
    ...
    <div class="col-md-4">
        ...
        <div class="row m-b-5">
            ...
            <div class="col-sm-8">
                ...
                <input type="text" name="mobile"  class="number numeric m_number" maxlength="10" value="<?php if(!empty($form_data['patient_id'])){ echo $form_data['pmobile']; } else { echo $form_data['cmobile']; } ?>" onkeypress="return isNumberKey(event);">
        ...
        <div class="row m-b-5">
            ...
            <div class="col-sm-8">
                <input type="text" class="m_input_default" name="email" value="<?php if(!empty($form_data['patient_id'])){ echo $form_data['pemail']; } else { echo $form_data['cemail']; } ?>">
        ...
        <div class="row m-b-5">
            ...
            <div class="col-sm-8">
                <input type="text" name="sale_date" style="width: 110px;" class="datepicker m_input_default" value="<?php if($form_data['sale_date']=='00-00-0000' || empty($form_data['sale_date'])){echo '';}else{echo $form_data['sale_date'];}?>">
   ...
   <div class="col-md-4">
       ...
       <div class="row m-b-3">
            ...
            <div class="col-xs-4">
               <input type="text" name="address" id="" class="address" value="<?php if(!empty($form_data['patient_id'])){ echo $form_data['paddress']; } else { echo $form_data['caddress']; } ?>"/>
           ...
           <div class="row m-b-3">
            ...
            <div class="col-xs-4">
               <input type="text"  name="address2" class="address" value="<?php if(!empty($form_data['patient_id'])){ echo $form_data['paddress2']; } else { echo $form_data['caddress2']; } ?>"/>
           ...
           <div class="row m-b-3">
            ...
            <div class="col-xs-4">
               <input type="text" name="address3" class="address" value="<?php if(!empty($form_data['patient_id'])){ echo $form_data['paddress3']; } else { echo $form_data['caddress3']; } ?>"/>
            ...
            <div class="col-xs-4">
                <textarea type="text" id="remarks" class="m_input_default" name="remarks"><?php if(!empty($form_data['patient_id'])){ echo $form_data['premarks']; } else { echo $form_data['cremarks']; } ?></textarea>
            </div>
          </div>
