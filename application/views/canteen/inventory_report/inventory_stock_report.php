...
function print_options_report(print_option){
  //alert(print_option);
     ...
     if(print_option!=''){
         ...
         $("#print").removeAttr("onClick");
                    $("#print").removeAttr("onClick");
                    $("#print").attr("onClick","return print_window_page('<?php echo base_url('inventory_report/inventory_purchase_report_excel?') ?>start_date="+start_date+"&end_date="+end_date+"&section_type=6&branch_id="+branch_id+"');");
          }else if(print_option==3){ 
                $("#print").removeAttr("onClick");
                $("#print").attr("onClick","return print_window_page('<?php echo base_url('inventory_report/inventory_purchase_report_pdf?') ?>start_date="+start_date+"&end_date="+end_date+"&section_type=6&branch_id="+branch_id+"');");
...
{   
  ...
  var branch_id = $('#branch_id option:selected').val();
   window.open('<?php echo base_url('inventory_report/print_inventory_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&section_type=6&branch_id='+branch_id,'mywin','width=800,height=600');
}  
...
$(document).ready(function(){
 ...
 $("button[data-number=1]").click(function(){
    $('#load_stock_item_modal_popup').modal('hide');
});
</script>
