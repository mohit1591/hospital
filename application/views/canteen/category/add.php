...
<div class="overlay-loader" id="overlay-loader">
  ...
  <form  id="Category" class="form-inline">
          ...
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row">
                ...
                <div class="col-md-8">
                    <input type="text" name="category"  value="<?php echo $form_data['category']; ?>" placeholder="Enter Stock Category">
...
$("#Category").on("submit", function(event) { 
  ...
  { 
    var path = 'edit/'+ids;
    var msg = 'Category successfully updated.';
  }
  else
  {
    var path = 'add/';
  ...
  $.ajax({
    ...
    success: function(result) {
      ...
      if(result==1)
      {
        $('#load_add_Cat_modal_popup').modal('hide');
      ...
      {
        $("#load_add_Cat_modal_popup").html(result);
      }       
      $('#overlay-loader').hide();
    }
  });
...
{
   $.ajax({url: "<?php echo base_url(); ?>canteen/item_category/Category_dropdown/", 
    success: function(result)
    {
