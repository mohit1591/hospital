                    ...
                    <div class="advance-search">
                      <div class="inner">
                        ...
                        <div class="grp">
                          ...
                          <input type="text" class="datepicker start_datepicker" placeholder="From Date" name="start_date" value="<?php echo $form_data['start_date']; ?>" id="" >
                        </div>
                        
                        <div class="grp">
                          <label><?php echo $data= get_setting_value('CUSTOMER_REG_NO');?></label>
                          <input type="text" class="inputFocus" placeholder="Customer Reg. No." name="customer_code"value="<?php echo $form_data['customer_code']; ?>">
                        </div>
                        ...
                        <div class="grp">
                          ...
                          <div class="rslt">
                              ...
                              <input type="text" name="customer_name" id="customer_name" placeholder="Customer Name" value="<?php echo $form_data['customer_name']; ?>" class="p-name inputFocus" autofocus="">
                          </div>
                        </div>
                         ...
                         <div class="grp">
                          ...
                          <div class="rslt">
                             ...
                             <input type="text" placeholder="Relation Name" value="<?php if(isset($form_data['relation_name'])){ echo $form_data['relation_name'];}?>" name="relation_name" id="relation_name" class="p-name inputFocus"/>
                          </div>
                        </div>
                       ...
                       <div class="grp">
                        ...
                        <div class="grp">
                          <label>Address</label>
                          <textarea name="address" id="address" placeholder="Address" maxlength="255"><?php echo $form_data['address']; ?></textarea>
                        </div>
                        ...
                        <div class="grp">
                          ...
                          <input type="text" name="pincode" placeholder="Pin Code" id="pincode" value="<?php echo $form_data['pincode']; ?>" maxlength="6" onkeypress="return isNumberKey(event);">
                        </div>
                        ...
                        <div class="grp">
                          ...
                          <input type="text" name="mother" id="mother" placeholder="Mother Name" value="<?php echo $form_data['mother']; ?>" />
                        </div>
                      ...
                      <div class="inner">
                        ...
                        <div class="grp">
                          <label>To Date</label>
                          <input type="text" name="end_date" class="end_datepicker" placeholder="To Date" value="<?php echo $form_data['end_date']; ?>" id="">
                        </div>
                          
                        <div class="grp">
                          <label>Guardian Name</label>
                          <input type="text" name="guardian_name" id="guardian_name" placeholder="Guardian Name" value="<?php echo $form_data['guardian_name']; ?>" />
                        </div>
                          
                        <div class="grp">
                          <label>Guardian Email</label>
                          <input type="text" name="guardian_email" id="guardian_email" placeholder="Guardian Email" value="<?php echo $form_data['guardian_email']; ?>" />
                        </div>
                          
                        <div class="grp">
                          <label>Guardian Mobile</label>
                          <input type="text" name="guardian_phone" placeholder="Guardian Mobile No." onkeypress="return isNumberKey(event);" id="guardian_phone" value="<?php echo $form_data['guardian_phone']; ?>" maxlength="10">
                        </div>
                        ...
                        <div class="grp">
                          ...
                          <input type="text" name="customer_email" id="customer_email" placeholder="Customer Email" value="<?php echo $form_data['customer_email']; ?>" />
                        </div>
                          
                        <div class="grp">
                          <label>Monthly Income</label>
                          <input type="text" name="monthly_income" placeholder="Monthly Income" onkeypress="return isNumberKey(event);" maxlength="10" id="monthly_income" value="<?php echo $form_data['monthly_income']; ?>" >
                        </div>
                          
                        <div class="grp">
                          <label>Occupation</label>
                          <input type="text" name="occupation"  placeholder="Occupation" id="occupation" value="<?php echo $form_data['occupation']; ?>" />
                        </div>
                        ...
                        <div class="grp">
                          ...
                          <input type="text" name="polocy_no" id="polocy_no" placeholder="Policy No." value="<?php echo $form_data['polocy_no']; ?>" maxlength="20" />
                        </div>
                          
                        <div class="grp">
                          <label>TPA ID</label>
                          <input type="text" name="tpa_id" id="tpa_id" placeholder="TPA ID" value="<?php echo $form_data['tpa_id']; ?>" />
                        </div>
                          
                        <div class="grp">
                          <label>Insurance Amount</label>
                          <input type="text" name="ins_amount" id="ins_amount" placeholder="Insurance Amount" value="<?php echo $form_data['ins_amount']; ?>" onkeypress="return isNumberKey(event);" />
                        </div>
                          
                        <div class="grp">
                          <label>Authorization No.</label>
                          <input type="text" name="ins_authorization_no"  placeholder="Authorization No." id="ins_authorization_no" value="<?php echo $form_data['ins_authorization_no']; ?>" />
                        </div>
