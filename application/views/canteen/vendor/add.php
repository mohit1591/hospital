                      ...
                      <div class="row m-b-5">
                        <div class="col-md-12">
                          <div class="row">
                            ...
                            <div class="col-md-8">
                              <input type="text" name="name"  class="alpha_numeric_space m_name inputFocus txt_firstCap" id="name" value="<?php echo $form_data['name']; ?>">
                  ...
                  <div class="row m-b-5">
                    <div class="col-md-12">
                      <div class="row">
                        ...
                        <div class="col-md-8">
                          <input type="radio" name="vendor_type" <?php echo 'checked="checked"'; ?> id="vendor_type" value="1" /> Canteen
                        </div> <!-- 8 -->
                      </div> <!-- innerRow -->
                    </div> <!-- 12 -->
                  </div> <!-- row -->
...
$("#vendor_type_new").on("submit", function(event) { 
  ...
  var uri_seg='canteen/<?php echo $this->uri->segment(2);?>';  
