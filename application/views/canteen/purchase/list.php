...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('canteen/purchase/ajax_list')?>",
            "type": "POST",
        }, 
        "columnDefs": [
        { 
        ...
        "drawCallback": function() 
        {
            $.ajax({
                      dataType: "json",
                      url: "<?php echo base_url('canteen/purchase/total_calc_return');?>",
...
function edit_purchase(id)
{
  ...
  window.location.href='<?php echo base_url().'canteen/purchase/edit/';?>'+id
...
function view_medicine_entry(id)
{
  ...
  $modal.load('<?php echo base_url().'canteen/purchase/view/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('canteen/purchase/deleteall');?>",
                      data: {row_id: allVals},
                      success: function(result) 
                      {
...
<section class="userlist">
    ...
    <table class="ptl_tbl">
      ...
      <tr>
        <td><label>Purchase No.</label><input type="text"  placeholder="Purchase No." id="purchase_no" value="<?php echo $form_data['purchase_no'] ?>" name="purchase_no" class=" "  onkeyup="return form_submit();" autofocus=""></td>
        <td><label>Invoice No.</label><input type="text" placeholder="Invoice No." id="invoice_id" value="<?php echo $form_data['invoice_id'] ?>" name="invoice_id" class=" "  onkeyup="return form_submit();"></td>
      </tr>
      <tr>
    ...
    <form>
  	...
  	<div class="userlist-right">
  		<div class="btns">
               ...
               ?>
  			     <button class="btn-update" onclick="window.location.href='<?php echo base_url('canteen/purchase/add'); ?>'">
               ...
               ?>
                ...
                <a href="<?php echo base_url('canteen/purchase/item_purchase_excel'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-excel-o"></i> Excel
                </a>

                <a href="<?php echo base_url('canteen/purchase/item_purchase_csv'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-word-o"></i> CSV
                </a>

                <a href="<?php echo base_url('canteen/purchase/pdf_item_purchase'); ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-pdf-o"></i> PDF
                </a>

                 <a href="javascript:void(0)" class="btn-anchor m-b-2"  onClick="return print_window_page('<?php echo base_url("canteen/purchase/print_item_purchase"); ?>');"> <i class="fa fa-print"></i> Print</a>
               ...
               ?>
  			    <!-- <button class="btn-update" onclick="window.location.href='<?php echo base_url('canteen/purchase/archive'); ?>'">
...
function reset_search()
  { 
    ...
    $('#invoice_id').val('');
    $('#branch_id').val('');
    $.ajax({url: "<?php echo base_url(); ?>canteen/purchase/reset_search/", 
      success: function(result)
      { 
        reload_table();
      } 
 ...
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('canteen/purchase/delete/'); ?>"+id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <!-- <a type="button" data-dismiss="modal" class="btn-anchor" id="delete" onClick="return openPrintnewWindow('< ?php echo base_url("canteen/purchase/print_purchase_recipt"); ?>', 'windowTitle', 'width=820,height=600');" target="_blank">Print</a> -->
...
$modal.load('<?php echo base_url().'canteen/purchase/advance_search/' ?>',
{ 
},
function(){
$modal.modal('show');
...
$("#new_search_form").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url(); ?>/canteen/purchase/advance_search/",
    type: "post",
    data: $(this).serialize(),
    success: function(result) 
    {
