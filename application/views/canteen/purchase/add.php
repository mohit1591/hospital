    ...
    <div class="row">
        <div class="col-md-4">
            <?php if(!empty($form_data['vendor_id'])){?>
                 <span class="new_vendor"><input type="radio" name="new_vendor" onClick="window.location='<?php echo base_url('canteen/purchase/');?>add/';"> <label>New Vendor</label></span>
                <span class="new_vendor"><input type="radio" name="new_vendor" checked onClick="window.location='<?php echo base_url('canteen/vendor');?>';"> <label>Registered Vendor</label></span>
               <?php  }else{?>
                 <span class="new_vendor"><input type="radio" name="new_vendor" checked onClick="window.location='<?php echo base_url('canteen/purchase/');?>add/';"> <label>New Vendor</label></span>
           ...
           <div class="col-md-4">
		    <div class="1">
              <label style="padding-right:6px">Purchase Estimate No. </label> <input type="text" name="estimate_no" id="estimate_no" placeholder="Purchase Estimate no" class="estimate_no">
           </div>
           </div>    
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="row m-b-5">
            ...
            <div class="col-sm-8">
                <input type="text" placeholder="Invoice No." class="m_input_default" name="invoice_id" value="<?php echo $form_data['invoice_id'];?>" autofocus="">
                 <?php // if(!empty($form_error)){ echo form_error('invoice_id'); } ?>
            </div>
        </div>
        ...
        <div class="row m-b-5">
            ...
            <div class="col-sm-8">
               <b><input type="text" class="m_input_default" name="purchase_no" value="<?php echo $form_data['purchase_no'];?>" readonly="readonly"></b>
            </div>
        </div>
        ...
        <div class="row m-b-5">
            ...
            <div class="col-sm-8">
                    <input type="text" name="name" placeholder="Vendor Name" class="alpha_numeric_space m_input_default txt_firstCap" id="ven_name" value="<?php echo $form_data['name'];?>">
    ...
    <div class="col-md-4">
        ...
        <div class="row m-b-5">
            ...
            <div class="col-sm-8">
                ...
                <input type="text" name="mobile"  placeholder="Mobile No."  class="number numeric m_number" maxlength="10" value="<?php echo $form_data['mobile'];?>" onkeypress="return isNumberKey(event);">
        ...
        <div class="row m-b-5">
            ...
            <div class="col-sm-8">
                <input type="text" class="m_input_default" placeholder="Email id"  name="email" id="email" value="<?php echo $form_data['email'];?>">
        ...
        <div class="row m-b-5">
         ...
         <div class="row m-b-5">
            ...
            <div class="col-sm-8">
                <input type="text" name="vendor_gst" placeholder="Vendor GST No."  id="vendor_gst_no" value="<?php echo $form_data['vendor_gst']; ?>">
            </div>
        </div>
   ...
   <div class="col-md-4">
       ...
       <div class="row m-b-3">
            ...
            <div class="col-xs-4">
               <input type="text" name="address"  placeholder="Address 1" id="" class="address" value="<?php echo $form_data['address'];?>"/>
           ...
           <div class="row m-b-3">
            ...
            <div class="col-xs-4">
               <input type="text"  name="address2" placeholder="Address 2"  class="address2" value="<?php echo $form_data['address2'];?>"/>
           ...
           <div class="row m-b-3">
            ...
            <div class="col-xs-4">
               <input type="text" name="address3"  placeholder="Address 3" class="address3" value="<?php echo $form_data['address3'];?>"/>
            ...
            <div class="col-xs-4">
                <textarea type="text" id="remarks"  placeholder="Remarks"  class="m_input_default remarks" name="remarks"><?php echo $form_data['remarks'];?></textarea>
            </div>
          </div>
       ...
       <div class="box_scroll" > <!-- class="left" on 07-12-2017-->
        ...
        <div class="right relative">
            <div class="fixed">
                ...
                <a href="<?php echo base_url('canteen/purchase');?>" class="btn-anchor"><i class="fa fa-sign-out"></i> Exit</a>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <a  data-dismiss="modal" class="btn-anchor"  onClick="return print_window_page('<?php echo base_url("canteen/purchase/print_purchase_recipt"); ?>');">Print</a>
...
$('#sgst_percent').keyup(function(){
 ...
 function payment_function(value,error_field){
    $('#updated_payment_detail').html('');
     $.ajax({
        type: "POST",
        url: "<?php echo base_url('canteen/purchase/get_payment_mode_data')?>",
...
{  
   ...
   // var vat = $('#vat').val();
    ...
    $.ajax({
       type: "POST",
       url: "<?php echo base_url('canteen/purchase/ajax_list_item')?>",
...
function child_item_vals() 
 ...
 function toggle(source) 
  ...
  {   
       ...
       if(allVals!="")
       {
        ...
        //  var qty = $('#qty_'+allVals).val();
          $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('canteen/purchase/set_item');?>",
  ...
  {
    $.ajax({
                    url: "<?php echo base_url(); ?>canteen/purchase/ajax_added_item", 
                    dataType: "json",
                   success: function(result)
                    {
  ...
  { 
   if(allVals!="")
   {
      $.ajax({
              type: "POST",
              url: "<?php echo base_url('canteen/purchase/remove_item_list');?>",
               dataType: "json",
 ...
 function payment_cal_perrow(ids){
   ...
   // {
        ...
        $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>canteen/purchase/payment_cal_perrow/", 
                dataType: "json",
   ...
   function payment_calc_all(pay)
    {
      ...
      {*/
            $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>canteen/purchase/payment_calc_all/", 
            dataType: "json",
...
$('#discount_all').keyup(function(){
 ...
 function validation_bar_code(id){
   ...
   // var unit2= $('#qty_'+id).val();
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>canteen/purchase/check_bar_code/", 
      dataType: "json",
...
$('documnet').ready(function(){
 <?php if(isset($_GET['status']) && isset($purchase_id) && $_GET['status']=='print'){?>
  ...
  .one('click', '#cancel', function(e)
    { 
        window.location.href='<?php echo base_url('canteen/purchase/add');?>'; 
    }) ;
...
<script type="text/javascript">
    ...
    var getData = function (request, response) {  
        ...
        row = i ;
        $.ajax({
        url : "<?php echo base_url('canteen/purchase/estimate_item/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
      data: { 
    ...
    var selectItem = function (event, ui) 
    {
            ...
            $('.address').val(names[6]); 
            $('.address2').val(names[7]);
            $('.address3').val(names[8]);
			$('.remarks').val(names[9]);
  ...
  {   
   ...
   if(allVals!="")
   {
      $.ajax({
              type: "POST",
              url: "<?php echo base_url('canteen/purchase/set_item_stockitem');?>",
      ...
      function get_canteen_vendor(i_id)
      {
       ...
       $.ajax({
              type: "POST",
              url: "<?php echo base_url('canteen/purchase/get_canteen_vendors');?>",
              data: {item_id: i_id},
              dataType: "json",
              success: function(result) 
              {
