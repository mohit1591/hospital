   ...
   $("#print").removeAttr("onClick");
     ...
     if(print_option!=''){
          if(print_option==1){
               ...
               $("#print").removeAttr("onClick");
               $("#print").attr("onClick","return openPrintWindows('<?php echo base_url('canteen/banking_report/banking_report_pdf?') ?>start_date="+start_date+"&end_date="+end_date+"&branch_id="+branch_id+"', 'windowTitle', 'width=820,height=600');");
          }else if(print_option==3){
            $("#print").removeAttr("onClick");
               $("#print").attr("onClick","return openPrintWindows('<?php echo base_url('canteen/banking_report/print_banking_report?') ?>start_date="+start_date+"&end_date="+end_date+"&branch_id="+branch_id+"', 'windowTitle', 'width=820,height=600');");
          }
...
{   
  ...
  var branch_id = $('#branch_id_new option:selected').val();
   ...
   window.open('<?php echo base_url('canteen/banking_report/print_banking_report_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&branch_id='+branch_id,'mywin','width=800,height=600');
}  
