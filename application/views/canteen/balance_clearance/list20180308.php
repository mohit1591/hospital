          	...
          	<li>
          		 <label></label>  
                      ...
                      if(in_array('60',$permission_section)){ ?>
                       ...
                       <input type="checkbox" name="section_id[]" <?php if(!empty($balance_search_data) && in_array('7',$balance_search_data['section_id'])){ echo 'checked="checked"'; } ?> onclick="return form_submit()" value="7"> Vaccine <?php }
        ...
        <ul class="list-inline">
          	...
          	<li>
          		<div id="previous_data"> 
                     <div  id="search_box_patient_name" style="display:none;"><input type="text" name="patient_name"  id="patient_name"/></div>
                      <?php if(!empty($form_error)){ echo form_error('patient_name'); } ?>
                     <div id="search_box_mobile_no" onkeypress="return isNumberKey(event);" style="display:none;"><input type="text" name="mobile_no" id="mobile_no"/></div> 
                      <?php if(!empty($form_error)){ echo form_error('mobile_no'); } ?>
                    <div  id="branch_list"> <div id="child_branch" ></div>  </div>
