      ...
      <div class="col-md-11 pr-0">
        ...
        <table class="table table-bordered stock_item_issue_upper" style="margin-bottom:0;background: transparent;">
          <tbody>
            ...
            <tr>
              <td>Item Name</td>
              <td><input type="text" name="item_name" placeholder="Enter Item Name" class="item_name txt_firstCap" value="" id="">
            ...
            <tr>
              <td>Item Code</td>
              <td><input type="text" name="item_code" placeholder="Item Code" id="item_code" value="" readonly></td>
              <td>Qty.</td>
      ...
      <span class="text-danger" id="error_message"></span>
        ...
        <table class="table table-bordered table-striped purchase_stock_item_list" id="item_list">
          <thead class="bg-theme">
           ...
           <tbody>
                  <?php //print '<pre>';print_r($stock_issue_allotment_item_list) ;
...
function select_user_type(user_type)
{
  $.ajax({
            type: "POST",
            url: "<?php echo base_url('canteen/stock_issue_allotment/usertype_list');?>",
            dataType: "text",
...
function employee_list_new(employe_id)
{
  $.ajax({
              type: "POST",
              url: "<?php echo base_url('canteen/stock_issue_allotment/employee_list');?>",
              dataType: "text",
...
{
  $.ajax({
          url: "<?php echo base_url('canteen/stock_issue_allotment/get_emp_data/'); ?>"+emp_id+'/'+user_type, 
          success: function(result)
          {
...
function payment_function(value,error_field){
    $('#updated_payment_detail').html('');
     $.ajax({
        type: "POST",
        url: "<?php echo base_url('canteen/stock_issue_allotment/get_payment_mode_data')?>",
  ...
  ?>
     ...
     var getData = function (request, response) { 
        ...
        row = i ;
        $.ajax({
        url : "<?php echo base_url('canteen/stock_issue_allotment/get_item_values/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
       data: {
  ...
  function item_payment_calculation()
  {
    ...
    if(item_name!='')
    {
     $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>canteen/stock_issue_allotment/item_payment_calculation/", 
            dataType: "json",
  ...
  function payment_new_calc_all(update_row)
  {
        ...
        $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>canteen/stock_issue_allotment/payment_calc_all/", 
        dataType: "json",
  ...
  function payment_cal_perrow(ids){
    ...
    $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>canteen/stock_issue_allotment/payment_cal_perrow/", 
            dataType: "json",
...
function remove_item(allVals)
  { 
   if(allVals!="")
   {
      $.ajax({
              type: "POST",
              url: "<?php echo base_url('canteen/stock_issue_allotment/remove_stock_purchase_item_list');?>",
               dataType: "json",
