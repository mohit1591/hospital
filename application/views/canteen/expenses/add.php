    ...
    <div class="modal-content"> 
               ...
               <div class="modal-body">    
                    ...
                    <div class="row m-b-5">
                         <div class="col-md-6">
                              ...
                              <div class="row m-b-5">
                                   <div class="col-md-4">
                                   <strong>Category Name<span class="star">*</span></strong>
                                   </div> <!-- 4 -->
                                   <div class="col-md-8">
          ...
          function payment_function(value,error_field){
               $('#updated_payment_detail').html('');
                    $.ajax({
                         type: "POST",
                         url: "<?php echo base_url('canteen/expenses/get_payment_mode_data')?>",
          ...
          function expense_category_modal(){
               ...
               $modal.load('<?php echo base_url().'canteen/expense_category/add/' ?>',
               {
                    //'id1': '1',
                    //'id2': '2'
               },
        ...
        format: 'dd-mm-yyyy',
         ...
         autoclose: true
          ...
          $("#expenses_form").on("submit", function(event) { 
               ...
               $.ajax({
                    url: "<?php echo base_url(); ?>canteen/expenses/"+path,
                    type: "post",
                    data: $(this).serialize(),
                     //dataType: "json",
                    success: function(result) {
                         ...
                         if(result==1){
                              ...
                              window.location.href='<?php echo base_url('canteen/expenses/?status=print');?>';
                         } else{
