  ...
  <input type="hidden" name="data_id" value="<?php echo $form_data['data_id'];?>" />
    <div class="row m-b-5">
     ...
     <div class="row m-b-5">
      ...
      <div class="col-xs-9">
        <textarea type="text" name="short_code" class="print_textarea" id="" cols="45"  readonly>{receipt_no} {receipt_date} {particulars} {payment_mode} {remarks} {amount} {total_amount} {signature}
</textarea>
      </div>
    </div> <!-- rowClose -->
