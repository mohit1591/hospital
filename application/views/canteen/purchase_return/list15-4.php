    ...
    <form>
  	...
  	<div class="userlist-right ">
  		<div class="btns">
               ...
               ?>
  			     <button class="btn-update" onclick="window.location.href='<?php echo base_url('purchase_return/add'); ?>'">
              ...
              <a href="<?php echo base_url('purchase_return/medicine_purchase_excel'); ?>" class="btn-anchor m-b-2">
                ...
                <!-- <a href="javascript:void(0)" class="btn-anchor m-b-2" id="deleteAll" onClick="return openPrintnewWindow('< ?php echo base_url("purchase_return/print_medicine_purchase"); ?>', 'windowTitle', 'width=820,height=600');">
...
/*function openPrintWindow(url, name, specs) {
 if(url==123){
    url='< ?php echo base_url("purchase_return/print_purchase_return_recipt"); ?>/'+name;
    name='windowTitle';
