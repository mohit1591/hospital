                    ...
                    <div class="advance-search">
                      <div class="inner">
                        ...
                        <div class="grp">
                          ...
                          <input type="text" placeholder="Vendor Code" name="vendor_code" class="inputFocus" value="<?php echo $form_data['vendor_code']; ?>">
                        </div>
                        ...
                        <div class="grp">
                          <label>Vendor Name</label>
                              ...
                              <input type="text" placeholder="Vendor Name" name="vendor_name" id="vendor_name" value="<?php echo $form_data['vendor_name']; ?>" class="p-name">
                         
                        </div>
                        
                        <div class="grp">
                          <label>Mobile No. </label>
                          <input type="text" placeholder="Mobile No." maxlength="10" name="mobile_no" value="<?php echo $form_data['mobile_no']; ?>" onkeypress="return isNumberKey(event);">
                        </div>

                        <div class="grp">
                          <label>Invoice No. </label>
                          <input type="text" placeholder="Invoice No." name="invoice_id" value="<?php echo $form_data['invoice_id']; ?>" onkeypress="return isNumberKey(event);">
                        </div>

                       <div class="grp">
                          <label>Purchase No. </label>
                          <input type="text" placeholder="Purchase No. "  name="purchase_no" value="<?php echo $form_data['purchase_no']; ?>" onkeypress="return isNumberKey(event);">
                        </div>
                      ...
                      <div class="grp">
                        ...
                        <input type="text" placeholder=""  name="bank_name" id="bank_name" value="<?php echo $form_data['bank_name']; ?>" >
                      </div>-->
