    ...
    <div class="row">
        <div class="col-md-4">
            <?php if(!empty($form_data['vendor_id'])){?>
                 <span class="new_vendor"><input type="radio" name="new_vendor" onClick="window.location='<?php echo base_url('canteen/purchase_estimate/');?>add/';"> <label>New Vendor</label></span>
               ...
               <?php  }else{?>
                 <span class="new_vendor"><input type="radio" name="new_vendor" checked onClick="window.location='<?php echo base_url('canteen/purchase_estimate/');?>add/';"> <label>New Vendor</label></span>
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="row m-b-5">
            ...
            <div class="col-sm-8">
                <input type="text" class="m_input_default" placeholder="Invoice No." name="invoice_id" value="<?php echo $form_data['invoice_id'];?>" autofocus="">
    ...
    <div class="col-md-4">
        ...
        <div class="row m-b-5">
            ...
            <div class="col-sm-8">
                <input type="text" class="m_input_default" placeholder="Email Id " name="email" value="<?php echo $form_data['email'];?>">
   ...
   <div class="col-md-4">
       ...
       <div class="row m-b-3">
           ...
           <div class="row m-b-3">
            ...
            <div class="col-xs-4">
               <input type="text"  name="address2"  placeholder="Address 2" class="address" value="<?php echo $form_data['address2'];?>"/>
           ...
           <div class="row m-b-3">
            ...
            <div class="col-xs-4">
               <input type="text" name="address3" placeholder="Address 3" class="address" value="<?php echo $form_data['address3'];?>"/>
       ...
       <div class="box_scroll" > <!-- class="left" on 07-12-2017-->
        ...
        <div class="right relative">
            <div class="fixed">
                ...
                <a href="<?php echo base_url('canteen/purchase_estimate');?>" class="btn-anchor"><i class="fa fa-sign-out"></i> Exit</a>
            </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <a  data-dismiss="modal" class="btn-anchor"  onClick="return print_window_page('<?php echo base_url("canteen/purchase_estimate/print_purchase_recipt"); ?>');">Print</a>
...
$('#sgst_percent').keyup(function(){
 ...
 function payment_function(value,error_field){
    $('#updated_payment_detail').html('');
     $.ajax({
        type: "POST",
        url: "<?php echo base_url('canteen/purchase_estimate/get_payment_mode_data')?>",
...
{  
   ...
   // var vat = $('#vat').val();
    ...
    $.ajax({
       type: "POST",
       url: "<?php echo base_url('canteen/purchase_estimate/ajax_list_item')?>",
...
function child_item_vals() 
 ...
 function toggle(source) 
  ...
  {   
       ...
       if(allVals!="")
       {
        ...
        //  var qty = $('#qty_'+allVals).val();
          $.ajax({
                  type: "POST",
                  url: "<?php echo base_url('canteen/purchase_estimate/set_item');?>",
  ...
  {
    $.ajax({
                    url: "<?php echo base_url(); ?>canteen/purchase_estimate/ajax_added_item", 
                    dataType: "json",
                   success: function(result)
                    {
  ...
  { 
   if(allVals!="")
   {
      $.ajax({
              type: "POST",
              url: "<?php echo base_url('canteen/purchase_estimate/remove_item_list');?>",
               dataType: "json",
 ...
 function payment_cal_perrow(ids){
   ...
   // {
        ...
        $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>canteen/purchase_estimate/payment_cal_perrow/", 
                dataType: "json",
   ...
   function payment_calc_all(pay)
    {
      ...
      {*/
            $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>canteen/purchase_estimate/payment_calc_all/", 
            dataType: "json",
...
$('#discount_all').keyup(function(){
 ...
 function validation_bar_code(id){
   ...
   // var unit2= $('#qty_'+id).val();
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>canteen/purchase_estimate/check_bar_code/", 
      dataType: "json",
...
$('documnet').ready(function(){
 <?php if(isset($_GET['status']) && isset($purchase_id) && $_GET['status']=='print'){?>
  ...
  .one('click', '#cancel', function(e)
    { 
        window.location.href='<?php echo base_url('canteen/purchase_estimate/add');?>'; 
    }) ;
...
<script type="text/javascript">
    ...
    var getData = function (request, response) {  
        ...
        row = i ;
        $.ajax({
        url : "<?php echo base_url('canteen/purchase_estimate/estimate_item/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
      data: { 
  ...
  {   
   ...
   if(allVals!="")
   {
      $.ajax({
              type: "POST",
              url: "<?php echo base_url('canteen/purchase_estimate/set_item_stockitem');?>",
      ...
      function get_canteen_vendor(i_id)
      {
       ...
       $.ajax({
              type: "POST",
              url: "<?php echo base_url('canteen/purchase_estimate/get_canteen_vendors');?>",
              data: {item_id: i_id},
              dataType: "json",
              success: function(result) 
              {
