...
<main class="main_page">
  <div class="main_wrapper">
                 ...
                 <div class="row">
                   ...
                   <div class="col-sm-10">
                     <table class="table table-bordered">
                        ...
                        <tbody>
                          <tr>
                            <td>Maida <small class="text-danger">(maida-2500)</small></td>
                            <td><input type="text" class="form-control" value="50"></td>
                            <td><input type="text" class="form-control" value="10"></td>
                            <td class="text-center">500</td>
                            <td class="text-center">
                              <a href="#" class="btn-custom">Delete</a>
                            </td>
                          </tr>
                          <tr>
                            <td>Salt <small class="text-danger">(Salt-2500)</small></td>
                            <td><input type="text" class="form-control" value="50"></td>
                            <td><input type="text" class="form-control" value="10"></td>
                            <td class="text-center">500</td>
                            <td class="text-center">
   ...
   <div class="main_btns">
    <div class="fixed-top">
      <button class="btn-hmas" id="deleteAll" onclick="return checkboxValues();">
        <i class="fa fa-trash"></i> Delete
      </button>
      <button class="btn-hmas" onclick="reload_table()">
        <i class="fa fa-refresh"></i> Reload
      </button>
      <button class="btn-hmas" onclick="window.location.href='<?php echo base_url('canteen/item_category/archive'); ?>'">
        <i class="fa fa-archive"></i> Archive
      </button>
      <button class="btn-hmas" onclick="window.location.href='<?php echo base_url('canteen/opening_stock'); ?>'">
