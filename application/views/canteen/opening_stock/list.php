...
<main class="main_page">
  <div class="main_wrapper">
    ...
    <div class="main_btns">
      <div class="fixed-top">
        <a href="<?php echo base_url('canteen/opening_stock/add');?>">
          <button class="btn-hmas" type="button"><i class="fa fa-plus"></i> Add</button>
        </a>
        ...
        <button class="btn-hmas" type="button"><i class="fa fa-archive"></i> Archive</button>
        <a href="<?php echo base_url('canteen/opening_stock');?>">
          <button class="btn-hmas" type="button">Exit</button>
        </a>
      </div>
    </div>
  </div>
