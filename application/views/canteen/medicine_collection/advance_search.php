                ...
                <div class="col-xs-12">
                    ...
                    <div class="advance-search">
                      <div class="inner">
                        ...
                        <div class="row m-b-5">
                          <label class="col-md-4">Sale No.</label>
                          <div class="col-md-8">
                          <input type="text" name="sale_no" id="sale_no" value="<?php echo $form_data['sale_no']; ?>" />
                          </div>
                        </div>
...
function reset_search(ele)
{
  ...
  $.ajax({url: "<?php echo base_url(); ?>canteen/canteen_collection_report/reset_date_search/", 
