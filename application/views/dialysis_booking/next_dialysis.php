...
<section class="userlist">
  <div class="userlist-box media_tbl_full">
      ...
      <input type="hidden" id="patient_id" value="<?php echo $form_data['patient_id'];?>" name="patient_id"/>
      <input type="hidden" id="dialysis_id" value="<?php echo $form_data['dialysis_id'];?>" name="dialysis_id"/>
     <div class="row">
          <div class="col-md-12">
          ...
          <div class="row">
            ...
            <div class="row">
              <div class="col-md-5">
                ...
                <tr>
                <th>Dialysis No. :</th>
                <td> <?php echo $patient_details['booking_code']; ?></td>
                </tr>
                <tr>
              ...
              <div class="row m-b-5">
               ...
               <select name="bed_no_id" id="bed_no_id">
                ...
                <div class="row m-b-5">
                <div class="col-sm-5"> <label> Dialysis Date <span class="star">*</span></label> </div>
                ...
                <div class="row m-b-5">
                <div class="col-sm-5"> <label>Dialysis Time <span class="star">*</span></label> </div>
               ...
               <label>Remarks </label> </div>
                ...
                <div class="row m-b-5">
                   ...
                   <div class="col-sm-7"><button class="btn-save"> <i class="fa fa-floppy-o"></i> Save</button></div>
                </div>
...
function select_no_bed(value_bed,bed_id){
  ...
  type: "post",
  data: {room_id:room_id,room_no_id:value_bed,bed_id:bed_id,dialysis_id:dialysis_id},
  success: function(result) 
  {
