        ...
        <div class="col-xs-8"> <br>
             ...
             <div class="row m-b-5">
              ...
              <div class="col-xs-8">
                  ...
                  <a href="<?=base_url('ot_summary')?>" target="_blank" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add new</a>
              </div>
            </div>
            ...
            <div class="row m-b-5" id="content">
                  <div class="col-xs-4"><strong> Pre Op Order</strong></div>
                  <div class="col-xs-8"> 
            ...
            <div class="row m-b-5" id="content">
              <div class="col-xs-4"><strong>Blood Transfusion</strong></div>
              <div class="col-xs-8"> 
            ...
            <div class="row m-b-5" id="content">
              <div class="col-xs-4"><strong>Blood Loss</strong></div>
              <div class="col-xs-8"> 
          ...
          <div class="row m-b-5" id="content">
                  <div class="col-xs-4"><strong>Drain</strong></div>
                  <div class="col-xs-8"> 
           ...
           <div class="row m-b-5" id="content">
                  <div class="col-xs-4"><strong>Materials Submitted for Histopathological Exam</strong></div>
                  <div class="col-xs-8"> 
            ...
            <div class="row m-b-5" id="content">
                  <div class="col-xs-4"><strong>Materials Submitted for Microbiological Exam</strong></div>
                  <div class="col-xs-8"> 
    ...
    <div class="row m-b-5 m-b-5">
         ...
         <div class="row m-b-5">
             <div class="col-xs-12">
                  ...
                  <table class="table table-bordered table-striped" id="prescription_name_table" style="">
                    <thead>
...
<script type="text/javascript">
 ...
 $('#template_list').change(function(){  
  ...
  function load_values(jdata)
  {
      ...
      //  $('#blood_transfusion').val(obj.blood_transfusion);
      //  $('#blood_loss').val(obj.blood_loss);
      //  $('#drain').val(obj.drain);
      //  $('#histopathological').val(obj.histopathological);
      //  $('#microbiological').val(obj.microbiological);
