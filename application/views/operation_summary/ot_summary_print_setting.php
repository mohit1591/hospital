      ...
      <div class="col-md-12">
        <div class="row">
          ...
          <div class="col-md-9" style="padding-left:7px;">
             <textarea style="width:100%;" readonly=""><?php echo $setting_list->short_codes; ?>,{remarks},{diagnosis},{op_findings},{procedures},{pos_op_orders},{surgeon_name},{assistant_surgeon_name},{blood_transfusion},{recovery_time},{blood_loss},{drain},{histopathological},{microbiological}</textarea>
        </div>
     </div>
     </div>
     </div>
...
for (instance in CKEDITOR.instances) {
  ...
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>operation_summary/update_ot_summary_settings",
    type: "post",
    data: $(this).serialize(),
