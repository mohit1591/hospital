...
function reset_date_search()
  {
      ...
      $('#end_date').val('');
      $.ajax({
         url: "<?php echo base_url('medicine_purchase_report/reset_date_search/'); ?>",  
...
$modal.load('<?php echo base_url().'medicine_purchase_report/advance_search/' ?>',
{
//'id1': '1',
//'id2': '2'
},
...
<?php }?>
      ...
      <div class="grp">
            ...
            <input type="text" name="end_date" id="end_date" class="datepicker datepicker_to end_datepicker m_input_default w-80px" value="<?php echo $form_data['end_date']; ?>" onkeyup="return form_submit();">
      </div>
      <div class="grp">
      ...
      <div class="fixed">
          ...
          <?php //if(in_array('560',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('medicine_purchase_report/medicine_report_excel');?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-excel-o"></i> Excel
               </a>
          <?php //endif;?>
          <?php //if(in_array('561',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('medicine_purchase_report/medicine_report_csv');?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-word-o"></i> CSV
               </a>
          <?php //endif;?>
         <?php //if(in_array('562',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('medicine_purchase_report/pdf_medicine_report'); ?>" class="btn-anchor m-b-2">
                    <i class="fa fa-file-pdf-o"></i> PDF
               </a>
        
              <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("medicine_purchase_report/print_medicine_report"); ?>');">
...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "aaSorting": [],
        "ajax": {
            "url": "<?php echo base_url('medicine_purchase_report/ajax_list')?>",
            "type": "POST"
        }, 
        "columnDefs": [
        { 
...
<div class="modal fade modal-w-50" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<style> .opd_collection_list td:nth-child(4), .opd_collection_list td:nth-child(5) {text-align: right !important;}</style>
</body>
</html>