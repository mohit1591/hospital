...
var table;
<?php
if(in_array('2442',$users_data['permission']['action'])) 
{
?>
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('crm/department/ajax_list')?>",
            "type": "POST",
...
$modal.load('<?php echo base_url().'crm/department/add/' ?>',
{
  //'id1': '1',
  //'id2': '2'
  },
...
{
  var $modal = $('#load_add_disease_modal_popup');
  $modal.load('<?php echo base_url().'crm/department/edit/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
...
<section class="userlist">
  ...
  <div class="row m-b-5">
    ...
    <form>
       <?php if(in_array('2442',$users_data['permission']['action'])) {
        ?>
    ...
    <div class="userlist-right">
        <div class="btns">
               <?php if(in_array('2443',$users_data['permission']['action'])) {
               ?>
