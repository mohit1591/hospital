...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('crm/lead_type/ajax_list')?>",
            "type": "POST",
...
function edit_lead_type(id)
{
  var $modal = $('#load_add_disease_modal_popup');
  $modal.load('<?php echo base_url().'crm/lead_type/edit/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        .one('click', '#delete', function(e)
        {
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('crm/lead_type/deleteall');?>",
                      data: {row_id: allVals},
...
function delete_lead_type(rate_id)
 {    
    $('#confirm').modal({
      backdrop: 'static',
      keyboard: false
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('crm/lead_type/delete/'); ?>"+rate_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
...
<section class="userlist">
  ...
  <div class="row m-b-5">
    ...
    <div class="userlist-right">
        <div class="btns">
               <?php if(in_array('2437',$users_data['permission']['action'])) {
               ?>
