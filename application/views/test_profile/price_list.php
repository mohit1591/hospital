    ...
    <div class="userlist-box">
         ...
         <form id="price_list">
          ...
          <table id="table" class="table table-striped table-bordered test_price" cellspacing="0" width="100%">
               ...
               <tbody id="test_lists">
                  <tr><td colspan="5" align="center"><font color="#b64a30">Profile not available.</font></td></tr>
               </tbody>
          </table>
          </form>
     </div> <!-- close -->
...
$(document).ready(function(){
 ...
 function get_test_list(val){
       $("#test_lists tbody").html('<tr><td colspan="5" align="center"><font color="#b64a30">Profile not available.</font></td></tr>');
       ...
       $.post('<?php echo base_url('test_profile/get_profile_list/'); ?>',{'test_head_id':chooseTestHead,'branch_id':chooseBranch,'doctors_id':doctors_id},function(result){
 ...
 function save_profile_rate(obj)
 {  
    ...
    $.post('<?php echo base_url('test_profile/save_profile_rate/'); ?>',{'rate':rate,'base_rate':base_rate,'branch_id':branchId, 'doc_id':doc_ids,'test_id':test_id,'type':type},function(result){
          if(type==1 && doc_ids=='')
          {
 ...
 {
  $.ajax({
    url: "<?php echo base_url('test_profile/save_all_price_list'); ?>",
    type: "post",
