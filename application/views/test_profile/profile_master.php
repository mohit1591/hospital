        ...
        if(isset($profile_data) && !empty($profile_data))
        {
          ...
          foreach($profile_data as $profile_dat)
          {
             $profile_row .= '<tr>
                              ...
                              <td><input type="text" size="20" class="numeric" value="'.$profile_dat['sort_order'].'" onkeyup="return set_profiletest_order('.$profile_dat['id'].',this.value);" /></td>
...
function add_multi_profile()
  {  
     ...
     $.ajax({
      url: "<?php echo base_url(); ?>test_profile/set_multi_profile/"+profile_id+'/'+prof_id, 
...
$("#test_search").keyup(function(){ 
  ...
  function set_ptest_order(t_id,vals)
  {
   ...
   function set_profiletest_order(t_id,vals)
  {
    $.ajax({
               type: "POST",
               url: "<?php echo base_url(); ?>test_profile/set_profiletest_order/"+t_id+"/"+vals, 
               success: function(msg)
               {
