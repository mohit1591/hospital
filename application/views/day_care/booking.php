...
$('document').ready(function(){
 ...
 if(isset($_GET['status']) && isset($day_booking_id) && $_GET['status']=='print'){ ?>
  ...
  .one('click', '#cancel', function(e)
    { 
       // window.location.href='<?php echo base_url('day_care/booking');?>'; 
    }); 
...
<input type="hidden" name="opd_type" value="0" > 
  <div class="row m-b-5">
    <div class="col-md-12">
       <div class="row">
  ...
  <div class="row m-b-5">
    <div class="col-md-12">
       <div class="row">
         <div class="col-md-4"><b>Day Care No.</b></div>
         <div class="col-md-8">
 ...
 <div class="row m-b-5">
   ...
   <div class="col-md-8">
     <select class="mr m_mr alpha_space"  name="simulation_id" id="simulation_id" onchange="find_gender(this.value)">
        ...
        <input type="text" name="patient_name" id="patient_name" style="width:118px!important;" value="<?php echo $form_data['patient_name']; ?>" class="mr-name m_name txt_firstCap"  autofocus/>
  ...
  <div class="row m-b-5">
    <div class="col-xs-4">
      ...
      <div class="col-xs-8">
        ...
        <input type="text" value="<?php if(isset($form_data['relation_name'])){ echo $form_data['relation_name'];}?>" name="relation_name" id="relation_name" class="mr-name m_name txt_firstCap_SO"/>
      </div>
    </div> <!-- row -->
 ...
 <div class="row m-b-5" id="pedic_spec" >
    <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-8">
           <input type="text" class="datepicker_dob" readonly="" name="dob" id="dob" value="<?php echo $form_data['dob']; ?>" onchange="showAge(this.value);" /> <!-- onchange="showAge(this.value);"-->
         </div>
       </div>
    </div>
  </div>
       ...
       <div class="row">
         ...
         <div class="col-md-7">
           <select name="referral_doctor" id="refered_id" class="w-150px m_select_btn"  onChange="return get_other(this.value)">
            ...
            <?php if(in_array('122',$users_data['permission']['action'])) {
                ?>
                    <a title="Add Referred Doctor" class="btn-new" id="doctor_add_modal"><i class="fa fa-plus"></i> New</a>
                <?php } ?>
         </div>
       </div>
    </div>
       ...
       <div class="row">
         ...
         <div class="col-md-7">
           <select name="referral_doctor" id="refered_id" class="w-150px m_select_btn"  onChange="return get_other(this.value)">
            ...
            <?php if(in_array('122',$users_data['permission']['action'])) {
                ?>
                    <a title="Add Doctor" class="btn-new" id="doctor_add_modal"><i class="fa fa-plus"></i> New</a>
                <?php } ?>
         </div>
       </div>
    </div>
  ...
  <div class="row m-b-5">
    <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-7">
           <select name="attended_doctor" class="w-150px m_select_btn" id="attended_doctor" <?php if(!empty($form_data['patient_id']) && $form_data['data_id']=='') { ?> get_validity_date_in_between(this.value); change_validity_date(this.value);<?php }?>>
    ...
    <div class="col-md-12">
       <div class="row">
         ...
         <div class="col-md-7">
              ...
              <a href="<?php echo base_url('day_care');?>" class="btn-anchor"><i class="fa fa-sign-out"></i> Exit</a>
         </div>
       </div>
    </div>
  </div> <!-- row -->
     ...
     <!-- //next 4th column -->
     <div class="col-xs-4 media_margin_left" id="payment_box" <?php ?>>
       <input type="hidden" class="m_input_default" name="package_id" id="package_id" value="" />
          ...
          <div class="row m-b-5 d-none">
               <div class="col-md-12">
                    <div class="row">
                         ...
                         <div class="col-md-7">
                              <input type="text" readonly=""  name="total_amount" id="total_amount" class="price_float m_input_default" value="<?php echo $form_data['total_amount']; ?>">
                         </div>
                    </div>
               </div>
          </div> <!-- row -->
        ...
        <?php $data= get_setting_value('REG_CHARGE_DAY_CARE_BOOK'); 
          ...
          <div class="row m-b-5">
               <div class="col-md-12">
                    <div class="row">
                         <div class="col-md-5"><b>Registration Charge</b></div>
                         <div class="col-md-7">
                              <input type="text" name="paid_amount" class="price_float m_input_default" id="paid_amount1" 
                              value="<?php echo $data;?>" readonly>
                         </div>
                    </div>
               </div>
          </div> <!-- row -->
         ...
         <div class="row m-b-5">
               <div class="col-md-12">
                    <div class="row">
                         ...
                         <div class="col-md-7">
                              <input type="text" name="paid_amount" class="price_float m_input_default" id="paid_amount1" 
                              value="<?php echo $form_data['paid_amount'];?>" readonly>
                         </div>
                    </div>
               </div>
          </div> <!-- row -->
...
function change_validity_date(vals)
{
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>day_care/get_validate_date/", 
        dataType: "json",
...
$(".txt_firstCap_SO").on('keyup', function(){

   var str = $('.txt_firstCap_SO').val();
   var part_val = str.split(" ");
    for ( var i = 0; i < part_val.length; i++ )
    {
      var j = part_val[i].charAt(0).toUpperCase();
   ...
   $('.txt_firstCap_SO').val(part_val.join(" "));
...
$modal.modal('show');
 ...
 function payment_function(value,error_field){
    $('#updated_payment_detail').html('');
     $.ajax({
        type: "POST",
        url: "<?php echo base_url('day_care/get_payment_mode_data')?>",
...
<?php if(empty($form_data['data_id'])){ ?>
      $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>day_care/generate_token/", 
              dataType: "json",
...
<?php if(empty($form_data['data_id'])){ ?>
  ...
  { 
          ...
          $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>day_care/doctor_rate/", 
              dataType: "json",
        ...
        else if(doctor_id!='' && opd_type=='1')
        {
          ...
          $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>day_care/doctor_emergency_rate/", 
              dataType: "json",
              data: 'branch_id='+branch_id+'&doctor_id='+doctor_id+'&total_amount='+total_amount+'&discount='+discount+'&paid_amount='+paid_amount+'&kit_amount='+kit_amount+'&panel_type='+panel_type+'&ins_company_id='+ins_company_id+'&opd_type='+opd_type,
              success: function(result)
              {
  ...
  function get_validity_date_in_between(vals)
  {
     ...
     $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>day_care/get_validity_date_in_between/", 
              dataType: "json",
              data: 'doctor_id='+doctor_id+'&booking_date='+booking_date+'&patient_id='+patient_id,
                  success: function(result)
                  {
   ...
   if(panel_type=='1')
    {
        ...
        $.ajax({
              type: "POST",
              url: "<?php echo base_url(); ?>day_care/doctor_panel_rate/", 
              dataType: "json",
  ...
  function kit_charge(vals)
  {
      ...
      $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>day_care/package_rate/", 
          dataType: "json",
 ...
 function update_kit_amount(val)
 {
     if(val!='')
     {
        ...
        var discount = $('#discount').val();
         ...
         $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>day_care/update_amount/", 
            dataType: "json",
...
$('#branch_id').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>day_care/get_branch_data/"+branch_id, 
        success: function(result)
        {
           load_values(result);
...
function more_patient_info()
 {
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>day_care/get_simulation_data/"+branch_id, 
    success: function(result)
    {
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>day_care/get_referral_doctor_data/"+branch_id, 
    success: function(result)
    {
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>day_care/get_specialization_data/"+branch_id, 
    success: function(result)
    {
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>day_care/get_attended_doctor_data/"+branch_id, 
    success: function(result)
    {
      $('#attended_doctor').html(result); 
    } 
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>day_care/get_source_from_data/"+branch_id, 
    success: function(result)
    {
  ...
  {
    $.ajax({url: "<?php echo base_url(); ?>day_care/get_diseases_data/"+branch_id, 
    success: function(result)
    {
  ...
  {
      $.ajax({url: "<?php echo base_url(); ?>day_care/get_package_data/"+branch_id, 
      success: function(result)
      {
