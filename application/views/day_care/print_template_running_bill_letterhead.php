...
*/
    ...
    $template_data->setting_value = str_replace("{bill_no}",'',$template_data->setting_value);
     ...
     $template_data->setting_value = str_replace("{booking_date}",date('d-m-Y',strtotime($get_opd_patient_details['admission_date'])),$template_data->setting_value);
    ...
    if(!empty($get_opd_patient_details['doctor_name']))
    {
        $consultant_new = '<div style="width:100%;display:inline-flex;">
            ...
            <div style="width:60%;line-height:17px;">'.'Dr. '. $get_opd_patient_details['doctor_name'].'</div>
            </div>';
    ...
    if(!empty($get_opd_patient_details['booking_code']))
    {
        $receipt_code = '<div style="width:100%;display:inline-flex;">
            ...
            <div style="width:100%;line-height:19px;">'.$get_opd_patient_details['booking_code'].'</div>
            </div>';
        $template_data->setting_value = str_replace("{booking_code}",$receipt_code,$template_data->setting_value);
    }

    if(!empty($get_opd_patient_details['admission_date']))
    {
        $booking_date = '<div style="width:100%;display:inline-flex;">
                        <div style="width:40%;line-height:19px;font-weight:600;">Day Care Reg. Date:</div>

            <div style="width:60%;line-height:19px;">'.date('d-m-Y',strtotime($get_opd_patient_details['admission_date'])).'</div>
            </div>';
        $template_data->setting_value = str_replace("{booking_date}",$booking_date,$template_data->setting_value);
    }

    if(!empty($get_opd_patient_details['created_date']))
    {
        $receipt_date = '<div style="width:100%;display:inline-flex;">
                        <div style="width:40%;line-height:19px;font-weight:600;">Receipt Date:</div>

            <div style="width:60%;line-height:19px;">'.date('d-m-Y h:i A',strtotime($get_opd_patient_details['created_date'])).'</div>
            </div>';
        $template_data->setting_value = str_replace("{receipt_date}",$receipt_date,$template_data->setting_value);
    }

    if(!empty($get_opd_patient_details['room_no']))
    {
        /*$room_no = '<div style="width:100%;display:inline-flex;">
                        <div style="width:40%;line-height:19px;font-weight:600;">Room No.:</div>

            <div style="width:60%;line-height:19px;">'.$get_opd_patient_details['room_no'].'</div>
            </div>';*/
        $template_data->setting_value = str_replace("{room_no}",$get_opd_patient_details['room_no'],$template_data->setting_value);
    }
    else
    {
    ...
    if(!empty($get_opd_patient_details['bad_no']))
    {
       /* $bed_no = '<div style="width:100%;display:inline-flex;">
                        <div style="width:40%;line-height:19px;font-weight:600;">Bed No.:</div>

            <div style="width:60%;line-height:19px;">'.$get_opd_patient_details['bad_no'].'</div>
            </div>';*/
        $template_data->setting_value = str_replace("{bed_no}",$get_opd_patient_details['bad_no'],$template_data->setting_value);
    }
    else
    {
            ...
            $table_data='<div style="float:left;width:100%;margin-top:20px;">
                    ...
                    array_sort_by_column($summurise_arr, 'start_date');
                       ...
                       /* pathalogy charges */
                        ...
                        if(isset($grand_total_amount) && isset($net_advance_data[0]))
                        {
                                 $balance= $grand_total_amount-$net_advance_data[0];
                        }
                        else
                        {
