    ...
    <!--  // prescription button modal -->
                ...
                <div class="row">
                    <div class="col-xs-2">
                        ...
                        <a class="btn-custom m-l-0 m-b-5" href="<?php echo base_url('day_care'); ?>"><i class="fa fa-user"></i> <b>Registered Patient</b></a>
                        
                    </div> <!-- 5 -->
                    <div class="col-xs-5">
                        <div class="row m-b-5">
                            <div class="col-xs-4"><strong>Day Care No.</strong></div>
                            <div class="col-xs-8">
...
<script type="text/javascript">
  ...
  $('#template_list').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>day_care/get_template_data/"+template_id, 
  ...
  function load_values(jdata)
  {
    ...
    {
        $.ajax({url: "<?php echo base_url(); ?>day_care/get_template_test_data/"+template_id, 
        success: function(result)
        {
...
/*<a href="javascript:void(0)" class="btn-w-60 addrow">Add</a>*/
    ...
    {
        $.ajax({url: "<?php echo base_url(); ?>day_care/get_template_prescription_data/"+template_id, 
        success: function(result)
        {
    ...
    function get_prescription_values(result)
    {
     ...
     $('#chief_complaints_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>day_care/complaints_name/"+complaints_id, 
        success: function(result)
        {
    ...
    $('#examination_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>day_care/examination_name/"+examination_id, 
        success: function(result)
        {
    ...
    $('#diagnosis_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>day_care/diagnosis_name/"+diagnosis_id, 
        success: function(result)
        {
     ...
     $('#suggestion_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>day_care/suggetion_name/"+suggetion_id, 
        success: function(result)
        {
           if(suggestion_val!='')
           {
     ...
     $('#personal_history_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>day_care/personal_history_name/"+personal_history_id, 
        success: function(result)
        {
     ...
     $('#prv_history_data').change(function(){  
      ...
      $.ajax({url: "<?php echo base_url(); ?>day_care/prv_history_name/"+prv_history_id, 
        success: function(result)
        {
...
$(function () 
{
      var getData = function (request, response) { 
        row = i ;
        $.ajax({
        url : "<?php echo base_url('day_care/get_medicine_auto_vals/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
      data: {
         name_startsWith: request.term,
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('day_care/get_dosage_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('day_care/get_type_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('day_care/get_duration_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('day_care/get_frequency_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
    var getData = function (request, response) { 
        $.getJSON(
            "<?php echo base_url('day_care/get_advice_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            });
    };
...
$(function () {
    var getData = function (request, response) { 
        /*$.getJSON(
            "<?php echo base_url('day_care/get_test_vals/'); ?>" + request.term,
            function (data) {
                response(data);
            })*/;
            ...
            row = 1;
        $.ajax({
        url : "<?php echo base_url('day_care/get_test_vals/'); ?>" + request.term,
        dataType: "json",
        method: 'post',
          data: {
             name_startsWith: request.term,
