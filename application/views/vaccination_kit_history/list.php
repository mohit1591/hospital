...
{  
    table = $('#table1').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('vaccination_kit_history/ajax_list/').$package_id.'/'.$type; ?>",
            "type": "POST",
...
{ 
   window.location.href='<?php echo base_url('vaccination_kit_history/index/').$package_id.'/'; ?>'+vals;
} 
</script>
    ...
    <form> 
  	...
  	<div class="userlist-right">
  		<div class="btns">
                ...
                <a href="<?php echo base_url('vaccination_kit_history/vaccination_kit_history_excel/').$package_id.'/'.$dept_type; ?>" class="btn-anchor m-b-2">
                <i class="fa fa-file-excel-o"></i> Excel
                </a>
               
                    <a href="<?php echo base_url('vaccination_kit_history/vaccination_kit_history_csv/').$package_id.'/'.$dept_type;; ?>" class="btn-anchor m-b-2">
                         <i class="fa fa-file-word-o"></i> CSV
                    </a>
               
                    <a href="<?php echo base_url('vaccination_kit_history/pdf_vaccination_kit_history/').$package_id.'/'.$dept_type;; ?>" class="btn-anchor m-b-2">
                    <i class="fa fa-file-pdf-o"></i> PDF
                    </a>
                     
                    <a href="javascript:void(0)" class="btn-anchor m-b-2" id="" onClick="return print_window_page('<?php echo base_url("vaccination_kit_history/print_vaccination_kit_history/").$package_id.'/'.$dept_type;; ?>');">
...
function package_quantity_edit(id,row_id){
     ...
     $modal1.load('<?php echo base_url().'vaccination_kit_history/add_medicine_kit_quantity/' ?>'+id+'/'+opt+'/'+row_id,
     {
          //'id1': '1',
          //'id2': '2'
    },
