...
$booking_time1 = date('h:i A', strtotime($all_detail['prescription_list'][0]->dialysis_time)); 
$template_data = str_replace("{date_time}",date('d-m-Y',strtotime($all_detail['prescription_list'][0]->dialysis_date)).' '.$booking_time1,$template_data);
    ...
    if(!empty($all_detail['prescription_list'][0]->validity_date) && $all_detail['prescription_list'][0]->validity_date!='0000-00-00')
{
    ...
    $template_data = str_replace("{doctor_name}",'Dr. '.get_doctor_name($all_detail['prescription_list'][0]->doctor_id),$template_data);
    //get_doctor_qualifications($all_detail['prescription_list'][0]->attended_doctor)
    $template_data = str_replace("{doctor_qualifications}",'',$template_data);
