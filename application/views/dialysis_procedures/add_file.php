        ...
        <div class="row m-b1">
           ...
           <div class="row m-b1">
                ...
                <div class="col-xs-7">
                    ...
                    if(!empty($form_data['old_prescription_img']) && file_exists(DIR_UPLOAD_PATH.'dialysis/prescription/'.$form_data['old_prescription_files']))
                    {
                        $prescription_files = ROOT_UPLOADS_PATH.'dialysis/prescription/'.$form_data['old_prescription_files'];
