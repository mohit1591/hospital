...
{*/
    ...
    ?>
      $(document).ready(function() {
        table = $('#table').DataTable({
          ...
          "pageLength": '25',
          "ajax": {
            "url": "<?php echo base_url('nurses_note_template/ajax_list') ?>",
            "type": "POST",
          },
          "columnDefs": [{
    ...
    function edit_diagnosis(id) {
      var $modal = $('#load_add_diagnosis_modal_popup');
      $modal.load('<?php echo base_url() . 'nurses_note_template/edit/' ?>' + id, {
          //'id1': '1',
          //'id2': '2'
        },
        function() {
    ...
    function view_diagnosis(id) {
      var $modal = $('#load_add_diagnosis_modal_popup');
      $modal.load('<?php echo base_url() . 'nurses_note_template/view/' ?>' + id, {
          //'id1': '1',
          //'id2': '2'
        },
        function() {
      ...
      if (allVals != "") {
        $('#confirm').modal({
          ...
          .one('click', '#delete', function(e) {
            $.ajax({
              type: "POST",
              url: "<?php echo base_url('nurses_note_template/deleteall'); ?>",
              data: {
                row_id: allVals
              },
    ...
    <script>
      function delete_diagnosis(rate_id) {
        $('#confirm').modal({
          ...
          .one('click', '#delete', function(e) {
            $.ajax({
              url: "<?php echo base_url('nurses_note_template/delete/'); ?>" + rate_id,
              success: function(result) {
                flash_session_msg(result);
                reload_table();
              }
