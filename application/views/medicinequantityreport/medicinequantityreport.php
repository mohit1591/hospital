...
function print_options_report(print_option)
{
      ...
      if(print_option!='')
      {
          ...
          { 
              $("#print").removeAttr("onClick");
              $("#print").removeAttr("onClick");
              $("#print").attr("onClick","return openPrintWindows('<?php echo base_url('medicinequantityreport/report_excel?') ?>start_date="+start_date+"&end_date="+end_date+"&module_type="+module_type+"', 'windowTitle', '');");
...
{    
    ...
    if(module_type=='1')
    {
      window.open('<?php echo base_url('medicinequantityreport/print_quantity_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&module_type='+module_type,'mywin','width=800,height=600');
    }
    else
    {
      window.open('<?php echo base_url('medicinequantityreport/print_quantity_reports?') ?>start_date='+start_date+'&end_date='+end_date+'&module_type='+module_type,'mywin','width=800,height=600');    
