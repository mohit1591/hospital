...
$("#discharge_field_master").on("submit", function(event) { 
  ...
  { 
    var path = 'edit/'+ids;
    var msg = 'Dialysis field successfully updated.';
  }
  else
  {
    var path = 'add/';
    var msg = 'Dialysis field successfully created.';
  } 
  //alert('ddd');return false;
  $.ajax({
    url: "<?php echo base_url('dialysis_summary_master/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
...
{
   $.ajax({url: "<?php echo base_url(); ?>dialysis_summary_master/discharge_field_master_dropdown/", 
    success: function(result)
    {
