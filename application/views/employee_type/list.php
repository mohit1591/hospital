...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('employee_type/ajax_list')?>",
            "type": "POST",
...
{
  var $modal = $('#load_add_emp_type_modal_popup');
  $modal.load('<?php echo base_url().'employee_type/edit/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        .one('click', '#delete', function(e)
        {
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('employee_type/deleteall');?>",
                      data: {row_id: allVals},
...
<section class="userlist">
    ...
    <form>
      ...
      {
      ?>
        <button class="btn-update" onclick="window.location.href='<?php echo base_url('employee_type/archive'); ?>', 'ok()';">
...
<script>  
 ...
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('employee_type/delete/'); ?>"+rate_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
