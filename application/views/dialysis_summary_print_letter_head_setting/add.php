    ...
    ?>
      ...
      <div class="col-xs-12 m-b-5 m12">
        <div class="row">
          ...
          <div class="col-xs-3">
          <?php if($setting_list->setting_name=='DIALYSIS_SUMMARY_PRINT_SETTING') { ?>
          </div>
        </div>
      ...
      <div  class="row m-b-5">
        ...
        <div class="col-xs-8">
          <div style="margin-left:-1.2%;padding-right: 4.8em;">
            <textarea readonly="" class="form-control" cols="" rows="6">{patient_reg_no},{patient_name},{patient_age},{mobile_no},{address},{booking_code},{dialysis_date},{doctor_name}, {investigation_list} , {medicine_detail} , {vitals_pulse}{vitals_chest}{vitals_bp}{vitals_cvs}{vitals_temp}{vitals_cns}{vitals_p_a} {signature} . </textarea>
...
for (instance in CKEDITOR.instances) {
  ...
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>dialysis_summary_print_letter_head_setting/",
    type: "post",
    data: $(this).serialize(),
