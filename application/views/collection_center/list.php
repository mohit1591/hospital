...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "pageLength": '20',
        "ajax": {
            "url": "<?php echo base_url('collection_center/ajax_list')?>",
            "type": "POST",
...
function edit_collection_center(id)
{
  var $modal = $('#load_add_emp_type_modal_popup');
  $modal.load('<?php echo base_url().'collection_center/edit/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        .one('click', '#delete', function(e)
        {
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('collection_center/deleteall');?>",
                      data: {row_id: allVals},
...
<section class="userlist">
    ...
    <form>
      ...
      {
      ?>
        <button class="btn-update" onclick="window.location.href='<?php echo base_url('collection_center/archive'); ?>'">
...
<script>  
 ...
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('collection_center/delete/'); ?>"+rate_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
