...
<div class="row">
  <div class="col-md-12 add_medicine_print_setting">
    <form action="<?php echo base_url('vaccination_print_setting/add'); ?>" method="post">
    <div class="row m-b-5">
      <div class="col-xs-2">
...
<script>
  function get_template_according(value){
   var sub_section= $('#sub_section_data').val();
    ...
    $.ajax({
      type:"POST",
      url: "<?php echo base_url(); ?>vaccination_print_setting/medicine_printtemplate_dropdown/", 
