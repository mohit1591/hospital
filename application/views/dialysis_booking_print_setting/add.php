...
<div class="row">
  <div class="col-md-12 add_ipd_print_setting">
    <form action="<?php echo base_url('dialysis_booking_print_setting/add'); ?>" method="post">
    <div class="row m-b-5">
      <div class="col-xs-2">
    ...
    <div class="row m-b-5">
      ...
      <div class="col-xs-9" >
      <textarea type="text" name="short_code"  class="print_textarea"  cols="45" value="" readonly />
      {pateint_reg_no},{patient_name},{mobile_no},{gender_age},{ipd_no},{reciept_date},{pateint_address},{dialysis_date_time},{doctor_name},{package_name},{package_type},{package_days},{package_amount},{package_remarks},{note},{dialysis},{signature}, {dialysis_booking_date} , {dialysis_date}  {dialysis_name},  {patient_reg_no}  ,  {s_no}  ,{particular_name}, {total_amount}, {discount}  ,   {net_amount}  ,   {paid_amount}  ,   {balance}  ,  {start_loop}  ,  {end_loop}  ,  {remarks}  ,  {parent_relation_type}  ,  {parent_relation_name}  , {adhar_no}  , {religion} , {dob}  , {relation_name}  , {guardian_name}  , {guardian_email}  , {guardian_phone} , {guardian_relation} , {patient_email}  , {insurance_type} , {insurance_type_name}  , {insurance_company_name} , {insurance_policy_no} , {insurance_tpa_id} , {insurance_amount} , {auth_no} , {referred_by} , {referrer_name} , {attented_doctors} , {assigned_doctor} , {dialysis_date_time} , {mobile_no} , {patient_address} , {hospital_receipt_no} , {booking_date} , {room_type} , {room_no}  , {bed_no} , {payment_mode} ,  {package_name} , {sales_name}</textarea>
      </div>
    </div> <!-- rowClose -->
    ...
    <div class="row m-b-5">
      ...
      <div class="col-xs-10">
       <button class="btn-save" type="submit" name="remove_levels" onClick=" validateForm();" ><i class="fa fa-floppy-o"></i> Save</button>
             <button type="button" class="btn-update" onclick="window.location.href='<?php echo base_url('dialysis_booking'); ?>'">
...
<script>
  function get_template_according(value){
    ...
    $.ajax({
      type:"POST",
      url: "<?php echo base_url(); ?>dialysis_booking_print_setting/dialysis_booking_printtemplate_dropdown/", 
      data: {value: value},
      datatype:'JSON',
