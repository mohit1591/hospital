...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "order": [], 
        "ajax": {
            "url": "<?php echo base_url('bnkarchive-acc')?>",
            "type": "POST",
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('bank_account/restoreall');?>",
                      data: {row_id: allVals},
...
<section class="userlist">
    ...
    <form>
       ...
       <!-- bootstrap data table -->
        <table id="table" class="table table-striped table-bordered employee_type_archive" cellspacing="0" width="100%">
  	...
  	<div class="userlist-right">
        ...
        ?>
        <button class="btn-update" onclick="window.location.href='<?php echo base_url('bank_account'); ?>'">
...
<script>  
 ...
 function restore_bank_account(bank_account_id)
 {    
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('bank_account/restore/'); ?>"+bank_account_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
...
{         
  ...
  function trash(bank_account_id)
 {     
    $('#confirm').modal({
      backdrop: 'static',
      keyboard: false, 
    ...
    { 
        $.ajax({
                 url: "<?php echo base_url('bank_account/trash/'); ?>"+bank_account_id, 
                 success: function(result)
                 {
                    flash_session_msg(result);
                    reload_table(); 
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('bank_account/trashall');?>",
                      data: {row_id: allVals},
                      success: function(result) 
                      {
                            flash_session_msg(result);
