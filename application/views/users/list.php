...
var table;
<?php
if(in_array('22',$users_data['permission']['action'])) 
{
?>
...
{
  var $modal = $('#load_add_modal_popup');
  $modal.load('<?php echo base_url().'users/edit/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
...
{
  var $modal = $('#load_add_modal_popup');
  $modal.load('<?php echo base_url().'users/view/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
   ...
   if(allVals!="")
   {
      ...
      keyboard: false
        ...
        { 
            $.ajax({
                      type: "POST",
                      url: "<?php echo base_url('users/deleteall');?>",
                      data: {row_id: allVals},
...
<section class="userlist">
    <div class="userlist-box">
  	...
  	<div class="userlist-right">
  		<div class="btns">
        <?php
        if(in_array('23',$users_data['permission']['action'])) 
        {
        ?>
         <button class="btn-new-red" id="modal_add">
        ...
        {
        ?>
         <button class="btn-update" onclick="window.location.href='<?php echo base_url('users/archive'); ?>'">
