...
<div class="overlay-loader" id="overlay-loader">
  ...
  <input type="hidden" name="data_id" id="type_id" value="<?php echo $form_data['data_id']; ?>" /> 
    ...
    <input type="hidden" name="package_amount" id="package_amount" value="<?php echo $form_data['package_amount']; ?>" /> 
...
function check_type(divsize,type_data)
{
    ...
    if(type_data==1)
    {
       ...
       else
       {
        ...
        $('#particular_div_'+divsize).html('<div class="col-md-7"><input type="text" name="doctor_wise['+divsize+'][particular_name][]" value="" id="particular_name_'+divsize+'" class="w-90px particular_name"/><input type="hidden" name="doctor_wise['+divsize+'][particular_id][]" id="particular_id_'+divsize+'" value=""/> <select name="doctor_wise['+divsize+'][master_type][]" class="w-50px master_type"><option value="0" > Rs </option><option value="1" > % </option></select> <input type="text" name="doctor_wise['+divsize+'][master_rate][]"  class="w-50px rate_plan" value=""> <a href="javascript:void(0)" class="btn-new" onclick="'+onclick_event+'"><i class="fa '+css_c+'"></i></a></div>');
...
$("#ot_pacakge_detail").on("submit", function(event) { 
  ...
  //////// Check Validtion
  var pack_amount = $('#package_amount').val();
   if(pack_amount!="")
   {
       var total_val = 0;
