       ...
       <div class="row">
            <div class="col-md-12">
                 <label><b>From Date:</b></label>
                      <input type="text" id="start_date" value="<?php echo $form_data['from_date'] ;?>" name="from_date" class="datepicker">
                      
                 <label><b>To Date:</b></label>
                      <input type="text" value="<?php echo $form_data['to_date'] ;?>" name="to_date" id="end_date" class="datepicker">
...
{ 
   ...
   window.open('<?php echo base_url('reports/print_dialysis_expenses_reports?') ?>branch_id='+branch_id+'&start_date='+start_date+'&end_date='+end_date,'mywin','width=800,height=600');
}  
