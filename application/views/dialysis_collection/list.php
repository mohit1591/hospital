...
$(document).ready(function() { 
    table = $('#table').DataTable({  
        ...
        "aaSorting": [],
        "ajax": {
            "url": "<?php echo base_url('dialysis_collection_report/ajax_list')?>",
            "type": "POST"
        }, 
        "columnDefs": [
        { 
...
$('#employee').val('');
      $.ajax({
         url: "<?php echo base_url('dialysis_collection_report/reset_date_search/'); ?>",  
...
$modal.load('<?php echo base_url().'dialysis_collection_report/advance_search/' ?>',
{
//'id1': '1',
//'id2': '2'
},
...
<div class="grp media_float_left" id="search_box_user">
              <b>User</b> 
              <select name="employee" class="m_input_default" id="employee" onchange="return form_submit();" style="width: 140px;">
      ...
      <div class="grp">
       ...
       <?php //if(in_array('207',$users_data['permission']['action'])): ?>
      ...
      <div class="fixed">
        <div class="btns"> 
          <?php //if(in_array('768',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('dialysis_collection_report/dialysis_report_excel'); ?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-excel-o"></i> Excel
               </a>
          <?php //endif;?>
          <?php //if(in_array('769',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('dialysis_collection_report/dialysis_report_csv'); ?>" class="btn-anchor m-b-2">
               <i class="fa fa-file-word-o"></i> CSV
               </a>
          <?php //endif;?>
          <?php //if(in_array('770',$users_data['permission']['action'])): ?>
               <a href="<?php echo base_url('dialysis_collection_report/pdf_dialysis_report'); ?>" class="btn-anchor m-b-2">
          ...
          <?php if(in_array('771',$users_data['permission']['action'])): ?>
            ...
            <a href="javascript:void(0)" class="btn-anchor m-b-2" onClick="return print_window_page('<?php echo base_url("dialysis_collection_report/print_dialysis_report"); ?>');">
...
var employee = $('#employee').val();
    ...
    $.ajax({ 
           url: "<?php echo base_url('dialysis_collection_report/search_data/'); ?>", 
           type: 'POST',
