     ...
     <form id="prescription_tab_setting_form">
      ...
      <div class="row">
        <div class="col-xs-6 br-h-small">
         ...
         <div class="col-xs-6">
          <div class="row">
            <div class="col-xs-8"><strong class="m14 p-l-2em">Value</strong></div>
      ...
      <?php 
        ...
        if(!empty($procedure_note_tab_setting_list))
        {
          foreach($procedure_note_tab_setting_list as $tab_setting_list)
          {
        ?>
      <div class="row">
        <div class="col-xs-6 br-h-small">
              <div class="row">
                <div class="col-xs-6">
                  <strong><?php echo ucwords(str_replace('_',' ',$tab_setting_list->var_title)); ?></strong> <!-- text-uppercase -->
                </div>
                <div class="col-xs-6">
                    <input class="form-control text-13px" style="width:100%" readonly  name="data[<?php echo $tab_setting_list->id; ?>][setting_name]" value="<?php echo $tab_setting_list->var_title; ?>"  onkeypress="return onlyAlphabets(event,this);" type="text" data-toggle="tooltip"  title="Allow only characters." class="tooltip-text" <?php if(!empty($tab_setting_list->setting_name)){ echo 'readonly'; } ?>>
                </div>
              </div> <!-- innerRow -->
        </div> <!-- 6 -->
        <div class="col-xs-6">
              <div class="row">
                <div class="col-xs-8">
                  <div class="p-l-2em">
                    <input class="form-control text-13px media5" style="width:100%" name="data[<?php echo $tab_setting_list->id; ?>][setting_value]" value="<?php echo $tab_setting_list->var_value; ?>" type="text" placeholder="Custom Name" data-toggle="tooltip"  title="Custom Name" class="tooltip-text">
                    </div>
                </div>
...
$("#prescription_tab_setting_form").on("submit", function(event) { 
  ...
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>procedure_note_tab_setting/",
    type: "post",
    data: $(this).serialize(),
