...
<div class="row">
  <div class="col-md-12 add_opd_print_setting">
    <form action="<?php echo base_url('opd_print_setting/add'); ?>" method="post">
    <div class="row m-b-5">
      <div class="col-xs-2">
...
{Consultant}  , {specialization}  ,   {next_app_date}  , {total_amount} ,  {total_discount}  , {net_amount}  ,  {paid_amount},  {balance} {Quantity_level} , {start_loop} ,  {s_no} ,  {particular}  ,  {quantity} ,  {amount}  , {end_loop}  ,  {payment_mode}  ,   {remarks}  ,  {token_no}   ,  {panel_type}  ,  {referral_by}  ,   {email_address}  ,  {source_from}  ,    {diseases}   ,    {validity_date}   ,   {remarks}   ,   {adhar_no}   ,   {marital_status}   ,   {religion_name}  ,   {father_husband}  ,   {mother} ,
 {guardian_name}   ,   {guardian_email}  ,  {guardian_phone}   ,     {relation}   ,    {monthly_income}   ,    {occupation},   {insurance_type}  ,   {insurance_name}  ,   {insurance_company}   ,   {policy_no}    ,   {tpa_id}   ,   {ins_amount}   ,   {ins_authorization_no}   ,  {parent_relation_type}  ,   {parent_relation_name} {patient_category_name} {authorize_person_name}   ,    ⁠{date_time_new}</textarea>
      </div>
    </div> <!-- rowClose -->
...
<script>
  function get_template_according(value){
    ...
    $.ajax({
      type:"POST",
      url: "<?php echo base_url(); ?>opd_print_setting/opd_printtemplate_dropdown/", 
      data: {value: value},
      datatype:'JSON',
