      ...
      <div class="modal-body">   
          ...
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row">
                <div class="col-md-5">
                    <label>Camp Date<span class="star">*</span></label>
                </div>
                <div class="col-md-7">
...
$("#camp_type").on("submit", function(event) { 
  ...
  $.ajax({
    url: "<?php echo base_url('eye/camp_details/'); ?>"+path,
    type: "post",
    data: $(this).serialize(),
    success: function(result) {
      if(result==1)
...
{
   $.ajax({url: "<?php echo base_url(); ?>eye/bag_type/deferral_reason_dropdown/", 
    success: function(result)
    {
...
function get_camp_dropdown()
{
   $.ajax({url: "<?php echo base_url(); ?>eye/camp_details/camp_dropdown/", 
    success: function(result)
    {
      $('#camp_id').html(result); 
    } 
