...
<div class="modal-dialog " style="max-width:80%;">
  ...
  <form  id="laboratory_set_form" class="form-inline"> 
   <input type="hidden" name="data_id" id="lab_set_id" value="<?php echo $form_data['data_id']; ?>">
   <div class="modal-body">


    <div class="row mb-2">
      <label class="col-md-4">Set Name : <span class="text-danger">*</span></label>
      <div class="col-md-8">
        ...
        <div class="row mb-2">
          ...
          <div class="col-md-8" id="append_div">
            ...
            <div class="row test_add_<?php echo $i ;?>">
              <div class="col-md-5"> 
                <input type="text" name="investig_name[]" id="investig_name" class="custom-select" value="<?php echo $investigation->investig_name ;?>">
...
<script>  
 ...
 $("#laboratory_set_form").on("submit", function(event) { 
  ...
  if(id=="")
  {
    var msg='Laboratory Set saved successfully';
    var path="<?php echo base_url('eye/laboratory_set/add'); ?>";
  }
  else{
    var msg='Laboratory Set updated successfully';
    var path="<?php echo base_url('eye/laboratory_set/edit/'); ?>"+id;
  }
