...
<section class="userlist">
    ...
    <!--  // prescription button modal -->
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5">
                        ...
                        <div class="row m-b-5">
                            ...
                            <div class="col-xs-8">
                                <input type="text" readonly name="patient_name" value="<?=get_simulation_name($form_data['simulation_id'])?> <?php echo $form_data['patient_name']; ?>">
                            </div>
                        </div>
                         ...
                         <div class="row m-b-5">
                            ...
                            <div class="col-xs-8">
                                <input type="text" readonly name="aadhaar_no" value="<?php echo $form_data['aadhaar_no']; ?>">
                    ...
                    <div class="col-xs-5">
                        <div class="row m-b-5">
                            ...
                            <div class="col-xs-8">
                                <input type="text" readonly name="mobile_no" value="<?php echo $form_data['mobile_no']; ?>">
                            </div>
                        </div>
                        <div class="row m-b-5 m-b-5">
                            ...
                            <div class="col-xs-8">
                               <input type="radio" name="gender" value="1" <?php if($form_data['gender']==1){ echo 'checked="checked"'; } ?> readonly> Male &nbsp;
                                <input type="radio" readonly name="gender" value="0" <?php if($form_data['gender']==0){ echo 'checked="checked"'; } ?>> Female
                ...
                <div class="row m-t-10">
                   ...
                   <select name="template_list"  id="template_list" >
                     ...
                     ?>
                        ...
                        <a href="<?=base_url('eye/prescription_template/add')?>" target="_blank" class="btn btn-success"><i class="fa fa-plus"></i> Add new</a>
                    </div>
                    <div class="col-xs-3">
                        <label for="">
                            <b>Date Time</b>
                ...
                <div class="row m-t-10">
                            ...
                            <div id="tab_previous_history" class="inner_tab_box tab-pane fade  <?php if($j==1){ ?> in active <?php  } ?>">
                                <div class="row m-t-10">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <a href="<?=base_url('eye/previous_history')?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-plus"></i> Add new</a>
                            ...
                            <div id="tab_personal_history" class="inner_tab_box tab-pane fade <?php if($j==1){ ?> in active <?php  } ?>">
                                <div class="row m-t-10">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <a href="<?=base_url('eye/personal_history')?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-plus"></i> Add new</a>
                  ...
                  <div id="tab_chief_complaint" class="inner_tab_box tab-pane fade <?php if($j==1){ ?> in active <?php  } ?>">
                    ...
                    <a href="<?=base_url('eye/chief_complaints')?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-plus"></i> Add new</a>
                      ...
                      <div class="row m-t-10">
                          ...
                          <div class="col-xs-4">
                              <div class="well tab-right-scroll">
                                  ...
                                  <div class="grp">DSHPT1</div>
                                  <div class="grp">DSHPT1</div> -->
                                  <input type="text" name="chief_complaints_search" data-appendId="systemic_illness_data" class="dropdown-box select-box-search-event" style="width: 300px;" placeholder="Type here for systemic illness">
                                  <a href="<?=base_url('eye/systemic_illness')?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-plus"></i> Add new</a>
                          ...
                          <div class="row m-t-10">
                              ...
                              <div class="col-xs-4">
                                  <div class="well tab-right-scroll">
                                      ...
                                      <a href="<?=base_url('eye/diagnosis')?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-plus"></i> Add new</a>
                            ...
                            <div id="tab_examination" class="inner_tab_box tab-pane fade <?php if($j==1){ ?> in active <?php  } ?>">
                                <div class="row m-t-10">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <a href="<?=base_url('eye/examination')?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-plus"></i> Add new</a>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $i=1;if(!empty($prescription_test_list))
                                                      ...
                                                      foreach($prescription_test_list as $test_list) {?>
                                                        ...
                                                        <td width="80">
                                                            <a title="Click to Remove Test" href="javascript:void(0)" class="btn-w-60">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php $i++;} } ?>
   ...
   //print '<pre>'; print_r($prescription_medicine_tab_setting);
    ...
    { 
    ?>
    <td><input type="text" name="prescription[<?php echo $l; ?>][medicine_advice]" class="medicine-name advice_val<?php echo $l; ?> form-control" value="<?php echo $prescriptiontemplate->medicine_advice; ?>"></td>
    <?php } 
  ...
  ?>        
        ...
        <script type="text/javascript">
                ...
                <td width="80">
                    <a title="Click to Remove Medicine" href="javascript:void(0)" onclick="delete_prescription_medicine('<?php echo $prescriptiontemplate->id; ?>,<?php echo $form_data['data_id']; ?>');" class="btn-w-60">Delete</a>
                </td>
                </tr>
                                ...
                                <div class="row m-t-10">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="well tab-right-scroll">
                                            ...
                                            <a href="<?=base_url('eye/suggestion')?>" class="btn btn-success btn-xs" target="_blank"><i class="fa fa-plus"></i> Add new</a>
...
function get_systemic_illness_values(result)
    ...
    //   var systemic_illness_val = $("#systemic_illness").val();
      var systemic_illness_val = CKEDITOR.instances.systemic_illness.getData();
    ...
    function get_prescription_values(result)
    {
      ...
      $.each(obj, function (index, value) {       
         pres += '<tr><td><input type="checkbox" name="is_eye_drop" value="'+i+'" onclick="check_eye_drop('+i+');" id="is_eye_drop'+i+'"/></td><?php foreach ($prescription_medicine_tab_setting as $tab_value) 
                        ...
                        if(strcmp(strtolower($tab_value->setting_name),'advice')=='0')
                        { 
                        ?>                        <td width="20%"><input type="text" name="prescription['+i+'][medicine_advice]" class="w-100px medicine-name" value="'+obj[index].medicine_advice+'"></td>                        <?php } 
...
$(".addprescriptionrow").click(function(){ 
  ...
  var i=$('#prescription_name_table tr').length;
        $("#prescription_name_table").append('<tr><td><input type="checkbox" name="is_eye_drop" value="'+i+'" onclick="check_eye_drop('+i+');" id="is_eye_drop'+i+'"/></td><?php foreach ($prescription_medicine_tab_setting as $tab_value) 
                        ...
                        if(strcmp(strtolower($tab_value->setting_name),'advice')=='0')
                        { 
                        ?>                        <td><input type="text" name="prescription['+i+'][medicine_advice]" class="form-control medicine-name advice_val'+i+'"></td>                        <?php } 
                      } ?>
                      <td width="80"><a href="javascript:void(0);" class="btn-w-60 remove_prescription_row">Delete</a></td></tr>');
                            $('.datepicker_m').datepicker({
                                format: 'dd-mm-yyyy',
