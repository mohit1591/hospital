    ...
    <input type="hidden" name="prescription_id" id="prescription_id" value="<?php echo $form_data['prescription_id']; ?>">
        ...
        <div class="modal-body">    
           <div class="row m-b1">
                ...
                <div class="col-xs-7">
                Allow, Only (pdf|jpeg|jpg|png|xls|csv)
...
$("#prescription_files_form").on("submit", function(event) { 
  ...
  {
     var path = 'edit_eye_prescription_file/'+data_id+'/'+prescription_id;
     var msg = "Prescription successfully updated.";
  }
  else
  {
     var path = 'upload_eye_prescription'+'/'+prescription_id;
     var msg = "Prescription file successfully added.";
  }

  $.ajax({
    url: "<?php echo base_url('eye/add_prescription/'); ?>"+path,
    type: "post", 
