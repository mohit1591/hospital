					...
					<div class="row m-t-5">
						...
						<div class="col-lg-4">
							...
							<select name="advs[advice][app_type]" class="w-200px">
							  	<option <?php if($advice_adv['app_type']=="1"){ echo 'selected';} ?> value="1">Review</option>
							  	<option <?php if($advice_adv['app_type']=="0"){ echo 'selected';} ?> value="0">New</option>
							  	<option <?php if($advice_adv['app_type']=="2"){ echo 'selected';} ?> value="2">Post OP</option>
							</select>
						</div>
						<div class="col-lg-4">
