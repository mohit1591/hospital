      ...
      <div class="modal-body">   
          ...
          <div class="row">
            <div class="col-md-12 m-b1">
              <div class="row">
                <div class="col-md-4">
                    <label>Report Break<span class="star">*</span></label>
                </div>
                <div class="col-md-8"> 

                     <input type="radio" name="report_break" value="1" <?php if(!empty($report_setting['report_break']) && $report_setting['report_break']=='1'){ echo 'checked="checked"'; } ?> /> Continue without break 
                     <br/>
                     <input type="radio" name="report_break" value="2" <?php if(!empty($report_setting['report_break']) && $report_setting['report_break']=='2'){ echo 'checked="checked"'; } ?> /> Head/Profile wise break
                      <br/>
                     <input type="radio" name="report_break" value="0" <?php if(empty($report_setting['report_break'])){ echo 'checked="checked"'; } ?> /> Normal  
                </div>
              </div> <!-- innerrow -->
            </div> <!-- 12 -->
          </div> <!-- row -->  
