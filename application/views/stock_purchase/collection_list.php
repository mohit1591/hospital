    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        ...
        <div class="row m-b-5">
           ...
           <div class="col-xs-7">
              <input type="text" name="vendor_name" id="vendor_name" value="<?php echo $form_data['vendor_name'];?>" onkeyup="return form_submit();">
           </div>
        </div> 
      </div>  
...
{ 
  ...
  $.ajax({
         ...
         type: 'POST',
         data: { start_date: start_date, end_date : end_date,purchase_no:purchase_no,vendor_name:vendor_name} ,
         success: function(result)
         { 
            if(vals!="1")
            {
