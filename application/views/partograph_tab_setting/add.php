...
<section class="userlist">
    ...
    <div class="overlay-loader">
     ...
     <form id="parto_tab_setting_form">
      ...
      <?php
       ...
       // {
        if(!empty($partograph_tab_setting_list))
        {
          foreach($partograph_tab_setting_list as $tab_setting_list)
          {
        ?>
      <div class="row">
        <div class="col-xs-4 br-h-small">
...
$("#parto_tab_setting_form").on("submit", function(event) { 
  event.preventDefault(); 
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>gynecology/partograph_tab_setting/",
    type: "post",
    data: $(this).serialize(),
