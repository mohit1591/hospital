      ...
      <div class="col-xs-12 m-b-5 m12">
        <div class="row">
          ...
          <div class="col-xs-3" style="padding-left:7px;">
             ...
             <textarea cols="45" readonly="" class="print_textarea">{patient_reg_no},{patient_name},{patient_age},{patient_address},{booking_code},{booking_time},{mobile_no},{booking_date},{token_no},{doctor_name},{ref_doctor_name},{patient_bp},{patient_temp},{patient_weight},{patient_pr},{patient_spo},{patient_rbs},{prv_history}, {personal_history}, {chief_complaints}, {examination}, {diagnosis}, {patient_test_name}, {patient_pres}, {suggestion}, {remark}, {appointment_date},{doctor_qualifications}, {signature} </textarea>
        </div>
     </div>
     </div>
     </div>
...
for (instance in CKEDITOR.instances) {
  ...
  $('.overlay-loader').show();
  $.ajax({
    url: "<?php echo base_url(); ?>blank_prescription_setting/",
    type: "post",
    data: $(this).serialize(),
...
function preview_template(id)
{
  ...
  $modal.load('<?php echo base_url().'blank_prescription_setting/preview/' ?>'+id,
  {
    //'id1': '1',
    //'id2': '2'
    },
